...
.method public static c(I)Layq;
    ...
    .line 2
    invoke-static {p0, v1, v1}, Layq;->a(IZZ)Landroid/os/Bundle;

    move-result-object v1

    invoke-virtual {v0, v1}, Layq;->setArguments(Landroid/os/Bundle;)V
...
.method private final u()I
    ...
    .prologue
    .line 148
    iget-object v0, p0, Layq;->E:Landroid/widget/Spinner;
...
.method public final b()V
    ...
    .prologue
    .line 133
    iget-object v0, p0, Layq;->w:Landroid/widget/TextView;
...
.method public final c()V
    ...
    iget-object v1, p0, Layq;->q:Ljava/lang/String;
...
.method public final f()Landroid/content/Loader;
    ...
    iget-object v2, p0, Layq;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    iget v3, p0, Layq;->c:I

    .line 154
    invoke-direct {v0, v1, v2, v3}, Layu;-><init>(Landroid/content/Context;Lcom/android/email/activity/setup/SetupDataFragment;I)V
...
.method public final g()I
    ...
    .line 156
    iget-object v0, p0, Layq;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    .line 159
    iget-object v0, p0, Layq;->D:Landroid/widget/Switch;
    ...
    invoke-virtual {p0, v1, v3}, Layq;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 161
    if-eqz v0, :cond_0

    .line 162
    iget-object v0, p0, Layq;->x:Landroid/widget/EditText;
    ...
    .line 163
    iget-object v1, p0, Layq;->y:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 167
    :goto_0
    iget-object v0, p0, Layq;->A:Landroid/widget/EditText;
    ...
    .line 168
    :try_start_0
    iget-object v0, p0, Layq;->C:Landroid/widget/EditText;
    ...
    invoke-virtual {p0, v0, v4}, Layq;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v5}, Layq;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 176
    iget-object v4, p0, Layq;->i:Ljava/lang/String;
...
.method protected final j()Landroid/widget/TextView;
    ...
    .prologue
    .line 180
    iget-object v0, p0, Layq;->F:Landroid/widget/TextView;
...
.method protected final k()Landroid/widget/TextView;
    ...
    .prologue
    .line 181
    iget-object v0, p0, Layq;->G:Landroid/widget/TextView;
...
.method protected final l()Landroid/widget/LinearLayout;
    ...
    .prologue
    .line 182
    iget-object v0, p0, Layq;->B:Landroid/support/design/widget/TextInputLayout;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 43
    invoke-virtual {p0}, Layq;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {v5, v6, v7}, Lbco;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 73
    iget-object v3, p0, Layq;->a:Landroid/content/Context;
    ...
    .line 74
    iget-object v3, p0, Layq;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    iget-object v4, p0, Layq;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    .line 81
    iget-object v4, v4, Lcom/android/email/activity/setup/SetupDataFragment;->d:Landroid/os/Bundle;

    .line 82
    invoke-static {v3, v0, v4}, Lbir;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Landroid/os/Bundle;)V
    ...
    .line 93
    iget-object v4, p0, Layq;->x:Landroid/widget/EditText;

    invoke-virtual {v4, v3}, Landroid/widget/EditText;->setText(Ljava/lang/CharSequence;)V

    .line 94
    iget-object v3, p0, Layq;->D:Landroid/widget/Switch;
    ...
    invoke-static {v3}, Lbcf;->a(Landroid/content/Context;)Lbcf;

    move-result-object v3

    invoke-virtual {v3}, Lbcf;->b()Z

    move-result v3

    .line 97
    iget-object v4, p0, Layq;->y:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 99
    iget-object v4, p0, Layq;->E:Landroid/widget/Spinner;

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-static {v4, v3}, Lbco;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V
    ...
    .line 102
    iget-object v4, p0, Layq;->A:Landroid/widget/EditText;
    ...
    .line 105
    iget-object v4, p0, Layq;->C:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Layq;->e:Lcom/android/emailcommon/provider/HostAuth;

    .line 111
    invoke-virtual {v3}, Landroid/os/Parcel;->recycle()V

    .line 112
    iput-boolean v1, p0, Layq;->H:Z

    .line 113
    invoke-virtual {p0}, Layq;->q()V
    ...
    .line 68
    invoke-virtual {p0}, Layq;->a()Z

    move-result v3

    invoke-virtual {p0, v0, v3}, Layq;->a(Lcom/android/emailcommon/provider/HostAuth;Z)V

    goto/16 :goto_2

    .line 106
    :cond_b
    invoke-virtual {p0}, Layq;->r()V
...
.method public final onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    .line 143
    :goto_0
    invoke-virtual {p0}, Layq;->getView()Landroid/view/View;

    move-result-object v1

    sget v2, Lavh;->J:I

    invoke-static {v1, v2, v0}, Lavr;->a(Landroid/view/View;II)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Layq;->H:Z

    .line 8
    :cond_0
    const-string v0, "smtp"

    iput-object v0, p0, Layq;->i:Ljava/lang/String;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Layq;->w:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Layq;->x:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Layq;->y:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    iput-object v0, p0, Layq;->z:Landroid/support/design/widget/TextInputLayout;
    ...
    iput-object v0, p0, Layq;->A:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Layq;->B:Landroid/support/design/widget/TextInputLayout;
    ...
    iput-object v0, p0, Layq;->C:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Layq;->D:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Layq;->E:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Layq;->F:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Layq;->G:Landroid/widget/TextView;
    ...
    .line 31
    iget-object v0, p0, Layq;->y:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    invoke-direct {v2, p0}, Layr;-><init>(Layq;)V
    ...
    invoke-direct {v0, p0}, Layt;-><init>(Layq;)V

    .line 34
    iget-object v2, p0, Layq;->x:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 35
    iget-object v2, p0, Layq;->A:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 36
    iget-object v2, p0, Layq;->C:Landroid/widget/EditText;
    ...
    .line 38
    invoke-virtual {p0, v1}, Layq;->a(Landroid/view/View;)V
    ...
    .line 17
    invoke-virtual/range {v0 .. v5}, Layq;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;IIZ)Landroid/view/View;
...
.method final q()V
    ...
    invoke-static {v2}, Lbqi;->b(Landroid/widget/TextView;)Z

    move-result v2

    .line 123
    iget-object v3, p0, Layq;->A:Landroid/widget/EditText;
    ...
    .line 125
    iget-object v2, p0, Layq;->z:Landroid/support/design/widget/TextInputLayout;

    sget v3, Lavk;->aT:I

    invoke-virtual {p0, v3}, Layq;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v2}, Lbqi;->a(Landroid/widget/TextView;)Z
    ...
    iget-object v2, p0, Layq;->y:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 131
    :goto_3
    invoke-virtual {p0, v0}, Layq;->a(Z)V

    goto :goto_0

    .line 127
    :cond_1
    iget-object v3, p0, Layq;->z:Landroid/support/design/widget/TextInputLayout;
...
.method final r()V
    ...
    .line 151
    iget-object v1, p0, Layq;->C:Landroid/widget/EditText;
...
.method public final t()V
    ...
    invoke-virtual {p0, v0, v1}, Layq;->startActivityForResult(Landroid/content/Intent;I)V
