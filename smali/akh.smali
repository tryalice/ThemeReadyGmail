...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Lakh;->b:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lmx;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-direct {p0, v0, p2}, Lakh;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lmx;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lakh;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 49
    iget-object v0, p0, Lakh;->c:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 50
    iput-object v1, p0, Lakh;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Lakh;->b:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Lard;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lard;

    move-result-object v4

    .line 5
    invoke-virtual {v4, v3}, Lard;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    iget-object v5, p0, Lakh;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lakh;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 21
    :cond_2
    invoke-virtual {v4, v9}, Lard;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 23
    iget-object v1, p0, Lakh;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lakh;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
