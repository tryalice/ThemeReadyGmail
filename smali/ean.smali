...
.method static constructor <clinit>()V
    ...
    .line 204
    sput-object v0, Lean;->a:Ljava/lang/String;
...
.method public final a(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;

    if-nez v0, :cond_0

    .line 72
    iget-object v0, p0, Lean;->f:Landroid/content/Context;
    ...
    iput-object v0, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;

    .line 75
    :cond_0
    iget-object v0, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;

    iget-object v1, p0, Lean;->c:Leak;

    .line 76
    iput-object v1, v0, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;->e:Leak;
    ...
    invoke-direct {v2, v0, v1}, Lebu;-><init>(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/QuickReplyButton;Leak;)V
...
.method public final synthetic a(Landroid/content/Context;Lorg/apache/http/client/HttpClient;)Leaj;
    .locals 3

    .prologue
    .line 197
    .line 198
    iput-object p1, p0, Lean;->f:Landroid/content/Context;
    ...
    iget-object v2, p0, Lean;->f:Landroid/content/Context;

    invoke-direct {v1, v2}, Leda;-><init>(Landroid/content/Context;)V

    invoke-direct {v0, p2, v1}, Leam;-><init>(Lorg/apache/http/client/HttpClient;Leda;)V

    iput-object v0, p0, Lean;->b:Leam;
...
.method public final a(Leak;Landroid/os/Bundle;)Leaj;
    .locals 4

    .prologue
    .line 3
    iput-object p1, p0, Lean;->c:Leak;
    ...
    iput-object v0, p0, Lean;->i:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;

    .line 7
    iget-object v0, p0, Lean;->i:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;
    ...
    iget-object v3, p0, Lean;->c:Leak;

    invoke-direct {v1, v2, v3, v0}, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;-><init>(Landroid/content/Context;Leak;Landroid/os/Parcelable;)V

    iput-object v1, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;
...
.method public final varargs a(Landroid/accounts/Account;[Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 11
    sget-object v0, Lean;->a:Ljava/lang/String;
    ...
    .line 19
    invoke-virtual {v2, p1, v4}, Leam;->a(Landroid/accounts/Account;Ljava/lang/String;)Ljava/util/List;
...
.method public final a()V
    ...
    invoke-virtual {p0, v0}, Lean;->a(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;)V
...
.method public final a(Landroid/app/LoaderManager;Landroid/accounts/Account;Ljava/lang/String;Z)V
    ...
    .line 38
    iput-boolean v3, p0, Lean;->j:Z

    .line 39
    iget-object v0, p0, Lean;->c:Leak;

    invoke-interface {v0}, Leak;->E()V

    .line 40
    iget-object v0, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;
    ...
    iget-object v1, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;

    invoke-interface {v0, v1, v2}, Leak;->a(Landroid/view/View;Z)V

    .line 46
    :cond_3
    iget-object v4, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;
    ...
    .line 66
    iput-object v4, v6, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonImage;->i:Leat;
    ...
    new-instance v4, Leaw;

    iget-object v5, p0, Lean;->f:Landroid/content/Context;

    new-array v3, v3, [Ljava/lang/String;

    aput-object p3, v3, v2

    invoke-direct {v4, v5, p0, p2, v3}, Leaw;-><init>(Landroid/content/Context;Lean;Landroid/accounts/Account;[Ljava/lang/String;)V
...
.method public final a(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lean;->i:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;
...
.method public final a(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;)V
    ...
    iget-object v1, p0, Lean;->b:Leam;

    iget-object v3, p0, Lean;->c:Leak;

    iget-object v5, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;

    invoke-direct {v0, p0, v1, v3, v5}, Lebo;-><init>(Leaj;Leam;Leak;Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;)V

    .line 130
    new-instance v1, Leax;

    iget-object v3, p0, Lean;->f:Landroid/content/Context;

    invoke-direct {v1, v3, v0}, Leax;-><init>(Landroid/content/Context;Leaz;)V

    .line 131
    iput-object v1, p0, Lean;->h:Leax;

    .line 132
    iget-object v0, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;

    iget-object v1, p0, Lean;->h:Leax;

    .line 133
    iput-object v1, v0, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;->f:Leax;

    .line 134
    iget-object v5, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;

    iget-object v6, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;
    ...
    invoke-direct {v3, v8, v9, v0}, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddon;-><init>(Landroid/accounts/Account;Ljava/lang/String;Ljlw;)V
    ...
    .line 146
    invoke-virtual {v3}, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddon;->b()Ljmq;

    move-result-object v0

    .line 147
    iget-object v11, v0, Ljmq;->b:Ljmw;
    ...
    .line 157
    iget-object v3, v3, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddon;->d:Ljlw;

    .line 158
    iget-object v8, v3, Ljlw;->e:Ljmm;

    if-nez v8, :cond_5

    .line 159
    sget-object v3, Ljmm;->d:Ljmm;

    .line 162
    :goto_4
    iget-object v8, v3, Ljmm;->b:Ljmq;

    if-nez v8, :cond_6

    .line 163
    sget-object v3, Ljmq;->e:Ljmq;

    .line 165
    :goto_5
    iget-object v3, v3, Ljmq;->c:Ljava/lang/String;
    ...
    .line 160
    :cond_5
    iget-object v3, v3, Ljlw;->e:Ljmm;

    goto :goto_4

    .line 164
    :cond_6
    iget-object v3, v3, Ljmm;->b:Ljmq;
    ...
    invoke-static {v1, v3, v7}, Lcvc;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-interface {v0}, Leak;->F()V

    .line 194
    iput-object p1, p0, Lean;->i:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;

    .line 195
    iput-boolean v2, p0, Lean;->j:Z
...
.method public final b()Z
    ...
    .line 84
    iget-object v2, v2, Leax;->g:Leay;

    .line 85
    invoke-virtual {v2}, Leay;->a()Z
    ...
    .line 87
    :cond_0
    iget-object v2, p0, Lean;->e:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;

    invoke-virtual {v2, v1}, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonReplyBar;->setVisibility(I)V

    .line 88
    iget-object v2, p0, Lean;->d:Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;
    ...
    .line 94
    iget-object v3, v2, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/AddonView;->c:Leak;

    invoke-interface {v3, v2, v1}, Leak;->a(Landroid/view/View;Z)V
