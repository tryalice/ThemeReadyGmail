...
.method public constructor <init>(Ldcj;)V
    ...
    iput-boolean v0, p0, Ldci;->b:Z

    .line 3
    iput-object p1, p0, Ldci;->d:Ldcj;
...
.method private final a(I)Lcom/android/mail/providers/Conversation;
    ...
    .prologue
    .line 5
    iget-object v0, p0, Ldci;->d:Ldcj;

    invoke-interface {v0}, Ldcj;->p()Lchs;
...
.method private static a(Lchs;)Z
    .locals 1
    ...
    invoke-virtual {p0}, Lchs;->isClosed()Z
...
.method private final b()Z
    ...
    .line 12
    invoke-static {v0}, Ldci;->a(Lchs;)Z
...
.method final a()I
    ...
    .line 13
    iget-object v1, p0, Ldci;->d:Ldcj;

    invoke-interface {v1}, Ldcj;->p()Lchs;

    move-result-object v1

    .line 14
    iget-boolean v2, p0, Ldci;->b:Z

    if-nez v2, :cond_1

    .line 15
    iget-object v0, p0, Ldci;->c:Lcom/android/mail/providers/Conversation;
    ...
    iget-object v2, p0, Ldci;->c:Lcom/android/mail/providers/Conversation;

    if-eqz v2, :cond_0

    .line 18
    iput-boolean v6, p0, Ldci;->b:Z

    .line 19
    invoke-virtual {v1}, Lchs;->getCount()I

    move-result v2

    .line 20
    invoke-static {v1}, Ldci;->a(Lchs;)Z
    ...
    invoke-virtual {v1, v4, v5}, Lchs;->a(J)I
    ...
    invoke-virtual {v1, v2}, Lchs;->moveToPosition(I)Z
    ...
    .line 31
    sget-object v2, Ldci;->a:Ljava/lang/String;
    ...
    iget-object v5, p0, Ldci;->c:Lcom/android/mail/providers/Conversation;
    ...
    iput-object v2, p0, Ldci;->c:Lcom/android/mail/providers/Conversation;

    .line 37
    iget-object v1, p0, Ldci;->c:Lcom/android/mail/providers/Conversation;
...
.method public final a(ILjava/util/Collection;)Lcom/android/mail/providers/Conversation;
    ...
    .line 74
    invoke-static {v1, v2, v7}, Lctg;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 47
    invoke-direct {p0, v2}, Ldci;->a(I)Lcom/android/mail/providers/Conversation;
    ...
    .line 60
    :goto_4
    iget-object v2, p0, Ldci;->d:Ldcj;

    invoke-interface {v2}, Ldcj;->p()Lchs;

    move-result-object v2

    .line 61
    invoke-static {v2}, Ldci;->a(Lchs;)Z
    ...
    .line 62
    invoke-virtual {v2}, Lchs;->getCount()I
    ...
    .line 65
    invoke-direct {p0, v0}, Ldci;->a(I)Lcom/android/mail/providers/Conversation;
