...
.method private constructor <init>(Ljava/lang/String;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;)V
    ...
    invoke-direct {p0, v0}, Lbqi;-><init>(B)V

    .line 17
    iput-object p1, p0, Lbqg;->a:Ljava/lang/String;

    .line 18
    iput-object p2, p0, Lbqg;->b:[Ljava/security/cert/X509Certificate;

    .line 19
    iput-object p3, p0, Lbqg;->c:Ljava/security/PrivateKey;

    .line 20
    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/lang/String;)Lbqg;
    .locals 3
    ...
    invoke-static {v1, v0}, Lbqg;->a(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v2, p1, v0, v1}, Lbqg;-><init>(Ljava/lang/String;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;)V
...
.method public final getCertificateChain(Ljava/lang/String;)[Ljava/security/cert/X509Certificate;
    ...
    .prologue
    .line 22
    iget-object v0, p0, Lbqg;->b:[Ljava/security/cert/X509Certificate;
...
.method public final getPrivateKey(Ljava/lang/String;)Ljava/security/PrivateKey;
    ...
    .prologue
    .line 23
    iget-object v0, p0, Lbqg;->c:Ljava/security/PrivateKey;
