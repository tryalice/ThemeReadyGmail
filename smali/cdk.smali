...
.method private final a()Lcet;
    ...
    invoke-direct {v3, v0}, Lcdl;-><init>(Ljava/util/concurrent/BlockingQueue;)V
    ...
    invoke-direct {v2, v4, v3, v0}, Lcet;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Lbqb;)V
    :try_end_0
...
.method public final a(Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    invoke-static {v1, v5}, Lctg;->a(Ljava/lang/String;I)Z
    ...
    .line 22
    invoke-virtual {p0}, Lcdk;->e()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcey;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcdk;->a(Landroid/accounts/Account;)Z
    ...
    .line 42
    iget-object v1, v2, Lcet;->c:Lbqb;

    .line 43
    iget-wide v6, v0, Lcom/android/emailcommon/provider/Account;->L:J

    .line 44
    invoke-interface {v1, v6, v7, v4, v5}, Lbqb;->a(JJ)V
    :try_end_1
    ...
    invoke-interface {v1, v4, v5, p2}, Lbqb;->a(JLandroid/os/Bundle;)I
    ...
    invoke-static {v0, v4, v5, v3}, Lcez;->a(Landroid/content/Context;JZ)V
