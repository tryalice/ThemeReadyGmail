...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lewe;)V
    ...
    .line 2
    iput-object p1, p0, Leus;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Leus;->b:Lewe;
...
.method public final a(JJ)Ljava/util/Map;
    ...
    .line 54
    iget-object v0, p0, Leus;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v1 .. v6}, Lewc;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Leus;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 20
    :cond_2
    new-instance v16, Leur;

    invoke-direct/range {v16 .. v16}, Leur;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Leus;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Leus;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Leus;->b:Lewe;

    invoke-direct {v5, v4, v6}, Lezm;-><init>(Landroid/database/sqlite/SQLiteDatabase;Lewe;)V
    ...
    .line 44
    invoke-virtual/range {v5 .. v17}, Leuq;->a(JIJLjava/util/Map;JLjava/util/Map;ZLeur;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Lewd;-><init>(Landroid/database/sqlite/SQLiteDatabase;Lewe;)V
    :try_end_5
