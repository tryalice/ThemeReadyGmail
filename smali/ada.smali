...
.method protected constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, v0}, Laeg;-><init>(Landroid/content/Context;I)V

    .line 98
    new-instance v0, Landroid/support/v7/app/AlertController;

    invoke-virtual {p0}, Lada;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p0}, Lada;->getWindow()Landroid/view/Window;

    move-result-object v2

    invoke-direct {v0, v1, p0, v2}, Landroid/support/v7/app/AlertController;-><init>(Landroid/content/Context;Laeg;Landroid/view/Window;)V

    iput-object v0, p0, Lada;->a:Landroid/support/v7/app/AlertController;
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 256
    invoke-super {p0, p1}, Laeg;->onCreate(Landroid/os/Bundle;)V

    .line 257
    iget-object v6, p0, Lada;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 10225
    :goto_0
    iget-object v1, v6, Landroid/support/v7/app/AlertController;->b:Laeg;

    invoke-virtual {v1, v0}, Laeg;->setContentView(I)V
    ...
    .line 48007
    sget-object v4, Lue;->a:Lur;

    const/4 v5, 0x3

    invoke-interface {v4, v2, v3, v5}, Lur;->a(Landroid/view/View;II)V
    ...
    invoke-direct {v3, v6, v1, v0}, Lacp;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V

    .line 54879
    iput-object v3, v2, Landroid/support/v4/widget/NestedScrollView;->A:Laam;
    ...
    invoke-direct {v3, v6, v1, v0}, Lacq;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Lacr;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Lacs;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 262
    iget-object v1, p0, Lada;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 265
    :cond_1
    invoke-super {p0, p1, p2}, Laeg;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 273
    :cond_1
    invoke-super {p0, p1, p2}, Laeg;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 143
    invoke-super {p0, p1}, Laeg;->setTitle(Ljava/lang/CharSequence;)V

    .line 144
    iget-object v0, p0, Lada;->a:Landroid/support/v7/app/AlertController;
