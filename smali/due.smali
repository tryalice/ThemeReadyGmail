...
.method constructor <init>(Ldsk;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Ldue;-><init>(Ldsk;Landroid/content/Context;Ljava/lang/String;)V

    .line 98
    return-void
.end method

.method private constructor <init>(Ldsk;Landroid/content/Context;Ljava/lang/String;)V
    .locals 3
    ...
    iput-object v0, p0, Ldue;->e:Landroid/content/Context;

    .line 111
    iput-object p3, p0, Ldue;->f:Ljava/lang/String;

    .line 112
    iput-object p1, p0, Ldue;->d:Ldsk;
    ...
    iput-object v0, p0, Ldue;->h:Ldsn;

    .line 119
    new-instance v0, Lduh;

    iget-object v1, p0, Ldue;->e:Landroid/content/Context;

    iget-object v2, p0, Ldue;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lduh;-><init>(Ldue;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Ldue;->b:Lduh;
    ...
    invoke-direct {v1, p0}, Ldug;-><init>(Ldue;)V

    iget-object v2, p0, Ldue;->e:Landroid/content/Context;

    invoke-direct {v0, v1, v2}, Lduk;-><init>(Ldtu;Landroid/content/Context;)V

    iput-object v0, p0, Ldue;->c:Ldso;

    .line 123
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ldue;->g:J
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 533
    :try_start_0
    iget-object v0, p0, Ldue;->b:Lduh;

    invoke-virtual {v0}, Lduh;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Ldtv;->f(Ljava/lang/String;)I
...
.method private static a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v0}, Ldtt;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Ldue;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Ldts;-><init>(JJ)V
    ...
    .line 1048
    iput-object v4, v3, Ldts;->d:Ljava/lang/String;
    ...
    invoke-static {v2}, Ldtv;->f(Ljava/lang/String;)I
    ...
    .line 4025
    iput-object v5, v2, Ldts;->a:Ljava/lang/String;
    :try_end_5
    ...
    .line 5021
    iget-object v8, v3, Ldts;->a:Ljava/lang/String;
...
.method private final a(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0}, Ldue;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 451
    iget-object v0, p0, Ldue;->d:Ldsk;

    invoke-direct {p0}, Ldue;->c()I
    ...
    :cond_4
    invoke-interface {v0, v2}, Ldsk;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Ldue;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public final a()V
    ...
    :goto_1
    invoke-interface {v2, v0}, Ldsk;->a(Z)V
...
.method public final a(Ljava/util/Map;JLjava/lang/String;Ljava/util/Collection;)V
    ...
    .line 7239
    invoke-direct {p0, v0}, Ldue;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Ldtv;->g(Ljava/lang/String;)I

    .line 7241
    invoke-direct {p0, v0}, Ldue;->a(Ljava/util/Collection;)V
    ...
    invoke-static {p1}, Ldue;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Ldsk;->a(Z)V
    :try_end_1
...
.method public final b()V
    ...
    invoke-static {v0}, Ldtv;->e(Ljava/lang/String;)I

    .line 483
    iget-object v0, p0, Ldue;->c:Ldso;

    invoke-interface {v0}, Ldso;->a()Z
    ...
    .line 493
    :cond_2
    iget-object v1, p0, Ldue;->c:Ldso;

    invoke-interface {v1, v0}, Ldso;->a(Ljava/util/List;)I
    ...
    invoke-static {v2}, Ldtv;->e(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2}, Ldue;->a(Ljava/util/Collection;)V
