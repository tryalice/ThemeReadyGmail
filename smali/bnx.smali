...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lbnx;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Context;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v6}, Lbnx;->a(Landroid/content/Context;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
...
.method public static a(Landroid/content/Context;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    ...
    invoke-direct {v1, p0}, Lbnx;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lbnx;->a(JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    :try_end_0
...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-direct {v0, p0}, Lbnx;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Lbnx;->b()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Lcom/android/emailcommon/provider/Policy;)Z
    ...
    invoke-virtual {v1, p1}, Lbnx;->a(Lcom/android/emailcommon/provider/Policy;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a()V
    ...
    invoke-direct {v0, p0}, Lbob;-><init>(Lbnx;)V

    const-string v1, "remoteWipe"

    invoke-virtual {p0, v0, v1}, Lbnx;->a(Lbph;Ljava/lang/String;)Z
...
.method public final a(JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v0 .. v6}, Lbnz;-><init>(Lbnx;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
...
.method public final a(JZ)V
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lboc;-><init>(Lbnx;JZ)V
...
.method public final a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p1}, Lbnw;-><init>(Landroid/os/IBinder;)V
...
.method public final a(Lcom/android/emailcommon/provider/Policy;)Z
    ...
    invoke-direct {v0, p0, p1}, Lbny;-><init>(Lbnx;Lcom/android/emailcommon/provider/Policy;)V

    .line 15
    const-string v2, "isActive"

    invoke-virtual {p0, v0, v2}, Lbnx;->a(Lbph;Ljava/lang/String;)Z
...
.method public final b()Z
    ...
    invoke-direct {v0, p0}, Lboa;-><init>(Lbnx;)V
