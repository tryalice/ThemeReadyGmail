...
.method constructor <init>(Ldxp;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Ldzj;-><init>(Ldxp;Landroid/content/Context;Ljava/lang/String;)V

    .line 2
    return-void
.end method

.method private constructor <init>(Ldxp;Landroid/content/Context;Ljava/lang/String;)V
    .locals 3
    ...
    iput-object v0, p0, Ldzj;->e:Landroid/content/Context;

    .line 5
    iput-object p3, p0, Ldzj;->f:Ljava/lang/String;

    .line 6
    iput-object p1, p0, Ldzj;->d:Ldxp;
    ...
    iput-object v0, p0, Ldzj;->h:Ldxs;

    .line 8
    new-instance v0, Ldzm;

    iget-object v1, p0, Ldzj;->e:Landroid/content/Context;

    iget-object v2, p0, Ldzj;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Ldzm;-><init>(Ldzj;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Ldzj;->b:Ldzm;
    ...
    invoke-direct {v1, p0}, Ldzl;-><init>(Ldzj;)V

    .line 11
    iget-object v2, p0, Ldzj;->e:Landroid/content/Context;

    invoke-direct {v0, v1, v2}, Ldzp;-><init>(Ldyz;Landroid/content/Context;)V

    iput-object v0, p0, Ldzj;->c:Ldxt;
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 189
    :try_start_0
    iget-object v0, p0, Ldzj;->b:Ldzm;

    invoke-virtual {v0}, Ldzm;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Ldza;->f(Ljava/lang/String;)I
...
.method private static a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v0}, Ldyy;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Ldzj;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Ldyx;-><init>(JJ)V
    ...
    .line 93
    iput-object v4, v3, Ldyx;->d:Ljava/lang/String;
    ...
    invoke-static {v2}, Ldza;->f(Ljava/lang/String;)I
    ...
    .line 116
    iput-object v5, v2, Ldyx;->a:Ljava/lang/String;
    :try_end_5
    ...
    .line 128
    iget-object v8, v3, Ldyx;->a:Ljava/lang/String;
...
.method private final a(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0}, Ldzj;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 153
    iget-object v0, p0, Ldzj;->d:Ldxp;

    invoke-direct {p0}, Ldzj;->c()I
    ...
    :cond_4
    invoke-interface {v0, v2}, Ldxp;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Ldzj;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public final a(Ljava/util/Map;JLjava/lang/String;Ljava/util/Collection;)V
    ...
    .line 52
    invoke-direct {p0, v0}, Ldzj;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Ldza;->g(Ljava/lang/String;)I

    .line 54
    invoke-direct {p0, v0}, Ldzj;->a(Ljava/util/Collection;)V
    ...
    invoke-static {p1}, Ldzj;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Ldxp;->a(Z)V
    :try_end_1
...
.method public final b()V
    ...
    invoke-static {v0}, Ldza;->e(Ljava/lang/String;)I

    .line 176
    iget-object v0, p0, Ldzj;->c:Ldxt;

    invoke-interface {v0}, Ldxt;->a()Z
    ...
    .line 183
    :cond_2
    iget-object v1, p0, Ldzj;->c:Ldxt;

    invoke-interface {v1, v0}, Ldxt;->a(Ljava/util/List;)I
    ...
    invoke-static {v2}, Ldza;->e(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2}, Ldzj;->a(Ljava/util/Collection;)V
