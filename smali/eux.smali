...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lerm;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1, p2}, Lepv;-><init>(Landroid/database/sqlite/SQLiteDatabase;Lerm;)V
...
# virtual methods
.method protected final a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLepw;Landroid/util/TimingLogger;)Z
    .locals 57
    ...
    iget-object v11, v0, Leux;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 22
    new-instance v35, Lepr;

    invoke-direct/range {v35 .. v35}, Lepr;-><init>()V

    .line 23
    :try_start_0
    move-object/from16 v0, p0

    iget-object v11, v0, Leux;->c:Leqf;

    invoke-virtual {v11}, Leqf;->f()J
    ...
    .line 40
    sget-object v5, Leqb;->e:Ljava/util/regex/Pattern;
    ...
    iput-wide v6, v4, Lerk;->a:J

    .line 70
    iget-wide v6, v4, Lerk;->b:J
    ...
    iput-boolean v6, v4, Lerk;->c:Z

    .line 72
    :cond_3
    move-object/from16 v0, p0

    iget-object v4, v0, Leux;->b:Lerm;

    iget-object v4, v4, Lerm;->f:Ljava/util/Map;
    ...
    .line 131
    invoke-virtual/range {v4 .. v11}, Leuq;->a(Ljava/lang/String;Ljava/lang/String;ZZZII)V
    ...
    :cond_18
    :try_start_1
    sget-object v5, Leqb;->g:Ljava/util/regex/Pattern;
    ...
    .line 126
    :goto_16
    sget-object v6, Leqb;->h:Ljava/util/regex/Pattern;
    ...
    .line 130
    :cond_19
    invoke-static/range {v32 .. v32}, Leqb;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 147
    invoke-virtual/range {v4 .. v13}, Leux;->a(JILjava/util/Map;Ljava/util/Map;JLjava/util/Set;Lepw;)V
    ...
    iget-object v4, v0, Leux;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v4}, Leqb;->a(Ljava/util/Set;)Ljava/lang/String;
    ...
    iget-object v6, v0, Lepr;->c:Leuq;

    invoke-static {v6}, Lepr;->a(Leuq;)[B
    ...
    .line 181
    invoke-static/range {p1 .. p2}, Lfby;->a(J)I
