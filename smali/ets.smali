...
.field public final b:Levj;

.field public final c:Leuc;


# direct methods
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Levj;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lets;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Lets;->b:Levj;

    .line 4
    iget-object v0, p0, Lets;->b:Levj;

    .line 5
    iget-object v0, v0, Levj;->j:Leuc;

    .line 6
    iput-object v0, p0, Lets;->c:Leuc;

    .line 7
    return-void
.end method

.method private final a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lett;)V
    .locals 14
    ...
    invoke-static {v10, v11}, Levj;->d(J)Z
    ...
    invoke-virtual {v0, v3, v2}, Lett;->a(ZLjava/lang/Long;)Z
    ...
    .line 130
    iget-object v3, p0, Lets;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v3, v9, v10}, Levi;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 162
    iget-object v2, v2, Leuc;->b:Landroid/content/ContentQueryMap;

    invoke-virtual {v2}, Landroid/content/ContentQueryMap;->requery()V

    .line 163
    iget-object v2, p0, Lets;->b:Levj;

    iget-object v2, v2, Levj;->i:Levl;

    invoke-interface {v2, v6}, Levl;->a(Ljava/util/Set;)V
...
.method private final a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    iget-object v2, v0, Lets;->b:Levj;

    iget-object v2, v2, Levj;->e:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v3}, Levm;->a(Ljava/util/Set;)Z
    ...
    invoke-virtual {v2, v0}, Levm;->a(Ljava/util/Set;)Z
    ...
    iget-object v3, v0, Lets;->b:Levj;

    move-object/from16 v0, p0

    iget-object v4, v0, Lets;->b:Levj;

    .line 72
    invoke-virtual {v4, v14, v15}, Levj;->c(J)Levk;
    ...
    iget-object v3, v3, Levj;->i:Levl;

    invoke-interface {v3, v2}, Levl;->a(Levm;)V
...
# virtual methods
.method final a(JIJLjava/util/Map;JLjava/util/Map;ZLett;Landroid/util/TimingLogger;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JIJ",
    ...
    .line 10
    invoke-virtual/range {v2 .. v13}, Lets;->a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLett;Landroid/util/TimingLogger;)Z
    ...
    .line 13
    invoke-virtual/range {v3 .. v8}, Lets;->a(JJLjava/util/Map;)V
...
.method public final a(JILjava/util/Map;Ljava/util/Map;JLjava/util/Set;Lett;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
    ...
    .line 31
    invoke-direct/range {v1 .. v11}, Lets;->a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    .line 35
    invoke-direct/range {v4 .. v11}, Lets;->a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lett;)V
...
.method public final a(JJLjava/util/Map;)V
    ...
    .line 47
    iget-object v0, p0, Lets;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method protected abstract a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLett;Landroid/util/TimingLogger;)Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
            "Ljava/lang/String;",
