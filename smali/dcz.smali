...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V
    ...
    .prologue
    .line 1
    invoke-direct/range {p0 .. p5}, Ldhr;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V
...
.method public static a(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 3
    invoke-static {p0, v1, v1, v0, v0}, Ldcz;->a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;ZZ)Landroid/database/Cursor;
...
.method public static a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;ZZ)Landroid/database/Cursor;
    ...
    invoke-direct {v4, v1}, Ldsr;-><init>([Ljava/lang/String;)V
    ...
    invoke-direct {v0, v7}, Ldrx;-><init>(Landroid/net/Uri;)V

    .line 20
    invoke-virtual {v0}, Ldrx;->a()Landroid/net/Uri;
