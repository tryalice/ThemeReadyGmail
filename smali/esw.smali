...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Leun;)V
    ...
    .line 2
    iput-object p1, p0, Lesw;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Lesw;->b:Leun;
...
.method public final a(JJ)Ljava/util/Map;
    ...
    .line 53
    iget-object v0, p0, Lesw;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v1 .. v6}, Leuk;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Lesw;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 20
    :cond_2
    new-instance v16, Lesv;

    invoke-direct/range {v16 .. v16}, Lesv;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Lesw;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Lesw;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Lesw;->b:Leun;

    invoke-direct {v5, v4, v6}, Leya;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leun;)V
    ...
    .line 43
    invoke-virtual/range {v5 .. v17}, Lesu;->a(JIJLjava/util/Map;JLjava/util/Map;ZLesv;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Leul;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leun;)V
    :try_end_5
