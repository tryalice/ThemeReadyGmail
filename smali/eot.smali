...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Leqk;)V
    ...
    .line 2
    iput-object p1, p0, Leot;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Leot;->b:Leqk;
...
.method public final a(JJ)Ljava/util/Map;
    ...
    .line 53
    iget-object v0, p0, Leot;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v1 .. v6}, Leqh;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Leot;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 20
    :cond_2
    new-instance v16, Leos;

    invoke-direct/range {v16 .. v16}, Leos;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Leot;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Leot;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Leot;->b:Leqk;

    invoke-direct {v5, v4, v6}, Letx;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leqk;)V
    ...
    .line 43
    invoke-virtual/range {v5 .. v17}, Leor;->a(JIJLjava/util/Map;JLjava/util/Map;ZLeos;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Leqi;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leqk;)V
    :try_end_5
