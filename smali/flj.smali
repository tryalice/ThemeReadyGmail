...
.method public final a(Lfll;)Ljava/lang/Object;
    ...
    invoke-direct {v4}, Lful;-><init>()V

    iget-object v0, p0, Lflj;->a:Landroid/content/Context;

    invoke-static {v0}, Lfsp;->a(Landroid/content/Context;)Lfsp;
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfsp;->a(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v4}, Lful;->a()Landroid/os/IBinder;
    ...
    .line 3
    :goto_0
    invoke-interface {p1, v0}, Lfll;->a(Lfna;)Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {v5, v1, v4, v6}, Lfsp;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-direct {v0, v6}, Lfnb;-><init>(Landroid/os/IBinder;)V
    :try_end_3
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfsp;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_5
