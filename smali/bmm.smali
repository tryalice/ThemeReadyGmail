...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 4
    iput-object p1, p0, Lbmm;->e:Landroid/content/Context;
...
.method private static a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;)Landroid/os/Bundle;
    ...
    .line 194
    :cond_0
    sget-object v0, Lbmm;->a:Ljava/lang/String;
    ...
    .line 196
    :cond_2
    invoke-static {v0, p0}, Lbhm;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhm;
    ...
    invoke-direct {v3, v1, v0}, Lbme;-><init>(Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;)V

    .line 200
    iget-object v0, v3, Lbme;->d:Lcom/android/emailcommon/provider/Mailbox;

    iget-object v0, v0, Lcom/android/emailcommon/provider/Mailbox;->d:Ljava/lang/String;

    invoke-virtual {v2, v0}, Lbhm;->a(Ljava/lang/String;)Lbov;
    ...
    invoke-virtual {v4, v0}, Lbov;->a(I)V
    ...
    .line 207
    invoke-virtual {v4, p3}, Lbov;->a(Lcom/android/emailcommon/service/SearchParams;)[Lboz;
    ...
    .line 210
    invoke-static {v1}, Lbme;->a([Lboz;)[Lbmh;

    move-result-object v0

    .line 211
    sget-object v1, Lbme;->b:Lsa;

    iget-object v5, v3, Lbme;->c:Lcom/android/emailcommon/provider/Account;

    iget-wide v6, v5, Lcom/android/emailcommon/provider/Account;->L:J

    invoke-virtual {v1, v6, v7, v0}, Lsa;->b(JLjava/lang/Object;)V
    ...
    .line 219
    sget-object v0, Lbme;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lbqw;->a(II)Landroid/os/Bundle;
    :try_end_0
    ...
    :cond_4
    :try_start_1
    sget-object v0, Lbme;->b:Lsa;

    iget-object v1, v3, Lbme;->c:Lcom/android/emailcommon/provider/Account;
    ...
    invoke-virtual {v0, v6, v7, v1}, Lsa;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v8, v8, Lbmh;->a:Lboz;

    .line 229
    invoke-virtual {v3, p0, v8}, Lbme;->a(Landroid/content/Context;Lboz;)Z
    ...
    invoke-direct {v1, v3, p0, p3}, Lbmg;-><init>(Lbme;Landroid/content/Context;Lcom/android/emailcommon/service/SearchParams;)V
    ...
    .line 237
    sget-object v7, Lbos;->a:Lbos;

    invoke-virtual {v6, v7}, Lbor;->add(Ljava/lang/Object;)Z

    .line 238
    sget-object v7, Lbos;->b:Lbos;

    invoke-virtual {v6, v7}, Lbor;->add(Ljava/lang/Object;)Z

    .line 239
    invoke-virtual {v4, v0, v6, v1}, Lbov;->a([Lboz;Lbor;Lbow;)V

    .line 240
    invoke-virtual {v3, p0, v4, v0}, Lbme;->a(Landroid/content/Context;Lbov;[Lboz;)V

    .line 241
    :cond_9
    const/4 v0, 0x0

    invoke-static {v0, v5}, Lbqw;->a(II)Landroid/os/Bundle;
    :try_end_1
...
.method private static a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    ...
    invoke-static {v4, v5}, Lbqw;->a(II)Landroid/os/Bundle;
    ...
    invoke-direct {v4, v5, v8}, Lbth;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 108
    iget-object v8, v4, Lbth;->n:Ljava/lang/String;
    ...
    iget-object v9, v4, Lbth;->j:Ljava/util/Set;

    invoke-static {v8, v9, v5}, Lbth;->a(Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;)V

    .line 111
    const-string v8, "to_addresses"

    iget-object v9, v4, Lbth;->i:Ljava/util/Set;
    ...
    iget-object v4, v4, Lbth;->k:Ljava/util/Set;

    invoke-static {v8, v4, v5}, Lbth;->a(Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-static {v6, v0}, Lbhm;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhm;
    :try_end_0
    ...
    invoke-virtual {v11, v4}, Lbhm;->a(Ljava/lang/String;)Lbov;
    ...
    invoke-virtual {v14, v4}, Lbov;->a(I)V

    .line 122
    const/4 v4, 0x0

    new-array v4, v4, [Lbmh;
    ...
    invoke-virtual {v14, v0}, Lbov;->a(Lcom/android/emailcommon/service/SearchParams;)[Lboz;
    ...
    .line 127
    invoke-static {v5}, Lbme;->a([Lboz;)[Lbmh;

    move-result-object v4

    .line 128
    sget-object v5, Lbmm;->b:Lsa;

    move-wide/from16 v0, p1

    invoke-virtual {v5, v0, v1, v4}, Lsa;->b(JLjava/lang/Object;)V
    ...
    invoke-virtual {v4, v0, v1, v5}, Lsa;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v10, v10, Lbmh;->a:Lboz;
    ...
    .line 158
    :cond_9
    new-instance v16, Lbor;

    invoke-direct/range {v16 .. v16}, Lbor;-><init>()V

    .line 159
    sget-object v4, Lbos;->a:Lbos;

    move-object/from16 v0, v16

    invoke-virtual {v0, v4}, Lbor;->add(Ljava/lang/Object;)Z
    ...
    invoke-direct/range {v5 .. v10}, Lbmn;-><init>(Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;JLandroid/content/Context;)V

    move-object/from16 v0, v16

    invoke-virtual {v14, v4, v0, v5}, Lbov;->a([Lboz;Lbor;Lbow;)V

    .line 163
    invoke-virtual/range {v16 .. v16}, Lbor;->clear()V

    .line 164
    sget-object v5, Lbos;->c:Lbos;

    move-object/from16 v0, v16

    invoke-virtual {v0, v5}, Lbor;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v5, v7}, Lboi;->a(Lbpe;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v7}, Lbor;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v14, v10, v0, v7}, Lbov;->a([Lboz;Lbor;Lbow;)V
    :try_end_3
    ...
    invoke-static {v0, v1, v6, v12, v5}, Lblj;->a(Landroid/content/Context;Lboz;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    :try_end_4
    ...
    invoke-static {v4, v15}, Lbqw;->a(II)Landroid/os/Bundle;
...
.method public final a(JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    ...
    .line 8
    iget-object v0, p0, Lbmm;->e:Landroid/content/Context;

    invoke-static {v0, p1, p2, p3}, Lbmm;->a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;)Landroid/os/Bundle;
    ...
    invoke-static/range {v0 .. v5}, Lbmm;->a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    :try_end_0
    ...
    .line 14
    invoke-static {v0}, Lblx;->a(Lcom/android/emailcommon/mail/MessagingException;)I

    move-result v0

    .line 15
    invoke-static {v0, v6}, Lbqw;->a(II)Landroid/os/Bundle;
...
.method public final a(Lbrf;JJZ)V
    ...
    iget-object v2, v0, Lbmm;->e:Landroid/content/Context;
    ...
    invoke-interface/range {v3 .. v9}, Lbrf;->a(JJII)V
    ...
    .line 24
    invoke-static {v2, v6, v7}, Lbpu;->a(Landroid/content/Context;J)Lbpu;
    ...
    invoke-static {v3, v2, v4, v5}, Lcug;->c(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    iget-object v4, v0, Lbmm;->e:Landroid/content/Context;
    ...
    invoke-static {v2, v14}, Lbta;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)Z
    ...
    iget-object v6, v0, Lbmm;->e:Landroid/content/Context;

    sget-object v7, Lbpj;->a:Landroid/net/Uri;
    ...
    .line 40
    invoke-static/range {v6 .. v12}, Lbty;->a(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/Long;
    ...
    iget-object v8, v0, Lbmm;->e:Landroid/content/Context;

    .line 43
    invoke-static {v8, v6, v7}, Lbpu;->a(Landroid/content/Context;J)Lbpu;
    ...
    .line 46
    iget-object v6, v6, Lbpu;->y:Ljava/lang/String;

    iput-object v6, v15, Lbpu;->y:Ljava/lang/String;
    ...
    invoke-static {v3, v6}, Lbhm;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhm;
    ...
    invoke-virtual {v3, v2}, Lbhm;->a(Ljava/lang/String;)Lbov;
    :try_end_3
    ...
    invoke-virtual {v10, v2}, Lbov;->a(I)V

    .line 58
    iget-object v2, v15, Lbpu;->y:Ljava/lang/String;

    invoke-virtual {v10, v2}, Lbov;->c(Ljava/lang/String;)Lboz;
    ...
    .line 69
    invoke-virtual {v3, v9}, Lboh;->a(Lbop;)V
    ...
    invoke-virtual {v2, v6, v7}, Lboz;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 71
    invoke-virtual {v2, v3}, Lboz;->a(Lboo;)V

    .line 72
    new-instance v11, Lbor;

    invoke-direct {v11}, Lbor;-><init>()V

    .line 73
    invoke-virtual {v11, v9}, Lbor;->add(Ljava/lang/Object;)Z

    .line 74
    const/4 v3, 0x1

    new-array v12, v3, [Lboz;
    ...
    invoke-direct/range {v3 .. v8}, Lbmo;-><init>(JJLbrf;)V

    invoke-virtual {v10, v12, v11, v3}, Lbov;->a([Lboz;Lbor;Lbow;)V

    .line 76
    iget-object v2, v9, Lboc;->b:Lboo;
    ...
    .line 80
    iget-object v3, v9, Lboc;->b:Lboo;

    .line 81
    invoke-interface {v3}, Lboo;->g_()Ljava/io/InputStream;

    move-result-object v3

    invoke-static {v2, v3, v14}, Lbta;->a(Landroid/content/Context;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Attachment;)V
