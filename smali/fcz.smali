...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfcz;->b:Ljgq;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lfqa;Ljava/lang/String;Ljava/util/Set;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    .line 109
    :try_start_0
    invoke-static {p0}, Lgvj;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    :try_end_0
...
.method private final a()Lkdp;
    ...
    .line 14
    invoke-static {v0, v2, v3, v4, v5}, Lfcz;->a(Landroid/content/Context;Lfqa;Ljava/lang/String;Ljava/util/Set;Z)Lkdp;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static a(Landroid/content/Context;Lfqa;Ljava/lang/String;Ljava/util/Set;Z)Lkdp;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 40
    sget-object v0, Lgvd;->i:Lgul;

    .line 41
    invoke-interface {v0, p1, v1, v5}, Lgul;->a(Lfqa;Ljava/lang/String;Lgum;)Lfqe;
    ...
    invoke-direct {v0, v3}, Lcdc;-><init>(Landroid/net/Uri;)V
    ...
    invoke-static {v8}, Laqy;->a(Ljava/lang/String;)V

    .line 68
    sget-object v8, Lfcz;->b:Ljgq;

    .line 69
    sget-object v9, Ljlv;->c:Ljlv;

    invoke-virtual {v8, v9}, Ljgq;->a(Ljlv;)Ljfh;
    ...
    invoke-interface {v8, v9}, Ljfh;->a(Ljava/lang/String;)Ljes;
    ...
    invoke-direct {v9}, Lgux;-><init>()V

    .line 73
    const/4 v10, 0x1

    iput v10, v9, Lgux;->a:I

    .line 75
    const/4 v10, 0x1

    iput v10, v9, Lgux;->b:I

    .line 76
    invoke-virtual {v9}, Lgux;->a()Lguw;

    move-result-object v9

    .line 77
    sget-object v10, Lgvd;->g:Lguv;
    ...
    invoke-interface {v10, p1, v0, v9}, Lguv;->a(Lfqa;Lcom/google/android/gms/people/model/AvatarReference;Lguw;)Lfqe;
    ...
    .line 80
    invoke-virtual {v0, v10, v11, v9}, Lfqe;->a(JLjava/util/concurrent/TimeUnit;)Lfqh;
    ...
    invoke-direct {v7, v3, v0}, Lcdc;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v0, v3, v7}, Lcdc;-><init>(Landroid/net/Uri;[B)V
