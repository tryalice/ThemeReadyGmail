...
.method public constructor <init>(Ljava/lang/Class;Landroid/os/Parcelable$Creator;)V
    ...
    .line 2
    iput-object p1, p0, Lcra;->a:Ljava/lang/Class;

    .line 3
    new-instance v0, Lcqz;

    invoke-direct {v0, p2}, Lcqz;-><init>(Landroid/os/Parcelable$Creator;)V

    iput-object v0, p0, Lcra;->b:Lcqz;
...
.method private final a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
    ...
    sget-object v0, Lcrb;->a:Ljava/util/Comparator;
    ...
    invoke-direct {v8, v9}, Lcrb;-><init>(I)V
    ...
    invoke-direct {v9, v0}, Lcrb;-><init>(I)V

    new-instance v0, Lcrb;

    invoke-direct {v0, v8}, Lcrb;-><init>(I)V
    ...
    .line 48
    iget-object v8, p0, Lcra;->b:Lcqz;

    invoke-virtual {v8, v7}, Lcqz;->a(Landroid/os/Parcelable;)Landroid/os/Parcelable;
...
.method public final a(Landroid/text/Spanned;)Landroid/text/Spanned;
    ...
    iget-object v3, p0, Lcra;->a:Ljava/lang/Class;
    ...
    .line 7
    invoke-direct {p0, v1, v0}, Lcra;->a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
