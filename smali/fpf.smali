...
.method public constructor <init>(Lcom/google/android/gms/common/images/ImageManager;Landroid/net/Uri;Landroid/graphics/Bitmap;ZLjava/util/concurrent/CountDownLatch;)V
    ...
    iput-object p1, p0, Lfpf;->e:Lcom/google/android/gms/common/images/ImageManager;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lfpf;->a:Landroid/net/Uri;

    iput-object p3, p0, Lfpf;->b:Landroid/graphics/Bitmap;

    iput-boolean p4, p0, Lfpf;->d:Z

    iput-object p5, p0, Lfpf;->c:Ljava/util/concurrent/CountDownLatch;
...
.method private final a(Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;Z)V
    ...
    iget-object v1, p0, Lfpf;->e:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iget-object v5, p0, Lfpf;->b:Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, Lfpf;->a:Landroid/net/Uri;
    ...
    iget-object v5, p0, Lfpf;->e:Lcom/google/android/gms/common/images/ImageManager;

    invoke-static {v5}, Lcom/google/android/gms/common/images/ImageManager;->c(Lcom/google/android/gms/common/images/ImageManager;)Lgbb;
...
.method public final run()V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lfpf;->b:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v0, p0, Lfpf;->e:Lcom/google/android/gms/common/images/ImageManager;

    invoke-static {v0}, Lcom/google/android/gms/common/images/ImageManager;->h(Lcom/google/android/gms/common/images/ImageManager;)Lfpd;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-boolean v0, p0, Lfpf;->d:Z
    ...
    invoke-virtual {v0}, Lfpd;->a()V

    invoke-static {}, Ljava/lang/System;->gc()V

    iput-boolean v2, p0, Lfpf;->d:Z
    ...
    iget-object v3, p0, Lfpf;->a:Landroid/net/Uri;

    invoke-direct {v2, v3}, Lfph;-><init>(Landroid/net/Uri;)V

    iget-object v3, p0, Lfpf;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v2, v3}, Lfpd;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lfpf;->a:Landroid/net/Uri;
    ...
    invoke-direct {p0, v0, v1}, Lfpf;->a(Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;Z)V

    :cond_4
    iget-object v0, p0, Lfpf;->c:Ljava/util/concurrent/CountDownLatch;
