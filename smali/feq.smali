...
# virtual methods
.method public final a(Lfes;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-direct {v4}, Lfnw;-><init>()V

    iget-object v0, p0, Lfeq;->a:Landroid/content/Context;

    invoke-static {v0}, Lfmc;->a(Landroid/content/Context;)Lfmc;
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfmc;->a(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v4}, Lfnw;->a()Landroid/os/IBinder;
    ...
    .line 3
    :goto_0
    invoke-interface {p1, v0}, Lfes;->a(Lfgh;)Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {v5, v1, v4, v6}, Lfmc;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-direct {v0, v6}, Lfgi;-><init>(Landroid/os/IBinder;)V
    :try_end_3
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfmc;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_5
