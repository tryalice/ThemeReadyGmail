...
.field public final synthetic l:Lcuc;


# direct methods
.method private constructor <init>(Lcuc;Ljava/util/Collection;Ljava/util/Collection;ZZZILcom/android/mail/providers/Folder;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcvj;->a:Ljava/util/Collection;
    ...
    .line 10
    iput-object p8, p0, Lcvj;->h:Lcom/android/mail/providers/Folder;
    ...
    .line 13
    iget-object v1, p0, Lcvj;->a:Ljava/util/Collection;
    ...
    invoke-direct {v0, p1, v1, v3, v2}, Lcum;-><init>(Lcuc;Ljava/util/Collection;ZI)V

    .line 17
    :goto_0
    iput-object v0, p0, Lcvj;->k:Ldlr;
...
.method synthetic constructor <init>(Lcuc;Ljava/util/Collection;Ljava/util/Collection;ZZZILcom/android/mail/providers/Folder;B)V
    .locals 0

    .prologue
    .line 80
    invoke-direct/range {p0 .. p8}, Lcvj;-><init>(Lcuc;Ljava/util/Collection;Ljava/util/Collection;ZZZILcom/android/mail/providers/Folder;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lcvj;->a:Ljava/util/Collection;
    ...
    iget-object v2, p0, Lcvj;->a:Ljava/util/Collection;
    ...
    iget-object v3, p0, Lcvj;->h:Lcom/android/mail/providers/Folder;

    iget-object v4, p0, Lcvj;->k:Ldlr;

    iget-boolean v5, p0, Lcvj;->j:Z
    ...
    .line 42
    :cond_3
    iget-object v1, p0, Lcvj;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Ldne;->toString()Ljava/lang/String;
    ...
    .line 59
    iget-object v9, v1, Lcby;->z:Landroid/accounts/Account;

    iget-object v9, v1, Lcby;->B:Landroid/content/Context;

    invoke-static {}, Lctg;->g()Z

    .line 60
    invoke-static {v10, v11, v8}, Lcby;->a(Ljava/util/List;Ljava/util/List;Landroid/content/ContentValues;)V

    .line 61
    iget-object v9, v1, Lcby;->z:Landroid/accounts/Account;

    iget-object v10, v1, Lcby;->B:Landroid/content/Context;

    invoke-static {v9, v10, v2, v3, v8}, Lcby;->a(Landroid/accounts/Account;Landroid/content/Context;Ljava/util/Collection;Ljava/util/Collection;Landroid/content/ContentValues;)V

    .line 62
    const/4 v2, 0x2

    invoke-virtual {v1, v0, v2, v8, v4}, Lcby;->a(Lcom/android/mail/providers/Conversation;ILandroid/content/ContentValues;Lcgi;)Lccd;
    ...
    .line 67
    invoke-virtual {v0, v5, v6}, Lcby;->a(Ljava/util/Collection;Z)I
