...
.method public static c(I)Lbcp;
    ...
    .line 2
    invoke-static {p0, v1, v1}, Lbcp;->a(IZZ)Landroid/os/Bundle;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbcp;->setArguments(Landroid/os/Bundle;)V
...
.method private final u()I
    ...
    .prologue
    .line 140
    iget-object v0, p0, Lbcp;->C:Landroid/widget/Spinner;
...
.method public final b()V
    ...
    .prologue
    .line 125
    iget-object v0, p0, Lbcp;->v:Landroid/widget/TextView;
...
.method public final c()V
    ...
    iget-object v1, p0, Lbcp;->q:Ljava/lang/String;
...
.method public final f()Landroid/content/Loader;
    ...
    iget-object v2, p0, Lbcp;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    iget v3, p0, Lbcp;->c:I

    .line 147
    invoke-direct {v0, v1, v2, v3}, Lbct;-><init>(Landroid/content/Context;Lcom/android/email/activity/setup/SetupDataFragment;I)V
...
.method public final g()I
    ...
    .line 149
    iget-object v0, p0, Lbcp;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    .line 152
    iget-object v0, p0, Lbcp;->B:Landroid/widget/Switch;
    ...
    invoke-virtual {p0, v1, v3}, Lbcp;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 154
    if-eqz v0, :cond_0

    .line 155
    iget-object v0, p0, Lbcp;->w:Landroid/widget/EditText;
    ...
    .line 156
    iget-object v1, p0, Lbcp;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 160
    :goto_0
    iget-object v0, p0, Lbcp;->y:Landroid/widget/EditText;
    ...
    .line 161
    :try_start_0
    iget-object v0, p0, Lbcp;->A:Landroid/widget/EditText;
    ...
    invoke-virtual {p0, v0, v4}, Lbcp;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v5}, Lbcp;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 170
    iget-object v4, p0, Lbcp;->i:Ljava/lang/String;
...
.method protected final j()Landroid/widget/TextView;
    ...
    .prologue
    .line 174
    iget-object v0, p0, Lbcp;->D:Landroid/widget/TextView;
...
.method protected final k()Landroid/widget/TextView;
    ...
    .prologue
    .line 175
    iget-object v0, p0, Lbcp;->E:Landroid/widget/TextView;
...
.method protected final l()Landroid/widget/LinearLayout;
    ...
    .prologue
    .line 176
    iget-object v0, p0, Lbcp;->z:Landroid/support/design/widget/TextInputLayout;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 42
    invoke-virtual {p0}, Lbcp;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {v5, v6, v7}, Lbgk;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 69
    iget-object v3, p0, Lbcp;->a:Landroid/content/Context;
    ...
    .line 70
    iget-object v3, p0, Lbcp;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    iget-object v4, p0, Lbcp;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    .line 77
    iget-object v4, v4, Lcom/android/email/activity/setup/SetupDataFragment;->d:Landroid/os/Bundle;

    .line 78
    invoke-static {v3, v0, v4}, Lbmf;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Landroid/os/Bundle;)V
    ...
    .line 89
    iget-object v4, p0, Lbcp;->w:Landroid/widget/EditText;

    invoke-virtual {v4, v3}, Landroid/widget/EditText;->setText(Ljava/lang/CharSequence;)V

    .line 90
    iget-object v3, p0, Lbcp;->B:Landroid/widget/Switch;
    ...
    invoke-static {v3}, Lbgb;->a(Landroid/content/Context;)Lbgb;

    move-result-object v3

    invoke-virtual {v3}, Lbgb;->b()Z

    move-result v3

    .line 93
    iget-object v4, p0, Lbcp;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 95
    iget-object v4, p0, Lbcp;->C:Landroid/widget/Spinner;

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-static {v4, v3}, Lbgk;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V
    ...
    .line 98
    iget-object v4, p0, Lbcp;->y:Landroid/widget/EditText;
    ...
    .line 101
    iget-object v4, p0, Lbcp;->A:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbcp;->e:Lcom/android/emailcommon/provider/HostAuth;

    .line 107
    invoke-virtual {v3}, Landroid/os/Parcel;->recycle()V

    .line 108
    iput-boolean v1, p0, Lbcp;->F:Z

    .line 109
    invoke-virtual {p0}, Lbcp;->q()V
    ...
    .line 64
    invoke-virtual {p0}, Lbcp;->a()Z

    move-result v3

    invoke-virtual {p0, v0, v3}, Lbcp;->a(Lcom/android/emailcommon/provider/HostAuth;Z)V

    goto/16 :goto_2

    .line 102
    :cond_b
    invoke-virtual {p0}, Lbcp;->r()V
...
.method public final onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    .line 135
    :goto_0
    invoke-virtual {p0}, Lbcp;->getView()Landroid/view/View;

    move-result-object v1

    sget v2, Lazk;->J:I

    invoke-static {v1, v2, v0}, Lazt;->a(Landroid/view/View;II)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lbcp;->i:Ljava/lang/String;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lbcp;->v:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbcp;->w:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbcp;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    iput-object v0, p0, Lbcp;->y:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbcp;->z:Landroid/support/design/widget/TextInputLayout;
    ...
    iput-object v0, p0, Lbcp;->A:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbcp;->B:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Lbcp;->C:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lbcp;->D:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbcp;->E:Landroid/widget/TextView;
    ...
    .line 30
    iget-object v0, p0, Lbcp;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 33
    iget-object v2, p0, Lbcp;->w:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 34
    iget-object v2, p0, Lbcp;->y:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 35
    iget-object v2, p0, Lbcp;->A:Landroid/widget/EditText;
    ...
    .line 37
    invoke-virtual {p0, v1}, Lbcp;->a(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lbcp;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;IIZ)Landroid/view/View;
...
.method final q()V
    ...
    .line 119
    invoke-static {v2}, Lbsx;->b(Landroid/widget/TextView;)Z
    ...
    invoke-static {v2}, Lbsx;->a(Landroid/widget/TextView;)Z
    ...
    iget-object v2, p0, Lbcp;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 123
    :goto_2
    invoke-virtual {p0, v0}, Lbcp;->a(Z)V
...
.method final r()V
    ...
    .line 144
    iget-object v1, p0, Lbcp;->A:Landroid/widget/EditText;
...
.method public final t()V
    ...
    invoke-virtual {p0, v0, v1}, Lbcp;->startActivityForResult(Landroid/content/Intent;I)V
