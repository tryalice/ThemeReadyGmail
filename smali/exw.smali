...
.field public static final h:Lfqq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lexw;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lexw;->e:Ljava/lang/String;
    ...
    sput-object v0, Lexw;->f:Landroid/content/ComponentName;
    ...
    sput-object v0, Lexw;->g:Landroid/content/ComponentName;
    ...
    invoke-direct {v1, v2, v0}, Lfqq;-><init>(Ljava/lang/String;[Ljava/lang/String;)V

    sput-object v1, Lexw;->h:Lfqq;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lexz;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-static {p0}, Lfgk;->a(Landroid/content/Context;)Lfgk;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lfgk;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lfie;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lexz;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lfgk;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    ...
    .line 1000
    invoke-virtual {v3, v4, v5}, Lfqq;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1, v2}, Lfqq;->a(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method static a(Landroid/accounts/Account;)V
    ...
    :cond_1
    sget-object v1, Lexw;->c:[Ljava/lang/String;
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lfcy;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Leya;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lfcv;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lexu;-><init>(Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p1}, Lexw;->a(Landroid/accounts/Account;)V
    ...
    sget-object v2, Lexw;->e:Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lexx;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object v0, Lexw;->f:Landroid/content/ComponentName;

    invoke-static {p0, v0, v1}, Lexw;->a(Landroid/content/Context;Landroid/content/ComponentName;Lexz;)Ljava/lang/Object;
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 1000
    invoke-static {p0}, Lfcu;->c(Landroid/content/Context;)V
