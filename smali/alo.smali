...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Lalo;->b:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lnx;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-direct {p0, v0, p2}, Lalo;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lnx;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lalo;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 49
    iget-object v0, p0, Lalo;->c:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 50
    iput-object v1, p0, Lalo;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Lalo;->b:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lalo;->a:[I

    invoke-static {v0, p1, v1, p2, v3}, Lasl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lasl;

    move-result-object v4

    .line 5
    invoke-virtual {v4, v3}, Lasl;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    iget-object v5, p0, Lalo;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lalo;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_2
    invoke-virtual {v4, v9}, Lasl;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    iget-object v1, p0, Lalo;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lalo;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
