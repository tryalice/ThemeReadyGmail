...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Levj;)V
    ...
    .line 2
    iput-object p1, p0, Letu;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Letu;->b:Levj;
...
.method public final a(JJ)Ljava/util/Map;
    ...
    .line 53
    iget-object v0, p0, Letu;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v1 .. v6}, Levg;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Letu;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 20
    :cond_2
    new-instance v16, Lett;

    invoke-direct/range {v16 .. v16}, Lett;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Letu;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Letu;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Letu;->b:Levj;

    invoke-direct {v5, v4, v6}, Leyw;-><init>(Landroid/database/sqlite/SQLiteDatabase;Levj;)V
    ...
    .line 43
    invoke-virtual/range {v5 .. v17}, Lets;->a(JIJLjava/util/Map;JLjava/util/Map;ZLett;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Levh;-><init>(Landroid/database/sqlite/SQLiteDatabase;Levj;)V
    :try_end_5
