...
.method protected constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, v0}, Lafp;-><init>(Landroid/content/Context;I)V

    .line 2
    new-instance v0, Landroid/support/v7/app/AlertController;

    invoke-virtual {p0}, Laej;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p0}, Laej;->getWindow()Landroid/view/Window;

    move-result-object v2

    invoke-direct {v0, v1, p0, v2}, Landroid/support/v7/app/AlertController;-><init>(Landroid/content/Context;Lafp;Landroid/view/Window;)V

    iput-object v0, p0, Laej;->a:Landroid/support/v7/app/AlertController;
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    .line 13
    iget-object v6, p0, Laej;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 20
    :goto_0
    iget-object v1, v6, Landroid/support/v7/app/AlertController;->b:Lafp;

    invoke-virtual {v1, v0}, Lafp;->setContentView(I)V
    ...
    .line 175
    sget-object v4, Lvk;->a:Lvx;

    const/4 v5, 0x3

    invoke-interface {v4, v2, v3, v5}, Lvx;->a(Landroid/view/View;II)V
    ...
    .line 191
    iput-object v3, v2, Landroid/support/v4/widget/NestedScrollView;->A:Labv;
    ...
    invoke-direct {v3, v6, v1, v0}, Ladz;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Laea;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Laeb;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 208
    iget-object v1, p0, Laej;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 212
    :cond_1
    invoke-super {p0, p1, p2}, Lafp;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 217
    :cond_1
    invoke-super {p0, p1, p2}, Lafp;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 9
    invoke-super {p0, p1}, Lafp;->setTitle(Ljava/lang/CharSequence;)V

    .line 10
    iget-object v0, p0, Laej;->a:Landroid/support/v7/app/AlertController;
