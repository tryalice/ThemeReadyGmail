...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Lahm;->b:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-direct {p0, v0, p2}, Lahm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Llo;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lahm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 49
    iget-object v0, p0, Lahm;->c:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 50
    iput-object v1, p0, Lahm;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Lahm;->b:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Laoc;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Laoc;

    move-result-object v4

    .line 5
    invoke-virtual {v4, v3}, Laoc;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    iget-object v5, p0, Lahm;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lahm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_2
    invoke-virtual {v4, v9}, Laoc;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    iget-object v1, p0, Lahm;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lahm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    :cond_3
    iget-object v0, v4, Laoc;->b:Landroid/content/res/TypedArray;
