...
.method public constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;I)V
    ...
    iput-object v0, p0, Lcby;->e:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcby;->f:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcby;->h:Ljava/io/File;
...
.method private final a(Lcbm;Lcbv;)V
    .locals 10
    ...
    .line 27
    iget-object v0, p2, Lcbv;->s:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lcbm;->a(I)Lcbm;

    .line 29
    const/16 v0, 0xc

    iget-object v1, p2, Lcbv;->t:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    iget-object v1, p2, Lcbv;->c:Ljava/lang/String;

    invoke-static {v1}, Lcby;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcbm;->a(ILjava/lang/String;)Lcbm;

    .line 34
    const/16 v0, 0x97

    iget-object v1, p2, Lcbv;->d:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcbv;->e:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcbv;->f:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcbv;->g:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Lcbm;->a(ILjava/lang/String;)Lcbm;

    .line 39
    iget-object v0, p2, Lcbv;->n:Ljava/lang/String;
    ...
    .line 40
    invoke-virtual {p1, v4}, Lcbm;->a(I)Lcbm;

    .line 41
    const-string v0, "2"

    invoke-virtual {p1, v2, v0}, Lcbm;->b(ILjava/lang/String;)Lcbm;

    .line 42
    iget-object v0, p2, Lcbv;->n:Ljava/lang/String;

    invoke-virtual {p1, v5, v0}, Lcbm;->b(ILjava/lang/String;)Lcbm;

    .line 43
    invoke-virtual {p1}, Lcbm;->b()Lcbm;

    .line 50
    :cond_0
    :goto_1
    iget-object v0, p2, Lcbv;->r:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p2, Lcbv;->p:Ljava/util/ArrayList;
    ...
    .line 55
    iget-object v2, p2, Lcbv;->q:Ljava/util/Map;
    ...
    invoke-virtual {p1, v6}, Lcbm;->a(I)Lcbm;

    .line 57
    const/16 v6, 0x45e

    iget-object v7, v2, Lcbu;->d:Ljava/lang/String;

    invoke-virtual {p1, v6, v7}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    .line 59
    iget-object v6, v2, Lcbu;->b:Ljava/io/InputStream;

    iget v7, v2, Lcbu;->c:I

    invoke-virtual {p1, v6, v7}, Lcbm;->a(Ljava/io/InputStream;I)Lcbm;

    .line 60
    iget-object v6, v2, Lcbu;->b:Ljava/io/InputStream;

    invoke-static {v6}, Llsb;->a(Ljava/io/InputStream;)V
    ...
    invoke-virtual {p1, v6}, Lcbm;->b(I)Lcbm;
    ...
    .line 68
    iget-object v6, p0, Lcby;->g:Ljava/util/Map;

    iget-object v2, v2, Lcbu;->d:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcbv;->s:Ljava/lang/String;
    ...
    .line 44
    :cond_5
    iget-object v0, p2, Lcbv;->o:Ljava/lang/String;
    ...
    invoke-virtual {p1, v3}, Lcbm;->a(I)Lcbm;

    .line 72
    const/16 v3, 0x451

    invoke-virtual {p1, v3, v1}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    invoke-static {p1, v0, v1}, Lcby;->a(Lcbm;ILbpq;)V
...
.method private final b(Lcbm;)Lcbm;
    .locals 2
    ...
    .line 15
    iget-object v0, p0, Lcby;->e:Ljava/util/Map;
    ...
    .line 16
    invoke-direct {p0, p1, v0}, Lcby;->a(Lcbm;Lcbv;)V
...
.method protected final a(Lbzs;)I
    ...
    .line 83
    iget-object v0, p0, Lcby;->k:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcby;->k:Landroid/content/Context;

    invoke-virtual {p1}, Lbzs;->d()Ljava/io/InputStream;

    move-result-object v2

    iget-object v4, p0, Lcby;->l:Lcom/android/emailcommon/provider/Account;

    iget-object v5, p0, Lcby;->e:Ljava/util/Map;

    iget-object v6, p0, Lcby;->f:Ljava/util/Map;

    iget-object v7, p0, Lcby;->g:Ljava/util/Map;

    invoke-direct/range {v0 .. v7}, Lcak;-><init>(Landroid/content/Context;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 94
    iget-object v4, p0, Lcby;->e:Ljava/util/Map;
    ...
    :cond_1
    iget-object v4, p0, Lcby;->f:Ljava/util/Map;
    ...
    invoke-direct {v4}, Lcbm;-><init>()V

    .line 98
    invoke-direct {p0, v4}, Lcby;->b(Lcbm;)Lcbm;
...
.method protected final b(Lbzs;)I
    ...
    iget-object v2, p0, Lcby;->e:Ljava/util/Map;
    ...
    .line 189
    iget-object v4, p0, Lcby;->k:Landroid/content/Context;
    ...
    iget-object v5, p0, Lcby;->l:Lcom/android/emailcommon/provider/Account;
    ...
    .line 204
    :cond_5
    invoke-super {p0, p1}, Lcbt;->b(Lbzs;)I
...
.method protected final c()Lorg/apache/http/HttpEntity;
    ...
    iget-object v2, p0, Lcby;->h:Ljava/io/File;

    invoke-static {v0, v1, v2}, Ljava/io/File;->createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, Lcby;->i:Ljava/io/File;
    :try_end_0
    ...
    iget-object v1, p0, Lcby;->i:Ljava/io/File;
    ...
    invoke-direct {v1, v0}, Lcbm;-><init>(Ljava/io/OutputStream;)V

    .line 146
    invoke-direct {p0, v1}, Lcby;->b(Lcbm;)Lcbm;
    ...
    iput-object v0, p0, Lcby;->j:Ljava/io/FileInputStream;

    .line 149
    new-instance v0, Lorg/apache/http/entity/InputStreamEntity;

    iget-object v1, p0, Lcby;->j:Ljava/io/FileInputStream;

    iget-object v2, p0, Lcby;->i:Ljava/io/File;
...
.method protected final j()V
    ...
    .line 150
    iget-object v0, p0, Lcby;->j:Ljava/io/FileInputStream;

    invoke-static {v0}, Llsb;->a(Ljava/io/InputStream;)V

    .line 151
    iput-object v1, p0, Lcby;->j:Ljava/io/FileInputStream;

    .line 152
    iget-object v0, p0, Lcby;->i:Ljava/io/File;
    ...
    .line 154
    iput-object v1, p0, Lcby;->i:Ljava/io/File;
...
.method public final o_()I
    ...
    .line 103
    iget-object v0, p0, Lcby;->l:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v0, p0, Lcby;->b:Ljava/lang/String;
    ...
    sget-object v2, Lbpu;->j:[Ljava/lang/String;
    ...
    iget-object v2, p0, Lcby;->k:Landroid/content/Context;

    invoke-direct {v0, v2, v8}, Lcbv;-><init>(Landroid/content/Context;Landroid/database/Cursor;)V

    .line 120
    iget-object v2, v0, Lcbv;->s:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcbv;->t:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcbv;->s:Ljava/lang/String;
