...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lflf;->c:Z

    sput-boolean v1, Lflf;->d:Z

    sput-boolean v1, Lflf;->e:Z

    sput-boolean v1, Lflf;->f:Z
    ...
    sput-object v0, Lflf;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lflf;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 2
    sget-object v3, Lflf;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lfph;->b(Landroid/content/Context;)I
    ...
    .line 3
    :cond_1
    invoke-static {p0}, Lfqb;->a(Landroid/content/Context;)Z
    ...
    .line 4
    sget-object v3, Lfqb;->b:Ljava/lang/Boolean;
    ...
    sput-object v3, Lfqb;->b:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lflg;->a(Landroid/content/Context;)Lflg;

    if-eqz v4, :cond_6

    sget-object v4, Lfqo;->a:[Lfql;

    invoke-static {v3, v4}, Lflg;->a(Landroid/content/pm/PackageInfo;[Lfql;)Lfql;
    ...
    :cond_5
    new-array v4, v1, [Lfql;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Lflg;->a(Landroid/content/pm/PackageInfo;[Lfql;)Lfql;
    ...
    :cond_6
    sget-object v3, Lfqo;->a:[Lfql;

    invoke-static {v6, v3}, Lflg;->a(Landroid/content/pm/PackageInfo;[Lfql;)Lfql;
...
.method public static d(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v1}, Lflb;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lflc;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lfld;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v4}, Lfyz;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array v3, v3, [Lfql;

    const/4 v4, 0x0

    sget-object v5, Lfqo;->a:[Lfql;
    ...
    invoke-static {v2, v3}, Lflg;->a(Landroid/content/pm/PackageInfo;[Lfql;)Lfql;
