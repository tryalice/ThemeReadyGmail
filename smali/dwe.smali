...
.method constructor <init>(Ldwd;Ldwa;Z)V
    ...
    .line 2
    iput-object p2, p0, Ldwe;->a:Ldwa;

    .line 3
    iput-boolean p3, p0, Ldwe;->d:Z
...
.method protected final decodeLoop(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 10
    iget-byte v0, p0, Ldwe;->c:B

    if-ne v2, v0, :cond_4

    .line 11
    invoke-direct {p0}, Ldwe;->a()Z
    ...
    .line 12
    invoke-static {p1}, Ldwe;->b(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 15
    invoke-static {p1}, Ldwe;->a(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 18
    :goto_2
    invoke-direct {p0}, Ldwe;->b()V

    .line 46
    :cond_2
    iput-boolean v5, p0, Ldwe;->h:Z

    goto :goto_0

    .line 17
    :cond_3
    iput-boolean v4, p0, Ldwe;->i:Z
    ...
    .line 48
    iput-boolean v4, p0, Ldwe;->e:Z

    .line 49
    iget-boolean v0, p0, Ldwe;->i:Z
