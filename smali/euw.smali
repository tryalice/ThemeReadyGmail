...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leuw;->b:Linf;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lffm;Ljava/lang/String;Ljava/util/Set;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 63
    iput-object p2, p0, Leuw;->c:Lffm;

    .line 64
    iput-object p3, p0, Leuw;->d:Ljava/lang/String;

    .line 65
    iput-object p4, p0, Leuw;->e:Ljava/util/Set;
...
.method public static a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    .line 214
    :try_start_0
    invoke-static {p0}, Lgke;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    :try_end_0
    ...
    .line 219
    :try_start_2
    sget-object v3, Leuw;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v2, v4}, Lcrw;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_2
...
.method private final a()Ljgo;
    ...
    .line 73
    :try_start_0
    iget-object v0, p0, Leuw;->e:Ljava/util/Set;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0}, Leuw;->getContext()Landroid/content/Context;

    move-result-object v0

    iget-object v2, p0, Leuw;->c:Lffm;

    iget-object v3, p0, Leuw;->d:Ljava/lang/String;

    iget-object v4, p0, Leuw;->e:Ljava/util/Set;

    const/4 v5, 0x1

    .line 77
    invoke-static {v0, v2, v3, v4, v5}, Leuw;->a(Landroid/content/Context;Lffm;Ljava/lang/String;Ljava/util/Set;Z)Ljgo;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static a(Landroid/content/Context;Lffm;Ljava/lang/String;Ljava/util/Set;Z)Ljgo;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 127
    sget-object v0, Lgjy;->i:Lgjg;

    .line 128
    invoke-interface {v0, p1, v1, v5}, Lgjg;->a(Lffm;Ljava/lang/String;Lgjh;)Lffq;
    ...
    .line 130
    invoke-virtual {v0, v8, v9, v7}, Lffq;->a(JLjava/util/concurrent/TimeUnit;)Lfft;
    ...
    .line 134
    sget-object v8, Leuw;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v8, v9}, Lcrw;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-direct {v0, v3}, Lceq;-><init>(Landroid/net/Uri;)V
    ...
    invoke-static {v0, v7, v8}, Lcrw;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-static {v8}, Laum;->a(Ljava/lang/String;)V

    .line 163
    sget-object v8, Leuw;->b:Linf;

    .line 6139
    sget-object v9, Lisc;->c:Lisc;

    invoke-virtual {v8, v9}, Linf;->a(Lisc;)Lilw;

    move-result-object v8

    const-string v9, "get image result"

    invoke-interface {v8, v9}, Lilw;->a(Ljava/lang/String;)Lilk;
    ...
    invoke-direct {v9}, Lgjs;-><init>()V

    .line 7000
    const/4 v10, 0x1

    iput v10, v9, Lgjs;->a:I

    .line 8000
    const/4 v10, 0x1

    iput v10, v9, Lgjs;->b:I

    .line 168
    invoke-virtual {v9}, Lgjs;->a()Lgjr;

    move-result-object v9

    .line 169
    sget-object v10, Lgjy;->g:Lgjq;
    ...
    .line 170
    invoke-interface {v10, p1, v0, v9}, Lgjq;->a(Lffm;Lcom/google/android/gms/people/model/AvatarReference;Lgjr;)Lffq;
    ...
    .line 173
    invoke-virtual {v0, v10, v11, v9}, Lffq;->a(JLjava/util/concurrent/TimeUnit;)Lfft;
    ...
    .line 193
    invoke-static {v9}, Leuw;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v7, v3, v0}, Lceq;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v9}, Leuw;->b(Landroid/os/ParcelFileDescriptor;)[B

    move-result-object v7

    invoke-direct {v0, v3, v7}, Lceq;-><init>(Landroid/net/Uri;[B)V
    ...
    .line 208
    invoke-static {v4}, Ljgo;->a(Ljava/util/Map;)Ljgo;
...
.method private static b(Landroid/os/ParcelFileDescriptor;)[B
    ...
    :goto_1
    :try_start_2
    sget-object v4, Leuw;->a:Ljava/lang/String;
    ...
    .line 251
    sget-object v2, Leuw;->a:Ljava/lang/String;
