...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lbhj;->c:Ljava/util/Map;
...
.method private static a(Landroid/content/Context;Lbhk;)V
    .locals 4
...
.method private final a(Landroid/content/Context;Lbhk;Lcom/android/emailcommon/provider/Account;Z)V
    .locals 10
    ...
    .line 48
    :try_start_0
    iget-object v1, p2, Lbhk;->b:Ljava/lang/String;

    invoke-static {v1}, Lbhl;->a(Ljava/lang/String;)Lbhl;

    move-result-object v1

    .line 49
    iget-object v2, p2, Lbhk;->b:Ljava/lang/String;

    iget-object v3, p2, Lbhk;->d:Ljava/lang/String;

    .line 51
    invoke-static {p1}, Lbgw;->a(Landroid/content/Context;)Lbgw;

    move-result-object v4

    invoke-virtual {v4, v2}, Lbgw;->c(Ljava/lang/String;)Lbnw;
    ...
    .line 53
    sget-object v1, Lbhl;->a:Ljava/lang/String;
    ...
    :goto_0
    invoke-direct {v3, v1}, Lboo;-><init>(Ljava/lang/String;)V

    throw v3
    :try_end_0
    .catch Lboo; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v1, p2, Lbhk;->c:Ljava/lang/String;

    .line 74
    const-string v1, ""

    iput-object v1, p2, Lbhk;->d:Ljava/lang/String;

    .line 75
    iput-wide v8, p2, Lbhk;->e:J

    .line 76
    invoke-static {p1, p2}, Lbhj;->a(Landroid/content/Context;Lbhk;)V

    .line 77
    iget-object v1, p0, Lbhj;->c:Ljava/util/Map;

    iget-wide v2, p2, Lbhk;->a:J
    ...
    iget-object v3, p2, Lbhk;->b:Ljava/lang/String;
    ...
    :try_end_1
    .catch Lboo; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-direct {v1, v2}, Lboo;-><init>(Ljava/lang/String;)V

    throw v1
    :try_end_2
    .catch Lboo; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :cond_3
    :try_start_3
    invoke-virtual {v1, p1, v4, v3}, Lbhl;->b(Landroid/content/Context;Lbnw;Ljava/lang/String;)Lorg/apache/http/client/methods/HttpPost;
    ...
    .line 60
    invoke-virtual {v1, v3, v2, v4}, Lbhl;->a(Lorg/apache/http/client/methods/HttpPost;Ljava/lang/String;Ljava/lang/String;)Lbhm;

    move-result-object v1

    .line 62
    iget-object v2, v1, Lbhm;->a:Ljava/lang/String;

    iput-object v2, p2, Lbhk;->c:Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v5}, Lcio;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_3
    .catch Lboo; {:try_start_3 .. :try_end_3} :catch_0
...
.method private final c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbhk;
    .locals 4
    ...
    .line 31
    iget-object v0, p0, Lbhj;->c:Ljava/util/Map;
    ...
    invoke-direct {v0, v2, v3, v1}, Lbhk;-><init>(JLcom/android/emailcommon/provider/Credential;)V
...
.method public final a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    .line 10
    :try_start_0
    invoke-direct {p0, p1, p2}, Lbhj;->c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbhk;
    ...
    invoke-direct {p0, p1, v2, p2, v0}, Lbhj;->a(Landroid/content/Context;Lbhk;Lcom/android/emailcommon/provider/Account;Z)V

    .line 16
    :cond_0
    iget-object v0, v2, Lbhk;->c:Ljava/lang/String;
...
.method public final b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1, v6, p2, v0}, Lbhj;->a(Landroid/content/Context;Lbhk;Lcom/android/emailcommon/provider/Account;Z)V

    .line 26
    iget-object v0, v6, Lbhk;->c:Ljava/lang/String;
