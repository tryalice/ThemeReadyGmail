...
.method constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Ljava/util/Map;)V
    ...
    .line 2
    iput-object p3, p0, Lbwy;->a:Ljava/util/Map;
...
.method protected final a(Lbsq;)I
    ...
    .prologue
    .line 32
    iget-object v0, p0, Lbwy;->k:Landroid/content/Context;
    ...
    iget-object v2, p0, Lbwy;->l:Lcom/android/emailcommon/provider/Account;

    iget-object v3, p0, Lbwy;->a:Ljava/util/Map;

    .line 34
    invoke-static {v0, v1, v2, v3}, Lbtk;->a(Landroid/content/Context;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Account;Ljava/util/Map;)Z
...
.method protected final d()Lorg/apache/http/HttpEntity;
    ...
    .line 6
    iget-object v1, p0, Lbwy;->a:Ljava/util/Map;
    ...
    .line 8
    :cond_0
    iget-object v2, p0, Lbwy;->a:Ljava/util/Map;
    ...
    .line 31
    :goto_1
    invoke-static {v0}, Lbwy;->a(Lbuk;)Lorg/apache/http/HttpEntity;
    ...
    invoke-virtual {v1, v4}, Lbuk;->a(I)Lbuk;
    ...
    invoke-virtual {v1, v4, v5}, Lbuk;->b(ILjava/lang/String;)Lbuk;

    .line 19
    const/16 v4, 0x12

    invoke-virtual {v1, v4, v3}, Lbuk;->b(ILjava/lang/String;)Lbuk;
