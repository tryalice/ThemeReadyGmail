...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lepf;->a:Ljava/lang/String;
    ...
    sput-wide v0, Lepf;->c:J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lepz;Ljava/lang/String;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lepf;->d:Landroid/content/Context;

    .line 3
    iput-object p3, p0, Lepf;->f:Ljava/lang/String;

    .line 4
    iput-object p2, p0, Lepf;->g:Lepz;

    .line 5
    iget-object v0, p0, Lepf;->g:Lepz;

    iget-object v0, v0, Lepz;->y:Landroid/database/sqlite/SQLiteDatabase;

    iput-object v0, p0, Lepf;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v0, p0, Lepf;->b:Ljava/lang/ThreadLocal;
...
.method private final d()Ljava/util/Set;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lepf;->b:Ljava/lang/ThreadLocal;
    ...
    iget-object v0, v0, Lepi;->a:Ljava/util/Set;
...
.method final a()V
    ...
    .line 49
    iget-boolean v1, v0, Lepi;->c:Z

    if-eqz v1, :cond_0

    .line 50
    iget-object v1, p0, Lepf;->g:Lepz;

    iget-boolean v3, v0, Lepi;->d:Z

    invoke-virtual {v1, v3}, Lepz;->c(Z)V

    .line 51
    :cond_0
    iput-boolean v2, v0, Lepi;->c:Z

    .line 52
    iput-boolean v2, v0, Lepi;->d:Z
    ...
    :goto_0
    invoke-virtual {v3, v1}, Lepz;->a(Z)V
...
.method public final a(J)V
    ...
    .line 8
    iget-object v0, p0, Lepf;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 13
    :cond_1
    invoke-direct {p0}, Lepf;->d()Ljava/util/Set;
...
.method public final a(Z)V
    ...
    .line 33
    iget-object v3, p0, Lepf;->d:Landroid/content/Context;

    iget-object v4, p0, Lepf;->f:Ljava/lang/String;
    ...
    .line 35
    :cond_0
    iget-object v0, p0, Lepf;->d:Landroid/content/Context;

    iget-object v2, p0, Lepf;->f:Ljava/lang/String;
    ...
    .line 37
    invoke-virtual {p0}, Lepf;->c()Ljava/util/Set;
    ...
    invoke-virtual {v1, v0}, Lepz;->b(Ljava/util/Set;)V
    ...
    sget-wide v2, Lepf;->c:J

    .line 43
    iget-boolean v4, v0, Lepz;->ao:Z

    if-nez v4, :cond_2

    iget-boolean v4, v0, Lepz;->p:Z
...
.method public final onBegin()V
    ...
    .prologue
    .line 17
    iget-object v0, p0, Lepf;->f:Ljava/lang/String;

    invoke-static {v0}, Lcom/google/android/gm/provider/MailIndexerService;->a(Ljava/lang/String;)V

    .line 18
    iget-object v0, p0, Lepf;->h:Landroid/database/sqlite/SQLiteTransactionListener;
