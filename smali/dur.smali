...
.method private static b(Landroid/content/Context;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v4, v3}, Ldur;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Lijb;
    ...
    .line 15
    iput-object v5, v3, Lijp;->recipientEmailAddresses:Ljava/util/List;

    .line 17
    iget-object v0, v0, Lcom/google/android/apps/common/drive/aclfix/PotentialFix;->c:Ljava/util/List;

    .line 19
    iput-object v0, v3, Lijp;->fileIds:Ljava/util/List;

    .line 21
    iput-object v2, v3, Lijp;->role:Ljava/lang/String;

    .line 23
    iput-object v4, v3, Lijp;->fixOptionType:Ljava/lang/String;

    .line 24
    invoke-virtual {v1}, Lijb;->d()Lijf;
    ...
    invoke-direct {v1, v0, v3}, Lijh;-><init>(Lijf;Lijp;)V

    .line 27
    invoke-virtual {v1}, Lijh;->c()Ljava/lang/Object;
    :try_end_0
