...
.field public final m:Lcyl;

.field public final n:Lcyk;
...
.method public constructor <init>(Ldbt;)V
    ...
    iput-object v0, p0, Lcyi;->g:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcyi;->i:Landroid/database/DataSetObservable;
    ...
    iput-object v0, p0, Lcyi;->j:Landroid/database/DataSetObservable;
    ...
    iput-object v0, p0, Lcyi;->k:Landroid/database/DataSetObservable;
    ...
    iput-object v0, p0, Lcyi;->l:Landroid/database/DataSetObservable;
    ...
    iput-object v0, p0, Lcyi;->r:[Lcom/android/mail/providers/Account;
    ...
    iput-object v0, p0, Lcyi;->t:Ljava/util/Set;

    .line 17
    iput-boolean v2, p0, Lcyi;->v:Z

    .line 18
    iput-boolean v2, p0, Lcyi;->x:Z

    .line 19
    iput-object p1, p0, Lcyi;->s:Ldbt;
    ...
    iput-object v0, p0, Lcyi;->d:Landroid/content/Context;

    .line 21
    iget-object v0, p0, Lcyi;->s:Ldbt;

    invoke-interface {v0}, Ldbt;->getFragmentManager()Landroid/app/FragmentManager;

    move-result-object v0

    iput-object v0, p0, Lcyi;->e:Landroid/app/FragmentManager;

    .line 22
    new-instance v0, Lcom/android/mail/ui/RecentFolderList;

    iget-object v1, p0, Lcyi;->d:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/android/mail/ui/RecentFolderList;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcyi;->f:Lcom/android/mail/ui/RecentFolderList;
...
.method public final a()Lcom/android/mail/providers/Account;
    ...
    .prologue
    .line 38
    iget-object v0, p0, Lcyi;->o:Lcom/android/mail/providers/Account;
...
.method public final a(Landroid/net/Uri;)Lcom/android/mail/providers/Account;
    ...
    .line 43
    :cond_1
    iget-object v2, p0, Lcyi;->r:[Lcom/android/mail/providers/Account;
...
.method protected final a(ILandroid/app/LoaderManager$LoaderCallbacks;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Ldbt;->getLoaderManager()Landroid/app/LoaderManager;
...
.method public final a(Landroid/database/DataSetObserver;)V
    ...
    .prologue
    .line 49
    iget-object v0, p0, Lcyi;->l:Landroid/database/DataSetObservable;
...
.method public a(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 26
    iget-object v0, p0, Lcyi;->f:Lcom/android/mail/ui/RecentFolderList;

    iget-object v1, p0, Lcyi;->s:Ldbt;

    .line 27
    iget-object v2, v0, Lcom/android/mail/ui/RecentFolderList;->d:Lcvq;

    invoke-interface {v1}, Ldbt;->j()Ldan;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcvq;->a(Ldan;)Lcom/android/mail/providers/Account;
...
.method public a(Lcom/android/mail/providers/Account;)V
    ...
    .line 97
    iget-object v3, p0, Lcyi;->g:Landroid/os/Handler;

    new-instance v4, Lcyj;

    invoke-direct {v4, v2}, Lcyj;-><init>(Ljava/lang/String;)V
    ...
    .line 99
    invoke-virtual {p0}, Lcyi;->k()V

    .line 100
    :cond_5
    invoke-virtual {p0, p1}, Lcyi;->b(Lcom/android/mail/providers/Account;)V

    .line 101
    if-eqz v0, :cond_6

    .line 102
    invoke-virtual {p0}, Lcyi;->m()V
    ...
    invoke-interface {v1, v0}, Ldbt;->startActivity(Landroid/content/Intent;)V
...
.method protected final a([Lcom/android/mail/providers/Account;)V
    ...
    .line 149
    :cond_0
    iput-object p1, p0, Lcyi;->r:[Lcom/android/mail/providers/Account;

    .line 150
    iget-object v0, p0, Lcyi;->k:Landroid/database/DataSetObservable;
...
.method protected final b(Lcom/android/mail/providers/Account;)V
    ...
    .line 114
    iput-object p1, p0, Lcyi;->o:Lcom/android/mail/providers/Account;
    ...
    .line 124
    invoke-interface {v1, v2, v0}, Lcgv;->a(ILjava/lang/String;)V
    ...
    .line 129
    invoke-interface {v0, v1, v2}, Lcgv;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 130
    const/16 v0, 0x1f

    iget-object v1, p0, Lcyi;->m:Lcyl;

    sget-object v2, Landroid/os/Bundle;->EMPTY:Landroid/os/Bundle;

    invoke-virtual {p0, v0, v1, v2}, Lcyi;->a(ILandroid/app/LoaderManager$LoaderCallbacks;Landroid/os/Bundle;)V
    ...
    .line 132
    iget-object v0, p0, Lcyi;->n:Lcyk;

    sget-object v1, Landroid/os/Bundle;->EMPTY:Landroid/os/Bundle;

    invoke-virtual {p0, v6, v0, v1}, Lcyi;->a(ILandroid/app/LoaderManager$LoaderCallbacks;Landroid/os/Bundle;)V
    ...
    .line 143
    :cond_3
    iget-object v0, p0, Lcyi;->i:Landroid/database/DataSetObservable;

    invoke-virtual {v0}, Landroid/database/DataSetObservable;->notifyChanged()V

    .line 144
    invoke-virtual {p0}, Lcyi;->l()V
...
.method public c()V
    ...
    iput-boolean v0, p0, Lcyi;->u:Z

    .line 32
    iget-object v0, p0, Lcyi;->f:Lcom/android/mail/ui/RecentFolderList;

    .line 33
    iget-object v0, v0, Lcom/android/mail/ui/RecentFolderList;->d:Lcvq;
...
.method public final g(Landroid/database/DataSetObserver;)V
    ...
    .prologue
    .line 62
    iget-object v0, p0, Lcyi;->j:Landroid/database/DataSetObservable;
...
.method public final g()[Lcom/android/mail/providers/Account;
    ...
    .prologue
    .line 39
    iget-object v0, p0, Lcyi;->r:[Lcom/android/mail/providers/Account;
...
.method final j()Lder;
    ...
    .line 69
    iget-object v1, p0, Lcyi;->e:Landroid/app/FragmentManager;
    ...
    .line 70
    invoke-static {v0}, Lcyi;->a(Landroid/app/Fragment;)Z
