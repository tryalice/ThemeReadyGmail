...
.method private static a(Landroid/content/Context;Lbgp;)V
    .locals 4
...
.method private final a(Landroid/content/Context;Lbgp;Lcom/android/emailcommon/provider/Account;Z)V
    .locals 10
    ...
    .line 48
    :try_start_0
    iget-object v1, p2, Lbgp;->b:Ljava/lang/String;

    invoke-static {v1}, Lbgq;->a(Ljava/lang/String;)Lbgq;

    move-result-object v1

    .line 49
    iget-object v2, p2, Lbgp;->b:Ljava/lang/String;

    iget-object v3, p2, Lbgp;->d:Ljava/lang/String;

    .line 51
    invoke-static {p1}, Lbgb;->a(Landroid/content/Context;)Lbgb;

    move-result-object v4

    invoke-virtual {v4, v2}, Lbgb;->c(Ljava/lang/String;)Lbmx;
    ...
    :goto_0
    invoke-direct {v3, v1}, Lbnn;-><init>(Ljava/lang/String;)V

    throw v3
    :try_end_0
    .catch Lbnn; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v1, p2, Lbgp;->c:Ljava/lang/String;

    .line 74
    const-string v1, ""

    iput-object v1, p2, Lbgp;->d:Ljava/lang/String;

    .line 75
    iput-wide v8, p2, Lbgp;->e:J

    .line 76
    invoke-static {p1, p2}, Lbgo;->a(Landroid/content/Context;Lbgp;)V

    .line 77
    iget-object v1, p0, Lbgo;->c:Ljava/util/Map;

    iget-wide v2, p2, Lbgp;->a:J
    ...
    iget-object v3, p2, Lbgp;->b:Ljava/lang/String;
    ...
    :try_end_1
    .catch Lbnn; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-direct {v1, v2}, Lbnn;-><init>(Ljava/lang/String;)V

    throw v1
    :try_end_2
    .catch Lbnn; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :cond_3
    :try_start_3
    invoke-virtual {v1, p1, v4, v3}, Lbgq;->b(Landroid/content/Context;Lbmx;Ljava/lang/String;)Lorg/apache/http/client/methods/HttpPost;
    ...
    .line 60
    invoke-virtual {v1, v3, v2, v4}, Lbgq;->a(Lorg/apache/http/client/methods/HttpPost;Ljava/lang/String;Ljava/lang/String;)Lbgr;

    move-result-object v1

    .line 62
    iget-object v2, v1, Lbgr;->a:Ljava/lang/String;

    iput-object v2, p2, Lbgp;->c:Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v5}, Lcgv;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_3
    .catch Lbnn; {:try_start_3 .. :try_end_3} :catch_0
...
.method private final c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbgp;
    .locals 4
    ...
    invoke-direct {v0, v2, v3, v1}, Lbgp;-><init>(JLcom/android/emailcommon/provider/Credential;)V
...
.method public final a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    .line 10
    :try_start_0
    invoke-direct {p0, p1, p2}, Lbgo;->c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbgp;
    ...
    invoke-direct {p0, p1, v2, p2, v0}, Lbgo;->a(Landroid/content/Context;Lbgp;Lcom/android/emailcommon/provider/Account;Z)V
...
.method public final b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1, v6, p2, v0}, Lbgo;->a(Landroid/content/Context;Lbgp;Lcom/android/emailcommon/provider/Account;Z)V

    .line 26
    iget-object v0, v6, Lbgp;->c:Ljava/lang/String;
