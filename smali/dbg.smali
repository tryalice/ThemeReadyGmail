...
# direct methods
.method constructor <init>(Ldbd;Ljava/lang/String;Landroid/app/Fragment;[Ljava/lang/String;[Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p4, p0, Ldbg;->a:[Ljava/lang/String;

    iput-object p5, p0, Ldbg;->b:[Ljava/lang/String;
...
.method public final a()V
    ...
    .line 4
    iget-object v4, p0, Ldbg;->c:Ldbd;

    iget-object v4, v4, Ldbd;->c:Ldae;

    .line 5
    iget-object v4, v4, Ldae;->aM:Ljava/util/Map;

    iget-object v5, p0, Ldbg;->a:[Ljava/lang/String;

    aget-object v5, v5, v0

    iget-object v6, p0, Ldbg;->b:[Ljava/lang/String;
    ...
    .line 6
    iget-object v4, p0, Ldbg;->a:[Ljava/lang/String;
    ...
    invoke-static {v4}, Ldpm;->c(Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 8
    iget-object v5, p0, Ldbg;->c:Ldbd;

    iget-object v5, v5, Ldbd;->c:Ldae;

    iget-object v6, p0, Ldbg;->a:[Ljava/lang/String;

    aget-object v6, v6, v0

    .line 9
    invoke-virtual {v5, v6}, Ldae;->a(Ljava/lang/String;)Lcom/android/mail/browse/ConversationMessage;
    ...
    .line 18
    sget-object v3, Ldae;->C:Ljava/lang/String;
    ...
    iget-object v7, p0, Ldbg;->b:[Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v2}, Ldfe;-><init>(Ldae;Ljava/util/concurrent/ConcurrentMap;)V

    .line 25
    iput-object v3, v0, Ldae;->aO:Ldfe;
    ...
    invoke-virtual {v0, v2, v1}, Ldae;->a(Ljava/lang/String;[Ljava/lang/Object;)V
