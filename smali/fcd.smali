...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfcd;->b:Ljbg;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lfob;Ljava/lang/String;Ljava/util/Set;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lfcd;->c:Lfob;

    .line 3
    iput-object p3, p0, Lfcd;->d:Ljava/lang/String;

    .line 4
    iput-object p4, p0, Lfcd;->e:Ljava/util/Set;
...
.method public static a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    .line 111
    :try_start_0
    invoke-static {p0}, Lgst;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    :try_end_0
    ...
    .line 116
    :try_start_2
    sget-object v3, Lfcd;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v2, v4}, Lcug;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_2
...
.method private final a()Ljvx;
    ...
    .line 9
    :try_start_0
    iget-object v0, p0, Lfcd;->e:Ljava/util/Set;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0}, Lfcd;->getContext()Landroid/content/Context;

    move-result-object v0

    iget-object v2, p0, Lfcd;->c:Lfob;

    iget-object v3, p0, Lfcd;->d:Ljava/lang/String;

    iget-object v4, p0, Lfcd;->e:Ljava/util/Set;

    const/4 v5, 0x1

    .line 14
    invoke-static {v0, v2, v3, v4, v5}, Lfcd;->a(Landroid/content/Context;Lfob;Ljava/lang/String;Ljava/util/Set;Z)Ljvx;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static a(Landroid/content/Context;Lfob;Ljava/lang/String;Ljava/util/Set;Z)Ljvx;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 20
    sget-object v0, Lfcd;->a:Ljava/lang/String;
    ...
    .line 29
    iput-object p2, v0, Lgrx;->a:Ljava/lang/String;
    ...
    .line 41
    sget-object v0, Lgsn;->i:Lgrv;

    .line 42
    invoke-interface {v0, p1, v1, v5}, Lgrv;->a(Lfob;Ljava/lang/String;Lgrw;)Lfof;
    ...
    .line 49
    sget-object v8, Lfcd;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v8, v9}, Lcug;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-direct {v0, v3}, Lcgq;-><init>(Landroid/net/Uri;)V
    ...
    :try_start_2
    invoke-interface {v2, v0}, Lfou;->a(I)Ljava/lang/Object;
    ...
    .line 62
    :goto_3
    invoke-interface {v0}, Lgux;->i()Lcom/google/android/gms/people/model/AvatarReference;
    ...
    invoke-static {v0, v7, v8}, Lcug;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-static {v8}, Lawc;->a(Ljava/lang/String;)V

    .line 69
    sget-object v8, Lfcd;->b:Ljbg;

    .line 70
    sget-object v9, Ljgj;->c:Ljgj;

    invoke-virtual {v8, v9}, Ljbg;->a(Ljgj;)Lizx;
    ...
    invoke-interface {v8, v9}, Lizx;->a(Ljava/lang/String;)Lizj;
    ...
    iput v10, v9, Lgsh;->a:I

    .line 76
    const/4 v10, 0x1

    iput v10, v9, Lgsh;->b:I

    .line 77
    invoke-virtual {v9}, Lgsh;->a()Lgsg;

    move-result-object v9

    .line 78
    sget-object v10, Lgsn;->g:Lgsf;
    ...
    .line 80
    invoke-interface {v10, p1, v0, v9}, Lgsf;->a(Lfob;Lcom/google/android/gms/people/model/AvatarReference;Lgsg;)Lfof;
    ...
    .line 82
    invoke-virtual {v0, v10, v11, v9}, Lfof;->a(JLjava/util/concurrent/TimeUnit;)Lfoi;
    ...
    .line 96
    invoke-static {v9}, Lfcd;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v7, v3, v0}, Lcgq;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v9}, Lfcd;->b(Landroid/os/ParcelFileDescriptor;)[B

    move-result-object v7

    invoke-direct {v0, v3, v7}, Lcgq;-><init>(Landroid/net/Uri;[B)V
    ...
    .line 107
    invoke-static {v4}, Ljvx;->a(Ljava/util/Map;)Ljvx;
...
.method private static b(Landroid/os/ParcelFileDescriptor;)[B
    ...
    :goto_1
    :try_start_2
    sget-object v4, Lfcd;->a:Ljava/lang/String;
    ...
    .line 145
    sget-object v2, Lfcd;->a:Ljava/lang/String;
