...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lbap;ILcom/android/email/activity/setup/SetupDataFragment;Landroid/os/Bundle;)V
    .locals 2
    ...
    .line 3
    iput-object p2, p0, Lbaq;->b:Lbap;

    .line 4
    iput p3, p0, Lbaq;->c:I

    .line 5
    iput-object p4, p0, Lbaq;->d:Lcom/android/email/activity/setup/SetupDataFragment;

    .line 6
    iput-object p5, p0, Lbaq;->e:Landroid/os/Bundle;

    .line 8
    iget-object v0, p4, Lcom/android/email/activity/setup/SetupDataFragment;->b:Lcom/android/emailcommon/provider/Account;

    .line 9
    iput-object v0, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;

    .line 10
    iget-object v0, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;
    ...
    iput-object v0, p0, Lbaq;->h:Ljava/lang/String;
    ...
    .line 13
    :cond_0
    iput-object v1, p0, Lbaq;->g:Ljava/lang/String;

    .line 14
    iput-object v1, p0, Lbaq;->h:Ljava/lang/String;
...
.method private final varargs a()Lcom/android/emailcommon/mail/MessagingException;
    ...
    invoke-virtual {p0, v0}, Lbaq;->publishProgress([Ljava/lang/Object;)V
    ...
    .line 22
    invoke-virtual {v0}, Lbhi;->d()I

    move-result v1

    if-lt v1, v9, :cond_1

    iget-object v1, p0, Lbaq;->e:Landroid/os/Bundle;

    if-eqz v1, :cond_1

    .line 23
    iget-object v1, p0, Lbaq;->i:Ljava/lang/String;

    iget-object v2, p0, Lbaq;->h:Ljava/lang/String;

    iget-object v3, p0, Lbaq;->e:Landroid/os/Bundle;

    invoke-virtual {v0, v1, v2, v3}, Lbhi;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v1}, Lbar;-><init>(Landroid/os/Bundle;)V
    :try_end_0
    ...
    iget-object v4, p0, Lbaq;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1, v2}, Lbhi;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v2}, Lbaq;->publishProgress([Ljava/lang/Object;)V

    .line 31
    iget-object v2, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;

    iget-object v3, p0, Lbaq;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lbhi;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhi;

    move-result-object v2

    .line 32
    invoke-virtual {v2}, Lbhi;->c()Landroid/os/Bundle;
    ...
    .line 44
    iget-object v6, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v5, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;
    ...
    .line 50
    iget-object v5, p0, Lbaq;->d:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    iget-object v5, p0, Lbaq;->a:Landroid/content/Context;
    ...
    iget-object v5, p0, Lbaq;->g:Ljava/lang/String;
    ...
    .line 73
    iget-object v2, p0, Lbaq;->a:Landroid/content/Context;

    .line 74
    invoke-static {v2, v0}, Lblt;->e(Landroid/content/Context;Ljava/lang/String;)Lblu;
    ...
    iget-object v3, p0, Lbaq;->f:Lcom/android/emailcommon/provider/Account;

    invoke-direct {v0, v2, v3}, Lbjb;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V

    .line 84
    iget-object v2, v0, Lbjb;->c:Lbja;

    invoke-virtual {v2}, Lbja;->e()V

    .line 85
    invoke-virtual {v0}, Lbjb;->a()V

    .line 87
    iget-object v0, v0, Lbjb;->c:Lbja;
...
.method protected final synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 132
    invoke-direct {p0}, Lbaq;->a()Lcom/android/emailcommon/mail/MessagingException;
...
.method protected final synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v2}, Lbap;->a(ILcom/android/emailcommon/mail/MessagingException;)V
    ...
    :goto_1
    :sswitch_0
    iget-object v1, p0, Lbaq;->b:Lbap;

    .line 130
    invoke-virtual {v1, v0, p1}, Lbap;->a(ILcom/android/emailcommon/mail/MessagingException;)V
