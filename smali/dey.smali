...
# direct methods
.method constructor <init>(Ldev;Ljava/lang/String;Landroid/app/Fragment;[Ljava/lang/String;[Ljava/lang/String;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Ldey;->c:Ldev;

    iput-object p4, p0, Ldey;->a:[Ljava/lang/String;

    iput-object p5, p0, Ldey;->b:[Ljava/lang/String;
...
.method public final a()V
    ...
    .line 3
    :try_start_0
    iget-object v0, p0, Ldey;->a:[Ljava/lang/String;
    ...
    .line 4
    iget-object v4, p0, Ldey;->c:Ldev;

    iget-object v4, v4, Ldev;->c:Lddv;

    .line 5
    iget-object v4, v4, Lddv;->aV:Ljava/util/Map;

    .line 6
    iget-object v5, p0, Ldey;->a:[Ljava/lang/String;

    aget-object v5, v5, v0

    iget-object v6, p0, Ldey;->b:[Ljava/lang/String;
    ...
    .line 7
    iget-object v4, p0, Ldey;->a:[Ljava/lang/String;
    ...
    invoke-static {v4}, Ldti;->c(Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 9
    iget-object v5, p0, Ldey;->c:Ldev;

    iget-object v5, v5, Ldev;->c:Lddv;

    iget-object v6, p0, Ldey;->a:[Ljava/lang/String;

    aget-object v6, v6, v0

    .line 10
    invoke-virtual {v5, v6}, Lddv;->a(Ljava/lang/String;)Lcom/android/mail/browse/ConversationMessage;
    ...
    iget-object v7, p0, Ldey;->b:[Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v2}, Ldiy;-><init>(Lddv;Ljava/util/concurrent/ConcurrentMap;)V

    .line 26
    iput-object v3, v0, Lddv;->aX:Ldiy;
    ...
    invoke-virtual {v0, v2, v1}, Lddv;->a(Ljava/lang/String;[Ljava/lang/Object;)V
