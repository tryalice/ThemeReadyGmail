...
.method public final a(Ljava/io/BufferedInputStream;Landroid/content/ContentValues;)V
    ...
    invoke-static {v2, v3}, Llic;->a(Ljava/lang/String;Z)V
    ...
    .line 10
    invoke-direct {v2, v3}, Lduv;-><init>(Llco;)V

    .line 11
    :try_start_0
    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lduv;->a(Ljava/io/InputStream;)Lkxz;
    ...
    invoke-virtual {v0, v2}, Llcj;->a(Ljava/lang/String;)Llab;
    ...
    .line 29
    invoke-virtual {v2}, Llgr;->a()Ljava/lang/String;
    ...
    .line 35
    iget-object v0, v2, Lkyg;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lkyg;->b(Ljava/lang/String;)Llab;

    move-result-object v2

    invoke-virtual {v2}, Llab;->a()Ljava/lang/String;
    ...
    sget-object v18, Ldxk;->a:Ljava/util/Map;
    ...
    .line 41
    sget-object v15, Ldxk;->a:Ljava/util/Map;
    ...
    invoke-virtual {v2, v3}, Lkyg;->b(Ljava/lang/String;)Llab;
    ...
    invoke-virtual {v3}, Lldi;->a()Llgf;

    move-result-object v3

    .line 54
    iget-object v3, v3, Llgb;->d:Lkyk;

    .line 55
    invoke-virtual {v3}, Lkyk;->getTime()J
    ...
    invoke-virtual {v3, v4}, Lldi;->b(Ljava/lang/String;)Llab;
    ...
    .line 69
    iget-object v3, v3, Llgh;->d:Lkyq;

    .line 71
    iget-object v6, v5, Llgb;->d:Lkyk;

    .line 72
    invoke-virtual {v3, v6}, Lkyq;->a(Ljava/util/Date;)Ljava/util/Date;
    ...
    .line 73
    invoke-virtual {v5, v3}, Llgf;->a(Ljava/lang/String;)Lkyv;
    ...
    .line 74
    invoke-static {v6, v3}, Llie;->a(Ljava/util/Date;Llfj;)Lkyk;

    move-result-object v3

    invoke-direct {v4, v3}, Llgd;-><init>(Lkyk;)V

    .line 75
    invoke-virtual {v5}, Llgf;->b()Z
    ...
    invoke-virtual {v4, v3}, Llgd;->a(Z)V

    .line 78
    :cond_3
    iget-object v3, v4, Llgb;->d:Lkyk;
    ...
    .line 48
    :cond_4
    invoke-virtual {v3}, Llab;->a()Ljava/lang/String;
    ...
    .line 64
    :cond_7
    iget-object v3, v5, Llgb;->d:Lkyk;

    .line 65
    instance-of v3, v3, Lkyn;
    ...
    invoke-direct {v4, v6}, Lkyq;-><init>(I)V

    invoke-direct {v3, v4}, Llgh;-><init>(Lkyq;)V
    :try_end_0
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lkxv; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-static {v3, v15}, Ldxj;->a(Ljava/lang/String;Ljava/util/TimeZone;)J
    ...
    .catch Lkxv; {:try_start_1 .. :try_end_1} :catch_2
