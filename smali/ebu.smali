...
.method public final a(Ljava/io/BufferedInputStream;Landroid/content/ContentValues;)V
    ...
    invoke-static {v2, v3}, Llpy;->a(Ljava/lang/String;Z)V
    ...
    .line 10
    invoke-direct {v2, v3}, Ldzf;-><init>(Llkk;)V

    .line 11
    :try_start_0
    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Ldzf;->a(Ljava/io/InputStream;)Llfv;
    ...
    invoke-virtual {v0, v2}, Llkf;->a(Ljava/lang/String;)Llhx;
    ...
    .line 29
    invoke-virtual {v2}, Llon;->a()Ljava/lang/String;
    ...
    .line 35
    iget-object v0, v2, Llgc;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Llgc;->b(Ljava/lang/String;)Llhx;

    move-result-object v2

    invoke-virtual {v2}, Llhx;->a()Ljava/lang/String;
    ...
    sget-object v18, Lebv;->a:Ljava/util/HashMap;
    ...
    .line 41
    sget-object v15, Lebv;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v3}, Llgc;->b(Ljava/lang/String;)Llhx;
    ...
    invoke-virtual {v3}, Llle;->a()Llob;

    move-result-object v3

    .line 54
    iget-object v3, v3, Llnx;->d:Llgg;

    .line 55
    invoke-virtual {v3}, Llgg;->getTime()J
    ...
    invoke-virtual {v3, v4}, Llle;->b(Ljava/lang/String;)Llhx;
    ...
    .line 69
    iget-object v3, v3, Llod;->d:Llgm;

    .line 71
    iget-object v6, v5, Llnx;->d:Llgg;

    .line 72
    invoke-virtual {v3, v6}, Llgm;->a(Ljava/util/Date;)Ljava/util/Date;
    ...
    .line 73
    invoke-virtual {v5, v3}, Llob;->a(Ljava/lang/String;)Llgr;
    ...
    .line 74
    invoke-static {v6, v3}, Llqa;->a(Ljava/util/Date;Llnf;)Llgg;

    move-result-object v3

    invoke-direct {v4, v3}, Llnz;-><init>(Llgg;)V

    .line 75
    invoke-virtual {v5}, Llob;->b()Z
    ...
    invoke-virtual {v4, v3}, Llnz;->a(Z)V

    .line 78
    :cond_3
    iget-object v3, v4, Llnx;->d:Llgg;
    ...
    .line 48
    :cond_4
    invoke-virtual {v3}, Llhx;->a()Ljava/lang/String;
    ...
    .line 64
    :cond_7
    iget-object v3, v5, Llnx;->d:Llgg;

    .line 65
    instance-of v3, v3, Llgj;
    ...
    invoke-direct {v4, v6}, Llgm;-><init>(I)V

    invoke-direct {v3, v4}, Llod;-><init>(Llgm;)V
    :try_end_0
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Llfr; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-static {v3, v15}, Lebu;->a(Ljava/lang/String;Ljava/util/TimeZone;)J
    ...
    .catch Llfr; {:try_start_1 .. :try_end_1} :catch_2
