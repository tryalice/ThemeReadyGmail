...
.method public static a(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    ...
    .prologue
    .line 44
    instance-of v0, p0, Ljqx;

    if-nez v0, :cond_0

    instance-of v0, p0, Ljtn;
    ...
    invoke-direct {v0, p0}, Ljtn;-><init>(Ljava/util/NavigableSet;)V
...
.method public static a(Ljava/util/Set;Ljava/util/Set;)Ljtm;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-direct {v0, p0, p1}, Ljtj;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method static a(Ljava/util/Set;Ljava/util/Collection;)Z
    ...
    invoke-static {p0, v0}, Ljti;->a(Ljava/util/Set;Ljava/util/Iterator;)Z
...
.method public static b(Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    .line 23
    invoke-static {v0, p0}, Ljrb;->a(Ljava/util/Collection;Ljava/lang/Iterable;)Z
