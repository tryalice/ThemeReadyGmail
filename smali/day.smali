...
# direct methods
.method public constructor <init>(Ldan;Lcom/android/mail/providers/Folder;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()V"
    ...
    .line 3
    iput-object p2, p0, Lday;->b:Lcom/android/mail/providers/Folder;

    .line 4
    iget-object v0, p2, Lcom/android/mail/providers/Folder;->r:Ldne;

    iput-object v0, p0, Lday;->a:Ldne;

    .line 5
    invoke-virtual {p0, v2}, Lday;->a(Lckl;)V
...
.method public final declared-synchronized a(Lckl;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-virtual {p0}, Lday;->clear()V

    .line 43
    iget-object v0, p0, Lday;->b:Lcom/android/mail/providers/Folder;

    invoke-virtual {p0, v0}, Lday;->add(Ljava/lang/Object;)V
...
.method public final declared-synchronized getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p2, v0, v1}, Lcom/android/mail/ui/FolderItemView;->a(Lcom/android/mail/providers/Folder;Ldne;)V

    .line 16
    iget-object v1, v0, Lcom/android/mail/providers/Folder;->r:Ldne;

    iget-object v4, p0, Lday;->c:Ldan;

    .line 17
    iget-object v4, v4, Ldan;->k:Ldne;

    .line 18
    invoke-virtual {v1, v4}, Ldne;->equals(Ljava/lang/Object;)Z
    ...
    .line 19
    iget-object v1, p0, Lday;->c:Ldan;

    invoke-virtual {v1}, Ldan;->getListView()Landroid/widget/ListView;
    ...
    .line 25
    invoke-virtual {v1}, Ldar;->getCount()I
    ...
    .line 29
    iget-object v1, v1, Ldan;->l:Lcom/android/mail/providers/Folder;
    ...
    .line 31
    iget-object v4, v4, Ldan;->l:Lcom/android/mail/providers/Folder;
    ...
    invoke-virtual {v1}, Ldan;->getActivity()Landroid/app/Activity;
