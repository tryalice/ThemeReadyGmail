...
.method public constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Ljava/lang/String;I)V
    ...
    .line 2
    iput-object p3, p0, Lbwg;->a:Ljava/lang/String;
...
.method protected final a(Lbsq;)I
    ...
    invoke-direct {v2, v1}, Lbto;-><init>(Ljava/io/InputStream;)V

    .line 22
    invoke-virtual {v2}, Lbto;->d()Z

    .line 24
    iget-object v2, v2, Lbto;->a:Lcom/android/exchange/provider/GalResult;

    .line 25
    iput-object v2, p0, Lbwg;->d:Lcom/android/exchange/provider/GalResult;
    :try_end_0
...
.method protected final d()Lorg/apache/http/HttpEntity;
    ...
    iget-object v3, p0, Lbwg;->a:Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {v1, v2, v0}, Lbuk;->b(ILjava/lang/String;)Lbuk;
    ...
    .line 13
    invoke-static {v1}, Lbwg;->a(Lbuk;)Lorg/apache/http/HttpEntity;
