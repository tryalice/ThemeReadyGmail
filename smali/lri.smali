...
.method private final a(I)[B
    ...
    .line 76
    iget-object v0, p0, Llri;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 80
    iget-object v1, p0, Llri;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 83
    :try_start_0
    iget-object v5, p0, Llri;->b:Ljava/nio/channels/SelectionKey;
    ...
    iget-wide v6, p0, Llri;->a:J

    invoke-static {v5, v6, v7}, Llri;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_1
...
.method static a(Ljava/net/SocketAddress;Ljava/net/SocketAddress;[BJ)[B
    ...
    invoke-direct {v1, p3, p4}, Llri;-><init>(J)V
    ...
    .line 120
    :try_start_0
    invoke-virtual {v1, p0}, Llri;->a(Ljava/net/SocketAddress;)V

    .line 121
    :cond_0
    invoke-virtual {v1, p1}, Llri;->b(Ljava/net/SocketAddress;)V

    .line 122
    invoke-virtual {v1, p2}, Llri;->a([B)V

    .line 123
    invoke-virtual {v1}, Llri;->b()[B
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final a([B)V
    ...
    .line 44
    invoke-static {v1, p1}, Llri;->a(Ljava/lang/String;[B)V
    ...
    .line 56
    iget-object v4, p0, Llri;->b:Ljava/nio/channels/SelectionKey;
    ...
    invoke-static {v4, v6, v7}, Llri;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final b(Ljava/net/SocketAddress;)V
    ...
    iget-wide v2, p0, Llri;->a:J

    invoke-static {v1, v2, v3}, Llri;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final b()[B
    ...
    invoke-direct {p0, v0}, Llri;->a(I)[B
    ...
    .line 108
    invoke-static {v2, v1}, Llri;->a(Ljava/lang/String;[B)V
