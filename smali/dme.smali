...
.method public static a(Ljava/util/List;)V
    ...
    invoke-direct {v3, v2}, Ldmg;-><init>(Ldmf;)V

    .line 2
    iput-boolean v8, v3, Ldmg;->d:Z
    ...
    .line 7
    iget-object v6, v0, Ldmf;->a:Lcom/android/mail/providers/Folder;

    .line 9
    iget-object v1, v6, Lcom/android/mail/providers/Folder;->p:Ldmh;
    ...
    invoke-direct {v1, v0}, Ldmg;-><init>(Ldmf;)V

    .line 12
    iget-object v7, v6, Lcom/android/mail/providers/Folder;->p:Ldmh;

    invoke-virtual {v7}, Ldmh;->a()Landroid/net/Uri;
    ...
    .line 17
    invoke-virtual {v3, v1}, Ldmg;->a(Ldmg;)V

    goto :goto_0

    .line 13
    :cond_0
    iput-object v0, v1, Ldmg;->a:Ldmf;

    goto :goto_1

    .line 18
    :cond_1
    iget-object v0, v6, Lcom/android/mail/providers/Folder;->K:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Ldmg;-><init>(Ldmf;)V

    .line 21
    iget-object v6, v6, Lcom/android/mail/providers/Folder;->K:Landroid/net/Uri;

    invoke-interface {v4, v6, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 22
    :cond_2
    invoke-virtual {v0, v1}, Ldmg;->a(Ldmg;)V
    ...
    iget-boolean v3, v0, Ldmg;->d:Z

    if-nez v3, :cond_6

    .line 30
    iget-object v3, v1, Ldmg;->a:Ldmf;

    if-eqz v3, :cond_5

    iget-object v3, v1, Ldmg;->a:Ldmf;

    iget-object v3, v3, Ldmf;->c:Ljava/lang/String;
    ...
    .line 32
    :cond_5
    iget-object v1, v0, Ldmg;->a:Ldmf;

    .line 33
    iget-object v1, v1, Ldmf;->a:Lcom/android/mail/providers/Folder;
    ...
    .line 44
    :goto_3
    iget-object v3, v0, Ldmg;->a:Ldmf;

    iput-object v1, v3, Ldmf;->c:Ljava/lang/String;
    ...
    .line 46
    iput-boolean v8, v0, Ldmg;->d:Z

    .line 48
    :cond_6
    iget-object v1, v0, Ldmg;->b:Ljava/util/List;
    ...
    .line 54
    iget-object v1, v0, Ldmg;->c:Ljava/util/PriorityQueue;
    ...
    .line 36
    iget-object v3, v3, Ldmf;->a:Lcom/android/mail/providers/Folder;
    ...
    iget-object v5, v1, Ldmg;->a:Ldmf;

    iput-object v5, v3, Ldmf;->d:Ldmf;

    .line 41
    :cond_9
    :goto_5
    iget-object v1, v1, Ldmg;->a:Ldmf;

    iget-object v1, v1, Ldmf;->c:Ljava/lang/String;
