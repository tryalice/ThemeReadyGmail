...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbto;->b:Ljavax/net/ssl/HostnameVerifier;
...
.method public static declared-synchronized a(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Ljavax/net/ssl/KeyManager;Z)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v0, p0}, Lbtq;->a(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v5, p0, p1}, Lbts;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;)V

    aput-object v5, v3, v4

    .line 65
    invoke-static {v0, v3, p1}, Lbtn;->a([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Lcom/android/emailcommon/provider/HostAuth;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-static {v3, v0, v4, v5}, Lcug;->f(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_3
    ...
    :cond_2
    :try_start_4
    sget-object v3, Lbto;->a:Ljavax/net/ssl/SSLSocketFactory;

    if-nez v3, :cond_3

    .line 69
    invoke-static {v0, p1}, Lbtn;->a([Ljavax/net/ssl/KeyManager;Lcom/android/emailcommon/provider/HostAuth;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 70
    sput-object v0, Lbto;->a:Ljavax/net/ssl/SSLSocketFactory;

    .line 71
    :cond_3
    sget-object v0, Lbto;->a:Ljavax/net/ssl/SSLSocketFactory;
    :try_end_4
...
.method public static a(Lbtq;)V
    .locals 0

    .prologue
    .line 56
    sput-object p0, Lbto;->c:Lbtq;
...
.method public static a(Lcom/android/emailcommon/provider/HostAuth;Ljavax/net/ssl/SSLSocket;ZLjava/lang/String;)V
    ...
    .line 8
    :cond_0
    invoke-static {v0}, Lbto;->a(Ljavax/net/ssl/SSLSession;)[Ljava/security/cert/X509Certificate;
    ...
    .line 13
    sget-object v2, Lbto;->b:Ljavax/net/ssl/HostnameVerifier;
...
.method public static a(Lcom/android/emailcommon/provider/HostAuth;)[Ljava/security/cert/X509Certificate;
    ...
    .line 36
    invoke-static {v2}, Lbto;->a(Ljavax/net/ssl/SSLSession;)[Ljava/security/cert/X509Certificate;
...
.method private static a(Ljavax/net/ssl/SSLSession;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v2, v0, v4, v3}, Lcug;->d(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public static b(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Ljavax/net/ssl/KeyManager;Z)Lbtm;
    .locals 2

    .prologue
    .line 75
    invoke-static {p0, p1, p2, p3}, Lbto;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Ljavax/net/ssl/KeyManager;Z)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-direct {v1, v0}, Lbtm;-><init>(Ljavax/net/ssl/SSLSocketFactory;)V

    .line 77
    if-eqz p3, :cond_1

    .line 78
    sget-object v0, Lbtm;->a:Lorg/apache/http/conn/ssl/X509HostnameVerifier;
    ...
    .line 81
    :cond_0
    iput-object v0, v1, Lbtm;->f:Lorg/apache/http/conn/ssl/X509HostnameVerifier;
