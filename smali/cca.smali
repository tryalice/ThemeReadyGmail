...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;JLbrf;)V
    .locals 5
    ...
    .line 2
    iput-object p5, p0, Lcca;->a:Lbrf;

    .line 3
    iput-wide p3, p0, Lcca;->b:J
    ...
    .line 5
    iget-object v0, p0, Lcca;->k:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcca;->c:Lcom/android/emailcommon/provider/Policy;
...
.method public static a(Lbrf;JJII)V
    .locals 5
    ...
    .line 9
    :try_start_0
    invoke-interface/range {p0 .. p6}, Lbrf;->a(JJII)V
    :try_end_0
...
.method private final a(Lcom/android/emailcommon/provider/Attachment;Ljava/io/File;)Z
    ...
    .line 91
    iget-object v1, p0, Lcca;->k:Landroid/content/Context;

    invoke-static {v1, v2, p1}, Lbta;->a(Landroid/content/Context;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Attachment;)V

    .line 92
    invoke-static {v2}, Lcca;->a(Ljava/io/Closeable;)V
...
.method protected final a(Lbzs;)I
    ...
    .line 102
    iget-object v1, p0, Lcca;->a:Lbrf;

    iget-object v2, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;
    ...
    invoke-static/range {v1 .. v7}, Lcca;->a(Lbrf;JJII)V
    ...
    iget-object v4, p0, Lcca;->k:Landroid/content/Context;
    ...
    .line 116
    :try_start_3
    new-instance v6, Lccc;

    iget-object v1, p0, Lcca;->a:Lbrf;

    iget-object v4, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;

    invoke-direct {v6, v1, v4}, Lccc;-><init>(Lbrf;Lcom/android/emailcommon/provider/Attachment;)V

    .line 118
    iget-object v1, p0, Lcci;->m:Lcer;

    .line 119
    iget-wide v4, v1, Lcer;->l:D
    ...
    invoke-direct/range {v1 .. v6}, Lcar;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;JLccc;)V

    .line 122
    invoke-virtual {v1}, Lcar;->d()Z
    ...
    .line 158
    :try_start_5
    invoke-static {v3}, Lcca;->a(Ljava/io/Closeable;)V
    :try_end_5
    ...
    .line 132
    iget-object v1, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;

    iget-wide v4, v1, Lcom/android/emailcommon/provider/Attachment;->k:J

    .line 133
    :goto_2
    invoke-static {v2, v3, v4, v5, v6}, Lcar;->a(Ljava/io/InputStream;Ljava/io/OutputStream;JLccc;)V
    ...
    .line 141
    iget-object v4, p0, Lcca;->e:Lbpu;

    invoke-static {v1, v4}, Lccd;->a(Ljava/io/InputStream;Lbpu;)V

    .line 142
    iget-object v1, p0, Lcca;->e:Lbpu;
    ...
    invoke-virtual {v1, v4}, Lbpu;->i(Landroid/content/Context;)Landroid/net/Uri;

    .line 144
    iget-object v1, p0, Lcca;->e:Lbpu;

    iget-wide v4, v1, Lbpu;->as:J
    ...
    iget-object v5, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;
    ...
    iget-object v5, p0, Lcca;->k:Landroid/content/Context;
    ...
    :cond_7
    :try_start_d
    iget-object v0, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;

    invoke-direct {p0, v0, v9}, Lcca;->a(Lcom/android/emailcommon/provider/Attachment;Ljava/io/File;)Z
...
.method protected final b()Ljava/lang/String;
    ...
    .line 61
    sget-object v3, Lcgk;->a:Ljava/nio/charset/Charset;

    invoke-virtual {v1, v2, v0, v3}, Lcgo;->a(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/nio/charset/Charset;)V
...
.method protected final c()Lorg/apache/http/HttpEntity;
    ...
    .line 78
    invoke-static {v0}, Lcca;->a(Lcbm;)Lorg/apache/http/HttpEntity;
...
.method public final f()I
    ...
    iput-object v1, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;
    ...
    invoke-static {v1, v4, v0}, Lcug;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 23
    :cond_1
    iget-object v1, p0, Lcca;->c:Lcom/android/emailcommon/provider/Policy;
    ...
    iget-object v3, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;
    ...
    .line 37
    invoke-static {v1, v2, v0}, Lcug;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 42
    iget-object v2, p0, Lcca;->a:Lbrf;

    iget-object v0, p0, Lcca;->d:Lcom/android/emailcommon/provider/Attachment;

    iget-wide v3, v0, Lcom/android/emailcommon/provider/Attachment;->o:J

    iget-wide v5, p0, Lcca;->b:J

    move v8, v7

    invoke-static/range {v2 .. v8}, Lcca;->a(Lbrf;JJII)V
