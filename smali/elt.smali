...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lenm;)V
    ...
    .line 26
    iput-object p1, p0, Lelt;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 27
    iput-object p2, p0, Lelt;->b:Lenm;

    .line 28
    iget-object v0, p0, Lelt;->b:Lenm;

    .line 10700
    iget-object v0, v0, Lenm;->j:Lemd;

    iput-object v0, p0, Lelt;->c:Lemd;

    .line 29
    return-void
.end method

.method private final a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lelu;)V
    .locals 14
    ...
    invoke-static {v10, v11}, Lenm;->d(J)Z
    ...
    invoke-virtual {v0, v3, v2}, Lelu;->a(ZLjava/lang/Long;)Z
    ...
    .line 275
    iget-object v3, p0, Lelt;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v3, v9, v10}, Lenl;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 13027
    iget-object v2, v2, Lemd;->b:Landroid/content/ContentQueryMap;

    invoke-virtual {v2}, Landroid/content/ContentQueryMap;->requery()V

    .line 13028
    iget-object v2, p0, Lelt;->b:Lenm;

    iget-object v2, v2, Lenm;->i:Leno;

    invoke-interface {v2, v6}, Leno;->a(Ljava/util/Set;)V
...
.method private final a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    iget-object v2, v0, Lelt;->b:Lenm;

    iget-object v2, v2, Lenm;->e:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v3}, Lenp;->a(Ljava/util/Set;)Z
    ...
    invoke-virtual {v2, v0}, Lenp;->a(Ljava/util/Set;)Z
    ...
    iget-object v3, v0, Lelt;->b:Lenm;

    move-object/from16 v0, p0

    iget-object v4, v0, Lelt;->b:Lenm;

    .line 40351
    invoke-virtual {v4, v14, v15}, Lenm;->c(J)Lenn;
    ...
    iget-object v3, v3, Lenm;->i:Leno;

    invoke-interface {v3, v2}, Leno;->a(Lenp;)V
...
# virtual methods
.method final a(JIJLjava/util/Map;JLjava/util/Map;ZLelu;Landroid/util/TimingLogger;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JIJ",
    ...
    .line 78
    invoke-virtual/range {v2 .. v13}, Lelt;->a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLelu;Landroid/util/TimingLogger;)Z
    ...
    .line 84
    invoke-virtual/range {v3 .. v8}, Lelt;->a(JJLjava/util/Map;)V
...
.method public final a(JILjava/util/Map;Ljava/util/Map;JLjava/util/Set;Lelu;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
    ...
    .line 122
    invoke-direct/range {v1 .. v11}, Lelt;->a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    .line 127
    invoke-direct/range {v4 .. v11}, Lelt;->a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lelu;)V
...
.method public final a(JJLjava/util/Map;)V
    ...
    .line 156
    iget-object v0, p0, Lelt;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method protected abstract a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLelu;Landroid/util/TimingLogger;)Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
            "Ljava/lang/String;",
