...
.method public final onPageFinished(Landroid/webkit/WebView;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lehb;->isAdded()Z
    ...
    .line 7
    iget-object v0, v0, Lehb;->g:Lddu;

    .line 8
    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lddu;->a(Ljava/lang/Runnable;)V
...
.method public final shouldOverrideUrlLoading(Landroid/webkit/WebView;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lehb;->getActivity()Landroid/app/Activity;
    ...
    .line 19
    :cond_2
    iget-object v4, v0, Ldao;->w:Lcom/android/mail/providers/Account;

    .line 21
    invoke-static {v0, v3, v4}, Ldrt;->b(Landroid/content/Context;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Z
    ...
    invoke-static {v5, v4}, Lfab;->a(Landroid/content/ContentResolver;Ljava/lang/String;)Z
    ...
    .line 27
    :cond_5
    iget-object v1, p0, Lehc;->a:Lehb;

    .line 28
    iget-object v1, v1, Lehb;->e:Ljava/lang/String;
    ...
    .line 32
    iget-object v4, v4, Lehb;->e:Ljava/lang/String;

    .line 33
    invoke-static {v0, v1, v3, v4}, Ldae;->a(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    .line 37
    :goto_1
    invoke-static {v0, v2}, Lcnh;->a(Landroid/content/Context;Z)Z
    ...
    invoke-static {v2, v0, v1}, Lcnh;->a(Ljava/lang/String;Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    .line 39
    :cond_7
    invoke-static {v0, v1}, Ldrs;->a(Landroid/content/Context;Landroid/content/Intent;)Z
