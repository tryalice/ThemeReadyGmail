...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/ListAdapter;IZ)V
    ...
    invoke-static {p2}, Lema;->a(Landroid/widget/ListAdapter;)Ljava/util/List;
    ...
    iput-object v0, p0, Lema;->a:Landroid/view/LayoutInflater;

    .line 3
    iput p3, p0, Lema;->b:I

    .line 4
    iput-boolean p4, p0, Lema;->e:Z

    .line 5
    iput-object p2, p0, Lema;->f:Landroid/widget/ListAdapter;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 17
    iget-object v0, p0, Lema;->a:Landroid/view/LayoutInflater;
    ...
    iput-object v0, v1, Lemb;->a:Landroid/widget/TextView;
    ...
    iput-object v0, v1, Lemb;->b:Landroid/widget/TextView;
    ...
    .line 26
    :goto_0
    invoke-virtual {p0, p1}, Lema;->getItem(I)Ljava/lang/Object;
    ...
    .line 30
    :goto_1
    iget-object v4, v1, Lemb;->a:Landroid/widget/TextView;
    ...
    .line 34
    iget-object v3, v1, Lemb;->b:Landroid/widget/TextView;

    invoke-virtual {v3, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 35
    iget-object v0, v1, Lemb;->b:Landroid/widget/TextView;
...
.method public final notifyDataSetChanged()V
    ...
    invoke-virtual {p0, v0}, Lema;->setNotifyOnChange(Z)V

    .line 40
    invoke-virtual {p0}, Lema;->clear()V

    .line 41
    iget-object v0, p0, Lema;->f:Landroid/widget/ListAdapter;

    invoke-static {v0}, Lema;->a(Landroid/widget/ListAdapter;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {p0, v0}, Lema;->addAll(Ljava/util/Collection;)V
