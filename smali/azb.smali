...
.method private final a(Lcom/android/emailcommon/provider/Account;)V
    ...
    .line 60
    iget-object v0, p0, Lazb;->b:Landroid/widget/Spinner;

    invoke-virtual {v0, v2}, Landroid/widget/Spinner;->setVisibility(I)V

    .line 61
    iget-object v0, p0, Lazb;->c:Landroid/view/View;

    invoke-virtual {v0, v2}, Landroid/view/View;->setVisibility(I)V

    .line 62
    invoke-virtual {p0}, Lazb;->getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {v7, v8, v9}, Lbcy;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 82
    iget-object v2, p0, Lazb;->b:Landroid/widget/Spinner;
    ...
    invoke-static {v0, v2}, Lbcy;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 29
    :cond_0
    iget-object v4, v0, Lbho;->z:[Ljava/lang/CharSequence;

    .line 30
    iget-object v5, v0, Lbho;->y:[Ljava/lang/CharSequence;
    ...
    .line 42
    iget-object v4, p0, Lazb;->a:Landroid/widget/Spinner;

    invoke-virtual {v4, v1}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 43
    iget-object v1, p0, Lazb;->a:Landroid/widget/Spinner;
    ...
    invoke-static {v1, v4}, Lbcy;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V

    .line 46
    :cond_2
    iget-boolean v1, v0, Lbho;->r:Z

    if-eqz v1, :cond_3

    .line 47
    invoke-direct {p0, v3}, Lazb;->a(Lcom/android/emailcommon/provider/Account;)V

    .line 48
    :cond_3
    iget-boolean v1, v0, Lbho;->u:Z

    if-eqz v1, :cond_4

    .line 49
    iget-object v1, p0, Lazb;->e:Landroid/widget/CheckBox;
    ...
    .line 51
    :cond_4
    iget-boolean v1, v0, Lbho;->v:Z

    if-eqz v1, :cond_5

    .line 52
    iget-object v1, p0, Lazb;->f:Landroid/widget/CheckBox;
    ...
    .line 55
    iget-object v1, p0, Lazb;->h:Landroid/widget/CheckBox;
    ...
    .line 57
    :cond_6
    iget-boolean v0, v0, Lbho;->x:Z

    if-nez v0, :cond_7

    .line 58
    iget-object v0, p0, Lazb;->i:Landroid/widget/CheckBox;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v5}, Lazb;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;IIZ)Landroid/view/View;
    ...
    iput-object v0, p0, Lazb;->a:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lazb;->b:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lazb;->d:Landroid/widget/CheckBox;

    .line 7
    iget-object v0, p0, Lazb;->d:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->e:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->f:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->g:Landroid/widget/CheckBox;

    .line 11
    iget-object v0, p0, Lazb;->g:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->h:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->i:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lazb;->c:Landroid/view/View;
