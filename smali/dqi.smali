...
.method constructor <init>(Ldqh;Ldqe;Z)V
    ...
    .line 50
    iput-object p2, p0, Ldqi;->a:Ldqe;

    .line 51
    iput-boolean p3, p0, Ldqi;->d:Z
...
.method protected final decodeLoop(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 62
    iget-boolean v0, p0, Ldqi;->e:Z

    if-eqz v0, :cond_b

    .line 63
    iget-byte v0, p0, Ldqi;->c:B

    if-ne v2, v0, :cond_4

    .line 64
    invoke-direct {p0}, Ldqi;->a()Z
    ...
    .line 65
    invoke-static {p1}, Ldqi;->b(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 68
    invoke-static {p1}, Ldqi;->a(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 72
    :goto_2
    invoke-direct {p0}, Ldqi;->b()V

    .line 80
    :cond_2
    iput-boolean v5, p0, Ldqi;->h:Z

    goto :goto_0

    .line 71
    :cond_3
    iput-boolean v4, p0, Ldqi;->i:Z
