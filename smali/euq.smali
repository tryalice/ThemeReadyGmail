...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lewe;)V
    ...
    .line 2
    iput-object p1, p0, Leuq;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Leuq;->b:Lewe;

    .line 4
    iget-object v0, p0, Leuq;->b:Lewe;

    .line 5
    iget-object v0, v0, Lewe;->i:Leuz;

    .line 6
    iput-object v0, p0, Leuq;->c:Leuz;

    .line 7
    return-void
.end method

.method private final a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Leur;)V
    .locals 14
    ...
    invoke-static {v10, v11}, Lewe;->d(J)Z
    ...
    invoke-virtual {v0, v3, v2}, Leur;->a(ZLjava/lang/Long;)Z
    ...
    .line 128
    iget-object v3, p0, Leuq;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 158
    iget-object v2, v2, Leuz;->b:Landroid/content/ContentQueryMap;

    invoke-virtual {v2}, Landroid/content/ContentQueryMap;->requery()V

    .line 159
    iget-object v2, p0, Leuq;->b:Lewe;

    iget-object v2, v2, Lewe;->h:Lewg;

    invoke-interface {v2, v6}, Lewg;->a(Ljava/util/Set;)V
...
.method private final a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    iget-object v2, v0, Leuq;->b:Lewe;

    iget-object v2, v2, Lewe;->d:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v3}, Lewh;->a(Ljava/util/Set;)Z
    ...
    invoke-virtual {v2, v0}, Lewh;->a(Ljava/util/Set;)Z
    ...
    iget-object v3, v0, Leuq;->b:Lewe;

    move-object/from16 v0, p0

    iget-object v4, v0, Leuq;->b:Lewe;

    .line 71
    invoke-virtual {v4, v14, v15}, Lewe;->c(J)Lewf;
    ...
    iget-object v3, v3, Lewe;->h:Lewg;

    invoke-interface {v3, v2}, Lewg;->a(Lewh;)V
...
# virtual methods
.method final a(JIJLjava/util/Map;JLjava/util/Map;ZLeur;Landroid/util/TimingLogger;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JIJ",
    ...
    .line 10
    invoke-virtual/range {v2 .. v13}, Leuq;->a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLeur;Landroid/util/TimingLogger;)Z
    ...
    .line 13
    invoke-virtual/range {v3 .. v8}, Leuq;->a(JJLjava/util/Map;)V
...
.method public final a(JILjava/util/Map;Ljava/util/Map;JLjava/util/Set;Leur;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
    ...
    .line 31
    invoke-direct/range {v1 .. v11}, Leuq;->a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    .line 34
    invoke-direct/range {v4 .. v11}, Leuq;->a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Leur;)V
...
.method public final a(JJLjava/util/Map;)V
    ...
    .line 46
    iget-object v0, p0, Leuq;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method protected abstract a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLeur;Landroid/util/TimingLogger;)Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
            "Ljava/lang/String;",
