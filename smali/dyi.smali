...
.method constructor <init>(Ldwo;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Ldyi;-><init>(Ldwo;Landroid/content/Context;Ljava/lang/String;)V

    .line 2
    return-void
.end method

.method private constructor <init>(Ldwo;Landroid/content/Context;Ljava/lang/String;)V
    .locals 3
    ...
    iput-object v0, p0, Ldyi;->e:Landroid/content/Context;

    .line 5
    iput-object p3, p0, Ldyi;->f:Ljava/lang/String;

    .line 6
    iput-object p1, p0, Ldyi;->d:Ldwo;
    ...
    iput-object v0, p0, Ldyi;->h:Ldwr;

    .line 8
    new-instance v0, Ldyl;

    iget-object v1, p0, Ldyi;->e:Landroid/content/Context;

    iget-object v2, p0, Ldyi;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Ldyl;-><init>(Ldyi;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Ldyi;->b:Ldyl;
    ...
    invoke-direct {v1, p0}, Ldyk;-><init>(Ldyi;)V

    .line 11
    iget-object v2, p0, Ldyi;->e:Landroid/content/Context;

    invoke-direct {v0, v1, v2}, Ldyo;-><init>(Ldxy;Landroid/content/Context;)V

    iput-object v0, p0, Ldyi;->c:Ldws;

    .line 12
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ldyi;->g:J
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 189
    :try_start_0
    iget-object v0, p0, Ldyi;->b:Ldyl;

    invoke-virtual {v0}, Ldyl;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Ldxz;->f(Ljava/lang/String;)I
...
.method private static a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v0}, Ldxx;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Ldyi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Ldxw;-><init>(JJ)V
    ...
    .line 93
    iput-object v4, v3, Ldxw;->d:Ljava/lang/String;
    ...
    invoke-static {v2}, Ldxz;->f(Ljava/lang/String;)I
    ...
    .line 116
    iput-object v5, v2, Ldxw;->a:Ljava/lang/String;
    :try_end_5
    ...
    .line 128
    iget-object v8, v3, Ldxw;->a:Ljava/lang/String;
...
.method private final a(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0}, Ldyi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 153
    iget-object v0, p0, Ldyi;->d:Ldwo;

    invoke-direct {p0}, Ldyi;->c()I
    ...
    :cond_4
    invoke-interface {v0, v2}, Ldwo;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Ldyi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public final a()V
    ...
    :goto_1
    invoke-interface {v2, v0}, Ldwo;->a(Z)V
...
.method public final a(Ljava/util/Map;JLjava/lang/String;Ljava/util/Collection;)V
    ...
    .line 29
    iget-object v3, p0, Ldyi;->h:Ldwr;

    invoke-interface {v3}, Ldwr;->a()J
    ...
    .line 52
    invoke-direct {p0, v0}, Ldyi;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Ldxz;->g(Ljava/lang/String;)I

    .line 54
    invoke-direct {p0, v0}, Ldyi;->a(Ljava/util/Collection;)V
    ...
    invoke-static {p1}, Ldyi;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Ldwo;->a(Z)V
    :try_end_1
...
.method public final b()V
    ...
    invoke-static {v0}, Ldxz;->e(Ljava/lang/String;)I

    .line 176
    iget-object v0, p0, Ldyi;->c:Ldws;

    invoke-interface {v0}, Ldws;->a()Z
    ...
    .line 183
    :cond_2
    iget-object v1, p0, Ldyi;->c:Ldws;

    invoke-interface {v1, v0}, Ldws;->a(Ljava/util/List;)I
    ...
    invoke-static {v2}, Ldxz;->e(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2}, Ldyi;->a(Ljava/util/Collection;)V
