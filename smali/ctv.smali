...
.method public constructor <init>(Ljava/lang/Class;Landroid/os/Parcelable$Creator;)V
    ...
    invoke-direct {v0, p2}, Lctu;-><init>(Landroid/os/Parcelable$Creator;)V

    iput-object v0, p0, Lctv;->b:Lctu;
...
.method private final a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
    ...
    sget-object v0, Lctw;->a:Ljava/util/Comparator;
    ...
    .line 20
    new-instance v8, Lctw;

    aget v9, v4, v0

    invoke-direct {v8, v9}, Lctw;-><init>(I)V
    ...
    .line 29
    new-instance v9, Lctw;

    invoke-direct {v9, v0}, Lctw;-><init>(I)V

    new-instance v0, Lctw;

    invoke-direct {v0, v8}, Lctw;-><init>(I)V
    ...
    .line 46
    iget-object v8, p0, Lctv;->b:Lctu;

    invoke-virtual {v8, v7}, Lctu;->a(Landroid/os/Parcelable;)Landroid/os/Parcelable;
...
.method public final a(Landroid/text/Spanned;)Landroid/text/Spanned;
    ...
    iget-object v3, p0, Lctv;->a:Ljava/lang/Class;
    ...
    .line 7
    invoke-direct {p0, v1, v0}, Lctv;->a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
