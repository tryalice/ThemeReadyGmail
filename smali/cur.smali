...
.method public constructor <init>(Ljava/lang/Class;Landroid/os/Parcelable$Creator;)V
    ...
    .line 2
    iput-object p1, p0, Lcur;->a:Ljava/lang/Class;

    .line 3
    new-instance v0, Lcuq;

    invoke-direct {v0, p2}, Lcuq;-><init>(Landroid/os/Parcelable$Creator;)V

    iput-object v0, p0, Lcur;->b:Lcuq;
...
.method private final a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
    ...
    sget-object v0, Lcus;->a:Ljava/util/Comparator;
    ...
    .line 20
    new-instance v8, Lcus;

    aget v9, v4, v0

    invoke-direct {v8, v9}, Lcus;-><init>(I)V
    ...
    invoke-direct {v9, v0}, Lcus;-><init>(I)V

    new-instance v0, Lcus;

    invoke-direct {v0, v8}, Lcus;-><init>(I)V
    ...
    .line 46
    iget-object v8, p0, Lcur;->b:Lcuq;

    invoke-virtual {v8, v7}, Lcuq;->a(Landroid/os/Parcelable;)Landroid/os/Parcelable;
...
.method public final a(Landroid/text/Spanned;)Landroid/text/Spanned;
    ...
    iget-object v3, p0, Lcur;->a:Ljava/lang/Class;
    ...
    .line 7
    invoke-direct {p0, v1, v0}, Lcur;->a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
