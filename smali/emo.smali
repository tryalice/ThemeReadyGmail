...
.method public static b(Landroid/content/Context;Landroid/os/Bundle;)Lemp;
    .locals 8
    ...
    iput-wide v4, v3, Lemp;->c:J

    .line 7
    iput-object v0, v3, Lemp;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Leta;->a(Landroid/content/ContentResolver;)Z

    move-result v5

    .line 10
    invoke-static {p0, v0, v4, v5}, Lemo;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Lipn;
    ...
    .line 14
    iput-object v1, v4, Lipv;->messageId:Ljava/lang/String;
    ...
    .line 21
    iput-object v1, v4, Lipv;->partId:Ljava/lang/String;

    .line 23
    new-instance v1, Lipo;

    invoke-direct {v1, v0}, Lipo;-><init>(Lipn;)V

    .line 25
    new-instance v0, Lipp;

    invoke-direct {v0, v1, v4}, Lipp;-><init>(Lipo;Lipv;)V

    .line 28
    invoke-virtual {v0}, Lipp;->c()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lipv;

    iput-object v0, v3, Lemp;->b:Lipv;
    :try_end_0
    ...
    invoke-static {v1, v0, v2, v4}, Lcug;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public final synthetic a(Landroid/content/Context;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-static {p1, p2}, Lemo;->b(Landroid/content/Context;Landroid/os/Bundle;)Lemp;
