...
.method public constructor <init>()V
    ...
    .line 3
    invoke-direct {v0, p0}, Lemq;-><init>(Lemo;)V

    .line 4
    iput-object v0, p0, Lemo;->h:Lemq;
    ...
    iput-object v0, p0, Lemo;->i:Landroid/os/Handler;
...
.method public final a()Landroid/webkit/WebView;
    ...
    .prologue
    .line 54
    iget-boolean v0, p0, Lemo;->c:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lemo;->b:Landroid/webkit/WebView;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 15
    invoke-virtual {p0}, Lemo;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lemo;->d:Ljava/lang/String;
    ...
    iput-object v1, p0, Lemo;->e:Ljava/lang/String;
    ...
    .line 19
    invoke-virtual {p0}, Lemo;->a()Landroid/webkit/WebView;
    ...
    .line 28
    invoke-virtual {p0}, Lemo;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-static {v0, v1}, Ldtq;->a(Landroid/webkit/WebView;Landroid/content/Context;)V

    .line 29
    new-instance v1, Lemp;

    .line 30
    invoke-direct {v1, p0}, Lemp;-><init>(Lemo;)V
    ...
    .line 33
    iget-object v0, p0, Lemo;->g:Lddl;

    .line 34
    invoke-virtual {v0, v4, v5}, Lddl;->a(ZLcom/android/mail/providers/Folder;)V

    .line 35
    invoke-virtual {p0}, Lemo;->getLoaderManager()Landroid/app/LoaderManager;

    move-result-object v0

    iget-object v1, p0, Lemo;->h:Lemq;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lemo;->b:Landroid/webkit/WebView;

    .line 10
    const/4 v0, 0x1

    iput-boolean v0, p0, Lemo;->c:Z

    .line 11
    new-instance v0, Lddl;

    iget-object v2, p0, Lemo;->i:Landroid/os/Handler;

    invoke-direct {v0, p0, v2}, Lddl;-><init>(Landroid/app/Fragment;Landroid/os/Handler;)V

    iput-object v0, p0, Lemo;->g:Lddl;
