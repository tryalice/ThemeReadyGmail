...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;Ldua;)V
    .locals 8
    ...
    iput-object v0, p0, Ldub;->d:Lcom/android/mail/providers/Account;
    ...
    iput-object v0, p0, Ldub;->i:Ljava/lang/String;
    ...
    .line 16
    iput-object v0, p0, Ldub;->g:Landroid/net/Uri;

    .line 17
    iput-object v1, p0, Ldub;->h:Landroid/net/Uri;
    ...
    iput-object v0, p0, Ldub;->j:Ldtx;

    .line 27
    iput-object p3, p0, Ldub;->s:Ldua;
    ...
    iput-object v1, p0, Ldub;->g:Landroid/net/Uri;

    .line 22
    iget-object v0, v0, Lcom/android/mail/providers/Folder;->k:Landroid/net/Uri;

    iput-object v0, p0, Ldub;->h:Landroid/net/Uri;
    ...
    .line 25
    iget-object v0, p0, Ldub;->a:Landroid/content/Context;

    iget v1, p0, Ldub;->c:I

    iget-object v2, p0, Ldub;->d:Lcom/android/mail/providers/Account;

    iget v3, p0, Ldub;->e:I

    iget v4, p0, Ldub;->f:I

    iget-object v5, p0, Ldub;->g:Landroid/net/Uri;

    iget-object v6, p0, Ldub;->h:Landroid/net/Uri;

    iget-object v7, p0, Ldub;->i:Ljava/lang/String;

    invoke-static/range {v0 .. v7}, Ldtv;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;IILandroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;)V
...
.method private final a()I
    ...
    .prologue
    .line 85
    sget-object v1, Ldua;->a:Ljava/lang/Object;
    ...
    .line 87
    :try_start_0
    iget-object v0, p0, Ldub;->l:Landroid/database/Cursor;
...
.method private final a(Ljava/util/List;)Landroid/text/SpannableStringBuilder;
    ...
    .line 181
    sget-object v0, Ldua;->b:Ljava/lang/String;
    ...
    .line 185
    iget-object v7, p0, Ldub;->b:Lcmi;

    iget-object v7, v7, Lcmi;->D:Ljava/lang/CharSequence;
    ...
    .line 187
    iget-object v4, p0, Ldub;->u:Ljava/lang/String;

    invoke-static {v0}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v7

    iget-object v8, p0, Ldub;->u:Ljava/lang/String;
    ...
    invoke-static {v1, v4}, Ldub;->a([Landroid/text/style/CharacterStyle;Ljava/lang/CharSequence;)Landroid/text/SpannableString;
    ...
    .line 192
    :cond_2
    iget-object v4, p0, Ldub;->t:Ljava/lang/String;
...
.method private final b()Landroid/widget/RemoteViews;
    ...
    iget-object v1, p0, Ldub;->a:Landroid/content/Context;
    ...
    iget-object v2, p0, Ldub;->g:Landroid/net/Uri;

    iget-object v3, p0, Ldub;->d:Lcom/android/mail/providers/Account;

    invoke-static {v1, v2, v3}, Ldti;->a(Landroid/content/Context;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Landroid/content/Intent;
    ...
    iget-object v3, p0, Ldub;->a:Landroid/content/Context;
...
.method public final getCount()I
    ...
    .line 77
    sget-object v3, Ldua;->a:Ljava/lang/Object;
    ...
    .line 79
    :try_start_0
    invoke-direct {p0}, Ldub;->a()I

    move-result v4

    .line 80
    iget-object v2, p0, Ldub;->l:Landroid/database/Cursor;
    ...
    :goto_1
    iput-boolean v2, p0, Ldub;->q:Z

    .line 83
    iget-boolean v2, p0, Ldub;->q:Z
...
.method public final getViewAt(I)Landroid/widget/RemoteViews;
    ...
    .prologue
    .line 91
    sget-object v11, Ldua;->a:Ljava/lang/Object;
    ...
    iget-object v2, v0, Ldub;->l:Landroid/database/Cursor;
    ...
    iget-boolean v2, v0, Ldub;->q:Z

    if-eqz v2, :cond_1

    .line 94
    invoke-direct/range {p0 .. p0}, Ldub;->a()I
    ...
    .line 95
    :cond_0
    invoke-direct/range {p0 .. p0}, Ldub;->b()Landroid/widget/RemoteViews;
    ...
    .line 97
    sget-object v2, Ldua;->b:Ljava/lang/String;
    ...
    iget-object v9, v0, Ldub;->d:Lcom/android/mail/providers/Account;

    move-object/from16 v0, p0

    iget v10, v0, Ldub;->f:I
    ...
    .line 104
    invoke-static/range {v2 .. v10}, Lcmo;->a(Lcmi;Lcom/android/mail/providers/ConversationInfo;Ljava/lang/String;ILjava/util/ArrayList;Ljava/util/ArrayList;Lcjp;Lcom/android/mail/providers/Account;Z)V

    .line 105
    move-object/from16 v0, p0

    invoke-direct {v0, v6}, Ldub;->a(Ljava/util/List;)Landroid/text/SpannableStringBuilder;
    ...
    iget-object v2, v0, Ldub;->a:Landroid/content/Context;
    ...
    iget-object v7, v0, Ldub;->j:Ldtx;

    move-object/from16 v0, p0

    iget-object v8, v0, Ldub;->a:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v9, v0, Ldub;->d:Lcom/android/mail/providers/Account;

    new-instance v10, Ldqw;

    move-object/from16 v0, p0

    iget-object v2, v0, Ldub;->g:Landroid/net/Uri;

    invoke-direct {v10, v2}, Ldqw;-><init>(Landroid/net/Uri;)V
    ...
    .line 119
    :goto_3
    invoke-static {v6, v15, v2}, Ldtx;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v6, v0, v2}, Ldtx;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v2, v0, v3}, Ldtx;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    invoke-direct {v3, v8}, Ldty;-><init>(Landroid/content/Context;)V

    iput-object v3, v7, Ldtx;->f:Ldty;

    .line 152
    iget-object v3, v7, Ldtx;->f:Ldty;

    invoke-virtual {v3, v12, v9, v10, v4}, Ldfy;->a(Lcom/android/mail/providers/Conversation;Lcom/android/mail/providers/Account;Ldqw;I)V

    .line 153
    iget-object v3, v7, Ldtx;->f:Ldty;

    invoke-virtual {v3, v2}, Ldty;->a(Landroid/widget/RemoteViews;)V
    ...
    iget-object v3, v0, Ldub;->a:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v4, v0, Ldub;->g:Landroid/net/Uri;

    move-object/from16 v0, p0

    iget-object v5, v0, Ldub;->d:Lcom/android/mail/providers/Account;

    invoke-static {v3, v12, v4, v5}, Ldti;->a(Landroid/content/Context;Lcom/android/mail/providers/Conversation;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Landroid/content/Intent;
...
.method public final onCreate()V
    ...
    iget-object v3, p0, Ldub;->g:Landroid/net/Uri;

    invoke-virtual {v3}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v1, v2, v3}, Ldua;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;Ljava/lang/String;)V

    .line 30
    iget-object v0, p0, Ldub;->s:Ldua;
    ...
    invoke-virtual {v0, v1, v2, v3}, Ldua;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;)Z
    ...
    .line 32
    :cond_0
    iput-boolean v9, p0, Ldub;->r:Z

    .line 33
    iget-object v0, p0, Ldub;->h:Landroid/net/Uri;
    ...
    iput-object v0, p0, Ldub;->k:Landroid/content/CursorLoader;

    .line 44
    iget-object v0, p0, Ldub;->k:Landroid/content/CursorLoader;
    ...
    iput-object v0, p0, Ldub;->t:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldub;->u:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldub;->m:Landroid/content/CursorLoader;

    .line 50
    iget-object v0, p0, Ldub;->m:Landroid/content/CursorLoader;
    ...
    invoke-direct {v0, p0, v1}, Lduc;-><init>(Ldub;I)V

    iput-object v0, p0, Ldub;->o:Lduc;

    .line 53
    iget-object v0, p0, Ldub;->o:Lduc;
    ...
    sget-object v3, Lcyi;->f:[Ljava/lang/String;
    ...
    iput-object v0, p0, Ldub;->n:Landroid/content/CursorLoader;

    .line 55
    iget-object v0, p0, Ldub;->n:Landroid/content/CursorLoader;
...
.method public final onDestroy()V
    ...
    iput-object v0, p0, Ldub;->l:Landroid/database/Cursor;
    ...
    .line 69
    iput-object v2, p0, Ldub;->m:Landroid/content/CursorLoader;
    ...
    .line 73
    iput-object v2, p0, Ldub;->n:Landroid/content/CursorLoader;
...
.method public final synthetic onLoadComplete(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    .line 226
    invoke-static {p2}, Ldub;->a(Landroid/database/Cursor;)Z
    ...
    iget-object v0, p0, Ldub;->d:Lcom/android/mail/providers/Account;
    ...
    iget-object v4, p0, Ldub;->d:Lcom/android/mail/providers/Account;

    iget v5, p0, Ldub;->e:I

    iget v6, p0, Ldub;->f:I

    iget-object v7, p0, Ldub;->g:Landroid/net/Uri;

    iget-object v8, p0, Ldub;->h:Landroid/net/Uri;

    move-object v2, v11

    invoke-virtual/range {v0 .. v9}, Ldua;->a(Landroid/content/Context;Landroid/widget/RemoteViews;ILcom/android/mail/providers/Account;IILandroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Ldub;->i:Ljava/lang/String;
    ...
    :cond_7
    :try_start_1
    iput-object p2, p0, Ldub;->l:Landroid/database/Cursor;
