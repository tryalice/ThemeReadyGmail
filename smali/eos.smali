...
.method constructor <init>(Landroid/content/Context;Leoe;Lepx;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1, p2, p3}, Lepw;-><init>(Landroid/content/Context;Leoe;Lepx;)V

    .line 2
    return-void
.end method

.method private final b(Landroid/os/Bundle;)Leot;
    .locals 10
    ...
    iget-object v2, p0, Leos;->c:Landroid/content/Context;

    iget-object v3, p0, Leos;->d:Leoe;
    ...
    .line 9
    invoke-direct/range {v1 .. v9}, Leot;-><init>(Landroid/content/Context;Leoe;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
# virtual methods
.method public final synthetic a(Landroid/os/Bundle;)Leop;
    .locals 1

    .prologue
    .line 70
    invoke-direct {p0, p1}, Leos;->b(Landroid/os/Bundle;)Leot;
...
.method protected final synthetic a(Lkrs;)V
    ...
    .line 68
    iget-object v0, p0, Lepw;->e:Leoq;

    check-cast v0, Lepx;

    invoke-interface {v0}, Lepx;->f()V
    ...
    invoke-interface {v0, v1}, Lepx;->c(Ljava/lang/String;)V
    ...
    .line 20
    iget-object v4, v1, Lkju;->d:Ljava/lang/String;
    ...
    .line 24
    iget-wide v2, v1, Lkju;->c:J

    .line 26
    iget-object v1, v1, Lkju;->d:Ljava/lang/String;

    .line 27
    invoke-interface {v0, v2, v3, v1}, Lepx;->a(JLjava/lang/String;)V
    ...
    .line 35
    invoke-interface {v0, v1}, Lepx;->a(Ljava/lang/String;)V
    ...
    .line 41
    iget-object v1, v1, Lkju;->e:Ljava/lang/String;
...
.method public final synthetic onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    .prologue
    .line 71
    invoke-direct {p0, p2}, Leos;->b(Landroid/os/Bundle;)Leot;
...
.method public final bridge synthetic onLoaderReset(Landroid/content/Loader;)V
    ...
    .prologue
    .line 11
    invoke-super {p0, p1}, Lepw;->onLoaderReset(Landroid/content/Loader;)V
