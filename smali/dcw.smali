...
.field public final synthetic h:Lcvp;

.field public final synthetic i:Ldcv;


# direct methods
.method constructor <init>(Ldcv;Ljava/lang/String;Landroid/app/Fragment;Lcvq;Ldgg;Landroid/view/View;Lcvp;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Ldcw;->i:Ldcv;

    iput-object p4, p0, Ldcw;->a:Lcvq;

    iput-object p5, p0, Ldcw;->b:Ldgg;

    iput-object p6, p0, Ldcw;->c:Landroid/view/View;

    iput-object p7, p0, Ldcw;->h:Lcvp;
...
.method public final a()V
    ...
    .line 2
    iget-object v0, p0, Ldcw;->a:Lcvq;

    .line 3
    iget-object v0, v0, Lcvq;->i:Lcom/android/mail/providers/Conversation;

    .line 4
    iget-wide v4, v0, Lcom/android/mail/providers/Conversation;->b:J

    .line 5
    iget-object v0, p0, Ldcw;->b:Ldgg;

    invoke-interface {v0, v4, v5}, Ldgg;->b(J)Z
    ...
    invoke-direct {v6, p0, v4, v5, v0}, Ldcx;-><init>(Ldcw;JZ)V

    .line 8
    iget-object v4, p0, Ldcw;->c:Landroid/view/View;
    ...
    .line 16
    iget-object v5, p0, Ldcw;->c:Landroid/view/View;
    ...
    .line 19
    iget-object v7, p0, Ldcw;->c:Landroid/view/View;
    ...
    .line 26
    new-instance v4, Ldcy;

    const-string v5, "CV-TL Animation"

    invoke-direct {v4, p0, v5}, Ldcy;-><init>(Ldcw;Ljava/lang/String;)V

    invoke-virtual {v3, v4}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 27
    sget-object v4, Lctv;->b:Ljava/lang/String;
    ...
    .line 29
    invoke-static {v4, v5, v7}, Lcnx;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    iget-object v1, p0, Ldcw;->h:Lcvp;

    invoke-virtual {v0, v1, v3, v6}, Lcvq;->a(Lcvp;Landroid/animation/AnimatorSet;Ljava/lang/Runnable;)V
    ...
    .line 33
    iget-object v2, v0, Lcde;->b:Lcom/android/mail/browse/ConversationPager;
    ...
    iget-object v4, v0, Lcde;->b:Lcom/android/mail/browse/ConversationPager;
    ...
    invoke-direct {v4, v0, v6}, Lcdf;-><init>(Lcde;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, v3}, Lcvq;->a(Landroid/animation/AnimatorSet;)V
