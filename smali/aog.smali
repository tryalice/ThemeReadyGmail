...
.method public final run()V
    ...
    .line 2
    iget-object v0, p0, Laog;->a:Laof;

    iget-object v0, v0, Laof;->c:Lamb;

    if-eqz v0, :cond_6

    iget-object v9, p0, Laog;->a:Laof;

    .line 3
    iget-object v0, v9, Laof;->c:Lamb;
    ...
    .line 6
    :goto_0
    iget-object v0, v9, Laof;->r:Landroid/support/v7/widget/RecyclerView;

    .line 7
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->v:Lalg;

    .line 9
    iget-object v1, v9, Laof;->B:Landroid/graphics/Rect;
    ...
    iput-object v1, v9, Laof;->B:Landroid/graphics/Rect;

    .line 13
    :cond_0
    iget-object v1, v9, Laof;->c:Lamb;

    iget-object v1, v1, Lamb;->a:Landroid/view/View;

    iget-object v2, v9, Laof;->B:Landroid/graphics/Rect;

    invoke-virtual {v0, v1, v2}, Lalg;->b(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget-object v3, v9, Laof;->r:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, v9, Laof;->r:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 36
    iget-object v0, v9, Laof;->m:Laol;

    iget-object v1, v9, Laof;->r:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v9, Laof;->c:Lamb;
    ...
    iget-object v8, v9, Laof;->r:Landroid/support/v7/widget/RecyclerView;

    .line 38
    invoke-virtual {v8}, Landroid/support/v7/widget/RecyclerView;->getWidth()I

    .line 39
    invoke-virtual/range {v0 .. v5}, Laol;->a(Landroid/support/v7/widget/RecyclerView;IIJ)I
    ...
    iget-object v1, v1, Laof;->c:Lamb;

    invoke-virtual {v0, v1}, Laof;->a(Lamb;)V
