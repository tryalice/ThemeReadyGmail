...
# direct methods
.method constructor <init>(Ldkd;Lalg;Ljava/util/Set;Ljava/util/Map;Ljava/util/List;Ldlp;II)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Ldkg;->h:Ldkd;

    iput-object p2, p0, Ldkg;->a:Lalg;

    iput-object p3, p0, Ldkg;->b:Ljava/util/Set;

    iput-object p4, p0, Ldkg;->c:Ljava/util/Map;

    iput-object p5, p0, Ldkg;->d:Ljava/util/List;

    iput-object p6, p0, Ldkg;->e:Ldlp;
...
.method public final onPreDraw()Z
    ...
    iget-object v2, v0, Ldkg;->b:Ljava/util/Set;
    ...
    invoke-static {v4, v2}, Ltk;->a(Landroid/view/View;Z)V
    ...
    iget-object v9, v0, Ldkg;->c:Ljava/util/Map;
    ...
    iget-object v3, v0, Ldkg;->d:Ljava/util/List;
    ...
    iget-object v3, v0, Ldkg;->b:Ljava/util/Set;
    ...
    invoke-interface {v2, v5, v7, v10}, Ldlp;->b(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v0, v3, v2}, Ldkk;-><init>(Ldkd;Landroid/view/View;)V
    ...
    iget-object v11, v0, Ldkg;->c:Ljava/util/Map;
    ...
    invoke-direct {v15, v2, v9, v0}, Ldkm;-><init>(Landroid/view/View;II)V
    ...
    iget-object v2, v0, Ldkg;->d:Ljava/util/List;
    ...
    iget-object v3, v0, Ldkg;->c:Ljava/util/Map;
    ...
    invoke-direct {v9, v6, v3}, Ldkk;-><init>(Ldkd;Landroid/view/View;)V
    ...
    iget-object v5, v0, Ldkg;->h:Ldkd;

    .line 82
    iget-object v5, v5, Ldkd;->c:Ljava/util/List;
    ...
    invoke-direct {v7, v5, v2}, Ldkk;-><init>(Ldkd;Landroid/view/View;)V
    ...
    iget-object v4, v0, Ldkg;->c:Ljava/util/Map;

    .line 100
    invoke-static {v2, v8, v10, v4}, Ldkd;->a(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)I
    ...
    invoke-direct {v2, v0}, Ldkh;-><init>(Ldkg;)V
    ...
    .line 110
    iput-object v13, v2, Ldkd;->e:Landroid/animation/AnimatorSet;
