...
.method protected final a(I)V
    ...
    .line 54
    iget-object v1, p0, Lcxm;->e:Ldeg;

    invoke-virtual {v1}, Ldeg;->getCount()I
    ...
    invoke-virtual {v1, v5}, Ldeg;->getItem(I)Ljava/lang/Object;

    move-result-object v2

    .line 56
    instance-of v1, v2, Ldnc;
    ...
    .line 58
    iput-boolean v4, v1, Ldnc;->b:Z

    .line 59
    check-cast v2, Ldnc;

    .line 60
    iget-object v2, v2, Ldnc;->a:Lcom/android/mail/providers/Folder;

    .line 62
    iget-object v7, p0, Lcxm;->b:Ljava/util/Map;
    ...
    .line 63
    :cond_2
    iget-object v1, v2, Lcom/android/mail/providers/Folder;->r:Ldne;
    ...
    .line 68
    :cond_3
    iput-boolean v3, v0, Ldnc;->b:Z

    .line 69
    iget-object v1, p0, Lcxm;->e:Ldeg;

    invoke-virtual {v1}, Ldeg;->notifyDataSetChanged()V

    .line 71
    iget-object v1, v0, Ldnc;->a:Lcom/android/mail/providers/Folder;

    .line 73
    iget-object v2, p0, Lcxm;->b:Ljava/util/Map;
...
.method protected final a(Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 18
    iget-object v0, p0, Lcxm;->f:Ljava/util/Collection;
    ...
    iget-object v0, p0, Lcxm;->i:Lcom/android/mail/providers/Folder;
    ...
    .line 24
    :cond_2
    invoke-static {v3}, Ljya;->a(Ljava/util/Collection;)Ljya;
    ...
    .line 32
    invoke-static {p2, v0, v6, v1, v2}, Lcwq;->a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;ZZ)Landroid/database/Cursor;
    ...
    .line 34
    iget-object v7, p0, Lcxm;->e:Ldeg;

    new-instance v0, Lcwq;

    sget v4, Lcal;->ag:I

    iget-object v5, p0, Lcxm;->h:Lcom/android/mail/providers/Account;

    move-object v1, p1

    invoke-direct/range {v0 .. v5}, Lcwq;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V

    invoke-virtual {v7, v0}, Ldeg;->a(Ldbi;)V
    ...
    invoke-virtual {v6, v0}, Ldeg;->a(Ldbi;)V
...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 78
    :pswitch_0
    invoke-virtual {p0}, Lcxm;->a()Lcyi;

    move-result-object v0

    iget-object v1, p0, Lcxm;->b:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcxm;->f:Ljava/util/Collection;

    iget-boolean v3, p0, Lcxm;->g:Z
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .line 4
    invoke-super {p0, p1}, Ldbf;->onCreate(Landroid/os/Bundle;)V

    .line 5
    iget-object v0, p0, Lcxm;->h:Lcom/android/mail/providers/Account;

    .line 6
    invoke-virtual {v0}, Lcom/android/mail/providers/Account;->c()Landroid/accounts/Account;

    invoke-virtual {p0}, Lcxm;->getActivity()Landroid/app/Activity;
    ...
    .line 11
    invoke-static {p1, v0, v2}, Ldox;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)[Landroid/os/Parcelable;
    ...
    .line 13
    iget-object v6, p0, Lcxm;->b:Ljava/util/Map;
    ...
    invoke-virtual {v2}, Ldne;->toString()Ljava/lang/String;
    ...
    .line 15
    :cond_2
    invoke-virtual {p0}, Lcxm;->getLoaderManager()Landroid/app/LoaderManager;
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 41
    invoke-super {p0, p1}, Ldbf;->onSaveInstanceState(Landroid/os/Bundle;)V
