...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V
    ...
    .prologue
    .line 1
    invoke-direct/range {p0 .. p5}, Ldbi;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V
...
.method public static a(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 3
    invoke-static {p0, v1, v1, v0, v0}, Lcwq;->a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;ZZ)Landroid/database/Cursor;
...
.method public static a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;ZZ)Landroid/database/Cursor;
    ...
    invoke-direct {v4, v1}, Ldoc;-><init>([Ljava/lang/String;)V
    ...
    invoke-direct {v0, v7}, Ldne;-><init>(Landroid/net/Uri;)V

    .line 21
    invoke-virtual {v0}, Ldne;->a()Landroid/net/Uri;
