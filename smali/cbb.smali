...
.method static constructor <clinit>()V
    ...
    .line 339
    sput-object v0, Lcbb;->b:Ljava/util/List;
    ...
    .line 340
    sget-object v0, Lcbb;->b:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcbb;->f:Ljava/util/Set;
    ...
    iput-object v0, p0, Lcbb;->g:Ljava/util/Set;

    .line 4
    iput-object p3, p0, Lcbb;->c:Landroid/os/Bundle;
...
.method private final a(JZ)I
    ...
    .line 174
    iget-object v3, p0, Lcbb;->m:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v7, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v7, p0, Lcbb;->c:Landroid/os/Bundle;
    ...
    invoke-interface {v2, v3, v4}, Lcgv;->a(Ljava/lang/String;I)Z
    ...
    sget-object v5, Lcbb;->a:[Ljava/lang/String;
    ...
    iget-object v10, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    invoke-static {v3}, Lboo;->c(Ljava/lang/String;)Z

    move-result v10

    .line 203
    iget-object v3, p0, Lcbb;->e:Ljava/util/Set;
    ...
    .line 207
    iget-object v2, p0, Lcbb;->g:Ljava/util/Set;
    ...
    .line 208
    :cond_6
    iget-object v2, p0, Lcbb;->m:Landroid/content/Context;

    const-string v3, "android.permission.READ_CALENDAR"

    invoke-static {v2, v3}, Lmk;->a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v2, v3}, Lcgu;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 226
    invoke-static {v2}, Lbys;->d(Ljava/lang/String;)Z
    ...
    .line 213
    iget-object v2, p0, Lcbb;->f:Ljava/util/Set;
    ...
    .line 236
    :goto_4
    invoke-direct {p0, v9, v4, v2}, Lcbb;->a(Lcom/android/emailcommon/provider/Mailbox;Landroid/content/ContentValues;I)V
    ...
    invoke-direct {p0, v6, v7, v0}, Lcbb;->b(JZ)I
    :try_end_1
    ...
    invoke-direct {p0, v9, v4, v3}, Lcbb;->a(Lcom/android/emailcommon/provider/Mailbox;Landroid/content/ContentValues;I)V

    .line 240
    const/4 v3, 0x0

    invoke-static {v3}, Lcbb;->b(I)I

    move-result v4

    .line 241
    invoke-static {v2, v4}, Lcxi;->a(II)I
    ...
    invoke-static {v3, v6, v7, v5, v2}, Lbpv;->a(Landroid/content/ContentResolver;JII)V
    ...
    :try_start_2
    invoke-static {v2, v3}, Lcxi;->a(II)I

    move-result v3

    .line 248
    iget-object v5, p0, Lcbb;->m:Landroid/content/Context;
    ...
    invoke-static {v5, v6, v7, v8, v3}, Lbpv;->a(Landroid/content/ContentResolver;JII)V

    .line 249
    iget-object v3, p0, Lcbb;->r:Lcbp;

    iget-object v5, p0, Lcbb;->m:Landroid/content/Context;

    iget-object v6, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;

    iget-object v7, p0, Lcbb;->d:Lcfh;

    invoke-interface {v3, v5, v6, v9, v7}, Lcbp;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;Lcfh;)Lccj;
    ...
    iget-object v11, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v2, v2, Lccv;->a:Landroid/content/SharedPreferences;
    ...
    invoke-static {v2, v3}, Lcay;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V
    ...
    invoke-static {v2, v3}, Lcbz;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V
...
.method private final b(JZ)I
    ...
    .line 304
    invoke-virtual {v3, v9}, Lbov;->a(Landroid/database/Cursor;)V
    ...
    invoke-static {v0, v4, v5}, Lbrz;->d(Landroid/content/Context;J)Z
    ...
    .line 306
    iget-object v0, p0, Lcbb;->r:Lcbp;

    iget-object v1, p0, Lcbb;->m:Landroid/content/Context;
    ...
    invoke-interface/range {v0 .. v5}, Lcbp;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lbov;ZZ)Lcbs;
...
.method private final k()I
    ...
    .line 287
    iget-object v2, p0, Lcbb;->r:Lcbp;

    iget-object v3, p0, Lcbb;->m:Landroid/content/Context;

    iget-object v4, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;

    .line 288
    invoke-interface {v2, v3, v4, v0}, Lcbp;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;I)Lcba;

    move-result-object v2

    .line 289
    invoke-virtual {v2}, Lcci;->o_()I
...
.method public final f()I
    ...
    invoke-virtual {p0}, Lcbb;->b()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    .line 24
    iget-object v1, p0, Lcbb;->c:Landroid/os/Bundle;
    ...
    iput-boolean v1, p0, Lcbb;->h:Z

    .line 26
    iget-boolean v1, p0, Lcbb;->h:Z
    ...
    sget-object v1, Lcbb;->b:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lcbb;->e:Ljava/util/Set;

    .line 29
    :goto_1
    iget-object v0, p0, Lcbb;->c:Landroid/os/Bundle;
    ...
    iget-boolean v3, p0, Lcbb;->h:Z

    invoke-direct/range {v0 .. v5}, Lcfh;-><init>(Landroid/content/Context;Ljava/lang/String;ZZZ)V

    iput-object v0, p0, Lcbb;->d:Lcfh;
    ...
    invoke-static {v0, v1}, Lcdx;->a(Landroid/accounts/Account;Ljava/util/List;)Ljava/util/Set;
    ...
    .line 58
    :cond_c
    iget-object v0, v2, Lcbr;->b:Ljava/lang/String;

    .line 60
    invoke-virtual {p0, v0}, Lcbb;->c(Ljava/lang/String;)V
    ...
    .line 64
    invoke-interface {v0, v1, v2, v9}, Lcbp;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Z)Lcaz;

    move-result-object v0

    .line 65
    invoke-virtual {v0}, Lcaz;->f()I
    ...
    .line 67
    iget-object v1, p0, Lcbb;->p:Lccv;

    .line 68
    iget-object v1, v1, Lccv;->a:Landroid/content/SharedPreferences;
    ...
    .line 75
    :cond_10
    iget-object v0, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;
    ...
    invoke-interface {v0, v1, v2}, Lcbp;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lcbg;

    move-result-object v0

    .line 82
    invoke-virtual {v0}, Lcbg;->k()I
    ...
    invoke-interface {v0, v1, v2}, Lcbp;->c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lcci;

    move-result-object v0

    .line 89
    invoke-virtual {v0}, Lcci;->o_()I
    ...
    .line 103
    invoke-interface {v0, v1, v2}, Lcbp;->b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lccg;
    ...
    .line 106
    :cond_18
    iget-object v0, p0, Lcbb;->f:Ljava/util/Set;

    invoke-interface {v0}, Ljava/util/Set;->clear()V

    .line 107
    iget-object v0, p0, Lcbb;->g:Ljava/util/Set;
    ...
    .line 110
    iget-boolean v4, p0, Lcbb;->h:Z

    invoke-direct {p0, v0, v1, v4}, Lcbb;->a(JZ)I
    ...
    invoke-direct {p0, v0, v1, v3}, Lcbb;->a(JZ)I
    ...
    .line 135
    iget-object v1, p0, Lcbb;->f:Ljava/util/Set;
    ...
    iget-object v1, p0, Lcbb;->g:Ljava/util/Set;
    ...
    .line 136
    invoke-interface {v0}, Lbmt;->d()V

    .line 141
    :cond_20
    :goto_d
    iget-object v0, p0, Lcbb;->d:Lcfh;

    .line 142
    iget-boolean v1, v0, Lcfh;->k:Z

    if-nez v1, :cond_21

    iget-object v1, v0, Lcfh;->i:Ljava/util/List;
    ...
    iget-object v5, p0, Lcbb;->n:Lcom/android/emailcommon/provider/Account;

    .line 162
    iget-object v5, v5, Lcom/android/emailcommon/provider/Account;->i:Ljava/lang/String;

    .line 163
    invoke-static {v5}, Ldow;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, v2, v3, v1}, Lbmt;->a(JLjava/util/Set;)V
    ...
    iget-object v4, v0, Lcfh;->i:Ljava/util/List;
    ...
    iget-object v4, v0, Lcfh;->b:Ljava/lang/String;
    ...
    .line 157
    iget-object v1, v0, Lcfh;->a:Landroid/content/Context;
