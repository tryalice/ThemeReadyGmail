...
.field public final synthetic c:Latv;


# direct methods
.method constructor <init>(Latv;Lcom/android/emailcommon/provider/Account;Landroid/content/Loader;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Latw;->c:Latv;

    iput-object p2, p0, Latw;->a:Lcom/android/emailcommon/provider/Account;

    iput-object p3, p0, Latw;->b:Landroid/content/Loader;
...
.method public final run()V
    ...
    .line 2
    iget-object v0, p0, Latw;->c:Latv;

    iget-object v1, v0, Latv;->a:Lcom/android/email/activity/setup/AccountSecurity;
    ...
    .line 7
    :cond_1
    iget-object v0, p0, Latw;->a:Lcom/android/emailcommon/provider/Account;
    ...
    .line 15
    iget-object v0, p0, Latw;->b:Landroid/content/Loader;

    check-cast v0, Latu;

    .line 16
    iget-object v2, p0, Latw;->a:Lcom/android/emailcommon/provider/Account;

    iget-boolean v3, v0, Latu;->b:Z

    iget-boolean v4, v0, Latu;->c:Z

    iget-boolean v0, v0, Latu;->d:Z
    ...
    .line 28
    invoke-virtual {v3, v4}, Latx;->setArguments(Landroid/os/Bundle;)V

    .line 30
    const-string v0, "password_expiration"

    invoke-virtual {v3, v2, v0}, Latx;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    ...
    .line 42
    invoke-virtual {v2, v3}, Laty;->setArguments(Landroid/os/Bundle;)V

    .line 44
    const-string v1, "security_needed"

    invoke-virtual {v2, v0, v1}, Laty;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
