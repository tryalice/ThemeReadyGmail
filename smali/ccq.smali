...
.method public constructor <init>(Lcom/android/exchange/service/EmailSyncAdapterService;Landroid/content/Context;)V
    ...
    .prologue
    .line 84
    iput-object p1, p0, Lccq;->a:Lcom/android/exchange/service/EmailSyncAdapterService;
...
.method public final a(Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    .line 101
    :goto_1
    invoke-virtual {p0}, Lccq;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Lccv;->a(Landroid/content/Context;)V

    .line 102
    iget-object v0, p0, Lccq;->a:Lcom/android/exchange/service/EmailSyncAdapterService;
    ...
    .line 129
    iget-object v1, p0, Lccq;->a:Lcom/android/exchange/service/EmailSyncAdapterService;

    iget-object v1, v1, Lcom/android/exchange/service/EmailSyncAdapterService;->a:Lboe;

    iget-wide v4, v0, Lcom/android/emailcommon/provider/Account;->J:J

    invoke-interface {v1, v4, v5, v2, v3}, Lboe;->a(JJ)V
    :try_end_0
    ...
    invoke-interface {v1, v2, v3, p2}, Lboe;->a(JLandroid/os/Bundle;)I

    move-result v1

    .line 139
    iget-object v2, p0, Lccq;->a:Lcom/android/exchange/service/EmailSyncAdapterService;
    ...
    .line 140
    invoke-static {v1, p4}, Lcbl;->a(ILandroid/content/SyncResult;)Z
    :try_end_1
