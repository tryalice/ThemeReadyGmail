...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lwk;->e:Landroid/support/v4/widget/DrawerLayout;
    ...
    iput-object v0, p0, Lwk;->a:Landroid/graphics/Rect;
...
.method public final a(Landroid/view/View;Lvd;)V
    ...
    .line 69
    invoke-virtual {p2, v1}, Lvd;->b(Z)V

    .line 70
    invoke-virtual {p2, v1}, Lvd;->c(Z)V

    .line 71
    sget-object v0, Lve;->a:Lve;

    invoke-virtual {p2, v0}, Lvd;->b(Lve;)Z
    ...
    .line 6
    :cond_1
    invoke-static {p2}, Lvd;->a(Lvd;)Lvd;

    move-result-object v2

    .line 7
    invoke-super {p0, p1, v2}, Lsg;->a(Landroid/view/View;Lvd;)V
    ...
    invoke-virtual {v0, p1}, Ltv;->e(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    .line 16
    :cond_2
    iget-object v0, p0, Lwk;->a:Landroid/graphics/Rect;

    .line 17
    invoke-virtual {v2, v0}, Lvd;->a(Landroid/graphics/Rect;)V

    .line 18
    invoke-virtual {p2, v0}, Lvd;->b(Landroid/graphics/Rect;)V

    .line 19
    invoke-virtual {v2, v0}, Lvd;->c(Landroid/graphics/Rect;)V

    .line 20
    invoke-virtual {p2, v0}, Lvd;->d(Landroid/graphics/Rect;)V

    .line 22
    iget-object v0, v2, Lvd;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 23
    invoke-virtual {p2, v0}, Lvd;->d(Z)V
    ...
    .line 26
    invoke-virtual {p2, v0}, Lvd;->a(Ljava/lang/CharSequence;)V
    ...
    .line 35
    invoke-virtual {p2, v0}, Lvd;->h(Z)V
    ...
    .line 38
    invoke-virtual {p2, v0}, Lvd;->g(Z)V
    ...
    .line 41
    invoke-virtual {p2, v0}, Lvd;->b(Z)V
    ...
    .line 44
    invoke-virtual {p2, v0}, Lvd;->c(Z)V
    ...
    .line 47
    invoke-virtual {p2, v0}, Lvd;->e(Z)V
    ...
    .line 54
    iget-object v3, p2, Lvd;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 66
    iget-object v4, p2, Lvd;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 98
    :cond_0
    invoke-super {p0, p1, p2, p3}, Lsg;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
...
.method public final d(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 79
    iget-object v0, p0, Lwk;->e:Landroid/support/v4/widget/DrawerLayout;
    ...
    .line 81
    iget-object v2, p0, Lwk;->e:Landroid/support/v4/widget/DrawerLayout;
    ...
    .line 96
    :cond_3
    invoke-super {p0, p1, p2}, Lsg;->d(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
