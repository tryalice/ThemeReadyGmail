...
# direct methods
.method constructor <init>(Ldwq;Ldwn;Z)V
    .locals 2
    ...
    .line 2
    iput-object p2, p0, Ldwr;->a:Ldwn;

    .line 3
    iput-boolean p3, p0, Ldwr;->d:Z

    .line 4
    invoke-virtual {p1}, Ldwq;->a()B

    move-result v0

    iput-byte v0, p0, Ldwr;->b:B

    .line 5
    invoke-virtual {p1}, Ldwq;->b()B

    move-result v0

    iput-byte v0, p0, Ldwr;->c:B
...
.method protected final decodeLoop(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 10
    iget-byte v0, p0, Ldwr;->c:B

    if-ne v2, v0, :cond_4

    .line 11
    invoke-direct {p0}, Ldwr;->a()Z
    ...
    .line 12
    invoke-static {p1}, Ldwr;->b(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 15
    invoke-static {p1}, Ldwr;->a(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 18
    :goto_2
    invoke-direct {p0}, Ldwr;->b()V

    .line 46
    :cond_2
    iput-boolean v5, p0, Ldwr;->h:Z

    goto :goto_0

    .line 17
    :cond_3
    iput-boolean v4, p0, Ldwr;->i:Z
    ...
    .line 48
    iput-boolean v4, p0, Ldwr;->e:Z

    .line 49
    iget-boolean v0, p0, Ldwr;->i:Z
