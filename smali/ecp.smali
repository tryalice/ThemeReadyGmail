...
.method public final a(Ljava/io/BufferedInputStream;Landroid/content/ContentValues;)V
    ...
    invoke-static {v2, v3}, Llxp;->a(Ljava/lang/String;Z)V
    ...
    .line 10
    invoke-direct {v2, v3}, Ldzv;-><init>(Llsb;)V

    .line 11
    :try_start_0
    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Ldzv;->a(Ljava/io/InputStream;)Llnm;
    ...
    invoke-virtual {v0, v2}, Llrw;->a(Ljava/lang/String;)Llpo;
    ...
    .line 29
    invoke-virtual {v2}, Llwe;->a()Ljava/lang/String;
    ...
    .line 35
    iget-object v0, v2, Llnt;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Llnt;->b(Ljava/lang/String;)Llpo;

    move-result-object v2

    invoke-virtual {v2}, Llpo;->a()Ljava/lang/String;
    ...
    sget-object v18, Lecq;->a:Ljava/util/Map;
    ...
    .line 40
    sget-object v15, Lecq;->a:Ljava/util/Map;
    ...
    invoke-virtual {v2, v3}, Llnt;->b(Ljava/lang/String;)Llpo;
    ...
    invoke-virtual {v3}, Llsv;->a()Llvs;

    move-result-object v3

    .line 52
    iget-object v3, v3, Llvo;->d:Llnx;

    .line 53
    invoke-virtual {v3}, Llnx;->getTime()J
    ...
    invoke-virtual {v3, v4}, Llsv;->b(Ljava/lang/String;)Llpo;
    ...
    .line 67
    iget-object v3, v3, Llvu;->d:Llod;

    .line 69
    iget-object v6, v5, Llvo;->d:Llnx;

    .line 70
    invoke-virtual {v3, v6}, Llod;->a(Ljava/util/Date;)Ljava/util/Date;
    ...
    .line 71
    invoke-virtual {v5, v3}, Llvs;->a(Ljava/lang/String;)Lloi;
    ...
    .line 72
    invoke-static {v6, v3}, Llxr;->a(Ljava/util/Date;Lluw;)Llnx;

    move-result-object v3

    invoke-direct {v4, v3}, Llvq;-><init>(Llnx;)V

    .line 73
    invoke-virtual {v5}, Llvs;->b()Z
    ...
    invoke-virtual {v4, v3}, Llvq;->a(Z)V

    .line 76
    :cond_3
    iget-object v3, v4, Llvo;->d:Llnx;
    ...
    .line 46
    :cond_4
    invoke-virtual {v3}, Llpo;->a()Ljava/lang/String;
    ...
    .line 62
    :cond_7
    iget-object v3, v5, Llvo;->d:Llnx;

    .line 63
    instance-of v3, v3, Lloa;
    ...
    invoke-direct {v4, v6}, Llod;-><init>(I)V

    invoke-direct {v3, v4}, Llvu;-><init>(Llod;)V
    :try_end_0
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Llni; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-static {v3, v15}, Lecp;->a(Ljava/lang/String;Ljava/util/TimeZone;)J
    ...
    .catch Llni; {:try_start_1 .. :try_end_1} :catch_2
