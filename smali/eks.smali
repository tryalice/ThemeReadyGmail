...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lekt;-><init>(Leks;)V

    iput-object v0, p0, Leks;->b:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method public final a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
    ...
    iput-object v0, p0, Leks;->a:Landroid/webkit/WebView;

    .line 6
    iget-object v0, p0, Leks;->a:Landroid/webkit/WebView;

    new-instance v2, Lemb;

    .line 7
    invoke-virtual {p0}, Leks;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {p0}, Leks;->getActivity()Landroid/app/Activity;
    ...
    .line 18
    iget-object v3, p0, Leks;->a:Landroid/webkit/WebView;

    new-instance v4, Leku;

    invoke-direct {v4, v0, v2}, Leku;-><init>(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    .line 22
    invoke-virtual {p0}, Leks;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    iget-object v4, p0, Leks;->b:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method final a()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Leks;->getString(I)Ljava/lang/String;
...
.method public final synthetic onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 27
    invoke-virtual {p0, p1, p2, p3}, Leks;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
