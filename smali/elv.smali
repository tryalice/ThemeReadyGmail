...
.method public final a(JJ)Ljava/util/Map;
    ...
    invoke-direct/range {v1 .. v6}, Lenj;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Lelv;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 81
    :cond_2
    new-instance v16, Lelu;

    invoke-direct/range {v16 .. v16}, Lelu;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Lelv;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Lelv;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Lelv;->b:Lenm;

    invoke-direct {v5, v4, v6}, Leqz;-><init>(Landroid/database/sqlite/SQLiteDatabase;Lenm;)V
    ...
    .line 1149
    invoke-virtual/range {v5 .. v17}, Lelt;->a(JIJLjava/util/Map;JLjava/util/Map;ZLelu;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Lenk;-><init>(Landroid/database/sqlite/SQLiteDatabase;Lenm;)V
    :try_end_5
