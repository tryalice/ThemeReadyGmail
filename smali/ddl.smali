...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;ILcom/android/mail/providers/Folder;)V
    ...
    iput-object v0, p0, Lddl;->a:Ljava/util/List;
    ...
    iput-object v0, p0, Lddl;->b:Landroid/view/LayoutInflater;

    .line 12
    iput p3, p0, Lddl;->c:I

    .line 13
    iput-object p4, p0, Lddl;->d:Lcom/android/mail/providers/Folder;

    .line 14
    iput-object p1, p0, Lddl;->f:Landroid/content/Context;

    .line 15
    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Lddl;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;ILcom/android/mail/providers/Account;)V
    ...
    .line 5
    iput-object p5, p0, Lddl;->e:Lcom/android/mail/providers/Account;

    .line 6
    iput-object p1, p0, Lddl;->f:Landroid/content/Context;

    .line 7
    invoke-direct {p0, p2, p3}, Lddl;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method private final a(Landroid/database/Cursor;Ljava/util/Set;)V
    ...
    .line 19
    :cond_0
    iget-object v0, p0, Lddl;->e:Lcom/android/mail/providers/Account;
    ...
    .line 27
    iget-object v1, v5, Lcom/android/mail/providers/Folder;->p:Ldmh;
    ...
    invoke-direct {v6, v5, v1}, Ldmf;-><init>(Lcom/android/mail/providers/Folder;Z)V

    .line 30
    invoke-interface {v0, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 31
    invoke-virtual {p0, v5}, Lddl;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v1

    if-eqz v1, :cond_3

    iget-object v1, p0, Lddl;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v5, v1}, Ljlp;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 38
    iget-object v6, v1, Ldmf;->a:Lcom/android/mail/providers/Folder;

    .line 40
    invoke-virtual {p0, v6}, Lddl;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v7

    if-eqz v7, :cond_5

    iget-object v7, p0, Lddl;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v6, v7}, Ljlp;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 44
    :cond_7
    iget-object v0, p0, Lddl;->a:Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 57
    iget-object v0, p0, Lddl;->b:Landroid/view/LayoutInflater;
    ...
    .line 59
    :cond_0
    invoke-virtual {p0, p1}, Lddl;->getItem(I)Ljava/lang/Object;
    ...
    .line 61
    iget-object v3, v0, Ldmf;->a:Lcom/android/mail/providers/Folder;

    .line 63
    iget-object v1, v0, Ldmf;->c:Ljava/lang/String;
