...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldbt;->s:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldbt;->z:Landroid/database/DataSetObservable;

    .line 87
    new-instance v0, Ldbu;

    invoke-direct {v0, p0}, Ldbu;-><init>(Ldbt;)V

    iput-object v0, p0, Ldbt;->A:Lcxf;
...
.method private final a(Landroid/app/Fragment;)V
    ...
    .prologue
    .line 214
    invoke-virtual {p0}, Ldbt;->getFragmentManager()Landroid/app/FragmentManager;
...
.method private final i()V
    ...
    invoke-virtual {p0, v0}, Ldbt;->setResult(I)V
...
.method public a(ILcom/android/mail/providers/Account;Lcom/android/mail/providers/Folder;)V
    ...
    iget-object v0, p3, Lcom/android/mail/providers/Folder;->e:Ldlo;

    iget-object v5, v0, Ldlo;->b:Landroid/net/Uri;
    ...
    invoke-static/range {v0 .. v7}, Ldoq;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;IILandroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Ldbt;->setResult(ILandroid/content/Intent;)V
...
.method public final a(Lcom/android/mail/providers/Folder;Ldbs;)V
    ...
    iget-object v0, p0, Ldbt;->B:Lcom/android/mail/providers/Folder;
    ...
    .line 357
    iput-object p1, p0, Ldbt;->B:Lcom/android/mail/providers/Folder;

    .line 1301
    iget-object v0, p1, Lcom/android/mail/providers/Folder;->k:Landroid/net/Uri;

    invoke-static {p1, v0, v3}, Ldbd;->a(Lcom/android/mail/providers/Folder;Landroid/net/Uri;Ljava/util/ArrayList;)Ldbd;

    move-result-object v0

    invoke-direct {p0, v0}, Ldbt;->a(Landroid/app/Fragment;)V
    ...
    .line 2278
    :cond_1
    iget-object v0, p0, Ldbt;->u:Lcom/android/mail/providers/Folder;
    ...
    .line 2279
    iput-object p1, p0, Ldbt;->u:Lcom/android/mail/providers/Folder;
    ...
    .line 2282
    iget-boolean v1, p0, Ldbt;->v:Z

    if-eqz v1, :cond_2

    .line 2289
    iget-object v1, p0, Ldbt;->u:Lcom/android/mail/providers/Folder;

    iget-object v1, v1, Lcom/android/mail/providers/Folder;->e:Ldlo;

    iget-object v1, v1, Ldlo;->b:Landroid/net/Uri;

    iget-object v2, p0, Ldbt;->t:Lcom/android/mail/providers/Account;

    invoke-static {p0, v1, v2}, Ldob;->a(Landroid/content/Context;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Landroid/content/Intent;
    ...
    .line 2318
    invoke-virtual {p0, v2}, Ldbt;->startActivity(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Ldbt;->t:Lcom/android/mail/providers/Account;

    iget-object v2, p0, Ldbt;->u:Lcom/android/mail/providers/Folder;

    invoke-virtual {p0, v0, v1, v2}, Ldbt;->a(ILcom/android/mail/providers/Account;Lcom/android/mail/providers/Folder;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Ldbt;->w:Z

    if-nez v1, :cond_0

    .line 182
    sget-object v1, Ldbt;->s:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldbt;->t:Lcom/android/mail/providers/Account;

    .line 199
    sget v0, Lcee;->bR:I

    invoke-virtual {p0, v0}, Ldbt;->findViewById(I)Landroid/view/View;
    ...
    .line 206
    iget-object v0, p0, Ldbt;->t:Lcom/android/mail/providers/Account;

    iget-object v0, v0, Lcom/android/mail/providers/Account;->k:Landroid/net/Uri;

    .line 207
    invoke-virtual {p0}, Ldbt;->h()Ljava/util/ArrayList;
    ...
    invoke-static {v2, v0, v1}, Ldbd;->a(Lcom/android/mail/providers/Folder;Landroid/net/Uri;Ljava/util/ArrayList;)Ldbd;
