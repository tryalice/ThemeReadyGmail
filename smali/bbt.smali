...
.field public final synthetic c:Lbbs;


# direct methods
.method constructor <init>(Lbbs;Lcom/android/emailcommon/provider/Account;Landroid/content/Loader;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lbbt;->c:Lbbs;

    iput-object p2, p0, Lbbt;->a:Lcom/android/emailcommon/provider/Account;

    iput-object p3, p0, Lbbt;->b:Landroid/content/Loader;
...
.method public final run()V
    ...
    .line 2
    iget-object v0, p0, Lbbt;->c:Lbbs;

    iget-object v1, v0, Lbbs;->a:Lcom/android/email/activity/setup/AccountSecurity;
    ...
    .line 7
    :cond_1
    iget-object v0, p0, Lbbt;->a:Lcom/android/emailcommon/provider/Account;
    ...
    .line 16
    iget-object v0, p0, Lbbt;->b:Landroid/content/Loader;

    check-cast v0, Lbbr;

    .line 17
    iget-object v2, p0, Lbbt;->a:Lcom/android/emailcommon/provider/Account;

    iget-boolean v3, v0, Lbbr;->b:Z

    iget-boolean v4, v0, Lbbr;->c:Z

    iget-boolean v0, v0, Lbbr;->d:Z
    ...
    .line 29
    invoke-virtual {v3, v4}, Lbbu;->setArguments(Landroid/os/Bundle;)V

    .line 31
    const-string v0, "password_expiration"

    invoke-virtual {v3, v2, v0}, Lbbu;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    ...
    .line 43
    invoke-virtual {v2, v3}, Lbbv;->setArguments(Landroid/os/Bundle;)V

    .line 45
    const-string v1, "security_needed"

    invoke-virtual {v2, v0, v1}, Lbbv;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
