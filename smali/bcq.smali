...
.field public final synthetic d:Lbdp;
...
# direct methods
.method public constructor <init>(Lcom/android/email/provider/EmailProvider;Landroid/content/Context;Lcom/android/emailcommon/service/SearchParams;JLbdp;J)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lbcq;->f:Lcom/android/email/provider/EmailProvider;

    iput-object p2, p0, Lbcq;->a:Landroid/content/Context;

    iput-object p3, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;

    iput-wide p4, p0, Lbcq;->c:J

    iput-object p6, p0, Lbcq;->d:Lbdp;

    iput-wide p7, p0, Lbcq;->e:J
...
.method private final varargs a()Ljava/lang/Void;
    ...
    .prologue
    .line 2
    iget-object v0, p0, Lbcq;->f:Lcom/android/email/provider/EmailProvider;

    .line 3
    invoke-virtual {v0}, Lcom/android/email/provider/EmailProvider;->a()Lbbz;
    ...
    iget-object v2, p0, Lbcq;->a:Landroid/content/Context;
    ...
    iget-object v0, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;

    iget-object v0, v0, Lcom/android/emailcommon/service/SearchParams;->c:Ljava/lang/String;

    iget-object v3, p0, Lbcq;->f:Lcom/android/email/provider/EmailProvider;

    iget-wide v4, p0, Lbcq;->c:J
    ...
    .line 10
    iget-object v4, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;

    iget v4, v4, Lcom/android/emailcommon/service/SearchParams;->g:I

    iget-object v5, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;
    ...
    invoke-direct {v6, v7, v0}, Lbms;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 18
    :goto_0
    invoke-virtual {v1, v0, v3, v4, v5}, Lbbz;->a(Ljava/lang/String;Landroid/accounts/Account;II)Lcom/google/android/gms/appdatasearch/SearchResults;
    ...
    .line 20
    invoke-virtual {v3}, Lcom/google/android/gms/appdatasearch/SearchResults;->b()Lfep;
    ...
    invoke-virtual {v0, v5}, Lfeo;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 23
    iget-object v0, v1, Lbmj;->g:Landroid/content/Context;
    ...
    .line 34
    :cond_2
    sget-object v0, Lbbz;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v5, v8}, Lcnx;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 43
    iget-object v1, p0, Lbcq;->d:Lbdp;

    .line 44
    iget-object v2, v1, Lbdp;->a:Lcom/android/emailcommon/service/SearchParams;

    iget v2, v2, Lcom/android/emailcommon/service/SearchParams;->g:I

    iget-object v3, v1, Lbdp;->a:Lcom/android/emailcommon/service/SearchParams;
    ...
    :goto_3
    iput-boolean v0, v1, Lbdp;->c:Z

    .line 45
    iget-object v0, p0, Lbcq;->f:Lcom/android/email/provider/EmailProvider;

    iget-object v1, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;
    ...
    .line 47
    :cond_4
    iget-object v0, p0, Lbcq;->a:Landroid/content/Context;

    iget-wide v2, p0, Lbcq;->c:J
    ...
    .line 50
    :try_start_0
    iget-wide v1, p0, Lbcq;->c:J

    iget-object v3, p0, Lbcq;->b:Lcom/android/emailcommon/service/SearchParams;

    iget-wide v4, p0, Lbcq;->e:J
    ...
    .line 58
    iget-object v0, v1, Lbdp;->a:Lcom/android/emailcommon/service/SearchParams;
