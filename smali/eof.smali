...
.method public static b(Landroid/content/Context;Landroid/os/Bundle;)Leog;
    .locals 8
    ...
    iput-wide v4, v3, Leog;->c:J

    .line 7
    iput-object v0, v3, Leog;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Leuv;->a(Landroid/content/ContentResolver;)Z

    move-result v5

    .line 10
    invoke-static {p0, v0, v4, v5}, Leof;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Livk;
    ...
    .line 14
    iput-object v1, v4, Livs;->messageId:Ljava/lang/String;
    ...
    .line 21
    iput-object v1, v4, Livs;->partId:Ljava/lang/String;

    .line 23
    new-instance v1, Livl;

    invoke-direct {v1, v0}, Livl;-><init>(Livk;)V

    .line 25
    new-instance v0, Livm;

    invoke-direct {v0, v1, v4}, Livm;-><init>(Livl;Livs;)V

    .line 28
    invoke-virtual {v0}, Livm;->c()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Livs;

    iput-object v0, v3, Leog;->b:Livs;
    :try_end_0
...
.method public final synthetic a(Landroid/content/Context;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-static {p1, p2}, Leof;->b(Landroid/content/Context;Landroid/os/Bundle;)Leog;
