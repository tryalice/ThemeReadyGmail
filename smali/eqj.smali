...
.method public constructor <init>()V
    ...
    .line 4
    iput-object v0, p0, Leqj;->k:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method public final a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
    ...
    .line 13
    invoke-virtual {p0}, Leqj;->getArguments()Landroid/os/Bundle;
    ...
    .line 17
    invoke-virtual {p0}, Leqj;->getActivity()Landroid/app/Activity;
    ...
    iput-object v0, p0, Leqj;->b:Landroid/widget/Spinner;

    .line 20
    iget-object v0, p0, Leqj;->b:Landroid/widget/Spinner;

    invoke-virtual {v0, v4}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 21
    iget-object v4, p0, Leqj;->b:Landroid/widget/Spinner;
...
.method final a()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Leqj;->getString(I)Ljava/lang/String;
...
.method public final a(Z)V
    ...
    invoke-virtual {p0, v0}, Leqj;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Leqj;->b(Z)V
...
.method final j()V
    ...
    invoke-direct {v1, v2, v3, v0}, Leqb;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 6
    invoke-super {p0, p1}, Leph;->onCreate(Landroid/os/Bundle;)V

    .line 7
    invoke-virtual {p0}, Leqj;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    iget-object v3, p0, Leqj;->k:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method public final synthetic onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 59
    invoke-virtual {p0, p1, p2, p3}, Leqj;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
...
.method public final onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Leqj;->c(Z)V

    .line 25
    const v0, 0x104000a

    invoke-virtual {p0, v0}, Leqj;->a(I)V
