...
.method private final a()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Leop;->getColumnIndex(Ljava/lang/String;)I
    ...
    invoke-direct {v1, v2, v3, v0}, Leoq;-><init>(JLjava/lang/Throwable;)V
    ...
    invoke-static {v2, v0}, Leuf;->a([BI)Ljava/lang/String;
    ...
    .line 28
    :cond_3
    invoke-virtual {p0, v1}, Leop;->getLong(I)J
    :try_end_4
...
.method public final fillWindow(ILandroid/database/CursorWindow;)V
    ...
    .prologue
    .line 34
    invoke-virtual {p0}, Leop;->getWrappedCursor()Landroid/database/Cursor;
    ...
    invoke-virtual {p0}, Leop;->getCount()I
    ...
    .line 39
    :try_start_0
    invoke-virtual {p0}, Leop;->getPosition()I
    ...
    invoke-virtual {p0, v1}, Leop;->moveToPosition(I)Z

    .line 41
    :goto_1
    invoke-virtual {p0}, Leop;->moveToNext()Z
    ...
    .line 42
    invoke-direct {p0}, Leop;->a()Ljava/lang/String;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0, v0}, Leop;->moveToPosition(I)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
