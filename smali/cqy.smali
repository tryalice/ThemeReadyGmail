...
.method public constructor <init>(Ljava/lang/Class;Landroid/os/Parcelable$Creator;)V
    ...
    .line 2
    iput-object p1, p0, Lcqy;->a:Ljava/lang/Class;

    .line 3
    new-instance v0, Lcqx;

    invoke-direct {v0, p2}, Lcqx;-><init>(Landroid/os/Parcelable$Creator;)V

    iput-object v0, p0, Lcqy;->b:Lcqx;
...
.method private final a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
    ...
    sget-object v0, Lcqz;->a:Ljava/util/Comparator;
    ...
    .line 20
    new-instance v8, Lcqz;

    aget v9, v4, v0

    invoke-direct {v8, v9}, Lcqz;-><init>(I)V
    ...
    invoke-direct {v9, v0}, Lcqz;-><init>(I)V

    new-instance v0, Lcqz;

    invoke-direct {v0, v8}, Lcqz;-><init>(I)V
    ...
    .line 45
    iget-object v8, p0, Lcqy;->b:Lcqx;

    invoke-virtual {v8, v7}, Lcqx;->a(Landroid/os/Parcelable;)Landroid/os/Parcelable;
...
.method public final a(Landroid/text/Spanned;)Landroid/text/Spanned;
    ...
    iget-object v3, p0, Lcqy;->a:Ljava/lang/Class;
    ...
    .line 7
    invoke-direct {p0, v1, v0}, Lcqy;->a(Landroid/text/Spannable;[Landroid/os/Parcelable;)Landroid/text/Spanned;
