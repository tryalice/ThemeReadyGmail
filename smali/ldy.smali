...
# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Ljava/lang/String;Llds;Lldq;IILldv;)V
    .locals 5
    ...
    .line 4
    iput-object p1, p0, Lldy;->b:Ljava/net/HttpURLConnection;

    .line 5
    iput-object p7, p0, Lldy;->a:Lldv;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p3}, Llds;->a()Ljava/util/Set;
    ...
    .line 24
    invoke-virtual {p3, v0}, Llds;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private final f()Lldt;
    ...
    .prologue
    .line 89
    invoke-direct {p0}, Lldy;->h()V

    .line 90
    :try_start_0
    iget-object v0, p0, Lldy;->b:Ljava/net/HttpURLConnection;
    ...
    .line 99
    iget-object v1, p0, Lldy;->b:Ljava/net/HttpURLConnection;
    ...
    .line 107
    iget-object v9, v4, Llds;->a:Ljava/util/Map;
    ...
    invoke-direct {v1, v5, v0, v3}, Lldt;-><init>(ILlds;Ljava/io/InputStream;)V
...
.method public final a()Lknv;
    ...
    invoke-direct {v0, p0}, Lldz;-><init>(Lldy;)V
...
.method final b()Lldt;
    ...
    invoke-direct {p0}, Lldy;->f()Lldt;
    :try_end_3
    .catch Llem; {:try_start_3 .. :try_end_3} :catch_2
    ...
    .line 62
    :try_start_4
    iget-object v7, p0, Lldy;->c:Lldq;

    sub-int v8, v12, v4

    invoke-interface {v7, v6, v4, v8}, Lldq;->a([BII)I

    move-result v7

    .line 63
    iget-wide v8, p0, Lldy;->d:J

    int-to-long v10, v7

    add-long/2addr v8, v10

    iput-wide v8, p0, Lldy;->d:J
    :try_end_4
