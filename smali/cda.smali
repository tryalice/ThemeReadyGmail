...
.method public constructor <init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/service/SearchParams;J)V
    ...
    .line 2
    iput-object p3, p0, Lcda;->a:Lcom/android/emailcommon/service/SearchParams;

    .line 3
    iput-wide p4, p0, Lcda;->b:J
    ...
    invoke-direct {v0, v1, v2}, Lbth;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v0, p0, Lcda;->e:Lbth;
...
.method protected final a(Lbzs;)I
    ...
    iget-object v1, p0, Lcda;->k:Landroid/content/Context;
    ...
    .line 75
    :goto_1
    invoke-direct/range {v0 .. v6}, Lcbj;-><init>(Landroid/content/Context;Landroid/content/ContentResolver;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;Ljava/lang/String;)V

    .line 76
    invoke-virtual {v0}, Lcbj;->d()Z
...
.method protected final c()Lorg/apache/http/HttpEntity;
    ...
    .line 9
    iget-object v1, p0, Lcda;->a:Lcom/android/emailcommon/service/SearchParams;

    iget v1, v1, Lcom/android/emailcommon/service/SearchParams;->g:I

    .line 10
    iget-object v2, p0, Lcda;->a:Lcom/android/emailcommon/service/SearchParams;

    iget v2, v2, Lcom/android/emailcommon/service/SearchParams;->f:I

    .line 11
    iget-object v3, p0, Lcda;->a:Lcom/android/emailcommon/service/SearchParams;
    ...
    .line 18
    iget-object v4, p0, Lcda;->k:Landroid/content/Context;

    iget-wide v6, p0, Lcda;->b:J
    ...
    iput-object v4, p0, Lcda;->d:Lcom/android/emailcommon/provider/Mailbox;

    .line 19
    iget-object v4, p0, Lcda;->d:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 25
    iget-object v5, p0, Lcda;->d:Lcom/android/emailcommon/provider/Mailbox;

    iget-object v6, p0, Lcda;->k:Landroid/content/Context;
    ...
    invoke-virtual {v5, v6}, Lcbm;->a(I)Lcbm;
    ...
    invoke-virtual {v4, v5, v6}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    .line 31
    iget-object v5, p0, Lcda;->k:Landroid/content/Context;

    iget-object v6, p0, Lcda;->l:Lcom/android/emailcommon/provider/Account;
    ...
    :cond_6
    :try_start_1
    iget-object v6, p0, Lcda;->a:Lcom/android/emailcommon/service/SearchParams;
    ...
    invoke-virtual {v4, v6, v5}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    invoke-virtual {v4, v3}, Lcbm;->a(I)Lcbm;

    .line 41
    const/16 v3, 0x8f

    invoke-virtual {v4, v3}, Lcbm;->b(I)Lcbm;

    .line 42
    const/16 v3, 0x3d2

    sget-object v5, Lbzq;->i:Ljava/text/SimpleDateFormat;
    ...
    invoke-virtual {v4, v3, v5}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    invoke-virtual {v4, v3, v1}, Lcbm;->b(ILjava/lang/String;)Lcbm;

    .line 56
    const/16 v1, 0x445

    invoke-virtual {v4, v1}, Lcbm;->a(I)Lcbm;
    ...
    invoke-virtual {v4, v1, v2}, Lcbm;->b(ILjava/lang/String;)Lcbm;
    ...
    .line 61
    invoke-static {v4}, Lcda;->a(Lcbm;)Lorg/apache/http/HttpEntity;
    :try_end_1
...
.method protected final o()V
    ...
    .prologue
    .line 84
    iget-object v0, p0, Lcda;->d:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 88
    iget-object v1, p0, Lcda;->d:Lcom/android/emailcommon/provider/Mailbox;
