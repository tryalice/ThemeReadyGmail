...
.method public constructor <init>(Landroid/content/Context;Lkra;Lhxz;Ljava/util/concurrent/Executor;Lhxo;Ljrd;)V
    ...
    iput-object v0, p0, Lhhs;->c:Ljava/util/List;

    .line 3
    iput-object p3, p0, Lhhs;->e:Lhxz;

    .line 4
    iput-object p4, p0, Lhhs;->d:Ljava/util/concurrent/Executor;
...
.method protected final a(Ljava/util/List;)Lkra;
    ...
    .prologue
    .line 49
    invoke-virtual {p0, p1}, Lhhs;->a_(Ljava/util/List;)Lkra;
...
.method public abstract a_(Ljava/util/List;)Lkra;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
...
.method public b(FFFF)V
    ...
    .line 26
    invoke-virtual {p0, p1, p2, p3, p4}, Lhhs;->c(FFFF)V
...
.method public final b(Ljava/util/List;)V
    ...
    .line 7
    iget-object v2, p0, Lhhs;->e:Lhxz;

    invoke-interface {v2, p0, v0}, Lhxz;->b(Lhvc;Lkra;)Lhvc;
    ...
    .line 10
    invoke-virtual {v2}, Lhvc;->c()Landroid/view/View;
    ...
    .line 15
    invoke-static {v3, v0, v2}, Lhwe;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_0

    .line 17
    :cond_1
    iget-object v4, p0, Lhhs;->c:Ljava/util/List;

    invoke-interface {v4, v0, v2}, Ljava/util/List;->add(ILjava/lang/Object;)V

    .line 18
    invoke-virtual {p0, v0, v3}, Lhhs;->a(ILandroid/view/View;)V

    .line 19
    invoke-static {v2}, Lhhq;->a(Lhvc;)V
...
.method public final c(FFFF)V
    ...
    .line 29
    iget-object v7, p0, Lhhs;->m:Landroid/view/View;
    ...
    .line 44
    :cond_2
    invoke-virtual {v0, v3, v5, v4, v1}, Lhvc;->a(FFFF)V
