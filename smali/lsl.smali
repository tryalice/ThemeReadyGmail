...
.method public constructor <init>(J)V
    ...
    invoke-direct {p0, v0, p1, p2}, Llpf;-><init>(Ljava/nio/channels/SelectableChannel;J)V
...
.method private final a(I)[B
    ...
    .line 46
    iget-object v0, p0, Llsl;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 50
    iget-object v1, p0, Llsl;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 52
    :try_start_0
    iget-object v5, p0, Llsl;->b:Ljava/nio/channels/SelectionKey;
    ...
    iget-wide v6, p0, Llsl;->a:J

    invoke-static {v5, v6, v7}, Llsl;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_1
...
.method static a(Ljava/net/SocketAddress;Ljava/net/SocketAddress;[BJ)[B
    ...
    invoke-direct {v1, p3, p4}, Llsl;-><init>(J)V
    ...
    .line 77
    :try_start_0
    invoke-virtual {v1, p0}, Llsl;->a(Ljava/net/SocketAddress;)V

    .line 78
    :cond_0
    invoke-virtual {v1, p1}, Llsl;->b(Ljava/net/SocketAddress;)V

    .line 79
    invoke-virtual {v1, p2}, Llsl;->a([B)V

    .line 80
    invoke-virtual {v1}, Llsl;->b()[B
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final a([B)V
    ...
    .line 21
    invoke-static {v1, p1}, Llsl;->a(Ljava/lang/String;[B)V
    ...
    .line 31
    iget-object v4, p0, Llsl;->b:Ljava/nio/channels/SelectionKey;
    ...
    invoke-static {v4, v6, v7}, Llsl;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final b(Ljava/net/SocketAddress;)V
    ...
    iget-wide v2, p0, Llsl;->a:J

    invoke-static {v1, v2, v3}, Llsl;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final b()[B
    ...
    invoke-direct {p0, v0}, Llsl;->a(I)[B
    ...
    .line 73
    invoke-static {v2, v1}, Llsl;->a(Ljava/lang/String;[B)V
