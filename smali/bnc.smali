...
.method public final a(Landroid/net/Uri;)V
    ...
    .line 5
    iget-object v0, p0, Lbnc;->b:Landroid/content/Context;
    ...
    .line 6
    sget-object v2, Lcze;->m:[Ljava/lang/String;
    ...
    .line 21
    iget-object v3, p0, Lbnc;->b:Landroid/content/Context;

    iget-wide v4, v0, Lcom/android/mail/providers/Task;->j:J

    .line 22
    invoke-static {v3, v4, v5}, Lcof;->a(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v3

    .line 23
    iget-object v4, p0, Lbnc;->b:Landroid/content/Context;
    ...
    .line 28
    sget-object v1, Lcvb;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Lbnc;->b:Landroid/content/Context;
    ...
    iget-object v7, p0, Lbnc;->b:Landroid/content/Context;
    ...
    iget-object v8, p0, Lbnc;->b:Landroid/content/Context;
    ...
    iget-object v9, p0, Lbnc;->b:Landroid/content/Context;
    ...
    invoke-direct {v6, v7, v8, v5}, Lka;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    iget-object v10, p0, Lbnc;->b:Landroid/content/Context;
    ...
    invoke-direct {v7, v8, v9, v5}, Lka;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v8}, Lkg;-><init>()V

    .line 51
    invoke-static {v2}, Lkh;->e(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v9

    iput-object v9, v8, Lkg;->e:Ljava/lang/CharSequence;

    .line 55
    invoke-static {v0}, Lkh;->e(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v9

    iput-object v9, v8, Lkg;->f:Ljava/lang/CharSequence;

    .line 56
    iput-boolean v13, v8, Lkg;->g:Z
    ...
    .line 60
    invoke-virtual {v8, v3}, Lkg;->a(Ljava/lang/CharSequence;)Lkg;
    ...
    invoke-direct {v3, v9}, Lkh;-><init>(Landroid/content/Context;)V

    sget v9, Lbac;->o:I

    .line 62
    invoke-virtual {v3, v9}, Lkh;->a(I)Lkh;
    ...
    .line 63
    invoke-static {v9}, Ldta;->a(Landroid/content/Context;)I
    ...
    .line 67
    invoke-virtual {v3, v2}, Lkh;->a(Ljava/lang/CharSequence;)Lkh;

    move-result-object v2

    .line 68
    invoke-virtual {v2, v0}, Lkh;->b(Ljava/lang/CharSequence;)Lkh;

    move-result-object v0

    .line 69
    invoke-virtual {v0, v8}, Lkh;->a(Lkv;)Lkh;

    move-result-object v0

    iget-object v2, p0, Lbnc;->b:Landroid/content/Context;
    ...
    .line 75
    invoke-virtual {v0, v6}, Lkh;->a(Lka;)Lkh;

    move-result-object v0

    .line 76
    invoke-virtual {v0, v7}, Lkh;->a(Lka;)Lkh;
    ...
    .line 78
    invoke-virtual {v0, v2}, Lkh;->a(Landroid/app/PendingIntent;)Lkh;
