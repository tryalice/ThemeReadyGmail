...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbkc;->a:Ljava/lang/Long;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lbkc;->b:Lbpz;

    .line 72
    return-void
.end method

.method private static a(Landroid/content/Context;JZILbkf;)V
    .locals 13
    ...
    sput-object v2, Lblg;->a:Ljava/io/File;
    ...
    .line 159
    invoke-static {p0, v3}, Lbkc;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Z

    move-result v5

    move-object/from16 v0, p5

    iput-boolean v5, v0, Lbkf;->c:Z
    ...
    iget-wide v10, v4, Lcom/android/emailcommon/provider/Mailbox;->J:J
    ...
    invoke-direct {v2, p0, v3}, Lbgl;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V

    .line 187
    move/from16 v0, p3

    invoke-virtual {v2, v0}, Lbgl;->a(Z)V
    :try_end_0
    ...
    :try_start_1
    invoke-static {v2, v5}, Lcug;->a(II)I
    ...
    invoke-static {v8, p1, p2, v2, v11}, Lbny;->a(Landroid/content/ContentResolver;JII)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/email/service/ImapService;->b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ZZLbkf;)I
    ...
    .line 6026
    :pswitch_0
    sget-object v3, Ldmh;->a:Ljava/lang/String;
    ...
    invoke-static {v8, p1, p2, v2, v4}, Lbny;->a(Landroid/content/ContentResolver;JII)V

    .line 213
    move-object/from16 v0, p5

    iput-object v5, v0, Lbkf;->k:Ljava/lang/Exception;

    .line 214
    move-object/from16 v0, p5

    invoke-virtual {v0, v4}, Lbkf;->a(I)V
    ...
    :try_start_3
    invoke-static/range {v2 .. v7}, Lcom/android/email/service/ImapService;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ZZLbkf;)I
    ...
    invoke-static {p0, v3, v4, v0, v1}, Lcom/android/email/service/Pop3Service;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ILbkf;)I
    :try_end_3
...
.method static synthetic a(Lbkc;Landroid/content/Context;Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/SyncResult;)V
    .locals 12
    ...
    invoke-direct {v6, p1, v0}, Lbkf;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 1236
    sget-object v0, Lbkc;->a:Ljava/lang/Long;
    ...
    .line 2120
    iput-wide v0, v6, Lcto;->s:J

    .line 3104
    iget-wide v0, v6, Lcto;->n:J
    ...
    iget-wide v8, v1, Lcom/android/emailcommon/provider/Account;->J:J
    ...
    .line 1254
    invoke-static {v4, v8, v9}, Lbnf;->b(Landroid/content/ContentResolver;J)Ljava/util/Set;
    ...
    .line 1256
    invoke-static {v4, v8, v9}, Lbni;->a(Landroid/content/ContentResolver;J)Ljava/util/Set;
    ...
    invoke-static/range {v1 .. v6}, Lbkc;->a(Landroid/content/Context;JZILbkf;)V
    :try_end_0
    ...
    .line 1319
    iput-object v0, v6, Lbkf;->k:Ljava/lang/Exception;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iput-object v0, v6, Lbkf;->j:Ljava/lang/String;

    .line 1324
    :cond_1
    invoke-virtual {v6}, Lbkf;->d()V

    .line 1325
    invoke-virtual {p0, v6}, Lbkc;->a(Lbkf;)V

    .line 1328
    iget-boolean v0, v6, Lbkf;->c:Z
    ...
    invoke-static {v0}, Ldlc;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1331
    iget-object v2, v6, Lbkf;->k:Ljava/lang/Exception;

    if-nez v2, :cond_14

    .line 1332
    iget-boolean v2, v6, Lbkf;->c:Z
    ...
    invoke-interface {v0, v2, v3}, Lcev;->a(Ljava/lang/String;I)Z
    ...
    invoke-static {v0}, Lbgy;->b(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    .line 1343
    invoke-virtual {p0}, Lbkc;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 1272
    invoke-static {p1, v4, v5}, Lbjf;->a(Landroid/content/Context;J)Lbnx;
    ...
    invoke-interface {v0, v4, v5}, Lbnx;->a(J)V
    ...
    .line 1298
    :cond_7
    invoke-static {p1, v1}, Lbkc;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Z
    ...
    .line 1300
    iget-wide v0, v1, Lcom/android/emailcommon/provider/Account;->J:J
    ...
    iget-object v1, v6, Lbkf;->k:Ljava/lang/Exception;
    ...
    invoke-interface/range {v3 .. v8}, Lcev;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lbkc;->b:Lbpz;

    invoke-virtual {v0}, Lbpz;->getSyncAdapterBinder()Landroid/os/IBinder;
...
.method public onCreate()V
    ...
    invoke-virtual {p0}, Lbkc;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lbkd;-><init>(Lbkc;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lbke;-><init>(Lbkc;Landroid/content/Context;)V
