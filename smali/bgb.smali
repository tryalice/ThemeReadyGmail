...
.method final a()V
    ...
    .line 106
    iget-object v0, p0, Lbgb;->a:Lcom/android/emailcommon/provider/Mailbox;

    invoke-static {v0}, Ljri;->a(Ljava/lang/Object;)Ljava/lang/Object;

    .line 108
    invoke-virtual {p0}, Lbgb;->getActivity()Landroid/app/Activity;
    ...
    .line 111
    iget-object v1, p0, Lbgb;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    invoke-virtual {p0, v1}, Lbgb;->getString(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lbgb;->k:Landroid/preference/ListPreference;
    ...
    .line 116
    invoke-virtual {p0, v2, v3}, Lbgb;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method final a(Z)V
    ...
    .line 50
    iget-object v0, p0, Lbgb;->j:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v0, p1}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 51
    iget-object v0, p0, Lbgb;->k:Landroid/preference/ListPreference;
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    iput-object v1, p0, Lbgb;->e:Ldhz;

    .line 8
    iget-object v1, p0, Lbgb;->e:Ldhz;

    invoke-interface {v1, p0}, Ldhz;->a(Ldia;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 14
    invoke-virtual {p0}, Lbgb;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v0}, Lbgb;->addPreferencesFromResource(I)V

    .line 19
    const-string v0, "folder_name"

    invoke-virtual {p0, v0}, Lbgb;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/EditTextPreference;

    iput-object v0, p0, Lbgb;->g:Landroid/preference/EditTextPreference;
    ...
    iput-object v0, p0, Lbgb;->h:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lbgb;->i:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lbgb;->j:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lbgb;->k:Landroid/preference/ListPreference;
    ...
    iput-object v0, p0, Lbgb;->l:Landroid/preference/Preference;

    .line 25
    invoke-virtual {p0}, Lbgb;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v0

    .line 26
    iget-object v1, p0, Lbgb;->g:Landroid/preference/EditTextPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 27
    iget-object v1, p0, Lbgb;->h:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 28
    iget-object v1, p0, Lbgb;->i:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 29
    iget-object v1, p0, Lbgb;->l:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 30
    iget-boolean v1, p0, Lbgb;->f:Z
    ...
    iput-object v0, p0, Lbgb;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 32
    :cond_2
    iget-object v1, p0, Lbgb;->j:Landroid/preference/CheckBoxPreference;
    ...
    .line 44
    :cond_3
    invoke-virtual {p0, v4}, Lbgb;->a(Z)V

    .line 45
    invoke-virtual {p0}, Lbgb;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    .line 46
    invoke-direct {v2, p0}, Lbge;-><init>(Lbgb;)V
...
.method public onDestroy()V
    ...
    .line 65
    :goto_0
    iget-object v3, p0, Lbgb;->k:Landroid/preference/ListPreference;
    ...
    .line 67
    :goto_1
    iget-object v3, p0, Lbgb;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    invoke-static {v3, v7, v8}, Lcug;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I

    .line 71
    invoke-virtual {p0, v2}, Lbgb;->a(Z)V

    .line 72
    iget-object v2, p0, Lbgb;->a:Lcom/android/emailcommon/provider/Mailbox;
...
.method public onDetach()V
    ...
    .line 84
    iget-object v0, p0, Lbgb;->e:Ldhz;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Ldhz;->a(Ldia;)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 88
    :pswitch_0
    iget-object v2, p0, Lbgb;->g:Landroid/preference/EditTextPreference;
    ...
    .line 89
    iget-object v0, p0, Lbgb;->g:Landroid/preference/EditTextPreference;
    ...
    iget-object v2, p0, Lbgb;->k:Landroid/preference/ListPreference;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 98
    :pswitch_1
    iget-object v0, p0, Lbgb;->h:Landroid/preference/CheckBoxPreference;
    ...
    iput-wide v2, p0, Lbgb;->b:J

    .line 100
    iget-object v0, p0, Lbgb;->i:Landroid/preference/Preference;
