...
.method public constructor <init>()V
    ...
    .line 4
    iput-object v0, p0, Leku;->k:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method public final a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
    ...
    .line 11
    invoke-virtual {p0}, Leku;->getArguments()Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {p0}, Leku;->getActivity()Landroid/app/Activity;
    ...
    iput-object v0, p0, Leku;->b:Landroid/widget/Spinner;

    .line 18
    iget-object v0, p0, Leku;->b:Landroid/widget/Spinner;

    invoke-virtual {v0, v4}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 19
    iget-object v4, p0, Leku;->b:Landroid/widget/Spinner;
...
.method final a()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Leku;->getString(I)Ljava/lang/String;
...
.method public final a(Z)V
    ...
    invoke-virtual {p0, v0}, Leku;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Leku;->b(Z)V
...
.method final j()V
    ...
    invoke-direct {v1, v2, v3, v0}, Lekm;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    .line 51
    invoke-static {v1}, Landroid/os/AsyncTask;->execute(Ljava/lang/Runnable;)V

    .line 52
    invoke-super {p0}, Lejs;->j()V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 6
    invoke-super {p0, p1}, Lejs;->onCreate(Landroid/os/Bundle;)V

    .line 7
    invoke-virtual {p0}, Leku;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    iget-object v3, p0, Leku;->k:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method public final synthetic onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 55
    invoke-virtual {p0, p1, p2, p3}, Leku;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Lcom/android/setupwizardlib/SetupWizardLayout;
...
.method public final onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Leku;->c(Z)V

    .line 25
    const v0, 0x104000a

    invoke-virtual {p0, v0}, Leku;->a(I)V
