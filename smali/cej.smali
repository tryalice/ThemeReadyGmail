...
.method private final a()Lcfs;
    ...
    invoke-direct {v3, v0}, Lcek;-><init>(Ljava/util/concurrent/BlockingQueue;)V

    .line 5
    invoke-virtual {p0}, Lcej;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v2, v4, v3, v0}, Lcfs;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Lbrc;)V
    :try_end_0
...
.method public final a(Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    .line 22
    invoke-virtual {p0}, Lcej;->e()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcfx;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcej;->a(Landroid/accounts/Account;)Z
    ...
    .line 42
    iget-object v1, v2, Lcfs;->c:Lbrc;

    .line 43
    iget-wide v6, v0, Lcom/android/emailcommon/provider/Account;->L:J

    .line 44
    invoke-interface {v1, v6, v7, v4, v5}, Lbrc;->a(JJ)V
    :try_end_1
    ...
    invoke-interface {v1, v4, v5, p2}, Lbrc;->a(JLandroid/os/Bundle;)I
    ...
    invoke-static {v0, v4, v5, v3}, Lcfy;->a(Landroid/content/Context;JZ)V
