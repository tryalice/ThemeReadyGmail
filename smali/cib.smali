...
# direct methods
.method constructor <init>(Lchy;Z)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lcib;->b:Lchy;

    iput-boolean p2, p0, Lcib;->a:Z
...
.method public final a()V
    ...
    .line 5
    iget-object v1, p0, Lcib;->b:Lchy;

    iget-object v1, v1, Lchy;->K:Lcom/android/mail/ui/ComposeAttachmentTileGrid;
    ...
    invoke-static {v5}, Ldpu;->b(Landroid/net/Uri;)Z
    ...
    .line 16
    sget-object v6, Lchy;->A:Ljava/util/concurrent/atomic/AtomicInteger;

    monitor-enter v6

    .line 17
    :try_start_0
    sget-object v0, Lchy;->A:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, v2}, Lchy;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    :try_end_1
...
.method public final a(Lcix;Lcom/android/mail/providers/Message;Lcsh;)V
    .locals 3
    ...
    .line 34
    iget-object v1, v0, Lchy;->aw:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v2, p3}, Lchy;->a(Lcom/android/mail/providers/Message;ILcsh;)V
    ...
    .line 41
    invoke-interface {v0, p1, p2, p3}, Lciw;->a(Lcix;Lcom/android/mail/providers/Message;Lcsh;)V
...
.method public final a(Lcix;Z)V
    .locals 5
    ...
    iget-boolean v1, p0, Lcib;->a:Z

    invoke-virtual {v0, v1}, Lchy;->c(Z)V

    .line 58
    :goto_0
    sget-object v1, Lchy;->A:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v3, p0, Lcib;->b:Lchy;

    const-class v4, Lcom/android/mail/compose/EmptyService;

    invoke-direct {v2, v3, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {v0, v2}, Lchy;->stopService(Landroid/content/Intent;)Z
    ...
    .line 65
    invoke-interface {v0, p1, p2}, Lciw;->a(Lcix;Z)V
