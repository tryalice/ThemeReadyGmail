...
.method public constructor <init>(Landroid/content/Context;Landroid/app/FragmentManager;Lcom/android/mail/providers/Account;Lcom/android/mail/providers/Folder;Lcom/android/mail/providers/Conversation;)V
    ...
    .line 1
    invoke-direct {p0, p2, v1}, Ldqx;-><init>(Landroid/app/FragmentManager;Z)V

    .line 2
    new-instance v0, Lcjw;

    .line 3
    invoke-direct {v0, p0}, Lcjw;-><init>(Lcju;)V

    .line 4
    iput-object v0, p0, Lcju;->c:Landroid/database/DataSetObserver;

    .line 5
    new-instance v0, Lcjv;

    invoke-direct {v0, p0}, Lcjv;-><init>(Lcju;)V

    iput-object v0, p0, Lcju;->d:Lcxi;

    .line 6
    iput-boolean v1, p0, Lcju;->j:Z

    .line 7
    iput-boolean v1, p0, Lcju;->k:Z

    .line 8
    iput-boolean v1, p0, Lcju;->l:Z

    .line 9
    iput-boolean v1, p0, Lcju;->n:Z

    .line 10
    iput-object p1, p0, Lcju;->e:Landroid/content/Context;

    .line 11
    iput-object p2, p0, Lcju;->q:Landroid/app/FragmentManager;

    .line 12
    iput-object p5, p0, Lcju;->g:Lcom/android/mail/providers/Conversation;

    .line 13
    iput-object p3, p0, Lcju;->h:Lcom/android/mail/providers/Account;

    .line 14
    iput-object p4, p0, Lcju;->i:Lcom/android/mail/providers/Folder;
...
.method private final a(Z)V
    ...
    .line 89
    iget-object v0, p0, Lcju;->f:Ldcb;

    invoke-interface {v0}, Ldcb;->ah()V

    .line 90
    :cond_1
    invoke-virtual {p0}, Lcju;->e()V
...
.method private final g()Lcir;
    ...
    invoke-interface {v0}, Ldcb;->p()Lcir;
...
.method private final h()Lcom/android/mail/providers/Conversation;
    ...
    invoke-interface {v0}, Ldcb;->S()Lcom/android/mail/providers/Conversation;
    ...
    .line 166
    iget-object v0, p0, Lcju;->g:Lcom/android/mail/providers/Conversation;
...
.method public final a()I
    ...
    invoke-static {v1, v4}, Lcug;->a(Ljava/lang/String;I)Z
    ...
    .line 57
    invoke-direct {p0, v1}, Lcju;->a(Landroid/database/Cursor;)Z
...
.method public final a(Lcom/android/mail/providers/Conversation;)I
    ...
    .line 171
    invoke-direct {p0, v0}, Lcju;->a(Landroid/database/Cursor;)Z
    ...
    .line 172
    invoke-direct {p0}, Lcju;->h()Lcom/android/mail/providers/Conversation;
    ...
    invoke-virtual {v0, v4, v5}, Lcir;->a(J)I
...
.method public final a(Landroid/app/Fragment;Z)V
    ...
    .prologue
    .line 149
    invoke-super {p0, p1, p2}, Ldqx;->a(Landroid/app/Fragment;Z)V

    .line 150
    check-cast p1, Ldbd;

    .line 151
    iget-boolean v0, p0, Lcju;->t:Z
    ...
    .line 154
    iget-boolean v0, p1, Ldbd;->n:Z

    if-eq v0, p2, :cond_0

    .line 155
    iput-boolean p2, p1, Ldbd;->n:Z

    .line 157
    iget-object v0, p1, Ldbd;->l:Lcll;

    .line 159
    iget-boolean v1, p1, Ldbd;->n:Z

    if-eqz v1, :cond_1

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcll;->e()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v0}, Lcll;->getCount()I
...
.method public final a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    .prologue
    .line 76
    invoke-super {p0, p1, p2}, Ldqx;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    .line 81
    invoke-direct {p0, v0}, Lcju;->a(Z)V

    .line 82
    iput-object p1, p0, Lcju;->p:Landroid/os/Bundle;
...
.method public final a(Landroid/support/v4/view/ViewPager;)V
    ...
    .prologue
    .line 189
    iget-object v0, p0, Lcju;->m:Landroid/support/v4/view/ViewPager;
    ...
    iput-object v1, v0, Landroid/support/v4/view/ViewPager;->ab:Lwu;

    .line 192
    :cond_0
    iput-object p1, p0, Lcju;->m:Landroid/support/v4/view/ViewPager;
...
.method public final a(Ldcb;)V
    ...
    iget-object v2, p0, Lcju;->c:Landroid/database/DataSetObserver;
    ...
    iget-object v2, p0, Lcju;->d:Lcxi;

    invoke-interface {v1, v2}, Ldcb;->l(Landroid/database/DataSetObserver;)V

    .line 201
    :cond_0
    iput-object p1, p0, Lcju;->f:Ldcb;
    ...
    invoke-interface {v1, v2}, Ldcb;->i(Landroid/database/DataSetObserver;)V

    .line 204
    iget-object v1, p0, Lcju;->d:Lcxi;

    iget-object v2, p0, Lcju;->f:Ldcb;
...
.method public final a_(I)V
    ...
    invoke-interface {v1, v0}, Ldcb;->d(Lcom/android/mail/providers/Conversation;)V
...
.method public final b(Ljava/lang/Object;)I
    ...
    .line 65
    iget-object v0, p1, Ldbd;->h:Lcom/android/mail/providers/Conversation;

    .line 66
    invoke-virtual {p0, v0}, Lcju;->a(Lcom/android/mail/providers/Conversation;)I
...
.method public final b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 68
    invoke-super {p0, p1, p2, p3}, Ldqx;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
...
.method public final c(I)Landroid/app/Fragment;
    ...
    .line 42
    :goto_0
    iget-object v1, p0, Lcju;->e:Landroid/content/Context;
    ...
    .line 44
    invoke-static {v1, v2, v0}, Lddv;->a(Landroid/content/Context;Lcom/android/mail/providers/Account;Lcom/android/mail/providers/Conversation;)Lddv;
...
.method public final d()Landroid/os/Parcelable;
    ...
    .line 71
    invoke-super {p0}, Ldqx;->d()Landroid/os/Parcelable;
    ...
    .line 74
    :cond_0
    sget-object v1, Lcju;->s:Ljava/lang/String;

    iget-boolean v2, p0, Lcju;->k:Z
...
.method public final e()V
    ...
    .line 119
    invoke-direct {p0, v5}, Lcju;->a(Z)V
    ...
    .line 125
    invoke-virtual {p0, v1}, Lcju;->d(I)Landroid/app/Fragment;
    ...
    .line 129
    iput-boolean v5, v0, Ldbd;->r:Z

    .line 146
    :cond_1
    :goto_1
    invoke-super {p0}, Ldqx;->e()V

    .line 147
    iput-boolean v6, p0, Lcju;->l:Z

    goto :goto_0

    .line 130
    :cond_2
    invoke-virtual {v0}, Ldbd;->n()V
    ...
    .line 139
    invoke-virtual {v3}, Lcir;->o()Lcom/android/mail/providers/Conversation;
    ...
    iget-object v4, p0, Lcju;->h:Lcom/android/mail/providers/Account;

    invoke-direct {v2, v4, v3, v1}, Lcrd;-><init>(Lcom/android/mail/providers/Account;Lcom/android/mail/providers/Conversation;Ljava/lang/Object;)V

    invoke-virtual {v0, v2}, Ldbd;->a(Lcrd;)V

    .line 143
    iget-object v0, p0, Lcju;->f:Ldcb;

    invoke-interface {v0, v3}, Ldcb;->c(Lcom/android/mail/providers/Conversation;)V

    goto :goto_1

    .line 137
    :cond_5
    invoke-virtual {p0, v2}, Lcju;->d(I)Landroid/app/Fragment;
...
.method public toString()Ljava/lang/String;
    ...
    .line 101
    iget-object v1, p0, Lcju;->m:Landroid/support/v4/view/ViewPager;
