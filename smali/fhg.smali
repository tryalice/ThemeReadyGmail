...
# virtual methods
.method public final a(Lfhi;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-direct {v4}, Lfqi;-><init>()V

    iget-object v0, p0, Lfhg;->a:Landroid/content/Context;

    invoke-static {v0}, Lfom;->a(Landroid/content/Context;)Lfom;
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfom;->a(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v4}, Lfqi;->a()Landroid/os/IBinder;
    ...
    .line 3
    :goto_0
    invoke-interface {p1, v0}, Lfhi;->a(Lfix;)Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {v5, v1, v4, v6}, Lfom;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-direct {v0, v6}, Lfiy;-><init>(Landroid/os/IBinder;)V
    :try_end_3
    ...
    invoke-virtual {v5, v0, v4, v6}, Lfom;->b(Ljava/lang/String;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    :try_end_5
