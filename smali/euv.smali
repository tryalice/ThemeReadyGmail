...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Leuv;->c:J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Levp;Ljava/lang/String;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Leuv;->d:Landroid/content/Context;

    .line 3
    iput-object p3, p0, Leuv;->f:Ljava/lang/String;

    .line 4
    iput-object p2, p0, Leuv;->g:Levp;

    .line 5
    iget-object v0, p0, Leuv;->g:Levp;

    iget-object v0, v0, Levp;->y:Landroid/database/sqlite/SQLiteDatabase;

    iput-object v0, p0, Leuv;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v0, p0, Leuv;->b:Ljava/lang/ThreadLocal;
...
.method private final d()Ljava/util/Set;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Leuv;->b:Ljava/lang/ThreadLocal;
    ...
    iget-object v0, v0, Leuy;->a:Ljava/util/Set;
...
.method final a()V
    ...
    .line 49
    iget-boolean v1, v0, Leuy;->c:Z

    if-eqz v1, :cond_0

    .line 50
    iget-object v1, p0, Leuv;->g:Levp;

    iget-boolean v3, v0, Leuy;->d:Z

    invoke-virtual {v1, v3}, Levp;->c(Z)V

    .line 51
    :cond_0
    iput-boolean v2, v0, Leuy;->c:Z

    .line 52
    iput-boolean v2, v0, Leuy;->d:Z
    ...
    :goto_0
    invoke-virtual {v3, v1}, Levp;->a(Z)V
...
.method public final a(J)V
    ...
    .line 8
    iget-object v0, p0, Leuv;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 13
    :cond_1
    invoke-direct {p0}, Leuv;->d()Ljava/util/Set;
...
.method public final a(Z)V
    ...
    .line 33
    iget-object v3, p0, Leuv;->d:Landroid/content/Context;

    iget-object v4, p0, Leuv;->f:Ljava/lang/String;
    ...
    .line 35
    :cond_0
    iget-object v0, p0, Leuv;->d:Landroid/content/Context;

    iget-object v2, p0, Leuv;->f:Ljava/lang/String;
    ...
    .line 37
    invoke-virtual {p0}, Leuv;->c()Ljava/util/Set;
    ...
    invoke-virtual {v1, v0}, Levp;->b(Ljava/util/Set;)V
    ...
    invoke-direct {v1, p0}, Leux;-><init>(Leuv;)V

    sget-wide v2, Leuv;->c:J

    .line 43
    iget-boolean v4, v0, Levp;->ao:Z

    if-nez v4, :cond_2

    iget-boolean v4, v0, Levp;->p:Z

    if-nez v4, :cond_2

    .line 44
    iget-object v0, v0, Levp;->az:Landroid/os/Handler;
...
.method final c()Ljava/util/Set;
    ...
    iget-object v0, v0, Leuy;->b:Ljava/util/Set;
...
.method public final onBegin()V
    ...
    .prologue
    .line 17
    iget-object v0, p0, Leuv;->f:Ljava/lang/String;

    invoke-static {v0}, Lcom/google/android/gm/provider/MailIndexerService;->a(Ljava/lang/String;)V

    .line 18
    iget-object v0, p0, Leuv;->h:Landroid/database/sqlite/SQLiteTransactionListener;
