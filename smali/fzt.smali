...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfzt;->a:Ljava/util/Map;
    ...
    sget-object v0, Lfzt;->a:Ljava/util/Map;
    ...
    sput-object v0, Lfzt;->b:Landroid/os/Handler;
    ...
    sput-object v0, Lfzt;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lfzt;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lfzt;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lfzt;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lfzt;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lfzt;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lfzt;->j:Ljava/security/SecureRandom;

    new-instance v0, Lfzu;

    invoke-direct {v0}, Lfzu;-><init>()V

    sput-object v0, Lfzt;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lfzv;

    invoke-direct {v0}, Lfzv;-><init>()V

    sput-object v0, Lfzt;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lfzw;

    invoke-direct {v0}, Lfzw;-><init>()V

    sput-object v0, Lfzt;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lfzx;

    invoke-direct {v0}, Lfzx;-><init>()V

    sput-object v0, Lfzt;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lfzy;

    invoke-direct {v0}, Lfzy;-><init>()V

    sput-object v0, Lfzt;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lfzz;

    invoke-direct {v0}, Lfzz;-><init>()V

    sput-object v0, Lfzt;->p:Ljava/lang/ThreadLocal;
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lfzt;->m:Ljava/lang/ThreadLocal;
