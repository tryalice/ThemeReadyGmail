...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;ILcom/android/mail/providers/Folder;)V
    ...
    iput-object v0, p0, Lddm;->a:Ljava/util/List;
    ...
    iput-object v0, p0, Lddm;->b:Landroid/view/LayoutInflater;

    .line 64
    iput p3, p0, Lddm;->c:I

    .line 65
    iput-object p4, p0, Lddm;->d:Lcom/android/mail/providers/Folder;

    .line 66
    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Lddm;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V
    ...
    .line 58
    invoke-direct {p0, p2, p3}, Lddm;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method private final a(Landroid/database/Cursor;Ljava/util/Set;)V
    ...
    invoke-direct {v6, v5, v1}, Ldnd;-><init>(Lcom/android/mail/providers/Folder;Z)V

    .line 87
    invoke-interface {v0, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 90
    invoke-virtual {p0, v5}, Lddm;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v1

    if-eqz v1, :cond_2

    iget-object v1, p0, Lddm;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v5, v1}, Ljbq;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 1064
    iget-object v6, v1, Ldnd;->a:Lcom/android/mail/providers/Folder;

    .line 102
    invoke-virtual {p0, v6}, Lddm;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v7

    if-eqz v7, :cond_4

    iget-object v7, p0, Lddm;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v6, v7}, Ljbq;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 107
    :cond_6
    iget-object v0, p0, Lddm;->a:Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 150
    iget-object v0, p0, Lddm;->b:Landroid/view/LayoutInflater;
    ...
    .line 154
    :cond_0
    invoke-virtual {p0, p1}, Lddm;->getItem(I)Ljava/lang/Object;
    ...
    .line 1064
    iget-object v3, v0, Ldnd;->a:Lcom/android/mail/providers/Folder;

    .line 156
    iget-object v1, v0, Ldnd;->c:Ljava/lang/String;
