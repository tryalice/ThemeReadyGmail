...
.method public static c(I)Lbbx;
    ...
    .line 90
    invoke-static {p0, v1, v1}, Lbbx;->a(IZZ)Landroid/os/Bundle;
...
.method private final u()I
    ...
    .prologue
    .line 367
    iget-object v0, p0, Lbbx;->C:Landroid/widget/Spinner;
...
.method public final b()V
    ...
    .prologue
    .line 342
    iget-object v0, p0, Lbbx;->v:Landroid/widget/TextView;
...
.method public final c()V
    ...
    iget-object v1, p0, Lbbx;->q:Ljava/lang/String;
...
.method public final f()Landroid/content/Loader;
    ...
    iget-object v1, p0, Lbbx;->a:Landroid/content/Context;

    iget-object v2, p0, Lbbx;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    iget v3, p0, Lbbx;->c:I

    .line 1377
    invoke-direct {v0, v1, v2, v3}, Lbcb;-><init>(Landroid/content/Context;Lcom/android/email/activity/setup/SetupDataFragment;I)V
...
.method public final g()I
    ...
    .line 446
    iget-object v0, p0, Lbbx;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    .line 449
    iget-object v0, p0, Lbbx;->B:Landroid/widget/Switch;
    ...
    invoke-virtual {p0, v1, v3}, Lbbx;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 451
    if-eqz v0, :cond_0

    .line 452
    iget-object v0, p0, Lbbx;->w:Landroid/widget/EditText;
    ...
    .line 453
    iget-object v1, p0, Lbbx;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 459
    :goto_0
    iget-object v0, p0, Lbbx;->y:Landroid/widget/EditText;
    ...
    .line 462
    :try_start_0
    iget-object v0, p0, Lbbx;->A:Landroid/widget/EditText;
    ...
    invoke-virtual {p0, v0, v4}, Lbbx;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v5}, Lbbx;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 472
    iget-object v4, p0, Lbbx;->i:Ljava/lang/String;
...
.method protected final j()Landroid/widget/TextView;
    ...
    .prologue
    .line 485
    iget-object v0, p0, Lbbx;->D:Landroid/widget/TextView;
...
.method protected final k()Landroid/widget/TextView;
    ...
    .prologue
    .line 490
    iget-object v0, p0, Lbbx;->E:Landroid/widget/TextView;
...
.method protected final l()Landroid/widget/LinearLayout;
    ...
    .prologue
    .line 495
    iget-object v0, p0, Lbbx;->z:Landroid/support/design/widget/TextInputLayout;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {v5, v6, v7}, Lbfs;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lbbx;->a:Landroid/content/Context;
    ...
    .line 3277
    iget-object v3, p0, Lbbx;->g:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    iget-object v4, p0, Lbbx;->g:Lcom/android/email/activity/setup/SetupDataFragment;

    .line 7203
    iget-object v4, v4, Lcom/android/email/activity/setup/SetupDataFragment;->d:Landroid/os/Bundle;

    .line 3279
    invoke-static {v3, v0, v4}, Lbln;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/HostAuth;Landroid/os/Bundle;)V
    ...
    .line 3290
    iget-object v4, p0, Lbbx;->w:Landroid/widget/EditText;

    invoke-virtual {v4, v3}, Landroid/widget/EditText;->setText(Ljava/lang/CharSequence;)V

    .line 3291
    iget-object v3, p0, Lbbx;->B:Landroid/widget/Switch;
    ...
    invoke-static {v3}, Lbfj;->a(Landroid/content/Context;)Lbfj;

    move-result-object v3

    invoke-virtual {v3}, Lbfj;->b()Z

    move-result v3

    .line 3296
    iget-object v4, p0, Lbbx;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 3300
    iget-object v4, p0, Lbbx;->C:Landroid/widget/Spinner;

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-static {v4, v3}, Lbfs;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V
    ...
    .line 3304
    iget-object v4, p0, Lbbx;->y:Landroid/widget/EditText;
    ...
    .line 3309
    iget-object v4, p0, Lbbx;->A:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbbx;->e:Lcom/android/emailcommon/provider/HostAuth;

    .line 3319
    invoke-virtual {v3}, Landroid/os/Parcel;->recycle()V

    .line 3321
    iput-boolean v1, p0, Lbbx;->F:Z

    .line 3322
    invoke-virtual {p0}, Lbbx;->q()V
    ...
    .line 1267
    invoke-virtual {p0}, Lbbx;->a()Z

    move-result v3

    invoke-virtual {p0, v0, v3}, Lbbx;->a(Lcom/android/emailcommon/provider/HostAuth;Z)V

    goto/16 :goto_2

    .line 3311
    :cond_b
    invoke-virtual {p0}, Lbbx;->r()V
...
.method public final onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    .line 360
    :goto_0
    invoke-virtual {p0}, Lbbx;->getView()Landroid/view/View;

    move-result-object v1

    sget v2, Lays;->J:I

    invoke-static {v1, v2, v0}, Lazb;->a(Landroid/view/View;II)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lbbx;->F:Z

    .line 108
    :cond_0
    const-string v0, "smtp"

    iput-object v0, p0, Lbbx;->i:Ljava/lang/String;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lbbx;->v:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbbx;->w:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbbx;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    iput-object v0, p0, Lbbx;->y:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbbx;->z:Landroid/support/design/widget/TextInputLayout;
    ...
    iput-object v0, p0, Lbbx;->A:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbbx;->B:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Lbbx;->C:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lbbx;->D:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbbx;->E:Landroid/widget/TextView;
    ...
    .line 156
    iget-object v0, p0, Lbbx;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    invoke-direct {v2, p0}, Lbby;-><init>(Lbbx;)V
    ...
    invoke-direct {v0, p0}, Lbca;-><init>(Lbbx;)V

    .line 193
    iget-object v2, p0, Lbbx;->w:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 194
    iget-object v2, p0, Lbbx;->y:Landroid/widget/EditText;

    invoke-virtual {v2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 195
    iget-object v2, p0, Lbbx;->A:Landroid/widget/EditText;
    ...
    .line 201
    invoke-virtual {p0, v1}, Lbbx;->a(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lbbx;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;IIZ)Landroid/view/View;
...
.method final q()V
    ...
    .line 331
    invoke-static {v2}, Lbsb;->b(Landroid/widget/TextView;)Z
    ...
    invoke-static {v2}, Lbsb;->a(Landroid/widget/TextView;)Z
    ...
    iget-object v2, p0, Lbbx;->x:Lcom/android/email/activity/setup/AuthenticationView;
    ...
    .line 337
    :goto_2
    invoke-virtual {p0, v0}, Lbbx;->a(Z)V
...
.method final r()V
    ...
    .line 374
    iget-object v1, p0, Lbbx;->A:Landroid/widget/EditText;
...
.method public final t()V
    ...
    invoke-virtual {p0, v0, v1}, Lbbx;->startActivityForResult(Landroid/content/Intent;I)V
