...
.method public constructor <init>(Landroid/content/Context;Leaj;Landroid/accounts/Account;[Ljava/lang/String;)V
    .locals 0
    ...
    .line 2
    iput-object p3, p0, Lebr;->d:Landroid/accounts/Account;

    .line 3
    iput-object p2, p0, Lebr;->b:Leaj;
...
.method private final a()Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;
    ...
    .line 17
    iget-object v0, p0, Lebr;->c:[Ljava/lang/String;
    ...
    .line 18
    iget-object v6, p0, Lebr;->c:[Ljava/lang/String;
    ...
    .line 20
    iget-object v0, v0, Leal;->c:Landroid/util/LruCache;
    ...
    iget-object v8, p0, Lebr;->c:[Ljava/lang/String;
    ...
    .line 26
    invoke-static {v0, v4, v6}, Lcvc;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I

    .line 27
    iget-object v4, p0, Lebr;->b:Leaj;

    iget-object v6, p0, Lebr;->d:Landroid/accounts/Account;
    ...
    .line 29
    invoke-interface {v4, v6, v0}, Leaj;->a(Landroid/accounts/Account;[Ljava/lang/String;)Ljava/util/Map;
    :try_end_0
    ...
    .line 38
    sget-object v6, Lebr;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lebr;->d:Landroid/accounts/Account;
    ...
    invoke-static {v2, v0, v4, v5}, Lcvc;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I

    .line 33
    new-instance v0, Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;

    iget-object v2, p0, Lebr;->d:Landroid/accounts/Account;
    ...
    iget-object v1, p0, Lebr;->c:[Ljava/lang/String;

    aget-object v1, v1, v3

    invoke-virtual {v0, v1}, Leal;->a(Ljava/lang/String;)Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;
...
.method private final a(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;)V
    ...
    .prologue
    .line 48
    invoke-virtual {p0}, Lebr;->isReset()Z
    ...
    .line 50
    :cond_1
    invoke-virtual {p0}, Lebr;->isStarted()Z
...
.method public final synthetic deliverResult(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lebr;->a(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;)V
...
.method public final synthetic loadInBackground()Ljava/lang/Object;
    ...
    .prologue
    .line 56
    invoke-direct {p0}, Lebr;->a()Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;
...
.method protected final onReset()V
    ...
    .line 54
    invoke-virtual {p0}, Lebr;->onStopLoading()V
...
.method protected final onStartLoading()V
    ...
    .line 10
    invoke-direct {p0, v0}, Lebr;->a(Lcom/google/android/apps/gmail/featurelibraries/addons/impl/ContextualAddonCollection;)V

    .line 11
    :cond_0
    invoke-virtual {p0}, Lebr;->takeContentChanged()Z
    ...
    .line 12
    :cond_1
    invoke-virtual {p0}, Lebr;->forceLoad()V
