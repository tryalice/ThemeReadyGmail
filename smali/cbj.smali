...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ContentResolver;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;Ljava/lang/String;)V
    ...
    .line 3
    iput-object p2, p0, Lcbj;->c:Landroid/content/ContentResolver;

    .line 4
    iput-object p4, p0, Lcbj;->d:Lcom/android/emailcommon/provider/Mailbox;

    .line 5
    iput-object p5, p0, Lcbj;->e:Lcom/android/emailcommon/provider/Account;

    .line 6
    iput-object p6, p0, Lcbj;->f:Ljava/lang/String;
...
.method private final a()Z
    ...
    invoke-virtual {p0, v0}, Lcbj;->b(I)I
    ...
    .line 21
    invoke-direct {p0}, Lcbj;->b()Z

    goto :goto_0

    .line 22
    :cond_0
    invoke-virtual {p0}, Lcbj;->i()V
...
.method private final a(Lcak;Ljava/util/ArrayList;)Z
    .locals 5
    ...
    invoke-virtual {p0, v1}, Lcbj;->b(I)I
    ...
    .line 51
    invoke-virtual {p0}, Lcbj;->g()Ljava/lang/String;
    ...
    .line 55
    iget-object v1, p0, Lcbj;->e:Lcom/android/emailcommon/provider/Account;

    iget-wide v2, v1, Lcom/android/emailcommon/provider/Account;->L:J

    iput-wide v2, v0, Lbpu;->X:J
    ...
    .line 59
    invoke-virtual {p0}, Lcbj;->j()V

    .line 60
    iget v1, p0, Lcbj;->E:I

    invoke-virtual {p1, v0, v1, v4}, Lcak;->a(Lbpu;IZ)V

    .line 61
    iget-object v1, v0, Lbpu;->aF:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcbj;->f:Ljava/lang/String;

    invoke-static {v1, v2}, Lbtw;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Lbpu;->aF:Ljava/lang/String;

    .line 63
    :cond_2
    iget-object v1, p0, Lcbj;->d:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 65
    invoke-virtual {v0, p2}, Lbpu;->a(Ljava/util/ArrayList;)V
...
.method private final b()Z
    ...
    iget-object v0, p0, Lcbj;->b:Landroid/content/Context;

    iget-object v2, p0, Lcbj;->d:Lcom/android/emailcommon/provider/Mailbox;

    iget-object v3, p0, Lcbj;->e:Lcom/android/emailcommon/provider/Account;

    invoke-direct {v1, p0, v0, v2, v3}, Lcak;-><init>(Lcom/android/exchange/adapter/Parser;Landroid/content/Context;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;)V
    ...
    invoke-virtual {p0, v3}, Lcbj;->b(I)I
    ...
    .line 33
    invoke-direct {p0, v1, v2}, Lcbj;->a(Lcak;Ljava/util/ArrayList;)Z
    ...
    :cond_3
    :try_start_0
    iget-object v1, p0, Lcbj;->c:Landroid/content/ContentResolver;
    ...
    .line 36
    sget-object v1, Lcbj;->a:Ljava/lang/String;
    ...
    sget-object v0, Lcbj;->a:Ljava/lang/String;
...
.method public final d()Z
    ...
    .line 8
    invoke-virtual {p0, v4}, Lcbj;->b(I)I
