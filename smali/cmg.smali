...
# direct methods
.method constructor <init>(Lclt;Z)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lcmg;->b:Lclt;

    iput-boolean p2, p0, Lcmg;->a:Z
...
.method public final a()V
    ...
    .line 6
    iget-object v1, p0, Lcmg;->b:Lclt;

    iget-object v1, v1, Lclt;->M:Lcom/android/mail/ui/ComposeAttachmentTileGrid;
    ...
    invoke-static {v5}, Ldpm;->b(Landroid/net/Uri;)Z
    ...
    .line 16
    :cond_3
    sget-object v6, Lclt;->B:Ljava/util/concurrent/atomic/AtomicInteger;

    monitor-enter v6

    .line 17
    :try_start_0
    sget-object v0, Lclt;->B:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, v2}, Lclt;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    :try_end_1
...
.method public final a(Lcms;Lcom/android/mail/providers/Message;Lcuw;)V
    .locals 3
    ...
    .line 35
    iget-object v1, v0, Lclt;->ax:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v2, p3}, Lclt;->a(Lcom/android/mail/providers/Message;ILcuw;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcmr;->a(Lcms;Lcom/android/mail/providers/Message;Lcuw;)V
...
.method public final a(Lcms;Z)V
    .locals 5
    ...
    iget-boolean v1, p0, Lcmg;->a:Z

    invoke-virtual {v0, v1}, Lclt;->c(Z)V

    .line 60
    :goto_0
    sget-object v1, Lclt;->B:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v3, p0, Lcmg;->b:Lclt;

    const-class v4, Lcom/android/mail/compose/EmptyService;

    invoke-direct {v2, v3, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {v0, v2}, Lclt;->stopService(Landroid/content/Intent;)Z
    ...
    invoke-interface {v0, p1, p2}, Lcmr;->a(Lcms;Z)V
