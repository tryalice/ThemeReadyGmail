...
.method public constructor <init>(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)V
    ...
    .line 2
    iput-object p2, p0, Lbio;->d:Landroid/content/Context;
    ...
    iput-object v0, p0, Lbio;->i:Lcom/android/emailcommon/provider/HostAuth;

    .line 4
    return-void
.end method

.method private final f()Lbqv;
    .locals 2
    ...
    iget-object v1, p0, Lbio;->i:Lcom/android/emailcommon/provider/HostAuth;

    iget-object v1, v1, Lcom/android/emailcommon/provider/HostAuth;->b:Ljava/lang/String;

    invoke-static {v0, v1}, Lblx;->d(Landroid/content/Context;Ljava/lang/String;)Lbqv;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 21
    :try_start_0
    invoke-direct {p0}, Lbio;->f()Lbqv;

    move-result-object v0

    invoke-interface {v0, p1, p2}, Lbqv;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    :try_end_0
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {v0, p1, p2, p3}, Lbqv;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final c()Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lbio;->i:Lcom/android/emailcommon/provider/HostAuth;

    invoke-direct {v1, v3}, Lcom/android/emailcommon/service/HostAuthCompat;-><init>(Lcom/android/emailcommon/provider/HostAuth;)V

    .line 11
    invoke-interface {v2, v1}, Lbqv;->a(Lcom/android/emailcommon/service/HostAuthCompat;)Landroid/os/Bundle;
