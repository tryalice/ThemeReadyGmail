...
# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Ljava/lang/String;Lkxe;Lkxc;IILkxh;)V
    .locals 5
    ...
    .line 4
    iput-object p1, p0, Lkxk;->b:Ljava/net/HttpURLConnection;

    .line 5
    iput-object p7, p0, Lkxk;->a:Lkxh;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p3}, Lkxe;->a()Ljava/util/Set;
    ...
    .line 24
    invoke-virtual {p3, v0}, Lkxe;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private final f()Lkxf;
    ...
    .prologue
    .line 89
    invoke-direct {p0}, Lkxk;->h()V

    .line 90
    :try_start_0
    iget-object v0, p0, Lkxk;->b:Ljava/net/HttpURLConnection;
    ...
    .line 99
    iget-object v1, p0, Lkxk;->b:Ljava/net/HttpURLConnection;
    ...
    .line 107
    iget-object v9, v4, Lkxe;->a:Ljava/util/Map;
    ...
    invoke-direct {v1, v5, v0, v3}, Lkxf;-><init>(ILkxe;Ljava/io/InputStream;)V
...
.method final b()Lkxf;
    ...
    invoke-direct {p0}, Lkxk;->f()Lkxf;
    :try_end_3
    .catch Lkxy; {:try_start_3 .. :try_end_3} :catch_2
    ...
    .line 62
    :try_start_4
    iget-object v7, p0, Lkxk;->c:Lkxc;

    sub-int v8, v12, v4

    invoke-interface {v7, v6, v4, v8}, Lkxc;->a([BII)I

    move-result v7

    .line 63
    iget-wide v8, p0, Lkxk;->d:J

    int-to-long v10, v7

    add-long/2addr v8, v10

    iput-wide v8, p0, Lkxk;->d:J
    :try_end_4
