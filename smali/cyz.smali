...
.method public constructor <init>(Lcza;)V
    ...
    iput-boolean v0, p0, Lcyz;->b:Z

    .line 57
    iput-object p1, p0, Lcyz;->d:Lcza;
...
.method private final a(I)Lcom/android/mail/providers/Conversation;
    ...
    .prologue
    .line 62
    iget-object v0, p0, Lcyz;->d:Lcza;

    invoke-interface {v0}, Lcza;->p()Lcfs;
...
.method private static a(Lcfs;)Z
    .locals 1
    ...
    invoke-virtual {p0}, Lcfs;->isClosed()Z
...
.method private final b()Z
    ...
    .line 145
    invoke-static {v0}, Lcyz;->a(Lcfs;)Z
...
.method final a()I
    ...
    .line 172
    iget-object v1, p0, Lcyz;->d:Lcza;

    invoke-interface {v1}, Lcza;->p()Lcfs;

    move-result-object v1

    .line 174
    iget-boolean v2, p0, Lcyz;->b:Z

    if-nez v2, :cond_1

    .line 175
    iget-object v0, p0, Lcyz;->c:Lcom/android/mail/providers/Conversation;
    ...
    iget-object v2, p0, Lcyz;->c:Lcom/android/mail/providers/Conversation;

    if-eqz v2, :cond_0

    .line 181
    iput-boolean v6, p0, Lcyz;->b:Z

    .line 182
    invoke-virtual {v1}, Lcfs;->getCount()I

    move-result v2

    .line 183
    invoke-static {v1}, Lcyz;->a(Lcfs;)Z
    ...
    invoke-virtual {v1, v4, v5}, Lcfs;->a(J)I
    ...
    invoke-virtual {v1, v2}, Lcfs;->moveToPosition(I)Z
    ...
    iget-object v5, p0, Lcyz;->c:Lcom/android/mail/providers/Conversation;
    ...
    iput-object v2, p0, Lcyz;->c:Lcom/android/mail/providers/Conversation;

    .line 217
    iget-object v1, p0, Lcyz;->c:Lcom/android/mail/providers/Conversation;
...
.method public final a(ILjava/util/Collection;)Lcom/android/mail/providers/Conversation;
    ...
    .line 1086
    invoke-virtual {p0}, Lcyz;->a()I

    move-result v0

    .line 1087
    invoke-direct {p0}, Lcyz;->b()Z
    ...
    .line 237
    invoke-static {v1, v2, v7}, Ldmi;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 1094
    invoke-direct {p0, v2}, Lcyz;->a(I)Lcom/android/mail/providers/Conversation;
    ...
    .line 3073
    :goto_4
    iget-object v2, p0, Lcyz;->d:Lcza;

    invoke-interface {v2}, Lcza;->p()Lcfs;

    move-result-object v2

    .line 3074
    invoke-static {v2}, Lcyz;->a(Lcfs;)Z
    ...
    .line 2116
    invoke-direct {p0, v0}, Lcyz;->a(I)Lcom/android/mail/providers/Conversation;
