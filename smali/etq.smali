...
.method private final a()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Letq;->getColumnIndex(Ljava/lang/String;)I
    ...
    invoke-direct {v1, v2, v3, v0}, Letr;-><init>(JLjava/lang/Throwable;)V
    ...
    invoke-static {v2, v0, v1}, Leze;->a([BII)Ljava/lang/String;
    ...
    .line 28
    :cond_3
    invoke-virtual {p0, v1}, Letq;->getLong(I)J
    :try_end_4
...
.method public final fillWindow(ILandroid/database/CursorWindow;)V
    ...
    .prologue
    .line 34
    invoke-virtual {p0}, Letq;->getWrappedCursor()Landroid/database/Cursor;
    ...
    invoke-virtual {p0}, Letq;->getCount()I
    ...
    .line 39
    :try_start_0
    invoke-virtual {p0}, Letq;->getPosition()I
    ...
    invoke-virtual {p0, v1}, Letq;->moveToPosition(I)Z

    .line 41
    :goto_1
    invoke-virtual {p0}, Letq;->moveToNext()Z
    ...
    .line 42
    invoke-direct {p0}, Letq;->a()Ljava/lang/String;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0, v0}, Letq;->moveToPosition(I)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
