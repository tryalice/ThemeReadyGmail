...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lehb;->i:Landroid/os/Handler;
...
.method public final a()Landroid/webkit/WebView;
    ...
    .prologue
    .line 54
    iget-boolean v0, p0, Lehb;->c:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lehb;->b:Landroid/webkit/WebView;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lehb;->d:Ljava/lang/String;
    ...
    iput-object v1, p0, Lehb;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lehb;->f:Ljava/lang/String;

    .line 19
    invoke-virtual {p0}, Lehb;->a()Landroid/webkit/WebView;
    ...
    invoke-static {v0, v1}, Ldrt;->a(Landroid/webkit/WebView;Landroid/content/Context;)V

    .line 29
    new-instance v1, Lehc;

    .line 30
    invoke-direct {v1, p0}, Lehc;-><init>(Lehb;)V

    .line 31
    invoke-virtual {v0, v1}, Landroid/webkit/WebView;->setWebViewClient(Landroid/webkit/WebViewClient;)V

    .line 32
    iget-object v0, p0, Lehb;->d:Ljava/lang/String;

    if-eqz v0, :cond_0

    .line 33
    iget-object v0, p0, Lehb;->g:Lddu;

    .line 34
    invoke-virtual {v0, v4, v5}, Lddu;->a(ZLcom/android/mail/providers/Folder;)V

    .line 35
    invoke-virtual {p0}, Lehb;->getLoaderManager()Landroid/app/LoaderManager;

    move-result-object v0

    iget-object v1, p0, Lehb;->h:Lehd;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lehb;->b:Landroid/webkit/WebView;

    .line 10
    const/4 v0, 0x1

    iput-boolean v0, p0, Lehb;->c:Z

    .line 11
    new-instance v0, Lddu;

    iget-object v2, p0, Lehb;->i:Landroid/os/Handler;

    invoke-direct {v0, p0, v2}, Lddu;-><init>(Landroid/app/Fragment;Landroid/os/Handler;)V

    iput-object v0, p0, Lehb;->g:Lddu;
