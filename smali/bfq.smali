...
.method public final a(Landroid/net/Uri;)V
    ...
    .prologue
    .line 5
    iget-object v0, p0, Lbfq;->b:Landroid/content/Context;
    ...
    .line 6
    sget-object v2, Lcss;->n:[Ljava/lang/String;
    ...
    .line 23
    invoke-static {v0, v4, v5}, Lcgs;->a(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v0

    .line 24
    iget-object v4, p0, Lbfq;->b:Landroid/content/Context;
    ...
    iget-object v7, p0, Lbfq;->b:Landroid/content/Context;
    ...
    iget-object v8, p0, Lbfq;->b:Landroid/content/Context;
    ...
    iget-object v9, p0, Lbfq;->b:Landroid/content/Context;
    ...
    iget-object v10, p0, Lbfq;->b:Landroid/content/Context;
    ...
    invoke-direct {v7, v8, v9, v6}, Lgt;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    iget-object v11, p0, Lbfq;->b:Landroid/content/Context;
    ...
    invoke-direct {v8, v9, v10, v6}, Lgt;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v9}, Lgz;-><init>()V

    .line 52
    invoke-static {v3}, Lha;->e(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v10

    iput-object v10, v9, Lgz;->e:Ljava/lang/CharSequence;

    .line 56
    invoke-static {v2}, Lha;->e(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v10

    iput-object v10, v9, Lgz;->f:Ljava/lang/CharSequence;

    .line 57
    const/4 v10, 0x1

    iput-boolean v10, v9, Lgz;->g:Z
    ...
    .line 61
    invoke-virtual {v9, v0}, Lgz;->a(Ljava/lang/CharSequence;)Lgz;
    ...
    invoke-direct {v0, v10, v11}, Lha;-><init>(Landroid/content/Context;B)V

    sget v10, Lasj;->o:I

    .line 63
    invoke-virtual {v0, v10}, Lha;->a(I)Lha;
    ...
    .line 64
    invoke-static {v10}, Ldok;->b(Landroid/content/Context;)I
    ...
    .line 68
    invoke-virtual {v0, v3}, Lha;->a(Ljava/lang/CharSequence;)Lha;

    move-result-object v0

    .line 69
    invoke-virtual {v0, v2}, Lha;->b(Ljava/lang/CharSequence;)Lha;

    move-result-object v0

    .line 70
    invoke-virtual {v0, v9}, Lha;->a(Lho;)Lha;
    ...
    .line 76
    invoke-virtual {v0, v7}, Lha;->a(Lgt;)Lha;

    move-result-object v0

    .line 77
    invoke-virtual {v0, v8}, Lha;->a(Lgt;)Lha;
    ...
    .line 79
    invoke-virtual {v0, v2}, Lha;->a(Landroid/app/PendingIntent;)Lha;
    ...
    .line 83
    invoke-static {v2}, Lcpe;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 84
    iget-object v3, p0, Lbfq;->b:Landroid/content/Context;
    ...
    .line 88
    :cond_5
    iput-object v2, v0, Lha;->H:Ljava/lang/String;
