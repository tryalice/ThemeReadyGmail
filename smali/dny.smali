...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldny;->g:Ljava/util/List;
...
.method public onBuildHeaders(Ljava/util/List;)V
    ...
    .prologue
    .line 24
    iget-object v0, p0, Ldny;->g:Ljava/util/List;
    ...
    .line 25
    invoke-virtual {p0}, Ldny;->a()Landroid/preference/PreferenceActivity$Header;
    ...
    .line 29
    iget-object v2, v0, Ldqu;->a:Lcom/android/mail/providers/Folder;
    ...
    .line 32
    iget-object v4, v0, Ldqu;->c:Ljava/lang/String;
    ...
    invoke-static {v4}, Ldti;->b(Landroid/net/Uri;)Z
    ...
    .line 35
    :goto_1
    invoke-virtual {p0, v3, v2}, Ldny;->a(Landroid/preference/PreferenceActivity$Header;Lcom/android/mail/providers/Folder;)V
    ...
    invoke-static {v0, p0}, Ldqt;->a(Ljava/lang/String;Landroid/content/Context;)Landroid/text/SpannableStringBuilder;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 8
    invoke-virtual {p0}, Ldny;->getIntent()Landroid/content/Intent;
    ...
    iput-object v0, p0, Ldny;->e:Lcom/android/mail/providers/Account;
    ...
    iput-object v0, p0, Ldny;->d:Landroid/net/Uri;

    .line 11
    iget-object v0, p0, Ldny;->d:Landroid/net/Uri;

    if-eqz v0, :cond_0

    .line 12
    invoke-virtual {p0}, Ldny;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    .line 13
    invoke-direct {v3, p0}, Ldnz;-><init>(Ldny;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 42
    invoke-virtual {p0}, Ldny;->onBackPressed()V
    ...
    :cond_0
    invoke-super {p0, p1}, Ldnw;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
