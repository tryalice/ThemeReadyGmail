...
.field public static final h:Lgcv;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfkg;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lfkg;->e:Ljava/lang/String;
    ...
    sput-object v0, Lfkg;->f:Landroid/content/ComponentName;
    ...
    sput-object v0, Lfkg;->g:Landroid/content/ComponentName;
    ...
    invoke-direct {v1, v2, v0}, Lgcv;-><init>(Ljava/lang/String;[Ljava/lang/String;)V

    .line 13
    sput-object v1, Lfkg;->h:Lgcv;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lfkj;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-static {p0}, Lfsp;->a(Landroid/content/Context;)Lfsp;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lfsp;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lful;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lfkj;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lfsp;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    ...
    .line 6
    invoke-virtual {v3, v4, v5}, Lgcv;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1, v2}, Lgcv;->a(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method static a(Landroid/accounts/Account;)V
    ...
    :cond_1
    sget-object v1, Lfkg;->c:[Ljava/lang/String;
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lfpi;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lfkk;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lfpf;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lfke;-><init>(Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p1}, Lfkg;->a(Landroid/accounts/Account;)V
    ...
    sget-object v2, Lfkg;->e:Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lfkh;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object v0, Lfkg;->f:Landroid/content/ComponentName;

    invoke-static {p0, v0, v1}, Lfkg;->a(Landroid/content/Context;Landroid/content/ComponentName;Lfkj;)Ljava/lang/Object;
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 1
    invoke-static {p0}, Lfpe;->c(Landroid/content/Context;)V

    invoke-static {p0}, Lfrj;->a(Ljava/lang/Object;)Ljava/lang/Object;
