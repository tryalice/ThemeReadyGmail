...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;ILcom/android/mail/providers/Folder;)V
    ...
    iput-object v0, p0, Ldfm;->a:Ljava/util/List;
    ...
    iput-object v0, p0, Ldfm;->b:Landroid/view/LayoutInflater;

    .line 10
    iput p3, p0, Ldfm;->c:I

    .line 11
    iput-object p4, p0, Ldfm;->d:Lcom/android/mail/providers/Folder;

    .line 12
    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Ldfm;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V
    ...
    .line 5
    invoke-direct {p0, p2, p3}, Ldfm;->a(Landroid/database/Cursor;Ljava/util/Set;)V
...
.method private final a(Landroid/database/Cursor;Ljava/util/Set;)V
    ...
    invoke-direct {v6, v5, v1}, Ldpg;-><init>(Lcom/android/mail/providers/Folder;Z)V

    .line 25
    invoke-interface {v0, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 26
    invoke-virtual {p0, v5}, Ldfm;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v1

    if-eqz v1, :cond_2

    iget-object v1, p0, Ldfm;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v5, v1}, Ljhi;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 33
    iget-object v6, v1, Ldpg;->a:Lcom/android/mail/providers/Folder;

    .line 35
    invoke-virtual {p0, v6}, Ldfm;->a(Lcom/android/mail/providers/Folder;)Z

    move-result v7

    if-eqz v7, :cond_4

    iget-object v7, p0, Ldfm;->d:Lcom/android/mail/providers/Folder;

    invoke-static {v6, v7}, Ljhi;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 39
    :cond_6
    iget-object v0, p0, Ldfm;->a:Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 52
    iget-object v0, p0, Ldfm;->b:Landroid/view/LayoutInflater;
    ...
    .line 54
    :cond_0
    invoke-virtual {p0, p1}, Ldfm;->getItem(I)Ljava/lang/Object;
    ...
    .line 56
    iget-object v3, v0, Ldpg;->a:Lcom/android/mail/providers/Folder;

    .line 58
    iget-object v1, v0, Ldpg;->c:Ljava/lang/String;
