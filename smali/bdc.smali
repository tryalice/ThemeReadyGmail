...
.method private static a(Landroid/content/Context;Lbdd;)V
    .locals 4

    .prologue
    .line 84
    iget-wide v0, p1, Lbdd;->a:J
...
.method private final a(Landroid/content/Context;Lbdd;Lcom/android/emailcommon/provider/Account;Z)V
    .locals 10
    ...
    .line 47
    :try_start_0
    iget-object v1, p2, Lbdd;->b:Ljava/lang/String;

    invoke-static {v1}, Lbde;->a(Ljava/lang/String;)Lbde;

    move-result-object v1

    .line 48
    iget-object v2, p2, Lbdd;->b:Ljava/lang/String;

    iget-object v3, p2, Lbdd;->d:Ljava/lang/String;

    .line 50
    invoke-static {p1}, Lbcp;->a(Landroid/content/Context;)Lbcp;

    move-result-object v4

    invoke-virtual {v4, v2}, Lbcp;->c(Ljava/lang/String;)Lbjq;
    ...
    :goto_0
    invoke-direct {v3, v1}, Lbkn;-><init>(Ljava/lang/String;)V

    throw v3
    :try_end_0
    .catch Lbkn; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v1, p2, Lbdd;->c:Ljava/lang/String;

    .line 72
    const-string v1, ""

    iput-object v1, p2, Lbdd;->d:Ljava/lang/String;

    .line 73
    iput-wide v8, p2, Lbdd;->e:J

    .line 74
    invoke-static {p1, p2}, Lbdc;->a(Landroid/content/Context;Lbdd;)V

    .line 75
    iget-object v1, p0, Lbdc;->c:Ljava/util/Map;

    iget-wide v2, p2, Lbdd;->a:J
    ...
    iget-object v3, p2, Lbdd;->b:Ljava/lang/String;
    ...
    :try_end_1
    .catch Lbkn; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-direct {v1, v2}, Lbkn;-><init>(Ljava/lang/String;)V

    throw v1
    :try_end_2
    .catch Lbkn; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :cond_3
    :try_start_3
    invoke-virtual {v1, p1, v4, v3}, Lbde;->b(Landroid/content/Context;Lbjq;Ljava/lang/String;)Lorg/apache/http/client/methods/HttpPost;
    ...
    .line 59
    invoke-virtual {v1, v3, v2, v4}, Lbde;->a(Lorg/apache/http/client/methods/HttpPost;Ljava/lang/String;Ljava/lang/String;)Lbdf;

    move-result-object v1

    .line 61
    iget-object v2, v1, Lbdf;->a:Ljava/lang/String;

    iput-object v2, p2, Lbdd;->c:Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v5}, Lced;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_3
    .catch Lbkn; {:try_start_3 .. :try_end_3} :catch_0
...
.method private final c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbdd;
    .locals 4
    ...
    invoke-direct {v0, v2, v3, v1}, Lbdd;-><init>(JLcom/android/emailcommon/provider/Credential;)V
...
.method public final a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    .line 10
    :try_start_0
    invoke-direct {p0, p1, p2}, Lbdc;->c(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Lbdd;
    ...
    invoke-direct {p0, p1, v2, p2, v0}, Lbdc;->a(Landroid/content/Context;Lbdd;Lcom/android/emailcommon/provider/Account;Z)V

    .line 16
    :cond_0
    iget-object v0, v2, Lbdd;->c:Ljava/lang/String;
...
.method public final b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1, v6, p2, v0}, Lbdc;->a(Landroid/content/Context;Lbdd;Lcom/android/emailcommon/provider/Account;Z)V

    .line 26
    iget-object v0, v6, Lbdd;->c:Ljava/lang/String;
