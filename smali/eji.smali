...
.method private static a(Landroid/content/Context;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    :try_start_3
    sget-object v2, Leji;->a:Ljava/lang/String;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 5
    invoke-virtual {v2, v3, v0}, Lffu;->a(Lfff;Lffh;)Lffu;
    ...
    .line 8
    :try_start_0
    invoke-virtual {v3}, Lfft;->c()Lcom/google/android/gms/common/ConnectionResult;
    ...
    .line 18
    invoke-interface {v2, v3, p3, v0}, Lgjn;->a(Lfft;Ljava/lang/String;Lgjo;)Lffx;
    ...
    invoke-virtual {v0, v4, v5, v2}, Lffx;->a(JLjava/util/concurrent/TimeUnit;)Lfga;
    ...
    invoke-static {p1, v4}, Ldos;->a(Landroid/content/Context;[Ljava/lang/String;)Z
    ...
    invoke-static {v0, v4, v5}, Lcrh;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_2
    ...
    :cond_5
    :try_start_3
    invoke-static {p1, v0}, Lgmi;->a(Landroid/content/Context;Lgmp;)Landroid/net/Uri;
    ...
    invoke-static {p1, v4, v0}, Leji;->a(Landroid/content/Context;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    .line 53
    sget-object v5, Lgkf;->g:Lgjx;

    .line 54
    invoke-interface {v5, v3, v4, v0}, Lgjx;->a(Lfft;Lcom/google/android/gms/people/model/AvatarReference;Lgjy;)Lffx;
    ...
    invoke-virtual {v0, v4, v5, v6}, Lffx;->a(JLjava/util/concurrent/TimeUnit;)Lfga;
    ...
    .line 60
    sget-object v5, Leji;->a:Ljava/lang/String;
    ...
    .line 62
    invoke-static {v4}, Leuy;->a(Landroid/os/ParcelFileDescriptor;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v0, v4}, Lcrh;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_3
