...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhno;->a:Ljava/nio/charset/Charset;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object v0, p0, Lhno;->c:Landroid/content/Context;
    ...
    invoke-direct {v0, p2}, Ljsk;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    invoke-direct {v0, p2}, Ljsj;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
# virtual methods
.method final a(Landroid/net/Uri;[BLjava/util/Map;Z)Lhoc;
    .locals 10
    ...
    .line 26
    iget-object v3, p0, Lhno;->c:Landroid/content/Context;
    ...
    .line 63
    iput-object v3, v6, Lhoc;->b:[B

    .line 64
    iput-object v1, v6, Lhoc;->a:Ljava/nio/charset/Charset;
    ...
    .line 48
    :try_start_4
    sget-object v4, Lhno;->a:Ljava/nio/charset/Charset;
    ...
    iput-object v1, v6, Lhoc;->e:Ljava/util/Map;

    .line 57
    iget-object v1, v6, Lhoc;->e:Ljava/util/Map;
    ...
    .line 61
    :goto_6
    iput-object v1, v6, Lhoc;->f:Ljava/lang/String;
...
.method public final a(Landroid/net/Uri;Z)Ljsd;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, Lhnp;-><init>(Lhno;Landroid/net/Uri;[BLjava/util/Map;Z)V

    .line 11
    invoke-interface {v6, v0}, Ljse;->a(Ljava/util/concurrent/Callable;)Ljsd;
    ...
    invoke-direct {v2}, Lhnq;-><init>()V

    iget-object v3, p0, Lhno;->b:Ljse;

    invoke-static {v0, v1, v2, v3}, Ljrs;->a(Ljsd;Ljava/lang/Class;Ljrj;Ljava/util/concurrent/Executor;)Ljsd;
