...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldbp;->b:Ljava/util/HashMap;
...
.method protected final a(I)V
    ...
    invoke-virtual {v1, v5}, Ldhu;->getItem(I)Ljava/lang/Object;

    move-result-object v2

    .line 54
    instance-of v1, v2, Ldpg;
    ...
    .line 56
    iput-boolean v4, v1, Ldpg;->b:Z

    .line 57
    check-cast v2, Ldpg;

    .line 58
    iget-object v1, v2, Ldpg;->a:Lcom/android/mail/providers/Folder;
    ...
    iget-object v7, v7, Ldpi;->b:Landroid/net/Uri;
    ...
    iget-object v2, v0, Lcom/android/mail/providers/Folder;->f:Ldpi;
...
.method protected final a(Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 15
    iget-object v0, p0, Ldbp;->e:Ljava/util/Collection;
    ...
    .line 20
    :cond_0
    iget-object v0, p0, Ldbp;->h:Lcom/android/mail/providers/Folder;
    ...
    .line 22
    :cond_1
    invoke-static {v2}, Ljmo;->a(Ljava/util/Collection;)Ljmo;
    ...
    .line 30
    invoke-static {p2, v0, v3, v1}, Ldax;->a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;Z)Landroid/database/Cursor;
    ...
    invoke-direct {v4, p1, v0, v2, v5}, Ldax;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V

    invoke-virtual {v1, v4}, Ldhu;->a(Ldfm;)V
    ...
    invoke-direct {v3, p1, v0, v2, v4}, Ldax;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V

    invoke-virtual {v1, v3}, Ldhu;->a(Ldfm;)V
...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v2, p0, Ldbp;->e:Ljava/util/Collection;

    iget-boolean v3, p0, Ldbp;->f:Z

    const/4 v4, 0x0

    invoke-interface {v0, v1, v2, v3, v4}, Ldcl;->a(Ljava/util/Collection;Ljava/util/Collection;ZZ)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .line 4
    invoke-super {p0, p1}, Ldfj;->onCreate(Landroid/os/Bundle;)V

    .line 5
    iget-object v0, p0, Ldbp;->g:Lcom/android/mail/providers/Account;
    ...
    invoke-static {p1, v0, v2}, Ldqy;->a(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)[Landroid/os/Parcelable;
    ...
    .line 10
    iget-object v5, p0, Ldbp;->b:Ljava/util/HashMap;
    ...
    .line 12
    :cond_1
    invoke-virtual {p0}, Ldbp;->getLoaderManager()Landroid/app/LoaderManager;
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 39
    invoke-super {p0, p1}, Ldfj;->onSaveInstanceState(Landroid/os/Bundle;)V
