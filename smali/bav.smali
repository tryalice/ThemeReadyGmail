...
.field public final synthetic c:Lbau;


# direct methods
.method constructor <init>(Lbau;Lcom/android/emailcommon/provider/Account;Landroid/content/Loader;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lbav;->c:Lbau;

    iput-object p2, p0, Lbav;->a:Lcom/android/emailcommon/provider/Account;

    iput-object p3, p0, Lbav;->b:Landroid/content/Loader;
...
.method public final run()V
    ...
    .line 2
    iget-object v0, p0, Lbav;->c:Lbau;

    iget-object v1, v0, Lbau;->a:Lcom/android/email/activity/setup/AccountSecurity;
    ...
    .line 7
    :cond_1
    iget-object v0, p0, Lbav;->a:Lcom/android/emailcommon/provider/Account;
    ...
    .line 16
    iget-object v0, p0, Lbav;->b:Landroid/content/Loader;

    check-cast v0, Lbat;

    .line 17
    iget-object v2, p0, Lbav;->a:Lcom/android/emailcommon/provider/Account;

    iget-boolean v3, v0, Lbat;->b:Z

    iget-boolean v4, v0, Lbat;->c:Z

    iget-boolean v0, v0, Lbat;->d:Z
    ...
    .line 29
    invoke-virtual {v3, v4}, Lbaw;->setArguments(Landroid/os/Bundle;)V

    .line 31
    const-string v0, "password_expiration"

    invoke-virtual {v3, v2, v0}, Lbaw;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v1}, Lbax;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
