...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ContentResolver;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;Ljava/lang/String;)V
    ...
    .line 2
    iput-object p1, p0, Lcal;->b:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Lcal;->c:Landroid/content/ContentResolver;

    .line 4
    iput-object p4, p0, Lcal;->d:Lcom/android/emailcommon/provider/Mailbox;

    .line 5
    iput-object p5, p0, Lcal;->e:Lcom/android/emailcommon/provider/Account;

    .line 6
    iput-object p6, p0, Lcal;->f:Ljava/lang/String;
...
.method private final a()Z
    ...
    invoke-virtual {p0, v0}, Lcal;->b(I)I
    ...
    .line 21
    invoke-direct {p0}, Lcal;->b()Z

    goto :goto_0

    .line 22
    :cond_0
    invoke-virtual {p0}, Lcal;->i()V
...
.method private final a(Lbzm;Ljava/util/ArrayList;)Z
    .locals 5
    ...
    invoke-virtual {p0, v1}, Lcal;->b(I)I
    ...
    .line 51
    invoke-virtual {p0}, Lcal;->g()Ljava/lang/String;
    ...
    .line 55
    iget-object v1, p0, Lcal;->e:Lcom/android/emailcommon/provider/Account;
    ...
    iput v2, p1, Lcom/android/exchange/adapter/Parser;->E:I
    ...
    invoke-virtual {p1, v0, v1, v4}, Lbzm;->a(Lbov;IZ)V

    .line 61
    iget-object v1, v0, Lbov;->aF:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcal;->f:Ljava/lang/String;

    invoke-static {v1, v2}, Lbsv;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Lbov;->aF:Ljava/lang/String;

    .line 63
    :cond_2
    iget-object v1, p0, Lcal;->d:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 65
    invoke-virtual {v0, p2}, Lbov;->a(Ljava/util/ArrayList;)V
...
.method private final b()Z
    ...
    iget-object v2, p0, Lcal;->d:Lcom/android/emailcommon/provider/Mailbox;

    iget-object v3, p0, Lcal;->e:Lcom/android/emailcommon/provider/Account;

    invoke-direct {v1, p0, v0, v2, v3}, Lbzm;-><init>(Lcom/android/exchange/adapter/Parser;Landroid/content/Context;Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;)V
    ...
    invoke-virtual {p0, v3}, Lcal;->b(I)I
    ...
    .line 33
    invoke-direct {p0, v1, v2}, Lcal;->a(Lbzm;Ljava/util/ArrayList;)Z
    ...
    :cond_3
    :try_start_0
    iget-object v1, p0, Lcal;->c:Landroid/content/ContentResolver;
...
.method public final d()Z
    ...
    .line 8
    invoke-virtual {p0, v4}, Lcal;->b(I)I
