...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 3
    invoke-direct {p0, p1, p2}, Lbml;-><init>(Landroid/content/Context;Landroid/content/Intent;)V

    .line 4
    iput-object p1, p0, Lbmi;->e:Landroid/content/Context;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1, p2}, Lbml;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
...
.method private static a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;)Landroid/os/Bundle;
    ...
    .line 194
    :cond_0
    sget-object v0, Lbmi;->a:Ljava/lang/String;
    ...
    .line 196
    :cond_2
    invoke-static {v0, p0}, Lbhi;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhi;
    ...
    invoke-direct {v3, v1, v0}, Lbma;-><init>(Lcom/android/emailcommon/provider/Mailbox;Lcom/android/emailcommon/provider/Account;)V

    .line 200
    iget-object v0, v3, Lbma;->d:Lcom/android/emailcommon/provider/Mailbox;

    iget-object v0, v0, Lcom/android/emailcommon/provider/Mailbox;->d:Ljava/lang/String;

    invoke-virtual {v2, v0}, Lbhi;->a(Ljava/lang/String;)Lbox;
    ...
    invoke-virtual {v4, v0}, Lbox;->a(I)V
    ...
    .line 207
    invoke-virtual {v4, p3}, Lbox;->a(Lcom/android/emailcommon/service/SearchParams;)[Lbpb;
    ...
    .line 210
    invoke-static {v1}, Lbma;->a([Lbpb;)[Lbmd;

    move-result-object v0

    .line 211
    sget-object v1, Lbma;->b:Lsd;

    iget-object v5, v3, Lbma;->c:Lcom/android/emailcommon/provider/Account;

    iget-wide v6, v5, Lcom/android/emailcommon/provider/Account;->M:J

    invoke-virtual {v1, v6, v7, v0}, Lsd;->b(JLjava/lang/Object;)V
    ...
    invoke-static {v0, v1}, Lbro;->a(II)Landroid/os/Bundle;
    :try_end_0
    ...
    :cond_4
    :try_start_1
    sget-object v0, Lbma;->b:Lsd;

    iget-object v1, v3, Lbma;->c:Lcom/android/emailcommon/provider/Account;
    ...
    invoke-virtual {v0, v6, v7, v1}, Lsd;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v8, v8, Lbmd;->a:Lbpb;

    .line 229
    invoke-virtual {v3, p0, v8}, Lbma;->a(Landroid/content/Context;Lbpb;)Z
    ...
    invoke-direct {v1, v3, p0, p3}, Lbmc;-><init>(Lbma;Landroid/content/Context;Lcom/android/emailcommon/service/SearchParams;)V
    ...
    .line 237
    sget-object v7, Lbou;->a:Lbou;

    invoke-virtual {v6, v7}, Lbot;->add(Ljava/lang/Object;)Z

    .line 238
    sget-object v7, Lbou;->b:Lbou;

    invoke-virtual {v6, v7}, Lbot;->add(Ljava/lang/Object;)Z

    .line 239
    invoke-virtual {v4, v0, v6, v1}, Lbox;->a([Lbpb;Lbot;Lboy;)V

    .line 240
    invoke-virtual {v3, p0, v4, v0}, Lbma;->a(Landroid/content/Context;Lbox;[Lbpb;)V

    .line 241
    :cond_9
    const/4 v0, 0x0

    invoke-static {v0, v5}, Lbro;->a(II)Landroid/os/Bundle;
    :try_end_1
...
.method private static a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    ...
    .line 101
    :cond_0
    sget-object v4, Lbmi;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lbro;->a(II)Landroid/os/Bundle;
    ...
    invoke-direct {v4, v5, v8}, Lbtz;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 108
    iget-object v8, v4, Lbtz;->n:Ljava/lang/String;
    ...
    iget-object v9, v4, Lbtz;->j:Ljava/util/Set;

    invoke-static {v8, v9, v5}, Lbtz;->a(Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;)V

    .line 111
    const-string v8, "to_addresses"

    iget-object v9, v4, Lbtz;->i:Ljava/util/Set;
    ...
    iget-object v4, v4, Lbtz;->k:Ljava/util/Set;

    invoke-static {v8, v4, v5}, Lbtz;->a(Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-static {v6, v0}, Lbhi;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhi;
    :try_end_0
    ...
    invoke-virtual {v11, v4}, Lbhi;->a(Ljava/lang/String;)Lbox;
    ...
    invoke-virtual {v14, v4}, Lbox;->a(I)V
    ...
    invoke-virtual {v14, v0}, Lbox;->a(Lcom/android/emailcommon/service/SearchParams;)[Lbpb;
    ...
    .line 127
    invoke-static {v5}, Lbma;->a([Lbpb;)[Lbmd;

    move-result-object v4

    .line 128
    sget-object v5, Lbmi;->b:Lsd;

    move-wide/from16 v0, p1

    invoke-virtual {v5, v0, v1, v4}, Lsd;->b(JLjava/lang/Object;)V
    ...
    invoke-virtual {v4, v0, v1, v5}, Lsd;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v10, v10, Lbmd;->a:Lbpb;
    ...
    .line 158
    :cond_9
    new-instance v16, Lbot;

    invoke-direct/range {v16 .. v16}, Lbot;-><init>()V
    ...
    invoke-virtual {v0, v4}, Lbot;->add(Ljava/lang/Object;)Z
    ...
    invoke-direct/range {v5 .. v10}, Lbmj;-><init>(Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;JLandroid/content/Context;)V

    move-object/from16 v0, v16

    invoke-virtual {v14, v4, v0, v5}, Lbox;->a([Lbpb;Lbot;Lboy;)V

    .line 163
    invoke-virtual/range {v16 .. v16}, Lbot;->clear()V
    ...
    invoke-virtual {v0, v5}, Lbot;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v5, v7}, Lboi;->a(Lbpg;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v7}, Lbot;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v14, v10, v0, v7}, Lbox;->a([Lbpb;Lbot;Lboy;)V
    :try_end_3
    ...
    invoke-static {v0, v1, v6, v12, v5}, Lblf;->a(Landroid/content/Context;Lbpb;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    :try_end_4
    ...
    invoke-static {v4, v15}, Lbro;->a(II)Landroid/os/Bundle;
...
.method public final a(JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    ...
    .line 8
    iget-object v0, p0, Lbmi;->e:Landroid/content/Context;

    invoke-static {v0, p1, p2, p3}, Lbmi;->a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;)Landroid/os/Bundle;
    ...
    invoke-static/range {v0 .. v5}, Lbmi;->a(Landroid/content/Context;JLcom/android/emailcommon/service/SearchParams;J)Landroid/os/Bundle;
    :try_end_0
    ...
    .line 12
    sget-object v1, Lbmi;->a:Ljava/lang/String;
    ...
    .line 14
    invoke-static {v0}, Lblt;->a(Lcom/android/emailcommon/mail/MessagingException;)I

    move-result v0

    .line 15
    invoke-static {v0, v6}, Lbro;->a(II)Landroid/os/Bundle;
...
.method public final a(Lbrx;JJZ)V
    ...
    iget-object v2, v0, Lbmi;->e:Landroid/content/Context;
    ...
    invoke-interface/range {v3 .. v9}, Lbrx;->a(JJII)V
    ...
    .line 24
    invoke-static {v2, v6, v7}, Lbqg;->a(Landroid/content/Context;J)Lbqg;
    ...
    :goto_1
    :try_start_1
    sget-object v3, Lbmi;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v2, v4, v5}, Lcvc;->c(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    iget-object v4, v0, Lbmi;->e:Landroid/content/Context;
    ...
    invoke-static {v2, v14}, Lbts;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)Z
    ...
    iget-object v6, v0, Lbmi;->e:Landroid/content/Context;

    sget-object v7, Lbpo;->a:Landroid/net/Uri;
    ...
    .line 40
    invoke-static/range {v6 .. v12}, Lbuq;->a(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/Long;
    ...
    iget-object v8, v0, Lbmi;->e:Landroid/content/Context;
    ...
    .line 46
    iget-object v6, v6, Lbqg;->z:Ljava/lang/String;

    iput-object v6, v15, Lbqg;->z:Ljava/lang/String;
    ...
    .line 53
    :cond_9
    invoke-static {v3}, Lbnz;->b(Lcom/android/emailcommon/provider/Account;)I
    ...
    invoke-static {v3, v6}, Lbhi;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbhi;
    ...
    invoke-virtual {v3, v2}, Lbhi;->a(Ljava/lang/String;)Lbox;
    :try_end_3
    ...
    invoke-virtual {v10, v2}, Lbox;->a(I)V

    .line 58
    iget-object v2, v15, Lbqg;->z:Ljava/lang/String;

    invoke-virtual {v10, v2}, Lbox;->c(Ljava/lang/String;)Lbpb;
    ...
    iget-object v6, v14, Lcom/android/emailcommon/provider/Attachment;->q:Ljava/lang/String;

    invoke-virtual {v9, v3, v6}, Lboc;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3}, Lboh;-><init>()V

    .line 68
    const-string v6, "mixed"

    invoke-virtual {v3, v6}, Lboh;->a(Ljava/lang/String;)V

    .line 69
    invoke-virtual {v3, v9}, Lboh;->a(Lbor;)V
    ...
    invoke-virtual {v2, v6, v7}, Lbpb;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 71
    invoke-virtual {v2, v3}, Lbpb;->a(Lboq;)V

    .line 72
    new-instance v11, Lbot;

    invoke-direct {v11}, Lbot;-><init>()V

    .line 73
    invoke-virtual {v11, v9}, Lbot;->add(Ljava/lang/Object;)Z

    .line 74
    const/4 v3, 0x1

    new-array v12, v3, [Lbpb;
    ...
    invoke-direct/range {v3 .. v8}, Lbmk;-><init>(JJLbrx;)V

    invoke-virtual {v10, v12, v11, v3}, Lbox;->a([Lbpb;Lbot;Lboy;)V

    .line 76
    iget-object v2, v9, Lboc;->b:Lboq;
    ...
    .line 80
    iget-object v3, v9, Lboc;->b:Lboq;

    .line 81
    invoke-interface {v3}, Lboq;->g_()Ljava/io/InputStream;

    move-result-object v3

    invoke-static {v2, v3, v14}, Lbts;->a(Landroid/content/Context;Ljava/io/InputStream;Lcom/android/emailcommon/provider/Attachment;)V
