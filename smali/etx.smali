...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Letx;->c:J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Leut;Ljava/lang/String;)V
    .locals 1
    ...
    .line 3
    iput-object p3, p0, Letx;->f:Ljava/lang/String;

    .line 4
    iput-object p2, p0, Letx;->g:Leut;

    .line 5
    iget-object v0, p0, Letx;->g:Leut;

    iget-object v0, v0, Leut;->y:Landroid/database/sqlite/SQLiteDatabase;

    iput-object v0, p0, Letx;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v0, p0, Letx;->b:Ljava/lang/ThreadLocal;
...
.method private final d()Ljava/util/Set;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Letx;->b:Ljava/lang/ThreadLocal;
    ...
    iget-object v0, v0, Leua;->a:Ljava/util/Set;
...
.method final a()V
    ...
    .line 49
    iget-boolean v1, v0, Leua;->c:Z

    if-eqz v1, :cond_0

    .line 50
    iget-object v1, p0, Letx;->g:Leut;

    iget-boolean v3, v0, Leua;->d:Z

    invoke-virtual {v1, v3}, Leut;->c(Z)V

    .line 51
    :cond_0
    iput-boolean v2, v0, Leua;->c:Z

    .line 52
    iput-boolean v2, v0, Leua;->d:Z
    ...
    :goto_0
    invoke-virtual {v3, v1}, Leut;->a(Z)V
...
.method public final a(J)V
    ...
    .line 8
    iget-object v0, p0, Letx;->e:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 13
    :cond_1
    invoke-direct {p0}, Letx;->d()Ljava/util/Set;
...
.method public final a(Z)V
    ...
    .line 33
    iget-object v3, p0, Letx;->d:Landroid/content/Context;

    iget-object v4, p0, Letx;->f:Ljava/lang/String;
    ...
    .line 35
    :cond_0
    iget-object v0, p0, Letx;->d:Landroid/content/Context;
    ...
    .line 37
    invoke-virtual {p0}, Letx;->c()Ljava/util/Set;
    ...
    invoke-virtual {v1, v0}, Leut;->b(Ljava/util/Set;)V
    ...
    invoke-direct {v1, p0}, Letz;-><init>(Letx;)V

    sget-wide v2, Letx;->c:J

    .line 43
    iget-boolean v4, v0, Leut;->ao:Z

    if-nez v4, :cond_2

    iget-boolean v4, v0, Leut;->p:Z

    if-nez v4, :cond_2

    .line 44
    iget-object v0, v0, Leut;->az:Landroid/os/Handler;
...
.method final c()Ljava/util/Set;
    ...
    iget-object v0, v0, Leua;->b:Ljava/util/Set;
...
.method public final onBegin()V
    ...
    .line 18
    iget-object v0, p0, Letx;->h:Landroid/database/sqlite/SQLiteTransactionListener;
