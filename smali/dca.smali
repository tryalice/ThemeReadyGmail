...
.method private final a(I)Lcom/android/mail/providers/Conversation;
    ...
    .prologue
    .line 5
    iget-object v0, p0, Ldca;->d:Ldcb;

    invoke-interface {v0}, Ldcb;->r()Lcff;
...
.method private static a(Lcff;)Z
    .locals 1
    ...
    invoke-virtual {p0}, Lcff;->isClosed()Z
...
.method private final b()Z
    ...
    .line 12
    invoke-static {v0}, Ldca;->a(Lcff;)Z
...
.method final a()I
    ...
    .line 13
    iget-object v1, p0, Ldca;->d:Ldcb;

    invoke-interface {v1}, Ldcb;->r()Lcff;

    move-result-object v1

    .line 14
    iget-boolean v2, p0, Ldca;->b:Z

    if-nez v2, :cond_1

    .line 15
    iget-object v0, p0, Ldca;->c:Lcom/android/mail/providers/Conversation;
    ...
    iget-object v2, p0, Ldca;->c:Lcom/android/mail/providers/Conversation;

    if-eqz v2, :cond_0

    .line 18
    iput-boolean v6, p0, Ldca;->b:Z

    .line 19
    invoke-virtual {v1}, Lcff;->getCount()I

    move-result v2

    .line 20
    invoke-static {v1}, Ldca;->a(Lcff;)Z
    ...
    iput v0, v2, Lcom/android/mail/providers/Conversation;->O:I

    .line 25
    add-int/lit8 v2, v0, 0x1

    invoke-virtual {v1, v2}, Lcff;->moveToPosition(I)Z
    ...
    iget-object v3, p0, Ldca;->c:Lcom/android/mail/providers/Conversation;
    ...
    iput-object v2, p0, Ldca;->c:Lcom/android/mail/providers/Conversation;

    .line 36
    iget-object v1, p0, Ldca;->c:Lcom/android/mail/providers/Conversation;

    iput v0, v1, Lcom/android/mail/providers/Conversation;->O:I
...
.method public final a(ILjava/util/Collection;)Lcom/android/mail/providers/Conversation;
    ...
    .line 41
    invoke-virtual {p0}, Ldca;->a()I

    move-result v0

    .line 42
    invoke-direct {p0}, Ldca;->b()Z
    ...
    .line 46
    invoke-direct {p0, v2}, Ldca;->a(I)Lcom/android/mail/providers/Conversation;
    ...
    .line 58
    :goto_4
    iget-object v2, p0, Ldca;->d:Ldcb;

    invoke-interface {v2}, Ldcb;->r()Lcff;

    move-result-object v2

    .line 59
    invoke-static {v2}, Ldca;->a(Lcff;)Z
    ...
    .line 63
    invoke-direct {p0, v0}, Ldca;->a(I)Lcom/android/mail/providers/Conversation;
