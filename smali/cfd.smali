...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1}, Lbtp;-><init>(Landroid/content/Context;)V
...
.method private final a()Lcgm;
    ...
    invoke-direct {v3, v0}, Lcfe;-><init>(Ljava/util/concurrent/BlockingQueue;)V

    .line 5
    invoke-virtual {p0}, Lcfd;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v2, v4, v3, v0}, Lcgm;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Lbru;)V
    :try_end_0
...
.method public final a(Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    .line 22
    invoke-virtual {p0}, Lcfd;->e()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcgr;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcfd;->a(Landroid/accounts/Account;)Z
    ...
    const-string v3, "onPerformLoggedSync %s: push only"
    ...
    .line 42
    iget-object v1, v2, Lcgm;->c:Lbru;

    .line 43
    iget-wide v6, v0, Lcom/android/emailcommon/provider/Account;->M:J

    .line 44
    invoke-interface {v1, v6, v7, v4, v5}, Lbru;->a(JJ)V
    :try_end_1
    ...
    :goto_3
    :pswitch_0
    invoke-virtual {v2}, Lcgm;->a()V

    .line 75
    const-string v0, "Exchange"

    const-string v1, "onPerformLoggedSync %s: finished"
    ...
    invoke-interface {v1, v4, v5, p2}, Lbru;->a(JLandroid/os/Bundle;)I
    ...
    invoke-static {v0, v4, v5, v3}, Lcgs;->a(Landroid/content/Context;JZ)V
