...
# direct methods
.method constructor <init>(Lcnn;Z)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lcoa;->b:Lcnn;

    iput-boolean p2, p0, Lcoa;->a:Z
...
.method public final a()V
    ...
    .line 6
    iget-object v1, p0, Lcoa;->b:Lcnn;

    iget-object v1, v1, Lcnn;->M:Lcom/android/mail/ui/ComposeAttachmentTileGrid;
    ...
    invoke-static {v5}, Ldrt;->b(Landroid/net/Uri;)Z
    ...
    .line 17
    :cond_3
    sget-object v6, Lcnn;->B:Ljava/util/concurrent/atomic/AtomicInteger;

    monitor-enter v6

    .line 18
    :try_start_0
    sget-object v0, Lcnn;->B:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, v2}, Lcnn;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    :try_end_1
...
.method public final a(Lcom;Lcom/android/mail/providers/Message;Lcwx;)V
    .locals 3
    ...
    .line 35
    iget-object v1, v0, Lcnn;->ax:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v2, p3}, Lcnn;->a(Lcom/android/mail/providers/Message;ILcwx;)V
    ...
    .line 42
    invoke-interface {v0, p1, p2, p3}, Lcol;->a(Lcom;Lcom/android/mail/providers/Message;Lcwx;)V
...
.method public final a(Lcom;Z)V
    .locals 5
    ...
    iget-boolean v1, p0, Lcoa;->a:Z

    invoke-virtual {v0, v1}, Lcnn;->c(Z)V

    .line 60
    :goto_0
    sget-object v1, Lcnn;->B:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v3, p0, Lcoa;->b:Lcnn;

    const-class v4, Lcom/android/mail/compose/EmptyService;

    invoke-direct {v2, v3, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {v0, v2}, Lcnn;->stopService(Landroid/content/Intent;)Z
    ...
    .line 67
    invoke-interface {v0, p1, p2}, Lcol;->a(Lcom;Z)V
