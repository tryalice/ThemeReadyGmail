...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmkq;->d:Ljava/security/SecureRandom;

    .line 66
    const/4 v0, 0x1

    sput-boolean v0, Lmkq;->e:Z
...
.method private constructor <init>(J)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lmgw;-><init>(Ljava/nio/channels/SelectableChannel;J)V

    .line 2
    const/4 v0, 0x0

    iput-boolean v0, p0, Lmkq;->f:Z
...
.method private final a(Ljava/net/SocketAddress;)V
    ...
    .line 12
    :cond_1
    iget-object v1, p0, Lmkq;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 14
    :try_start_1
    sget-object v2, Lmkq;->d:Ljava/security/SecureRandom;
    ...
    iput-boolean v2, p0, Lmkq;->f:Z
    :try_end_1
    .catch Ljava/net/SocketException; {:try_start_1 .. :try_end_1} :catch_0

    .line 23
    :cond_2
    iget-boolean v0, p0, Lmkq;->f:Z
    ...
    .line 26
    iget-object v0, p0, Lmkq;->b:Ljava/nio/channels/SelectionKey;
...
.method private final a(I)[B
    ...
    .line 32
    iget-object v2, p0, Lmkq;->b:Ljava/nio/channels/SelectionKey;
    ...
    iget-wide v4, p0, Lmkq;->a:J

    invoke-static {v2, v4, v5}, Lmkq;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_0
    ...
    .line 47
    invoke-static {v1, v3}, Lmkq;->a(Ljava/lang/String;[B)V
...
.method static a(Ljava/net/SocketAddress;Ljava/net/SocketAddress;[BIJ)[B
    ...
    invoke-direct {v1, p4, p5}, Lmkq;-><init>(J)V

    .line 50
    :try_start_0
    invoke-direct {v1, p0}, Lmkq;->a(Ljava/net/SocketAddress;)V

    .line 52
    iget-boolean v0, v1, Lmkq;->f:Z
    ...
    invoke-direct {v1, v0}, Lmkq;->a(Ljava/net/SocketAddress;)V

    .line 54
    :cond_0
    iget-object v0, v1, Lmkq;->b:Ljava/nio/channels/SelectionKey;
    ...
    .line 60
    invoke-static {v2, p2}, Lmkq;->a(Ljava/lang/String;[B)V
    ...
    .line 62
    invoke-direct {v1, p3}, Lmkq;->a(I)[B
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
