...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Leqk;)V
    ...
    .line 2
    iput-object p1, p0, Leor;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Leor;->b:Leqk;

    .line 4
    iget-object v0, p0, Leor;->b:Leqk;

    .line 5
    iget-object v0, v0, Leqk;->j:Lepb;

    .line 6
    iput-object v0, p0, Leor;->c:Lepb;

    .line 7
    return-void
.end method

.method private final a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Leos;)V
    .locals 14
    ...
    invoke-static {v10, v11}, Leqk;->d(J)Z
    ...
    invoke-virtual {v0, v3, v2}, Leos;->a(ZLjava/lang/Long;)Z
    ...
    .line 130
    iget-object v3, p0, Leor;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v3, v9, v10}, Leqj;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 162
    iget-object v2, v2, Lepb;->b:Landroid/content/ContentQueryMap;

    invoke-virtual {v2}, Landroid/content/ContentQueryMap;->requery()V

    .line 163
    iget-object v2, p0, Leor;->b:Leqk;

    iget-object v2, v2, Leqk;->i:Leqm;

    invoke-interface {v2, v6}, Leqm;->a(Ljava/util/Set;)V
...
.method private final a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    iget-object v2, v0, Leor;->b:Leqk;

    iget-object v2, v2, Leqk;->e:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v3}, Leqn;->a(Ljava/util/Set;)Z
    ...
    invoke-virtual {v2, v0}, Leqn;->a(Ljava/util/Set;)Z
    ...
    iget-object v3, v0, Leor;->b:Leqk;

    move-object/from16 v0, p0

    iget-object v4, v0, Leor;->b:Leqk;

    .line 72
    invoke-virtual {v4, v14, v15}, Leqk;->c(J)Leql;
    ...
    iget-object v3, v3, Leqk;->i:Leqm;

    invoke-interface {v3, v2}, Leqm;->a(Leqn;)V
...
# virtual methods
.method final a(JIJLjava/util/Map;JLjava/util/Map;ZLeos;Landroid/util/TimingLogger;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JIJ",
    ...
    .line 10
    invoke-virtual/range {v2 .. v13}, Leor;->a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLeos;Landroid/util/TimingLogger;)Z
    ...
    .line 13
    invoke-virtual/range {v3 .. v8}, Leor;->a(JJLjava/util/Map;)V
...
.method public final a(JILjava/util/Map;Ljava/util/Map;JLjava/util/Set;Leos;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
    ...
    .line 31
    invoke-direct/range {v1 .. v11}, Leor;->a(JJLjava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;I)V
    ...
    .line 35
    invoke-direct/range {v4 .. v11}, Leor;->a(ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Leos;)V
...
.method public final a(JJLjava/util/Map;)V
    ...
    .line 47
    iget-object v0, p0, Leor;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method protected abstract a(JILjava/lang/String;Ljava/util/Map;JLjava/util/Map;ZLeos;Landroid/util/TimingLogger;)Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JI",
            "Ljava/lang/String;",
