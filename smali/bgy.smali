...
.method public static a(Landroid/content/Context;Lbkz;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    .locals 10
    ...
    .line 14
    invoke-virtual {v0, p0, v6}, Lblw;->a(Landroid/content/Context;Landroid/database/Cursor;)Lblu;
    ...
    invoke-static {p0, v2, v3}, Lblm;->a(Landroid/content/Context;J)Lblm;
    ...
    .line 27
    invoke-static {p1, v1, v2}, Lbkc;->a(Lble;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    .line 29
    invoke-static {v1}, Lbpr;->a(Ljava/util/ArrayList;)Lbps;

    move-result-object v3

    .line 30
    iget-boolean v4, v3, Lbps;->d:Z

    iget-boolean v5, v3, Lbps;->e:Z

    invoke-virtual {v0, v4, v5}, Lbme;->a(ZZ)V

    .line 31
    iget-object v4, v3, Lbps;->c:Ljava/lang/String;

    iput-object v4, v0, Lbme;->ai:Ljava/lang/String;

    .line 32
    iget-object v4, v3, Lbps;->a:Ljava/lang/String;

    iput-object v4, v7, Lblm;->f:Ljava/lang/String;

    .line 33
    iget-object v3, v3, Lbps;->b:Ljava/lang/String;

    iput-object v3, v7, Lblm;->e:Ljava/lang/String;

    .line 34
    invoke-static {v0, p0}, Lbgy;->a(Lblu;Landroid/content/Context;)V

    .line 35
    iget-wide v4, v0, Lbme;->M:J

    iput-wide v4, v7, Lblm;->d:J

    .line 36
    invoke-static {v7, p0}, Lbgy;->a(Lblu;Landroid/content/Context;)V

    .line 37
    invoke-static {p4}, Lbme;->a(I)Z
    ...
    .line 38
    invoke-static {p0, v0, v2}, Lavm;->a(Landroid/content/Context;Lbme;Ljava/util/ArrayList;)V

    .line 39
    invoke-static {p0, v0, v1}, Lavm;->b(Landroid/content/Context;Lbme;Ljava/util/ArrayList;)V
...
.method public static a(Lblu;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lblu;->a(Landroid/content/Context;Landroid/content/ContentValues;)I
    ...
    .line 62
    :cond_0
    invoke-virtual {p0, p1}, Lblu;->i(Landroid/content/Context;)Landroid/net/Uri;
