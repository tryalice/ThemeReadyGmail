...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbfe;->a:Ljava/lang/Long;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lbfe;->b:Lbmi;

    .line 3
    return-void
.end method

.method private static a(Landroid/content/Context;JZILbfh;Lcoi;)V
    .locals 13
    ...
    sput-object v2, Lbgn;->a:Ljava/io/File;
    ...
    .line 26
    invoke-static {p0, v3}, Lbfe;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Z

    move-result v5

    move-object/from16 v0, p5

    iput-boolean v5, v0, Lbfh;->c:Z
    ...
    invoke-direct {v2, p0, v3}, Lbbm;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V

    .line 50
    move/from16 v0, p3

    invoke-virtual {v2, v0}, Lbbm;->a(Z)V
    :try_end_0
    ...
    :try_start_1
    invoke-static {v2, v5}, Lcss;->a(II)I
    ...
    invoke-static {v9, p1, p2, v2, v12}, Lbkh;->a(Landroid/content/ContentResolver;JII)V
    ...
    .line 57
    invoke-static/range {v2 .. v8}, Lcom/android/email/service/ImapService;->b(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ZZLbfh;Lcoi;)I
    ...
    invoke-static {v9, p1, p2, v2, v4}, Lbkh;->a(Landroid/content/ContentResolver;JII)V

    .line 85
    move-object/from16 v0, p5

    iput-object v5, v0, Lbfh;->k:Ljava/lang/Exception;

    .line 86
    move-object/from16 v0, p5

    invoke-virtual {v0, v4}, Lbfh;->a(I)V
    ...
    .line 59
    :try_start_3
    invoke-static/range {v2 .. v8}, Lcom/android/email/service/ImapService;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ZZLbfh;Lcoi;)I
    ...
    .line 61
    invoke-static/range {v2 .. v7}, Lcom/android/email/service/Pop3Service;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;ILbfh;Lcoi;)I
    :try_end_3
...
.method static synthetic a(Lbfe;Landroid/content/Context;Landroid/accounts/Account;Landroid/os/Bundle;Landroid/content/SyncResult;)V
    .locals 16
    ...
    invoke-direct {v8, v0, v2}, Lbfh;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 101
    sget-object v2, Lbfe;->a:Ljava/lang/Long;
    ...
    .line 102
    iput-wide v2, v8, Lcsa;->s:J

    .line 104
    iget-wide v2, v8, Lcsa;->n:J
    ...
    sput-object v2, Lbfe;->a:Ljava/lang/Long;
    ...
    .line 117
    invoke-static {v6, v10, v11}, Lbje;->b(Landroid/content/ContentResolver;J)Ljava/util/Set;
    ...
    .line 122
    invoke-static {v6, v10, v11}, Lbjj;->a(Landroid/content/ContentResolver;J)Ljava/util/Set;
    ...
    invoke-static/range {v3 .. v9}, Lbfe;->a(Landroid/content/Context;JZILbfh;Lcoi;)V
    :try_end_0
    ...
    .line 181
    iput-object v2, v8, Lbfh;->k:Ljava/lang/Exception;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iput-object v2, v8, Lbfh;->j:Ljava/lang/String;
    ...
    invoke-virtual {v0, v8}, Lbfe;->a(Lbfh;)V

    .line 186
    iget-boolean v2, v8, Lbfh;->c:Z
    ...
    invoke-static {v2}, Ldmr;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 189
    iget-object v4, v8, Lbfh;->k:Ljava/lang/Exception;

    if-nez v4, :cond_14

    .line 190
    iget-boolean v4, v8, Lbfh;->c:Z
    ...
    invoke-interface {v2, v4, v5}, Lcba;->a(Ljava/lang/String;I)Z
    ...
    invoke-static {v2}, Lbbz;->b(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v3

    .line 201
    invoke-virtual/range {p0 .. p0}, Lbfe;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-static {v0, v6, v7}, Lbeh;->a(Landroid/content/Context;J)Lbkg;
    ...
    invoke-interface {v2, v6, v7}, Lbkg;->a(J)V
    ...
    invoke-static {v0, v3}, Lbfe;->a(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)Z
    ...
    iget-object v3, v8, Lbfh;->k:Ljava/lang/Exception;
    ...
    invoke-interface/range {v5 .. v10}, Lcba;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .prologue
    .line 11
    iget-object v0, p0, Lbfe;->b:Lbmi;

    invoke-virtual {v0}, Lbmi;->getSyncAdapterBinder()Landroid/os/IBinder;
...
.method public onCreate()V
    ...
    .line 8
    invoke-virtual {p0}, Lbfe;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lbff;-><init>(Lbfe;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lbfg;-><init>(Lbfe;Landroid/content/Context;)V
