...
.method protected constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, v0}, Lafm;-><init>(Landroid/content/Context;I)V

    .line 2
    new-instance v0, Landroid/support/v7/app/AlertController;

    invoke-virtual {p0}, Laeg;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p0}, Laeg;->getWindow()Landroid/view/Window;

    move-result-object v2

    invoke-direct {v0, v1, p0, v2}, Landroid/support/v7/app/AlertController;-><init>(Landroid/content/Context;Lafm;Landroid/view/Window;)V

    iput-object v0, p0, Laeg;->a:Landroid/support/v7/app/AlertController;
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    .line 13
    iget-object v6, p0, Laeg;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 20
    :goto_0
    iget-object v1, v6, Landroid/support/v7/app/AlertController;->b:Lafm;

    invoke-virtual {v1, v0}, Lafm;->setContentView(I)V
    ...
    .line 175
    sget-object v4, Lvh;->a:Lvu;

    const/4 v5, 0x3

    invoke-interface {v4, v2, v3, v5}, Lvu;->a(Landroid/view/View;II)V
    ...
    invoke-direct {v3, v6, v1, v0}, Ladv;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V

    .line 191
    iput-object v3, v2, Landroid/support/v4/widget/NestedScrollView;->A:Labs;
    ...
    invoke-direct {v3, v6, v1, v0}, Ladw;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Ladx;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v6, v1, v0}, Lady;-><init>(Landroid/support/v7/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 208
    iget-object v1, p0, Laeg;->a:Landroid/support/v7/app/AlertController;
    ...
    .line 212
    :cond_1
    invoke-super {p0, p1, p2}, Lafm;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 217
    :cond_1
    invoke-super {p0, p1, p2}, Lafm;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 9
    invoke-super {p0, p1}, Lafm;->setTitle(Ljava/lang/CharSequence;)V

    .line 10
    iget-object v0, p0, Laeg;->a:Landroid/support/v7/app/AlertController;
