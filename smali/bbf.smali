...
.method final a()V
    ...
    .line 99
    iget-object v0, p0, Lbbf;->a:Lcom/android/emailcommon/provider/Mailbox;

    invoke-static {v0}, Ljzc;->a(Ljava/lang/Object;)Ljava/lang/Object;

    .line 100
    invoke-virtual {p0}, Lbbf;->getActivity()Landroid/app/Activity;
    ...
    .line 103
    iget-object v1, p0, Lbbf;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    invoke-virtual {p0, v1}, Lbbf;->getString(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lbbf;->k:Landroid/preference/ListPreference;
    ...
    .line 108
    invoke-virtual {p0, v2, v3}, Lbbf;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method final a(Z)V
    ...
    .line 49
    iget-object v0, p0, Lbbf;->j:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v0, p1}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 50
    iget-object v0, p0, Lbbf;->k:Landroid/preference/ListPreference;
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    iput-object v1, p0, Lbbf;->e:Ldgm;

    .line 8
    iget-object v1, p0, Lbbf;->e:Ldgm;

    invoke-interface {v1, p0}, Ldgm;->a(Ldgn;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 15
    invoke-virtual {p0}, Lbbf;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v0}, Lbbf;->addPreferencesFromResource(I)V

    .line 20
    const-string v0, "folder_name"

    invoke-virtual {p0, v0}, Lbbf;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/EditTextPreference;

    iput-object v0, p0, Lbbf;->g:Landroid/preference/EditTextPreference;
    ...
    iput-object v0, p0, Lbbf;->h:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lbbf;->i:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lbbf;->j:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lbbf;->k:Landroid/preference/ListPreference;
    ...
    iput-object v0, p0, Lbbf;->l:Landroid/preference/Preference;

    .line 26
    invoke-virtual {p0}, Lbbf;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v0

    .line 27
    iget-object v1, p0, Lbbf;->g:Landroid/preference/EditTextPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 28
    iget-object v1, p0, Lbbf;->h:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 29
    iget-object v1, p0, Lbbf;->i:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 30
    iget-object v1, p0, Lbbf;->l:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 31
    iget-boolean v1, p0, Lbbf;->f:Z
    ...
    iput-object v0, p0, Lbbf;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 33
    :cond_2
    iget-object v1, p0, Lbbf;->j:Landroid/preference/CheckBoxPreference;
    ...
    .line 43
    :cond_3
    invoke-virtual {p0, v4}, Lbbf;->a(Z)V

    .line 44
    invoke-virtual {p0}, Lbbf;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    .line 45
    invoke-direct {v2, p0}, Lbbi;-><init>(Lbbf;)V
...
.method public onDestroy()V
    ...
    .line 64
    :goto_0
    iget-object v3, p0, Lbbf;->k:Landroid/preference/ListPreference;
    ...
    .line 67
    :goto_1
    iget-object v3, p0, Lbbf;->a:Lcom/android/emailcommon/provider/Mailbox;
    ...
    .line 71
    invoke-virtual {p0, v2}, Lbbf;->a(Z)V

    .line 72
    iget-object v2, p0, Lbbf;->a:Lcom/android/emailcommon/provider/Mailbox;
...
.method public onDetach()V
    ...
    .line 83
    iget-object v0, p0, Lbbf;->e:Ldgm;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Ldgm;->a(Ldgn;)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 87
    :pswitch_0
    iget-object v2, p0, Lbbf;->g:Landroid/preference/EditTextPreference;
    ...
    .line 88
    iget-object v0, p0, Lbbf;->g:Landroid/preference/EditTextPreference;
    ...
    iget-object v2, p0, Lbbf;->k:Landroid/preference/ListPreference;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 95
    :pswitch_0
    iget-object v0, p0, Lbbf;->h:Landroid/preference/CheckBoxPreference;
    ...
    iput-wide v2, p0, Lbbf;->b:J

    .line 97
    iget-object v0, p0, Lbbf;->i:Landroid/preference/Preference;
