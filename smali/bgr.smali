...
.method public static a(Landroid/content/Context;Lbku;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    .locals 10
    ...
    .line 15
    invoke-virtual {v0, p0, v6}, Lblr;->a(Landroid/content/Context;Landroid/database/Cursor;)Lblp;
    ...
    invoke-static {p0, v2, v3}, Lblh;->a(Landroid/content/Context;J)Lblh;
    ...
    .line 28
    invoke-static {p1, v1, v2}, Lbjx;->a(Lbkz;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    .line 30
    invoke-static {v1}, Lbpn;->a(Ljava/util/ArrayList;)Lbpo;

    move-result-object v3

    .line 31
    iget-boolean v4, v3, Lbpo;->d:Z

    iget-boolean v5, v3, Lbpo;->e:Z

    invoke-virtual {v0, v4, v5}, Lblz;->a(ZZ)V

    .line 32
    iget-object v4, v3, Lbpo;->c:Ljava/lang/String;

    iput-object v4, v0, Lblz;->ai:Ljava/lang/String;

    .line 33
    iget-object v4, v3, Lbpo;->a:Ljava/lang/String;

    iput-object v4, v7, Lblh;->f:Ljava/lang/String;

    .line 34
    iget-object v3, v3, Lbpo;->b:Ljava/lang/String;

    iput-object v3, v7, Lblh;->e:Ljava/lang/String;

    .line 35
    invoke-static {v0, p0}, Lbgr;->a(Lblp;Landroid/content/Context;)V

    .line 36
    iget-wide v4, v0, Lblz;->M:J

    iput-wide v4, v7, Lblh;->d:J

    .line 37
    invoke-static {v7, p0}, Lbgr;->a(Lblp;Landroid/content/Context;)V

    .line 38
    invoke-static {p4}, Lblz;->a(I)Z
    ...
    .line 39
    invoke-static {p0, v0, v2}, Laux;->a(Landroid/content/Context;Lblz;Ljava/util/ArrayList;)V

    .line 40
    invoke-static {p0, v0, v1}, Laux;->b(Landroid/content/Context;Lblz;Ljava/util/ArrayList;)V
...
.method public static a(Lblp;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lblp;->a(Landroid/content/Context;Landroid/content/ContentValues;)I
    ...
    .line 64
    :cond_0
    invoke-virtual {p0, p1}, Lblp;->i(Landroid/content/Context;)Landroid/net/Uri;
