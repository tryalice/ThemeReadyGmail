...
.method public constructor <init>()V
    ...
    .line 3
    invoke-direct {v0, p0}, Lelb;-><init>(Lekz;)V

    .line 4
    iput-object v0, p0, Lekz;->h:Lelb;
    ...
    iput-object v0, p0, Lekz;->i:Landroid/os/Handler;
...
.method public final a()Landroid/webkit/WebView;
    ...
    iget-object v0, p0, Lekz;->b:Landroid/webkit/WebView;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 15
    invoke-virtual {p0}, Lekz;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lekz;->d:Ljava/lang/String;
    ...
    .line 19
    invoke-virtual {p0}, Lekz;->a()Landroid/webkit/WebView;
    ...
    .line 28
    invoke-virtual {p0}, Lekz;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-static {v0, v1}, Ldti;->a(Landroid/webkit/WebView;Landroid/content/Context;)V
    ...
    .line 32
    iget-object v0, p0, Lekz;->d:Ljava/lang/String;

    if-eqz v0, :cond_0

    .line 33
    iget-object v0, p0, Lekz;->g:Ldfd;

    .line 34
    invoke-virtual {v0, v4, v5}, Ldfd;->a(ZLcom/android/mail/providers/Folder;)V

    .line 35
    invoke-virtual {p0}, Lekz;->getLoaderManager()Landroid/app/LoaderManager;

    move-result-object v0

    iget-object v1, p0, Lekz;->h:Lelb;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lekz;->b:Landroid/webkit/WebView;

    .line 10
    const/4 v0, 0x1

    iput-boolean v0, p0, Lekz;->c:Z

    .line 11
    new-instance v0, Ldfd;

    iget-object v2, p0, Lekz;->i:Landroid/os/Handler;

    invoke-direct {v0, p0, v2}, Ldfd;-><init>(Landroid/app/Fragment;Landroid/os/Handler;)V

    iput-object v0, p0, Lekz;->g:Ldfd;
