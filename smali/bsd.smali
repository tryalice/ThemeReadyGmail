...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lbsd;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Context;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    ...
    invoke-direct {v1, p0}, Lbsd;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lbsd;->a(JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    :try_end_0
...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-direct {v0, p0}, Lbsd;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Lbsd;->b()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Lcom/android/emailcommon/provider/Policy;)Z
    ...
    invoke-virtual {v1, p1}, Lbsd;->a(Lcom/android/emailcommon/provider/Policy;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a()V
    ...
    invoke-direct {v0, p0}, Lbsh;-><init>(Lbsd;)V

    const-string v1, "remoteWipe"

    invoke-virtual {p0, v0, v1}, Lbsd;->a(Lbtn;Ljava/lang/String;)Z
...
.method public final a(JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v0 .. v6}, Lbsf;-><init>(Lbsd;JLcom/android/emailcommon/provider/Policy;Ljava/lang/String;Z)V
...
.method public final a(JZ)V
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lbsi;-><init>(Lbsd;JZ)V
...
.method public final a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p1}, Lbsc;-><init>(Landroid/os/IBinder;)V
...
.method public final a(Lcom/android/emailcommon/provider/Policy;)Z
    ...
    invoke-direct {v0, p0, p1}, Lbse;-><init>(Lbsd;Lcom/android/emailcommon/provider/Policy;)V

    .line 15
    const-string v2, "isActive"

    invoke-virtual {p0, v0, v2}, Lbsd;->a(Lbtn;Ljava/lang/String;)Z
