...
.method protected constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Leno;)V
    ...
    .line 2
    iput-object p1, p0, Lelx;->a:Landroid/database/sqlite/SQLiteDatabase;

    .line 3
    iput-object p2, p0, Lelx;->b:Leno;
...
.method public final a(JJ)Ljava/util/Map;
    ...
    .line 55
    iget-object v0, p0, Lelx;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v1 .. v6}, Lenl;-><init>(JJZ)V
...
.method final a(JIZZ)V
    ...
    iget-object v4, v0, Lelx;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 20
    :cond_2
    new-instance v16, Lelw;

    invoke-direct/range {v16 .. v16}, Lelw;-><init>()V
    ...
    invoke-virtual {v0, v1, v2, v9, v10}, Lelx;->a(JJ)Ljava/util/Map;
    ...
    iget-object v6, v0, Lelx;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v0, Lelx;->b:Leno;

    invoke-direct {v5, v4, v6}, Lerb;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leno;)V
    ...
    .line 43
    invoke-virtual/range {v5 .. v17}, Lelv;->a(JIJLjava/util/Map;JLjava/util/Map;ZLelw;Landroid/util/TimingLogger;)V
    :try_end_3
    ...
    invoke-direct {v5, v4, v6}, Lenm;-><init>(Landroid/database/sqlite/SQLiteDatabase;Leno;)V
    :try_end_5
