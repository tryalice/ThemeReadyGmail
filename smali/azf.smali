...
# direct methods
.method public constructor <init>(Landroid/content/Context;Laze;ILcom/android/email/activity/setup/SetupDataFragment;Landroid/os/Bundle;)V
    .locals 2
    ...
    .line 380
    iput-object p1, p0, Lazf;->a:Landroid/content/Context;

    .line 381
    iput-object p2, p0, Lazf;->b:Laze;

    .line 382
    iput p3, p0, Lazf;->c:I

    .line 383
    iput-object p4, p0, Lazf;->d:Lcom/android/email/activity/setup/SetupDataFragment;

    .line 384
    iput-object p5, p0, Lazf;->e:Landroid/os/Bundle;

    .line 1183
    iget-object v0, p4, Lcom/android/email/activity/setup/SetupDataFragment;->b:Lcom/android/emailcommon/provider/Account;

    iput-object v0, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;

    .line 386
    iget-object v0, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;
    ...
    iput-object v0, p0, Lazf;->g:Ljava/lang/String;
    ...
    iput-object v0, p0, Lazf;->h:Ljava/lang/String;
    ...
    iput-object v0, p0, Lazf;->i:Ljava/lang/String;
    ...
    .line 390
    :cond_0
    iput-object v1, p0, Lazf;->g:Ljava/lang/String;

    .line 391
    iput-object v1, p0, Lazf;->h:Ljava/lang/String;
...
.method private final varargs a()Lcom/android/emailcommon/mail/MessagingException;
    ...
    .line 400
    invoke-virtual {p0}, Lazf;->isCancelled()Z
    ...
    iget-object v4, p0, Lazf;->i:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lazf;->publishProgress([Ljava/lang/Object;)V

    .line 403
    iget-object v0, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;

    iget-object v1, p0, Lazf;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lazf;->e:Landroid/os/Bundle;

    if-eqz v1, :cond_1

    .line 410
    iget-object v1, p0, Lazf;->i:Ljava/lang/String;

    iget-object v2, p0, Lazf;->h:Ljava/lang/String;

    iget-object v3, p0, Lazf;->e:Landroid/os/Bundle;

    invoke-virtual {v0, v1, v2, v3}, Lbfv;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v1}, Lazg;-><init>(Landroid/os/Bundle;)V
    :try_end_0
    ...
    iget-object v4, p0, Lazf;->a:Landroid/content/Context;

    .line 522
    invoke-static {v4, v0}, Lblo;->a(Landroid/content/Context;Lcom/android/emailcommon/mail/MessagingException;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Lbfv;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v2}, Lazf;->publishProgress([Ljava/lang/Object;)V

    .line 430
    iget-object v2, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;

    iget-object v3, p0, Lazf;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lbfv;->a(Lcom/android/emailcommon/provider/Account;Landroid/content/Context;)Lbfv;

    move-result-object v2

    .line 431
    invoke-virtual {v2}, Lbfv;->c()Landroid/os/Bundle;
    ...
    .line 448
    iget-object v6, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;
    ...
    iget-object v5, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;
    ...
    .line 458
    iget-object v5, p0, Lazf;->d:Lcom/android/email/activity/setup/SetupDataFragment;
    ...
    iget-object v4, p0, Lazf;->g:Ljava/lang/String;
    ...
    iget-object v5, p0, Lazf;->a:Landroid/content/Context;

    .line 481
    invoke-static {v5, v0}, Lblo;->a(Landroid/content/Context;Lcom/android/emailcommon/mail/MessagingException;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lazf;->g:Ljava/lang/String;
    ...
    .line 490
    iget-object v2, p0, Lazf;->a:Landroid/content/Context;

    .line 491
    invoke-static {v2, v0}, Lbkg;->e(Landroid/content/Context;Ljava/lang/String;)Lbkh;
    ...
    iget-object v3, p0, Lazf;->f:Lcom/android/emailcommon/provider/Account;

    invoke-direct {v0, v2, v3}, Lbho;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Account;)V

    .line 2647
    iget-object v2, v0, Lbho;->c:Lbhn;

    invoke-virtual {v2}, Lbhn;->e()V

    .line 2648
    invoke-virtual {v0}, Lbho;->a()V

    .line 3647
    iget-object v0, v0, Lbho;->c:Lbhn;

    invoke-virtual {v0}, Lbhn;->e()V

    .line 3648
    :cond_10
    iget-object v0, p0, Lazf;->a:Landroid/content/Context;
    ...
    invoke-interface {v0, v2, v3, v4}, Lbmb;->b(JZ)V
...
.method protected final synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 360
    invoke-direct {p0}, Lazf;->a()Lcom/android/emailcommon/mail/MessagingException;
...
.method protected final synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v2}, Laze;->a(ILcom/android/emailcommon/mail/MessagingException;)V
    ...
    :goto_1
    :sswitch_0
    iget-object v1, p0, Lazf;->b:Laze;

    .line 4059
    invoke-virtual {v1, v0, p1}, Laze;->a(ILcom/android/emailcommon/mail/MessagingException;)V
