...
.method private final a(Lcom/android/emailcommon/provider/Account;)V
    ...
    .line 60
    iget-object v0, p0, Lbco;->b:Landroid/widget/Spinner;

    invoke-virtual {v0, v2}, Landroid/widget/Spinner;->setVisibility(I)V

    .line 61
    iget-object v0, p0, Lbco;->c:Landroid/view/View;
    ...
    invoke-direct {v7, v8, v9}, Lbgk;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 82
    iget-object v2, p0, Lbco;->b:Landroid/widget/Spinner;
    ...
    invoke-static {v0, v2}, Lbgk;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 29
    :cond_0
    iget-object v4, v0, Lbkz;->z:[Ljava/lang/CharSequence;

    .line 30
    iget-object v5, v0, Lbkz;->y:[Ljava/lang/CharSequence;
    ...
    .line 42
    iget-object v4, p0, Lbco;->a:Landroid/widget/Spinner;

    invoke-virtual {v4, v1}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 43
    iget-object v1, p0, Lbco;->a:Landroid/widget/Spinner;
    ...
    invoke-static {v1, v4}, Lbgk;->a(Landroid/widget/Spinner;Ljava/lang/Object;)V

    .line 46
    :cond_2
    iget-boolean v1, v0, Lbkz;->r:Z

    if-eqz v1, :cond_3

    .line 47
    invoke-direct {p0, v3}, Lbco;->a(Lcom/android/emailcommon/provider/Account;)V

    .line 48
    :cond_3
    iget-boolean v1, v0, Lbkz;->u:Z

    if-eqz v1, :cond_4

    .line 49
    iget-object v1, p0, Lbco;->e:Landroid/widget/CheckBox;
    ...
    .line 51
    :cond_4
    iget-boolean v1, v0, Lbkz;->v:Z

    if-eqz v1, :cond_5

    .line 52
    iget-object v1, p0, Lbco;->f:Landroid/widget/CheckBox;
    ...
    invoke-static {v1}, Ldsc;->b(Ljava/lang/String;)Z
    ...
    .line 55
    iget-object v1, p0, Lbco;->h:Landroid/widget/CheckBox;
    ...
    iget-boolean v2, v0, Lbkz;->w:Z

    invoke-virtual {v1, v2}, Landroid/widget/CheckBox;->setChecked(Z)V

    .line 57
    :cond_6
    iget-boolean v0, v0, Lbkz;->x:Z

    if-nez v0, :cond_7

    .line 58
    iget-object v0, p0, Lbco;->i:Landroid/widget/CheckBox;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v5}, Lbco;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;IIZ)Landroid/view/View;
    ...
    iput-object v0, p0, Lbco;->a:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lbco;->b:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lbco;->d:Landroid/widget/CheckBox;

    .line 7
    iget-object v0, p0, Lbco;->d:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->e:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->f:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->g:Landroid/widget/CheckBox;

    .line 11
    iget-object v0, p0, Lbco;->g:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->h:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->i:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lbco;->c:Landroid/view/View;
