...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Ls;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->q:Lsg;
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->q:Lsg;
...
.method public final a()Ladv;
    ...
    .prologue
    .line 82
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Ladv;
...
.method public final a(Ladv;)V
    ...
    .line 14
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Ladv;
    ...
    .line 27
    :goto_1
    invoke-static {p0, v0}, Ltk;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 28
    :cond_0
    invoke-virtual {p1}, Ladv;->isCheckable()Z
    ...
    .line 32
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->q:Lsg;

    iget-object v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->k:Landroid/widget/CheckedTextView;

    const/16 v6, 0x800

    invoke-virtual {v0, v5, v6}, Lsg;->a(Landroid/view/View;I)V

    .line 33
    :cond_1
    invoke-virtual {p1}, Ladv;->isChecked()Z
    ...
    .line 37
    invoke-virtual {p1}, Ladv;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 44
    :goto_2
    sget-object v5, Loc;->a:Loh;

    invoke-virtual {v5, v0}, Loh;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v5}, Loc;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v5, v0, v3, v3, v3}, Lyc;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 68
    invoke-virtual {v0}, Ladv;->getActionView()Landroid/view/View;
    ...
    .line 52
    invoke-static {v0, v5, v6}, Lnm;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method protected onCreateDrawableState(I)[I
    ...
    invoke-super {p0, v0}, Ls;->onCreateDrawableState(I)[I

    move-result-object v0

    .line 85
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Ladv;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Ladv;

    invoke-virtual {v1}, Ladv;->isCheckable()Z
    ...
    invoke-virtual {v1}, Ladv;->isChecked()Z
