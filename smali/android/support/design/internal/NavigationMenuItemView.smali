...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lt;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 6
    new-instance v0, Lv;

    invoke-direct {v0, p0}, Lv;-><init>(Landroid/support/design/internal/NavigationMenuItemView;)V

    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->q:Lsq;
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->q:Lsq;
...
.method public final a()Laix;
    ...
    .prologue
    .line 80
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Laix;
...
.method public final a(Laix;)V
    ...
    .line 14
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Laix;

    .line 15
    invoke-virtual {p1}, Laix;->isVisible()Z
    ...
    .line 27
    :goto_1
    invoke-static {p0, v0}, Lvh;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 28
    :cond_0
    invoke-virtual {p1}, Laix;->isCheckable()Z
    ...
    invoke-static {v0, v5}, Lsq;->a(Landroid/view/View;I)V

    .line 33
    :cond_1
    invoke-virtual {p1}, Laix;->isChecked()Z
    ...
    .line 37
    invoke-virtual {p1}, Laix;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 39
    invoke-virtual {p1}, Laix;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v5}, Lnv;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v5, v0, v3, v3, v3}, Lact;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0}, Laix;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 66
    invoke-virtual {v0}, Laix;->getActionView()Landroid/view/View;
    ...
    .line 50
    invoke-static {v0, v5, v6}, Lnt;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method protected onCreateDrawableState(I)[I
    ...
    invoke-super {p0, v0}, Lt;->onCreateDrawableState(I)[I

    move-result-object v0

    .line 83
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Laix;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->m:Laix;

    invoke-virtual {v1}, Laix;->isCheckable()Z
    ...
    invoke-virtual {v1}, Laix;->isChecked()Z
