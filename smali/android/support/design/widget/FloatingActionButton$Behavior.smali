...
.method private final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 38
    invoke-static {p1, p2, v0}, Lce;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;I)Z
    ...
    .line 121
    invoke-static {p2, v2}, Ltk;->c(Landroid/view/View;I)V
    ...
    .line 123
    invoke-static {p2, v1}, Ltk;->d(Landroid/view/View;I)V
...
.method private final b(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 45
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Lax;

    .line 46
    invoke-virtual {p2}, Landroid/support/design/widget/FloatingActionButton;->c()Laz;

    move-result-object v3

    invoke-virtual {p2, v0}, Landroid/support/design/widget/FloatingActionButton;->a(Lax;)Lbf;

    move-result-object v4

    .line 48
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0}, Lci;->getVisibility()I
    ...
    invoke-virtual {v0}, Lci;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    sget-object v5, Lx;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v5, v3, v1, v4}, Lba;-><init>(Laz;ZLbf;)V
    ...
    invoke-virtual {v0, v3, v1}, Lci;->a(IZ)V

    .line 64
    if-eqz v4, :cond_1

    .line 65
    invoke-interface {v4}, Lbf;->b()V
    ...
    invoke-virtual {v0, v5}, Lci;->setAlpha(F)V

    .line 79
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0, v5}, Lci;->setScaleY(F)V

    .line 80
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0, v5}, Lci;->setScaleX(F)V
    ...
    sget-object v5, Lx;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v5, v3, v1, v4}, Lbb;-><init>(Laz;ZLbf;)V
    ...
    invoke-virtual {v0, v1, v1}, Lci;->a(IZ)V

    .line 90
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0, v6}, Lci;->setAlpha(F)V

    .line 91
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0, v6}, Lci;->setScaleY(F)V

    .line 92
    iget-object v0, v3, Laz;->p:Lci;

    invoke-virtual {v0, v6}, Lci;->setScaleX(F)V

    .line 93
    if-eqz v4, :cond_1

    .line 94
    invoke-interface {v4}, Lbf;->a()V
