...
.method private final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 38
    invoke-static {p1, p2, v0}, Lcc;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;I)Z
    ...
    .line 121
    invoke-static {p2, v2}, Lpw;->c(Landroid/view/View;I)V
    ...
    .line 123
    invoke-static {p2, v1}, Lpw;->d(Landroid/view/View;I)V
...
.method private final b(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 45
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Lav;

    .line 46
    invoke-virtual {p2}, Landroid/support/design/widget/FloatingActionButton;->b()Lax;

    move-result-object v3

    invoke-virtual {p2, v0}, Landroid/support/design/widget/FloatingActionButton;->a(Lav;)Lbd;

    move-result-object v4

    .line 48
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0}, Lcg;->getVisibility()I
    ...
    invoke-virtual {v0}, Lcg;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    sget-object v5, Lv;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v5, v3, v1, v4}, Lay;-><init>(Lax;ZLbd;)V
    ...
    invoke-virtual {v0, v3, v1}, Lcg;->a(IZ)V

    .line 64
    if-eqz v4, :cond_1

    .line 65
    invoke-interface {v4}, Lbd;->b()V
    ...
    invoke-virtual {v0, v5}, Lcg;->setAlpha(F)V

    .line 79
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0, v5}, Lcg;->setScaleY(F)V

    .line 80
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0, v5}, Lcg;->setScaleX(F)V
    ...
    sget-object v5, Lv;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v5, v3, v1, v4}, Laz;-><init>(Lax;ZLbd;)V
    ...
    invoke-virtual {v0, v1, v1}, Lcg;->a(IZ)V

    .line 90
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0, v6}, Lcg;->setAlpha(F)V

    .line 91
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0, v6}, Lcg;->setScaleY(F)V

    .line 92
    iget-object v0, v3, Lax;->p:Lcg;

    invoke-virtual {v0, v6}, Lcg;->setScaleX(F)V

    .line 93
    if-eqz v4, :cond_1

    .line 94
    invoke-interface {v4}, Lbd;->a()V
