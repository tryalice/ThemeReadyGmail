...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Lacm;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Lacr;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Lacs;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;
    ...
    invoke-direct {v1, v2, p0}, Labp;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Labp;

    .line 40
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Labp;

    .line 41
    iget-object v1, v1, Labp;->e:Labt;
    ...
    .line 43
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Labp;

    invoke-virtual {v1, v2}, Laac;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, v2}, Laac;->setVisibility(I)V
    ...
    invoke-interface {v1, p0, v4}, Lvx;->a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-direct {v0, p0}, Luu;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Luu;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->i:Lus;
...
.method private final a(II)Landroid/view/animation/Animation;
    ...
    invoke-direct {v0, p0, p1, p2}, Lacp;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V
    ...
    iput-object v2, v1, Laac;->a:Landroid/view/animation/Animation$AnimationListener;

    .line 118
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-virtual {v1}, Laac;->clearAnimation()V

    .line 119
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-virtual {v1, v0}, Laac;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private final a(ZZ)V
    ...
    .line 100
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    .line 101
    iput-object v1, v0, Laac;->a:Landroid/view/animation/Animation$AnimationListener;

    .line 102
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-virtual {v0}, Laac;->clearAnimation()V
    ...
    invoke-virtual {v0, v1}, Laac;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private final c()V
    ...
    .line 135
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;
...
.method private final c(F)V
    ...
    .line 270
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Labp;

    invoke-virtual {v0, v13}, Labp;->a(Z)V
    ...
    invoke-virtual {v1}, Laac;->getVisibility()I
    ...
    invoke-virtual {v1, v4}, Laac;->setVisibility(I)V
    ...
    invoke-static {v1, v10}, Lvk;->d(Landroid/view/View;F)V

    .line 284
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-static {v1, v10}, Lvk;->e(Landroid/view/View;F)V
    ...
    invoke-virtual {v1}, Labp;->getAlpha()I
    ...
    .line 297
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Labp;

    invoke-static {v12, v1}, Ljava/lang/Math;->min(FF)F

    move-result v1

    invoke-virtual {v4, v1}, Labp;->b(F)V
    ...
    invoke-virtual {v1, v4}, Labp;->a(F)V
    ...
    .line 301
    iget-object v2, v2, Labp;->e:Labt;

    invoke-virtual {v2, v1}, Labt;->c(F)V
...
.method private final d(F)V
    ...
    invoke-virtual {v0, v1}, Labp;->b(F)V
    ...
    invoke-direct {v0, p0}, Lacq;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-interface {v2, v1}, Lvx;->p(Landroid/view/View;)F
    ...
    invoke-direct {v1, p0}, Lact;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    .line 322
    iput-object v0, v1, Laac;->a:Landroid/view/animation/Animation$AnimationListener;
    ...
    invoke-virtual {v0, v4}, Labp;->a(Z)V
...
.method private final e(F)V
    ...
    invoke-virtual {v0, v1}, Labp;->setAlpha(I)V
...
.method public final a()V
    ...
    invoke-virtual {v0, v1}, Laac;->setVisibility(I)V

    .line 5
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-virtual {v0}, Laac;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v2}, Labp;->setAlpha(I)V
    ...
    invoke-virtual {v0}, Laac;->getTop()I
...
.method public final a(F)V
    ...
    invoke-static {v0, p1}, Lvk;->d(Landroid/view/View;F)V

    .line 87
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-static {v0, p1}, Lvk;->e(Landroid/view/View;F)V
...
.method public final a(IZ)V
    ...
    invoke-virtual {v0}, Laac;->bringToFront()V

    .line 389
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;

    invoke-static {v0, p1}, Lvk;->e(Landroid/view/View;I)V
...
.method public final a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    .line 110
    iput-object p1, v0, Laac;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method public final a(Z)V
    ...
    invoke-virtual {v1, v2}, Labp;->setAlpha(I)V

    .line 76
    new-instance v1, Lacn;

    invoke-direct {v1, p0}, Lacn;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method public final varargs a([I)V
    ...
    .line 129
    iget-object v2, v0, Labp;->e:Labt;

    invoke-virtual {v2, v3}, Labt;->a([I)V

    .line 130
    iget-object v0, v0, Labp;->e:Labt;
...
.method public final b(F)V
    ...
    invoke-virtual {v1}, Laac;->getTop()I
...
.method public b()Z
    ...
    .prologue
    .line 179
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->L:Lacu;
    ...
    invoke-static {v0, v1}, Lvk;->b(Landroid/view/View;I)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    .prologue
    .line 267
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->i:Lus;
...
.method public getNestedScrollAxes()I
    ...
    .prologue
    .line 237
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Luu;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Laac;->getTop()I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v1}, Laac;->getMeasuredWidth()I
    ...
    invoke-virtual {v2}, Laac;->getMeasuredHeight()I

    move-result v2

    .line 156
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Laac;
    ...
    invoke-virtual {v3, v4, v5, v0, v1}, Laac;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    .line 171
    invoke-virtual {v0, v1, v2}, Laac;->measure(II)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 212
    invoke-static {v0}, Lvk;->w(Landroid/view/View;)Z
