...
# static fields
.field public static final M:Lzi;
...
.field public final j:Labv;

.field public final k:Labv;

.field public final l:Lzo;

.field public final m:Lzo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lzi;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lzh;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lzh;
    ...
    invoke-direct {v2, p0, v3}, Lzo;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lzo;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lzo;

    .line 383
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lzo;

    invoke-static {p0, v5, v2}, Labv;->a(Landroid/view/ViewGroup;FLaby;)Labv;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;

    .line 32068
    iput-object v3, v2, Lzo;->b:Labv;

    .line 32069
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lzo;

    invoke-static {p0, v5, v2}, Labv;->a(Landroid/view/ViewGroup;FLaby;)Labv;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;
    ...
    .line 50405
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lzo;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;

    .line 62068
    iput-object v2, v1, Lzo;->b:Labv;
    ...
    invoke-direct {v1, p0}, Lzg;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Lue;->a(Landroid/view/View;Lrl;)V

    .line 4663
    sget-object v1, Lvc;->a:Lvf;

    const/4 v2, 0x0

    invoke-interface {v1, p0, v2}, Lvf;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 402
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lzi;

    invoke-interface {v1, p0}, Lzi;->a(Landroid/view/View;)V

    .line 403
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lzi;

    invoke-interface {v1, p1}, Lzi;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private final a(II)V
    ...
    .line 618
    invoke-static {p2, v0}, Lse;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lmp;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1174
    :cond_1
    invoke-static {p0, p1}, Lmp;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static d(Landroid/view/View;)Z
    ...
    .line 1422
    invoke-static {v0, v2}, Lse;->a(II)I
...
.method public final a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Lzl;->a(Landroid/view/View;F)V
...
.method public final a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lue;->c(Landroid/view/View;I)V
...
.method public final a(Lzl;)V
    ...
    .prologue
    .line 535
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lzl;
    ...
    .line 20560
    :cond_2
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lzl;
...
.method public final a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;
    ...
    .line 1569
    invoke-virtual {v7, v5, v6, v8}, Labv;->a(Landroid/view/View;II)Z
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;
    ...
    .line 1572
    invoke-virtual {v6, v5, v7, v8}, Labv;->a(Landroid/view/View;II)Z
    ...
    .line 1579
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lzo;

    invoke-virtual {v0}, Lzo;->b()V

    .line 1580
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lzo;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lue;->c(Landroid/view/View;I)V
    ...
    .line 1990
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lzh;

    invoke-static {p1, v0}, Lue;->a(Landroid/view/View;Lrl;)V
...
.method public final b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Labv;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;

    invoke-virtual {v1}, Labv;->c()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1405
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lzm;-><init>(Lzm;)V
    ...
    invoke-direct {v0, p1}, Lzm;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1344
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lzi;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lzi;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Labv;

    .line 1441
    invoke-virtual {v4, p1}, Labv;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Labv;->b(II)Landroid/view/View;
    ...
    .line 21352
    invoke-virtual {v5, v3}, Labv;->a(I)Z
    ...
    .line 21359
    iget-object v0, v5, Labv;->f:[F

    aget v0, v0, v3

    iget-object v7, v5, Labv;->d:[F
    ...
    .line 21360
    iget-object v7, v5, Labv;->g:[F

    aget v7, v7, v3

    iget-object v8, v5, Labv;->e:[F
...
.method protected onLayout(ZIIII)V
    ...
    .line 1193
    iget v1, v0, Lzm;->leftMargin:I

    iget v2, v0, Lzm;->topMargin:I

    iget v3, v0, Lzm;->leftMargin:I
    ...
    .line 1217
    iget v4, v0, Lzm;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lzm;->topMargin:I
    ...
    .line 1224
    iget v10, v0, Lzm;->bottomMargin:I
    ...
    iget v11, v0, Lzm;->bottomMargin:I
    ...
    iget v13, v0, Lzm;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Lse;->a(II)I

    move-result v6

    .line 1068
    invoke-static {v10}, Lue;->t(Landroid/view/View;)Z
    ...
    .line 1069
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->M:Lzi;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Lzi;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 1077
    iget v6, v0, Lzm;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Lzm;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Lzi;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 1084
    invoke-static {v10}, Lue;->p(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Lue;->h(Landroid/view/View;F)V
    ...
    iget v12, v0, Lzm;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Lzm;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Labv;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Labv;->b(II)Landroid/view/View;
