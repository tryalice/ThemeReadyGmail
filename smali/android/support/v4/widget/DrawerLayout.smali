...
# static fields
.field public static final M:Lxa;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lxa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lwz;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lwz;
    ...
    invoke-direct {v2, p0, v3}, Lxg;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lxg;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lxg;

    .line 24
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lxg;

    invoke-static {p0, v5, v2}, Lzp;->a(Landroid/view/ViewGroup;FLzs;)Lzp;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;

    .line 25
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;

    .line 30
    iput-object v3, v2, Lxg;->b:Lzp;

    .line 31
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lxg;

    invoke-static {p0, v5, v2}, Lzp;->a(Landroid/view/ViewGroup;FLzs;)Lzp;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;

    .line 32
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;
    ...
    .line 36
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lxg;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;

    .line 37
    iput-object v2, v1, Lxg;->b:Lzp;
    ...
    invoke-direct {v1, p0}, Lwy;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Lrw;->a(Landroid/view/View;Lpj;)V

    .line 42
    sget-object v1, Lsu;->a:Lsx;

    const/4 v2, 0x0

    invoke-interface {v1, p0, v2}, Lsx;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 44
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lxa;

    invoke-interface {v1, p0}, Lxa;->a(Landroid/view/View;)V

    .line 45
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lxa;

    invoke-interface {v1, p1}, Lxa;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private final a(II)V
    ...
    .line 78
    invoke-static {p2, v0}, Lqc;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;
    ...
    .line 88
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lle;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 269
    :cond_1
    invoke-static {p0, p1}, Lle;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public final a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Lxd;->a(Landroid/view/View;F)V
...
.method public final a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lrw;->c(Landroid/view/View;I)V
...
.method public final a(Lxd;)V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lxd;
    ...
    .line 71
    :cond_2
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lxd;
...
.method public final a(Z)V
    ...
    .line 501
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;
    ...
    .line 503
    invoke-virtual {v7, v5, v6, v8}, Lzp;->a(Landroid/view/View;II)Z
    ...
    .line 504
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;
    ...
    .line 506
    invoke-virtual {v6, v5, v7, v8}, Lzp;->a(Landroid/view/View;II)Z
    ...
    .line 509
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lxg;

    invoke-virtual {v0}, Lxg;->b()V

    .line 510
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lxg;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lrw;->c(Landroid/view/View;I)V
    ...
    .line 650
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lwz;

    invoke-static {p1, v0}, Lrw;->a(Landroid/view/View;Lpj;)V
...
.method public final b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lzp;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 391
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 336
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lxa;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lxa;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lzp;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lzp;

    .line 414
    invoke-virtual {v4, p1}, Lzp;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 422
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Lzp;->b(II)Landroid/view/View;
    ...
    .line 432
    invoke-virtual {v5, v3}, Lzp;->a(I)Z
    ...
    .line 433
    iget-object v0, v5, Lzp;->f:[F

    aget v0, v0, v3

    iget-object v7, v5, Lzp;->d:[F
    ...
    .line 434
    iget-object v7, v5, Lzp;->g:[F

    aget v7, v7, v3

    iget-object v8, v5, Lzp;->e:[F
...
.method protected onLayout(ZIIII)V
    ...
    .line 279
    iget v1, v0, Lxe;->leftMargin:I

    iget v2, v0, Lxe;->topMargin:I

    iget v3, v0, Lxe;->leftMargin:I
    ...
    .line 293
    iget v4, v0, Lxe;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lxe;->topMargin:I
    ...
    .line 296
    iget v10, v0, Lxe;->bottomMargin:I
    ...
    iget v11, v0, Lxe;->bottomMargin:I
    ...
    iget v13, v0, Lxe;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Lqc;->a(II)I

    move-result v6

    .line 215
    invoke-static {v10}, Lrw;->r(Landroid/view/View;)Z
    ...
    .line 216
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->M:Lxa;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Lxa;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 219
    iget v6, v0, Lxe;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Lxe;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Lxa;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 224
    invoke-static {v10}, Lrw;->o(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Lrw;->f(Landroid/view/View;F)V
    ...
    iget v12, v0, Lxe;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Lxe;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lzp;->b(Landroid/view/MotionEvent;)V
    ...
    .line 470
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lzp;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lzp;->b(II)Landroid/view/View;
