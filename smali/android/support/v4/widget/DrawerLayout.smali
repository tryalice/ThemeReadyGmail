...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lwl;
    ...
    invoke-direct {v2, p0, v3}, Lwp;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lwp;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lwp;

    .line 24
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lwp;

    invoke-static {p0, v6, v2}, Lyl;->a(Landroid/view/ViewGroup;FLyo;)Lyl;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;

    .line 25
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;

    .line 30
    iput-object v3, v2, Lwp;->b:Lyl;

    .line 31
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lwp;

    invoke-static {p0, v6, v2}, Lyl;->a(Landroid/view/ViewGroup;FLyo;)Lyl;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;

    .line 32
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;
    ...
    .line 36
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lwp;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;

    .line 37
    iput-object v2, v1, Lwp;->b:Lyl;

    .line 38
    invoke-virtual {p0, v5}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 39
    invoke-static {p0, v5}, Ltk;->a(Landroid/view/View;I)V

    .line 40
    new-instance v1, Lwk;

    invoke-direct {v1, p0}, Lwk;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Ltk;->a(Landroid/view/View;Lsg;)V

    .line 41
    invoke-static {p0}, Ltx;->a(Landroid/view/ViewGroup;)V
...
.method private final a(II)V
    ...
    .line 82
    invoke-static {p2, v0}, Lst;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;
    ...
    .line 92
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-virtual {v0, p0}, Loh;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 321
    :cond_1
    invoke-static {p0, p1}, Loc;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static d(Landroid/view/View;)Z
    ...
    .line 465
    invoke-static {v0, v2}, Lst;->a(II)I
...
.method public final a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Lwm;->a(Landroid/view/View;F)V
...
.method public final a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Ltk;->a(Landroid/view/View;I)V
...
.method public final a(Lwm;)V
    ...
    .prologue
    .line 63
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lwm;
    ...
    .line 74
    :cond_2
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lwm;
...
.method public final a(Z)V
    ...
    .line 560
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;
    ...
    .line 562
    invoke-virtual {v7, v5, v6, v8}, Lyl;->a(Landroid/view/View;II)Z
    ...
    .line 563
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;
    ...
    .line 565
    invoke-virtual {v6, v5, v7, v8}, Lyl;->a(Landroid/view/View;II)Z
    ...
    .line 568
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lwp;

    invoke-virtual {v0}, Lwp;->b()V

    .line 569
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lwp;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Ltk;->a(Landroid/view/View;I)V
    ...
    .line 709
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lwl;

    invoke-static {p1, v0}, Ltk;->a(Landroid/view/View;Lsg;)V
...
.method public final b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lyl;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    .line 379
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;

    invoke-virtual {v1}, Lyl;->b()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 449
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lwn;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lyl;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lyl;

    .line 473
    invoke-virtual {v4, p1}, Lyl;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 481
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Lyl;->b(II)Landroid/view/View;
    ...
    .line 491
    invoke-virtual {v5, v3}, Lyl;->a(I)Z
    ...
    .line 492
    iget-object v0, v5, Lyl;->f:[F

    aget v0, v0, v3

    iget-object v7, v5, Lyl;->d:[F
    ...
    .line 493
    iget-object v7, v5, Lyl;->g:[F

    aget v7, v7, v3

    iget-object v8, v5, Lyl;->e:[F
...
.method protected onLayout(ZIIII)V
    ...
    .line 331
    iget v1, v0, Lwn;->leftMargin:I

    iget v2, v0, Lwn;->topMargin:I

    iget v3, v0, Lwn;->leftMargin:I
    ...
    .line 345
    iget v4, v0, Lwn;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lwn;->topMargin:I
    ...
    .line 348
    iget v10, v0, Lwn;->bottomMargin:I
    ...
    iget v11, v0, Lwn;->bottomMargin:I
    ...
    iget v13, v0, Lwn;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1, v9}, Lst;->a(II)I
    ...
    invoke-virtual {v1, v11}, Ltv;->i(Landroid/view/View;)Z
    ...
    .line 263
    iget v1, v2, Lwn;->leftMargin:I

    sub-int v1, v4, v1

    iget v12, v2, Lwn;->rightMargin:I
    ...
    .line 264
    iget v12, v2, Lwn;->topMargin:I

    sub-int v12, v3, v12

    iget v2, v2, Lwn;->bottomMargin:I
    ...
    invoke-virtual {v1, v11}, Ltv;->u(Landroid/view/View;)F
    ...
    invoke-static {v11, v1}, Ltk;->d(Landroid/view/View;F)V
    ...
    iget v13, v2, Lwn;->bottomMargin:I

    add-int/2addr v12, v13

    iget v2, v2, Lwn;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lyl;->b(Landroid/view/MotionEvent;)V
    ...
    .line 529
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lyl;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lyl;->b(II)Landroid/view/View;
