...
# static fields
.field public static final M:Laal;
...
.field public final j:Ladc;

.field public final k:Ladc;

.field public final l:Laar;

.field public final m:Laar;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Laal;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Laak;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Laak;
    ...
    invoke-direct {v2, p0, v3}, Laar;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Laar;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Laar;

    .line 24
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Laar;

    invoke-static {p0, v5, v2}, Ladc;->a(Landroid/view/ViewGroup;FLadf;)Ladc;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;

    .line 25
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;

    .line 30
    iput-object v3, v2, Laar;->b:Ladc;

    .line 31
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Laar;

    invoke-static {p0, v5, v2}, Ladc;->a(Landroid/view/ViewGroup;FLadf;)Ladc;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;

    .line 32
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;
    ...
    .line 36
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Laar;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;

    .line 37
    iput-object v2, v1, Laar;->b:Ladc;
    ...
    invoke-direct {v1, p0}, Laaj;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Lvh;->a(Landroid/view/View;Lsq;)V

    .line 42
    sget-object v1, Lwf;->a:Lwi;

    const/4 v2, 0x0

    invoke-interface {v1, p0, v2}, Lwi;->a(Landroid/view/ViewGroup;Z)V

    .line 43
    invoke-static {p0}, Lvh;->t(Landroid/view/View;)Z
    ...
    .line 44
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Laal;

    invoke-interface {v1, p0}, Laal;->a(Landroid/view/View;)V

    .line 45
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Laal;

    invoke-interface {v1, p1}, Laal;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private final a(II)V
    ...
    .line 78
    invoke-static {p2, v0}, Ltj;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;
    ...
    .line 88
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lnv;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 269
    :cond_1
    invoke-static {p0, p1}, Lnv;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static d(Landroid/view/View;)Z
    ...
    .line 406
    invoke-static {v0, v2}, Ltj;->a(II)I
...
.method public final a(Laao;)V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->w:Laao;
    ...
    .line 71
    :cond_2
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->w:Laao;
...
.method public final a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Laao;->a(Landroid/view/View;F)V
...
.method public final a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lvh;->c(Landroid/view/View;I)V
...
.method public final a(Z)V
    ...
    .line 501
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;
    ...
    .line 503
    invoke-virtual {v7, v5, v6, v8}, Ladc;->a(Landroid/view/View;II)Z
    ...
    .line 504
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;
    ...
    .line 506
    invoke-virtual {v6, v5, v7, v8}, Ladc;->a(Landroid/view/View;II)Z
    ...
    .line 509
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Laar;

    invoke-virtual {v0}, Laar;->b()V

    .line 510
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Laar;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lvh;->c(Landroid/view/View;I)V
    ...
    .line 650
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Laak;

    invoke-static {p1, v0}, Lvh;->a(Landroid/view/View;Lsq;)V
...
.method public final b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Ladc;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;

    invoke-virtual {v1}, Ladc;->c()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 391
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Laap;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Laap;-><init>(Laap;)V
    ...
    invoke-direct {v0, p1}, Laap;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Laap;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 336
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Laal;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v0, v1}, Laal;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Ladc;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ladc;

    .line 414
    invoke-virtual {v4, p1}, Ladc;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 422
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Ladc;->b(II)Landroid/view/View;
    ...
    .line 432
    invoke-virtual {v5, v3}, Ladc;->a(I)Z
    ...
    .line 433
    iget-object v0, v5, Ladc;->f:[F

    aget v0, v0, v3

    iget-object v7, v5, Ladc;->d:[F
    ...
    .line 434
    iget-object v7, v5, Ladc;->g:[F

    aget v7, v7, v3

    iget-object v8, v5, Ladc;->e:[F
...
.method protected onLayout(ZIIII)V
    ...
    .line 279
    iget v1, v0, Laap;->leftMargin:I

    iget v2, v0, Laap;->topMargin:I

    iget v3, v0, Laap;->leftMargin:I
    ...
    .line 293
    iget v4, v0, Laap;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Laap;->topMargin:I
    ...
    .line 296
    iget v10, v0, Laap;->bottomMargin:I
    ...
    iget v11, v0, Laap;->bottomMargin:I
    ...
    iget v13, v0, Laap;->bottomMargin:I
    ...
    .line 305
    iget v4, v0, Laap;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Ltj;->a(II)I

    move-result v6

    .line 215
    invoke-static {v10}, Lvh;->t(Landroid/view/View;)Z
    ...
    .line 216
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->M:Laal;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Laal;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 219
    iget v6, v0, Laap;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Laap;->rightMargin:I
    ...
    iget v0, v0, Laap;->bottomMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Laal;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 224
    invoke-static {v10}, Lvh;->p(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Lvh;->f(Landroid/view/View;F)V
    ...
    iget v12, v0, Laap;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Laap;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Ladc;->b(Landroid/view/MotionEvent;)V
    ...
    .line 470
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Ladc;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Ladc;->b(II)Landroid/view/View;
