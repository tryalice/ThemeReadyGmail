...
.field public static final aj:Lwy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->aj:Lwy;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lwr;
    ...
    invoke-direct {v0, p0}, Lwo;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method private final a(II)Lwr;
    ...
    .line 236
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    invoke-virtual {v1, p0, p1}, Lut;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lwr;->a:Ljava/lang/Object;
...
.method private final a(Landroid/view/View;)Lwr;
    .locals 4
    ...
    .line 501
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget-object v3, v0, Lwr;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Lut;->a(Landroid/view/View;Ljava/lang/Object;)Z
...
.method private final a(IFI)V
    ...
    .line 731
    :cond_1
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Lwu;
    ...
    invoke-interface {v0, p1, p2}, Lwu;->a(IF)V
    ...
    .line 739
    :cond_4
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ac:Lwu;
    ...
    .line 741
    :cond_5
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ae:Lwv;
    ...
    .line 749
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ae:Lwv;

    invoke-interface {v5, v3, v0}, Lwv;->a(Landroid/view/View;F)V
...
.method private final a(IIII)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->e(I)Lwr;
...
.method private final a(IZIZ)V
    ...
    .prologue
    .line 157
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->e(I)Lwr;
...
.method private final a(IZZI)V
    ...
    .line 133
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lut;
...
.method private final a(Lwr;ILwr;)V
    .locals 12
...
.method private final a(Z)V
    ...
    .line 781
    iget-boolean v5, v0, Lwr;->c:Z

    if-eqz v5, :cond_2

    .line 783
    iput-boolean v2, v0, Lwr;->c:Z
...
.method private final a(F)Z
    ...
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    invoke-virtual {v9}, Lut;->a()I
    ...
    .line 968
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Laaw;
    ...
    invoke-virtual {v1, v0}, Laaw;->a(F)Z
    ...
    .line 973
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Laaw;
    ...
    invoke-virtual {v2, v0}, Laaw;->a(F)Z
...
.method private final a(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Lvh;->a(Landroid/view/View;I)Z
...
.method private final b(Landroid/view/View;)Lwr;
    .locals 2
    ...
    .line 509
    :cond_2
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method private final c()V
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Laaw;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Laaw;
    ...
    invoke-direct {v0, p0}, Lwt;-><init>(Landroid/support/v4/view/ViewPager;)V
    ...
    .line 52
    invoke-static {p0, v4}, Lvh;->c(Landroid/view/View;I)V

    .line 53
    :cond_0
    new-instance v0, Lwp;

    invoke-direct {v0, p0}, Lwp;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-static {p0, v0}, Lvh;->a(Landroid/view/View;Lus;)V
...
.method private final d(I)V
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->e(I)Lwr;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Lut;
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Lut;

    invoke-virtual {v4}, Lut;->a()I
    ...
    invoke-direct {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->a(II)Lwr;
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget-object v2, v2, Lwr;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lut;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->a(II)Lwr;
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget-object v2, v2, Lwr;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lut;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->a(II)Lwr;
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->a(Lwr;ILwr;)V

    .line 364
    :cond_16
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Lut;
    ...
    iget-object v2, v9, Lwr;->a:Ljava/lang/Object;

    :goto_11
    move-object/from16 v0, p0

    invoke-virtual {v3, v0, v4, v2}, Lut;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Lwr;
    ...
    invoke-direct {v0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method private final e()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->aj:Lwy;
...
.method private final f()Z
    ...
    .line 941
    :cond_0
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Laaw;

    invoke-virtual {v0}, Laaw;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Laaw;
...
.method private final f(I)Z
    ...
    .line 692
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->h()Lwr;
...
.method private final g(I)V
    ...
    invoke-interface {v0, p1}, Lwu;->a_(I)V
...
.method private final h()Lwr;
    ...
    .line 990
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lwr;
...
.method public final a()V
    ...
    .line 250
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget-object v9, v0, Lwr;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lut;->b(Ljava/lang/Object;)I
    ...
    .line 257
    :cond_0
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget v7, v0, Lwr;->b:I

    iget-object v9, v0, Lwr;->a:Ljava/lang/Object;

    invoke-virtual {v6, p0, v7, v9}, Lut;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
...
.method public final a(I)V
    ...
    invoke-static {v5, v2, v6}, Lvh;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
    ...
    invoke-interface {v0, p1}, Lwu;->b(I)V
...
.method public final a(Lut;)V
    ...
    invoke-virtual {v0, v5}, Lut;->a(Landroid/database/DataSetObserver;)V
    ...
    .line 86
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget v4, v0, Lwr;->b:I

    iget-object v0, v0, Lwr;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Lut;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 100
    :cond_3
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Lut;
    ...
    .line 103
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lww;
    ...
    invoke-direct {v0, p0}, Lww;-><init>(Landroid/support/v4/view/ViewPager;)V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lww;

    .line 105
    :cond_4
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lut;

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Lww;

    invoke-virtual {v0, v1}, Lut;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v0, v1, v3}, Lut;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 1194
    invoke-direct {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 1211
    invoke-direct {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 1110
    :sswitch_2
    sget-object v2, Ltn;->a:Ltq;

    invoke-virtual {p1}, Landroid/view/KeyEvent;->getMetaState()I

    move-result v3

    invoke-interface {v2, v3}, Ltq;->b(I)Z
    ...
    invoke-interface {v2, v3, v1}, Ltq;->a(II)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1020
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->R:Laaw;

    invoke-virtual {v3, v0, v2}, Laaw;->a(II)V
    ...
    .line 1029
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->S:Laaw;

    invoke-virtual {v4, v3, v2}, Laaw;->a(II)V

    .line 1030
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Laaw;

    invoke-virtual {v2, p1}, Laaw;->a(Landroid/graphics/Canvas;)Z
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lws;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Lut;
...
.method protected onLayout(ZIIII)V
    ...
    .line 648
    iget-boolean v10, v1, Lws;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-direct {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 1227
    invoke-direct {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lwr;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Lut;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Lut;->d()Landroid/os/Parcelable;
