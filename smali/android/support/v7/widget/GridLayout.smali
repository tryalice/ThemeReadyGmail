...
.field public static final B:Lafz;

.field public static final C:Lafz;
...
.field public static final r:Lafz;

.field public static final s:Lafz;

.field public static final t:Lafz;

.field public static final u:Lafz;

.field public static final v:Lafz;

.field public static final w:Lafz;

.field public static final x:Lafz;

.field public static final y:Lafz;

.field public static final z:Lafz;


# instance fields
.field public final j:Lagc;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->r:Lafz;
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->s:Lafz;
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->t:Lafz;

    .line 354
    sget-object v0, Landroid/support/v7/widget/GridLayout;->s:Lafz;

    sput-object v0, Landroid/support/v7/widget/GridLayout;->u:Lafz;

    .line 355
    sget-object v0, Landroid/support/v7/widget/GridLayout;->t:Lafz;

    sput-object v0, Landroid/support/v7/widget/GridLayout;->v:Lafz;

    .line 356
    sget-object v0, Landroid/support/v7/widget/GridLayout;->s:Lafz;

    sput-object v0, Landroid/support/v7/widget/GridLayout;->w:Lafz;

    .line 357
    sget-object v0, Landroid/support/v7/widget/GridLayout;->t:Lafz;

    sput-object v0, Landroid/support/v7/widget/GridLayout;->x:Lafz;

    .line 358
    sget-object v0, Landroid/support/v7/widget/GridLayout;->w:Lafz;

    sget-object v1, Landroid/support/v7/widget/GridLayout;->x:Lafz;

    invoke-static {v0, v1}, Landroid/support/v7/widget/GridLayout;->a(Lafz;Lafz;)Lafz;

    move-result-object v0

    sput-object v0, Landroid/support/v7/widget/GridLayout;->y:Lafz;

    .line 359
    sget-object v0, Landroid/support/v7/widget/GridLayout;->x:Lafz;

    sget-object v1, Landroid/support/v7/widget/GridLayout;->w:Lafz;

    invoke-static {v0, v1}, Landroid/support/v7/widget/GridLayout;->a(Lafz;Lafz;)Lafz;

    move-result-object v0

    sput-object v0, Landroid/support/v7/widget/GridLayout;->z:Lafz;
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->A:Lafz;
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->B:Lafz;
    ...
    sput-object v0, Landroid/support/v7/widget/GridLayout;->C:Lafz;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0, v2}, Lagc;-><init>(Landroid/support/v7/widget/GridLayout;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/GridLayout;->j:Lagc;

    .line 3
    new-instance v0, Lagc;

    invoke-direct {v0, p0, v1}, Lagc;-><init>(Landroid/support/v7/widget/GridLayout;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/GridLayout;->k:Lagc;
    ...
    .line 12
    iget-object v2, p0, Landroid/support/v7/widget/GridLayout;->k:Lagc;

    invoke-virtual {v2, v0}, Lagc;->a(I)V
    ...
    .line 16
    iget-object v2, p0, Landroid/support/v7/widget/GridLayout;->j:Lagc;
    ...
    invoke-virtual {v2, v0}, Lagc;->a(Z)V
...
.method public static a(IZ)Lafz;
    .locals 2
    ...
    .line 64
    sget-object v0, Landroid/support/v7/widget/GridLayout;->r:Lafz;
    ...
    sget-object v0, Landroid/support/v7/widget/GridLayout;->y:Lafz;

    goto :goto_2

    :cond_2
    sget-object v0, Landroid/support/v7/widget/GridLayout;->u:Lafz;
    ...
    sget-object v0, Landroid/support/v7/widget/GridLayout;->z:Lafz;

    goto :goto_2

    :cond_3
    sget-object v0, Landroid/support/v7/widget/GridLayout;->v:Lafz;
    ...
    .line 61
    :sswitch_3
    sget-object v0, Landroid/support/v7/widget/GridLayout;->A:Lafz;
...
.method private static a(Lafz;Lafz;)Lafz;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lafu;-><init>(Lafz;Lafz;)V

    return-object v0
.end method

.method public static a(Landroid/view/View;)Lagg;
    .locals 1
...
.method public static a()Lagj;
    ...
    invoke-static {v0, v2, v1, v3}, Landroid/support/v7/widget/GridLayout;->a(IILafz;F)Lagj;
...
.method public static a(IILafz;F)Lagj;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lagj;-><init>(ZIILafz;F)V
...
.method private final a(IIZ)V
    ...
    .line 228
    iget v4, v0, Lagg;->width:I

    iget v5, v0, Lagg;->height:I
    ...
    iget-object v2, v0, Lagg;->p:Lagj;

    .line 231
    :goto_3
    invoke-virtual {v2, v3}, Lagj;->a(Z)Lafz;

    move-result-object v4

    sget-object v5, Landroid/support/v7/widget/GridLayout;->C:Lafz;

    if-ne v4, v5, :cond_0

    .line 232
    iget-object v4, v2, Lagj;->c:Lagf;
...
.method private static a(Lagg;IIII)V
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lagf;-><init>(II)V

    .line 112
    iget-object v1, p0, Lagg;->o:Lagj;

    invoke-virtual {v1, v0}, Lagj;->a(Lagf;)Lagj;
    ...
    invoke-direct {v0, p3, v1}, Lagf;-><init>(II)V
...
.method private final a(Lagg;Z)V
    .locals 5
    ...
    iget-object v0, p0, Landroid/support/v7/widget/GridLayout;->j:Lagc;
    ...
    .line 132
    :cond_5
    iget-object v0, p0, Landroid/support/v7/widget/GridLayout;->k:Lagc;
...
.method private final b(Landroid/view/View;ZZ)I
    ...
    iput-object v1, v0, Lagc;->j:[I

    .line 92
    :cond_1
    iget-boolean v1, v0, Lagc;->k:Z
    ...
    .line 94
    iput-boolean v2, v0, Lagc;->k:Z

    .line 95
    :cond_2
    iget-object v0, v0, Lagc;->j:[I
    ...
    iget-object v0, v0, Lagg;->p:Lagj;

    .line 108
    :goto_3
    if-eqz p3, :cond_8

    iget-object v0, v0, Lagj;->c:Lagf;
    ...
    iput-object v1, v0, Lagc;->l:[I

    .line 99
    :cond_5
    iget-boolean v1, v0, Lagc;->m:Z
...
.method private final e()I
    ...
    invoke-virtual {v0}, Lagg;->hashCode()I
...
.method private final f()V
    ...
    .line 165
    :goto_5
    iget-object v5, v2, Lagj;->c:Lagf;

    .line 166
    iget-boolean v10, v2, Lagj;->b:Z

    .line 167
    invoke-virtual {v5}, Lagf;->a()I
    ...
    .line 171
    :goto_6
    iget-object v12, v2, Lagj;->c:Lagf;

    .line 172
    iget-boolean v13, v2, Lagj;->b:Z

    .line 174
    invoke-virtual {v12}, Lagf;->a()I
    ...
    .line 203
    invoke-static {v0, v3, v11, v2, v5}, Landroid/support/v7/widget/GridLayout;->a(Lagg;IIII)V
    ...
    .line 204
    :cond_10
    invoke-static {v0, v2, v5, v3, v11}, Landroid/support/v7/widget/GridLayout;->a(Lagg;IIII)V
...
.method public final a(Landroid/view/View;ZZ)I
    ...
    iget v2, v0, Lagg;->topMargin:I

    goto :goto_0

    :cond_2
    iget v2, v0, Lagg;->bottomMargin:I
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    .line 143
    invoke-direct {p0, p1, v1}, Landroid/support/v7/widget/GridLayout;->a(Lagg;Z)V

    .line 144
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/GridLayout;->a(Lagg;Z)V
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lagg;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lagg;-><init>(Lagg;)V
    ...
    invoke-direct {v0, p1}, Lagg;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Lagg;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v3, v0, Landroid/support/v7/widget/GridLayout;->j:Lagc;

    sub-int v4, v12, v13

    sub-int/2addr v4, v15

    invoke-virtual {v3, v4}, Lagc;->c(I)V

    .line 278
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v7/widget/GridLayout;->k:Lagc;

    sub-int/2addr v1, v14

    sub-int/2addr v1, v2

    invoke-virtual {v3, v1}, Lagc;->c(I)V

    .line 279
    move-object/from16 v0, p0

    iget-object v1, v0, Landroid/support/v7/widget/GridLayout;->j:Lagc;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/GridLayout;->k:Lagc;
    ...
    .line 287
    iget-object v2, v1, Lagg;->p:Lagj;

    .line 288
    iget-object v1, v1, Lagg;->o:Lagj;

    .line 289
    iget-object v4, v2, Lagj;->c:Lagf;

    .line 290
    iget-object v5, v1, Lagj;->c:Lagf;
    ...
    invoke-virtual {v2, v4}, Lagj;->a(Z)Lafz;
    ...
    invoke-virtual {v1, v2}, Lagj;->a(Z)Lafz;
    ...
    invoke-virtual {v1}, Lagc;->b()Lagi;

    move-result-object v1

    invoke-virtual {v1, v11}, Lagi;->a(I)Ljava/lang/Object;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/GridLayout;->k:Lagc;

    invoke-virtual {v2}, Lagc;->b()Lagi;

    move-result-object v2

    invoke-virtual {v2, v11}, Lagi;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Lage;->a(Z)I

    move-result v2

    sub-int v2, v21, v2

    invoke-virtual {v4, v3, v2}, Lafz;->a(Landroid/view/View;I)I
    ...
    invoke-virtual {v7, v2}, Lage;->a(Z)I

    move-result v2

    sub-int v2, v22, v2

    invoke-virtual {v8, v3, v2}, Lafz;->a(Landroid/view/View;I)I
    ...
    invoke-virtual/range {v1 .. v6}, Lage;->a(Landroid/support/v7/widget/GridLayout;Landroid/view/View;Lafz;IZ)I
    ...
    invoke-virtual/range {v5 .. v10}, Lage;->a(Landroid/support/v7/widget/GridLayout;Landroid/view/View;Lafz;IZ)I
    ...
    invoke-virtual {v4, v0, v5}, Lafz;->a(II)I
    ...
    invoke-virtual {v8, v0, v5}, Lafz;->a(II)I
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v4}, Lagc;->b(I)I
    ...
    invoke-virtual {v0, v5}, Lagc;->b(I)I
    ...
    .line 258
    iget-object v1, p0, Landroid/support/v7/widget/GridLayout;->j:Lagc;

    invoke-virtual {v1, v4}, Lagc;->b(I)I
