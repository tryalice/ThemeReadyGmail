...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Laek;-><init>(Landroid/content/Context;II)V
    ...
    invoke-direct {v0, p0}, Lagm;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->D:Lagm;
...
.method public final a(Landroid/view/ViewGroup;)Lafn;
    ...
    .prologue
    .line 39
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lafn;

    .line 40
    invoke-super {p0, p1}, Laek;->a(Landroid/view/ViewGroup;)Lafn;
...
.method public final a(Laez;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 46
    :cond_0
    invoke-super {p0, p1, p2, p3}, Laek;->a(Laez;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 51
    invoke-static {v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lagq;
...
.method public final a(Laev;Z)V
    ...
    .line 260
    invoke-super {p0, p1, p2}, Laek;->a(Laev;Z)V

    .line 261
    return-void
.end method

.method public final a(Laez;Lafo;)V
    .locals 1

    .prologue
    .line 53
    invoke-interface {p2, p1}, Lafo;->a(Laez;)V
    ...
    .line 57
    iput-object v0, p2, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Laex;

    .line 58
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Lagh;
    ...
    invoke-direct {v0, p0}, Lagh;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Lagh;
    ...
    .line 61
    iput-object v0, p2, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Laej;
...
.method public final a(Landroid/content/Context;Laev;)V
    ...
    .line 5
    invoke-super {p0, p1, p2}, Laek;->a(Landroid/content/Context;Laev;)V
    ...
    .line 7
    invoke-static {p1}, Ladt;->a(Landroid/content/Context;)Ladt;
    ...
    .line 16
    iget-object v0, v3, Ladt;->a:Landroid/content/Context;
    ...
    .line 22
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;
    ...
    invoke-direct {v3, p0, v4}, Lagj;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;
    ...
    invoke-virtual {v3, v4}, Lagj;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v1, v1}, Lagj;->measure(II)V

    .line 30
    :cond_5
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;

    invoke-virtual {v1}, Lagj;->getMeasuredWidth()I
    ...
    .line 12
    :cond_6
    iget-object v4, v3, Ladt;->a:Landroid/content/Context;
    ...
    .line 31
    :cond_7
    iput-object v6, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;
...
.method public final a(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    .prologue
    .line 262
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lafn;

    .line 263
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laev;
...
.method public final a(Z)V
    ...
    .line 70
    iget-object v4, v0, Laev;->j:Ljava/util/ArrayList;
    ...
    .line 75
    iget-object v0, v0, Laez;->s:Lpu;

    .line 77
    if-eqz v0, :cond_0

    .line 79
    iput-object p0, v0, Lpu;->b:Lpv;
    ...
    invoke-virtual {v0}, Laez;->isActionViewExpanded()Z
    ...
    .line 90
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;
    ...
    invoke-direct {v0, p0, v2}, Lagj;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;

    .line 92
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;

    invoke-virtual {v0}, Lagj;->getParent()Landroid/view/ViewParent;
    ...
    .line 93
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lafn;
    ...
    .line 95
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lagj;
    ...
    .line 98
    invoke-static {}, Landroid/support/v7/widget/ActionMenuView;->a()Lagq;

    move-result-object v3

    .line 99
    iput-boolean v1, v3, Lagq;->a:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lafn;
...
.method public final a()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laev;
    ...
    invoke-virtual {v2}, Laev;->h()Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lafn;
    ...
    invoke-virtual {v3}, Laez;->isActionViewExpanded()Z
    ...
    invoke-virtual {v0, v3, v8, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Laez;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v3, v9}, Laez;->c(Z)V
    ...
    invoke-virtual {v0, v3, v10, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Laez;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 254
    :cond_e
    invoke-virtual {v3, v13}, Laez;->c(Z)V
    ...
    invoke-virtual {v4, v0}, Laez;->c(Z)V
    ...
    invoke-virtual {v3, v8}, Laez;->c(Z)V
...
.method public final a(Lafu;)Z
    ...
    .line 112
    :goto_1
    iget-object v1, v0, Lafu;->A:Laev;

    .line 113
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laev;

    if-eq v1, v2, :cond_2

    .line 115
    iget-object v0, v0, Lafu;->A:Laev;
    ...
    .line 124
    invoke-interface {v1}, Lafo;->a()Laez;
    ...
    .line 131
    invoke-virtual {p1}, Lafu;->getItem()Landroid/view/MenuItem;
    ...
    .line 135
    invoke-virtual {p1, v0}, Lafu;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, v4, p1, v2}, Lagg;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Lafu;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lagg;

    .line 141
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lagg;

    invoke-virtual {v1, v0}, Lagg;->a(Z)V

    .line 142
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lagg;

    invoke-virtual {v0}, Lagg;->a()V

    .line 143
    invoke-super {p0, p1}, Laek;->a(Lafu;)Z
...
.method public final a(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Laek;->a(Landroid/view/ViewGroup;I)Z
...
.method public final c()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lagi;
    ...
    invoke-direct {v0, p0, v1, v2, v3}, Lagl;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Laev;Landroid/view/View;)V

    .line 148
    new-instance v1, Lagi;

    invoke-direct {v1, p0, v0}, Lagi;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Lagl;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lagi;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lagi;
    ...
    invoke-super {p0, v0}, Laek;->a(Lafu;)Z
...
.method public final d()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lagi;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lagi;
    ...
    .line 157
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->z:Lagl;
