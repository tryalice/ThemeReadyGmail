...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Laid;-><init>(Landroid/content/Context;II)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->D:Lakf;
...
.method public final a(Landroid/view/ViewGroup;)Lajg;
    ...
    .prologue
    .line 39
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lajg;

    .line 40
    invoke-super {p0, p1}, Laid;->a(Landroid/view/ViewGroup;)Lajg;
...
.method public final a(Lais;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 46
    :cond_0
    invoke-super {p0, p1, p2, p3}, Laid;->a(Lais;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 51
    invoke-static {v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lakj;
...
.method public final a(Laio;Z)V
    ...
    .line 260
    invoke-super {p0, p1, p2}, Laid;->a(Laio;Z)V

    .line 261
    return-void
.end method

.method public final a(Lais;Lajh;)V
    .locals 1

    .prologue
    .line 53
    invoke-interface {p2, p1}, Lajh;->a(Lais;)V
    ...
    .line 57
    iput-object v0, p2, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Laiq;

    .line 58
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Laka;
    ...
    invoke-direct {v0, p0}, Laka;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Laka;
    ...
    .line 61
    iput-object v0, p2, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Laic;
...
.method public final a(Landroid/content/Context;Laio;)V
    ...
    .line 5
    invoke-super {p0, p1, p2}, Laid;->a(Landroid/content/Context;Laio;)V
    ...
    .line 16
    iget-object v0, v3, Lahm;->a:Landroid/content/Context;
    ...
    .line 22
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;
    ...
    invoke-direct {v3, p0, v4}, Lakc;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;
    ...
    invoke-virtual {v3, v4}, Lakc;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v1, v1}, Lakc;->measure(II)V

    .line 30
    :cond_5
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;

    invoke-virtual {v1}, Lakc;->getMeasuredWidth()I
    ...
    .line 12
    :cond_6
    iget-object v4, v3, Lahm;->a:Landroid/content/Context;

    invoke-static {v4}, Landroid/view/ViewConfiguration;->get(Landroid/content/Context;)Landroid/view/ViewConfiguration;

    move-result-object v4

    invoke-static {v4}, Lvy;->a(Landroid/view/ViewConfiguration;)Z
    ...
    .line 31
    :cond_7
    iput-object v6, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;
...
.method public final a(Landroid/os/Parcelable;)V
    ...
    .line 269
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laio;

    iget v1, p1, Landroid/support/v7/widget/ActionMenuPresenter$SavedState;->a:I

    invoke-virtual {v0, v1}, Laio;->findItem(I)Landroid/view/MenuItem;
    ...
    .line 272
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Lajn;)Z
...
.method public final a(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    .prologue
    .line 279
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lajg;
...
.method public final a(Z)V
    ...
    .line 70
    iget-object v4, v0, Laio;->j:Ljava/util/ArrayList;
    ...
    .line 75
    iget-object v0, v0, Lais;->s:Lsx;

    .line 77
    if-eqz v0, :cond_0

    .line 79
    iput-object p0, v0, Lsx;->b:Lsy;
    ...
    .line 90
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;
    ...
    invoke-direct {v0, p0, v2}, Lakc;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;

    .line 92
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;

    invoke-virtual {v0}, Lakc;->getParent()Landroid/view/ViewParent;
    ...
    .line 93
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lajg;
    ...
    .line 95
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Lakc;
    ...
    .line 98
    invoke-static {}, Landroid/support/v7/widget/ActionMenuView;->a()Lakj;

    move-result-object v3

    .line 99
    iput-boolean v1, v3, Lakj;->a:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lajg;
...
.method public final a()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laio;
    ...
    invoke-virtual {v2}, Laio;->h()Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Lajg;
    ...
    invoke-virtual {v3}, Lais;->isActionViewExpanded()Z
    ...
    invoke-virtual {v0, v3, v8, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Lais;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v3, v9}, Lais;->c(Z)V
    ...
    invoke-virtual {v0, v3, v10, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Lais;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 254
    :cond_e
    invoke-virtual {v3, v13}, Lais;->c(Z)V
    ...
    .line 249
    invoke-virtual {v4}, Lais;->getGroupId()I
    ...
    invoke-virtual {v4, v0}, Lais;->c(Z)V
    ...
    invoke-virtual {v3, v8}, Lais;->c(Z)V
...
.method public final a(Lajn;)Z
    ...
    .line 112
    :goto_1
    iget-object v1, v0, Lajn;->A:Laio;

    .line 113
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Laio;

    if-eq v1, v2, :cond_2

    .line 115
    iget-object v0, v0, Lajn;->A:Laio;
    ...
    .line 124
    invoke-interface {v1}, Lajh;->a()Lais;
    ...
    .line 131
    invoke-virtual {p1}, Lajn;->getItem()Landroid/view/MenuItem;
    ...
    .line 135
    invoke-virtual {p1, v0}, Lajn;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, v4, p1, v2}, Lajz;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Lajn;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lajz;

    .line 141
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lajz;

    invoke-virtual {v1, v0}, Lajz;->a(Z)V

    .line 142
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->A:Lajz;

    invoke-virtual {v0}, Lajz;->a()V

    .line 143
    invoke-super {p0, p1}, Laid;->a(Lajn;)Z
...
.method public final a(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Laid;->a(Landroid/view/ViewGroup;I)Z
...
.method public final b(Z)V
    ...
    invoke-super {p0, v0}, Laid;->a(Lajn;)Z
...
.method public final e()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lakb;
    ...
    invoke-direct {v0, p0, v1, v2, v3}, Lake;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Laio;Landroid/view/View;)V

    .line 148
    new-instance v1, Lakb;

    invoke-direct {v1, p0, v0}, Lakb;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Lake;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lakb;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lakb;
...
.method public final f()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lakb;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Lakb;
    ...
    .line 157
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->z:Lake;
