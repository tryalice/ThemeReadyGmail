...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Lakk;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 5
    iput-boolean v2, p0, Lakk;->r:Z
...
.method protected static a()Lagq;
    .locals 2
...
.method protected static a(Landroid/view/ViewGroup$LayoutParams;)Lagq;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lagq;-><init>(Lagq;)V
    ...
    invoke-direct {v0, p0}, Lagq;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final b(Landroid/util/AttributeSet;)Lagq;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lagq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Lakl;
    .locals 1

    .prologue
    .line 312
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->b(Landroid/util/AttributeSet;)Lagq;
...
.method public final a(Lafm;Laew;)V
    ...
    .prologue
    .line 293
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lafm;

    .line 294
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->g:Laew;
...
.method public final a(Laez;)Z
    ...
    invoke-virtual {v0, p1, v1, v2}, Laev;->a(Landroid/view/MenuItem;Lafl;I)Z
...
.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Lakl;
    .locals 1

    .prologue
    .line 310
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lagq;
...
.method public final b()Landroid/view/Menu;
    ...
    invoke-direct {v2, p0}, Lagr;-><init>(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lafm;
    ...
    invoke-virtual {v0, v1, v2}, Laev;->a(Lafl;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lagp;-><init>(Landroid/support/v7/widget/ActionMenuView;)V
...
.method protected final synthetic d()Lakl;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 21
    invoke-super {p0, p1}, Lakk;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onDetachedFromWindow()V
    ...
    .prologue
    .line 263
    invoke-super {p0}, Lakk;->onDetachedFromWindow()V
...
.method protected onLayout(ZIIII)V
    ...
    .line 189
    invoke-super/range {p0 .. p5}, Lakk;->onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Lagq;->a:Z

    if-nez v5, :cond_b

    .line 242
    iget v5, v0, Lagq;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laev;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laev;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Laev;->b(Z)V
    ...
    iput-boolean v7, v6, Lagq;->d:Z

    .line 72
    const/4 v7, 0x0

    iput v7, v6, Lagq;->leftMargin:I

    .line 73
    const/4 v7, 0x0

    iput v7, v6, Lagq;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lagq;->e:Z

    .line 75
    iget-boolean v7, v6, Lagq;->a:Z
    ...
    iput-boolean v8, v6, Lagq;->f:Z

    .line 136
    if-nez v9, :cond_11

    iget-boolean v8, v6, Lagq;->e:Z
    ...
    iput v10, v6, Lagq;->rightMargin:I
    ...
    iput v9, v6, Lagq;->rightMargin:I

    iput v9, v6, Lagq;->leftMargin:I
    ...
    .line 166
    :cond_1d
    invoke-super/range {p0 .. p2}, Lakk;->onMeasure(II)V
