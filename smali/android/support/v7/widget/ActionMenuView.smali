...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Laok;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 5
    iput-boolean v2, p0, Laok;->r:Z
...
.method protected static a()Lakh;
    .locals 2
...
.method protected static a(Landroid/view/ViewGroup$LayoutParams;)Lakh;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lakh;-><init>(Lakh;)V
    ...
    invoke-direct {v0, p0}, Lakh;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final b(Landroid/util/AttributeSet;)Lakh;
    .locals 2
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Laol;
    .locals 1

    .prologue
    .line 312
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->b(Landroid/util/AttributeSet;)Lakh;
...
.method public final a(Laim;)V
    ...
    .prologue
    .line 280
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;
...
.method public final a(Lajd;Lain;)V
    ...
    .prologue
    .line 293
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lajd;

    .line 294
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lain;
...
.method public final a(Laiq;)Z
    ...
    .prologue
    .line 277
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;
    ...
    invoke-virtual {v0, p1, v1, v2}, Laim;->a(Landroid/view/MenuItem;Lajc;I)Z
...
.method public final b()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Laim;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;

    .line 285
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;

    new-instance v2, Laki;

    invoke-direct {v2, p0}, Laki;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Laim;->a(Lain;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lajd;
    ...
    invoke-virtual {v0, v1, v2}, Laim;->a(Lajc;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lakg;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    goto :goto_0
.end method

.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Laol;
    .locals 1

    .prologue
    .line 310
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lakh;
...
.method protected final synthetic d()Laol;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 21
    invoke-super {p0, p1}, Laok;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Lakh;->a:Z

    if-nez v5, :cond_b

    .line 242
    iget v5, v0, Lakh;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laim;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Laim;->a(Z)V
    ...
    iput-boolean v7, v6, Lakh;->d:Z

    .line 72
    const/4 v7, 0x0

    iput v7, v6, Lakh;->leftMargin:I

    .line 73
    const/4 v7, 0x0

    iput v7, v6, Lakh;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lakh;->e:Z

    .line 75
    iget-boolean v7, v6, Lakh;->a:Z
    ...
    iput-boolean v8, v6, Lakh;->f:Z

    .line 136
    if-nez v9, :cond_11

    iget-boolean v8, v6, Lakh;->e:Z
    ...
    iput v10, v6, Lakh;->rightMargin:I
    ...
    iput v9, v6, Lakh;->rightMargin:I

    iput v9, v6, Lakh;->leftMargin:I
    ...
    .line 166
    :cond_1d
    invoke-super/range {p0 .. p2}, Laok;->onMeasure(II)V
