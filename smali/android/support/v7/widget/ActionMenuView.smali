...
.method protected static a()Laji;
    .locals 2
...
.method protected static a(Landroid/view/ViewGroup$LayoutParams;)Laji;
    .locals 2
    ...
    invoke-direct {v0, p0}, Laji;-><init>(Laji;)V
    ...
    invoke-direct {v0, p0}, Laji;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final b(Landroid/util/AttributeSet;)Laji;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Laji;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Lano;
    .locals 1

    .prologue
    .line 47
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->b(Landroid/util/AttributeSet;)Laji;
...
.method public final a(Lahn;)V
    ...
    .prologue
    .line 635
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;
...
.method public final a(Laie;Laho;)V
    ...
    .prologue
    .line 668
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Laie;

    .line 669
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->g:Laho;
...
.method public final a(Lahr;)Z
    ...
    .prologue
    .line 623
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lahn;->a(Landroid/view/MenuItem;Laid;I)Z
...
.method public final b()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Lahn;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;

    .line 650
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;

    new-instance v2, Lajj;

    invoke-direct {v2, p0}, Lajj;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Lahn;->a(Laho;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Laie;
    ...
    invoke-virtual {v0, v1, v2}, Lahn;->a(Laid;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lajh;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    goto :goto_0
.end method

.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Lano;
    .locals 1

    .prologue
    .line 47
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Laji;
...
.method protected final synthetic d()Lano;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 127
    invoke-super {p0, p1}, Lann;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Laji;->a:Z

    if-nez v5, :cond_b

    .line 515
    iget v5, v0, Laji;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lahn;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lahn;->a(Z)V
    ...
    iput-boolean v7, v6, Laji;->d:Z

    .line 1230
    const/4 v7, 0x0

    iput v7, v6, Laji;->leftMargin:I

    .line 1231
    const/4 v7, 0x0

    iput v7, v6, Laji;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Laji;->e:Z

    .line 1235
    iget-boolean v7, v6, Laji;->a:Z
    ...
    iput-boolean v8, v6, Laji;->f:Z

    .line 1340
    if-nez v9, :cond_11

    iget-boolean v8, v6, Laji;->e:Z
    ...
    iput v10, v6, Laji;->rightMargin:I
    ...
    iput v9, v6, Laji;->rightMargin:I

    iput v9, v6, Laji;->leftMargin:I
    ...
    .line 171
    :cond_1d
    invoke-super/range {p0 .. p2}, Lann;->onMeasure(II)V
