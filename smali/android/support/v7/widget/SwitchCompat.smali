...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 101
    iput-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 106
    iput-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->g:Landroid/content/res/ColorStateList;

    .line 107
    iput-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 208
    iget-object v5, p0, Landroid/support/v7/widget/SwitchCompat;->F:Landroid/text/TextPaint;
    ...
    .line 210
    sget-object v0, Lafb;->df:[I

    invoke-static {p1, p2, v0, p3, v1}, Laqz;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Laqz;
    ...
    invoke-virtual {v5, v0}, Laqz;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v0}, Laqz;->c(I)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->o:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v0, v2}, Laqz;->a(IZ)Z
    ...
    invoke-virtual {v5, v0, v1}, Laqz;->e(II)I
    ...
    invoke-virtual {v5, v0, v1}, Laqz;->a(IZ)Z
    ...
    invoke-virtual {v5, v0}, Laqz;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 237
    invoke-virtual {v5, v0, v9}, Laqz;->a(II)I

    move-result v0

    .line 236
    invoke-static {v0, v4}, Lals;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    .line 238
    iget-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, v6}, Lml;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v0, v6}, Lml;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 253
    iget-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v5, v0, v1}, Laqz;->g(II)I
    ...
    invoke-static {p1, v0, v6}, Laqz;->a(Landroid/content/Context;I[I)Laqz;
    ...
    invoke-virtual {v6, v0}, Laqz;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v0, v1}, Laqz;->e(II)I
    ...
    iget-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->F:Landroid/text/TextPaint;
    ...
    .line 30302
    iget-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->F:Landroid/text/TextPaint;
    ...
    invoke-virtual {v6, v0, v9}, Laqz;->a(II)I
    ...
    invoke-virtual {v6, v7, v9}, Laqz;->a(II)I
    ...
    invoke-virtual {v6, v0, v1}, Laqz;->a(IZ)Z
    ...
    invoke-direct {v0, v1}, Lafr;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->J:Landroid/text/method/TransformationMethod;

    .line 60210
    :goto_7
    iget-object v0, v6, Laqz;->b:Landroid/content/res/TypedArray;

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 4674
    :cond_11
    iget-object v0, v5, Laqz;->b:Landroid/content/res/TypedArray;
    ...
    .line 30317
    :cond_18
    iput-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->J:Landroid/text/method/TransformationMethod;
...
.method private final a()V
    ...
    .prologue
    .line 1035
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->K:Laqs;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->K:Laqs;
...
.method private final d()I
    ...
    invoke-static {v0}, Lals;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1312
    :cond_0
    sget-object v0, Lals;->a:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1189
    invoke-static {v2, v1, v3, v0, v5}, Lml;->a(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Lml;->a(Landroid/graphics/drawable/Drawable;FF)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1218
    invoke-static {v4}, Lals;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v1}, Lals;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    .line 843
    invoke-static {p0}, Ltv;->g(Landroid/view/View;)I
...
.method public setChecked(Z)V
    ...
    .line 11008
    iget-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->K:Laqs;
    ...
    :goto_0
    invoke-direct {v3, p0, v4, v0}, Laqs;-><init>(Landroid/support/v7/widget/SwitchCompat;FF)V

    iput-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->K:Laqs;
    ...
    invoke-virtual {v0, v4, v5}, Laqs;->setDuration(J)V
    ...
    invoke-direct {v1, p0, v2}, Laqr;-><init>(Landroid/support/v7/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Laqs;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
