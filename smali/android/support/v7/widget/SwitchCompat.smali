...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 210
    sget-object v0, Lafk;->df:[I

    invoke-static {p1, p2, v0, p3, v1}, Lari;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lari;
    ...
    invoke-virtual {v5, v0}, Lari;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v0}, Lari;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v0, v2}, Lari;->a(IZ)Z
    ...
    invoke-virtual {v5, v0, v1}, Lari;->e(II)I
    ...
    invoke-virtual {v5, v0, v1}, Lari;->a(IZ)Z
    ...
    invoke-virtual {v5, v0}, Lari;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 237
    invoke-virtual {v5, v0, v9}, Lari;->a(II)I

    move-result v0

    .line 236
    invoke-static {v0, v4}, Lamb;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, v6}, Lmp;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v0, v6}, Lmp;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v5, v0, v1}, Lari;->g(II)I
    ...
    .line 30285
    sget-object v6, Lafk;->dw:[I

    invoke-static {p1, v0, v6}, Lari;->a(Landroid/content/Context;I[I)Lari;
    ...
    invoke-virtual {v6, v0}, Lari;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v0, v1}, Lari;->e(II)I
    ...
    invoke-virtual {v6, v0, v9}, Lari;->a(II)I
    ...
    invoke-virtual {v6, v7, v9}, Lari;->a(II)I
    ...
    invoke-virtual {v6, v0, v1}, Lari;->a(IZ)Z
    ...
    invoke-direct {v0, v1}, Laga;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->J:Landroid/text/method/TransformationMethod;

    .line 60210
    :goto_7
    iget-object v0, v6, Lari;->b:Landroid/content/res/TypedArray;

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 4674
    :cond_11
    iget-object v0, v5, Lari;->b:Landroid/content/res/TypedArray;
...
.method private final a()V
    ...
    .prologue
    .line 1035
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->K:Larb;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->K:Larb;
...
.method private final d()I
    ...
    invoke-static {v0}, Lamb;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1312
    :cond_0
    sget-object v0, Lamb;->a:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1189
    invoke-static {v2, v1, v3, v0, v5}, Lmp;->a(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Lmp;->a(Landroid/graphics/drawable/Drawable;FF)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1218
    invoke-static {v4}, Lamb;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v1}, Lamb;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    .line 843
    invoke-static {p0}, Lue;->g(Landroid/view/View;)I
...
.method public setChecked(Z)V
    ...
    .line 11008
    iget-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->K:Larb;
    ...
    :goto_0
    invoke-direct {v3, p0, v4, v0}, Larb;-><init>(Landroid/support/v7/widget/SwitchCompat;FF)V

    iput-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->K:Larb;
    ...
    invoke-virtual {v0, v4, v5}, Larb;->setDuration(J)V
    ...
    invoke-direct {v1, p0, v2}, Lara;-><init>(Landroid/support/v7/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Larb;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
