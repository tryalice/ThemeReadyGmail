...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lagw;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final i()V
    ...
    .line 65
    :goto_0
    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_0

    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Ladv;
    ...
    .line 69
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Ladv;

    invoke-virtual {v0}, Ladv;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Ladv;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :goto_4
    invoke-static {p0, v3}, Lanp;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0}, Ladv;->getTitle()Ljava/lang/CharSequence;
...
.method public final a(Ladv;)V
    ...
    .line 29
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Ladv;

    .line 30
    invoke-virtual {p1}, Ladv;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 46
    invoke-virtual {p1, p0}, Ladv;->a(Laek;)Ljava/lang/CharSequence;
    ...
    .line 49
    invoke-virtual {p1}, Ladv;->getItemId()I
    ...
    .line 50
    invoke-virtual {p1}, Ladv;->isVisible()Z
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Laig;
    ...
    invoke-direct {v0, p0}, Ladd;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Laig;
...
.method public final f()Z
    ...
    invoke-virtual {v0}, Ladv;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Ladt;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Ladv;

    invoke-interface {v0, v1}, Ladt;->a(Ladv;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 17
    invoke-super {p0, p1}, Lagw;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    .line 85
    invoke-super {p0, v0, v2, v3, v4}, Lagw;->setPadding(IIII)V

    .line 86
    :cond_0
    invoke-super {p0, p1, p2}, Lagw;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lagw;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Lagw;->setPadding(IIII)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Lagw;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lagw;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setPadding(IIII)V
    ...
    .line 26
    invoke-super {p0, p1, p2, p3, p4}, Lagw;->setPadding(IIII)V
