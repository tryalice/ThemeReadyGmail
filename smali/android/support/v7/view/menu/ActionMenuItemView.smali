...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Ladz;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final i()V
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Laay;
    ...
    .line 69
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Laay;

    invoke-virtual {v0}, Laay;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Laay;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :goto_4
    invoke-static {p0, v3}, Laks;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final a(Laay;)V
    ...
    .line 29
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Laay;
    ...
    .line 46
    invoke-virtual {p1, p0}, Laay;->a(Labn;)Ljava/lang/CharSequence;
    ...
    .line 49
    invoke-virtual {p1}, Laay;->getItemId()I
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Lafj;
    ...
    invoke-direct {v0, p0}, Laag;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Lafj;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Laaw;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Laay;

    invoke-interface {v0, v1}, Laaw;->a(Laay;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 17
    invoke-super {p0, p1}, Ladz;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    .line 85
    invoke-super {p0, v0, v2, v3, v4}, Ladz;->setPadding(IIII)V

    .line 86
    :cond_0
    invoke-super {p0, p1, p2}, Ladz;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Ladz;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Ladz;->setPadding(IIII)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Ladz;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Ladz;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setPadding(IIII)V
    ...
    .line 26
    invoke-super {p0, p1, p2, p3, p4}, Ladz;->setPadding(IIII)V
