...
# direct methods
.method constructor <init>(Lbbb;Lcom/android/emailcommon/provider/Account;)V
    .locals 0
    ...
    iput-object p2, p0, Lbbd;->a:Lcom/android/emailcommon/provider/Account;
...
.method public final run()V
    ...
    .line 2
    iget-object v0, p0, Lbbd;->a:Lcom/android/emailcommon/provider/Account;
    ...
    .line 5
    iget-object v1, p0, Lbbd;->a:Lcom/android/emailcommon/provider/Account;

    invoke-interface {v0, v1}, Lbbi;->a(Lcom/android/emailcommon/provider/Account;)V
    ...
    invoke-direct {v0, p0}, Lbbe;-><init>(Lbbd;)V
    ...
    iget-object v1, p0, Lbbd;->b:Lbbb;

    iget-object v1, v1, Lbbb;->a:Lbay;
    ...
    .line 16
    invoke-virtual {v0}, Lbay;->getArguments()Landroid/os/Bundle;
    ...
    iget-object v4, v1, Lbay;->b:Landroid/content/Context;

    invoke-direct {v3, v4}, Lbgr;-><init>(Landroid/content/Context;)V

    new-instance v4, Lbaz;

    invoke-direct {v4, v1, v2}, Lbaz;-><init>(Lbay;Lcom/android/emailcommon/provider/Account;)V

    .line 22
    invoke-virtual {v3}, Lbgr;->a()Z
    ...
    .line 26
    invoke-direct {v1, v3, v4, v0}, Lbgy;-><init>(Lbgr;Lbgv;Ljava/lang/String;)V

    .line 27
    new-array v0, v5, [Ljava/lang/Void;

    invoke-virtual {v1, v0}, Lbgy;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
