...
.method public static a(Landroid/content/Context;Lboz;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    .locals 10
    ...
    .line 5
    iget-object v6, p1, Lboz;->q:Ljava/lang/String;
    ...
    invoke-static {p0, v6, v0}, Lbpn;->a(Landroid/content/Context;Landroid/database/Cursor;Ljava/lang/Class;)Lbpn;
    ...
    invoke-static {p0, v2, v3}, Lbpj;->a(Landroid/content/Context;J)Lbpj;
    ...
    .line 26
    invoke-static {p1, v1, v2}, Lboi;->a(Lbpe;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    .line 28
    invoke-static {v1}, Lbtb;->a(Ljava/util/ArrayList;)Lbtc;

    move-result-object v3

    .line 29
    iget-boolean v4, v3, Lbtc;->d:Z

    iget-boolean v5, v3, Lbtc;->e:Z

    invoke-virtual {v0, v4, v5}, Lbpu;->a(ZZ)V

    .line 30
    iget-object v4, v3, Lbtc;->c:Ljava/lang/String;

    iput-object v4, v0, Lbpu;->ah:Ljava/lang/String;

    .line 31
    iget-object v4, v3, Lbtc;->a:Ljava/lang/String;

    iput-object v4, v7, Lbpj;->e:Ljava/lang/String;

    .line 32
    iget-object v3, v3, Lbtc;->b:Ljava/lang/String;

    iput-object v3, v7, Lbpj;->d:Ljava/lang/String;

    .line 33
    invoke-static {v0, p0}, Lblj;->a(Lbpn;Landroid/content/Context;)V

    .line 34
    iget-wide v4, v0, Lbpu;->L:J

    iput-wide v4, v7, Lbpj;->c:J

    .line 35
    invoke-static {v7, p0}, Lblj;->a(Lbpn;Landroid/content/Context;)V

    .line 36
    invoke-static {p4}, Lbpu;->a(I)Z
    ...
    .line 37
    invoke-static {p0, v0, v2}, Lazy;->a(Landroid/content/Context;Lbpu;Ljava/util/ArrayList;)V

    .line 38
    invoke-static {p0, v0, v1}, Lazy;->b(Landroid/content/Context;Lbpu;Ljava/util/ArrayList;)V
...
.method public static a(Lbpn;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lbpn;->a(Landroid/content/Context;Landroid/content/ContentValues;)I
    ...
    .line 61
    :cond_0
    invoke-virtual {p0, p1}, Lbpn;->i(Landroid/content/Context;)Landroid/net/Uri;
