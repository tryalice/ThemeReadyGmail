...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgbx;->a:Ljava/util/Map;
    ...
    sget-object v0, Lgbx;->a:Ljava/util/Map;
    ...
    sput-object v0, Lgbx;->b:Landroid/os/Handler;
    ...
    sput-object v0, Lgbx;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgbx;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgbx;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgbx;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lgbx;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lgbx;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lgbx;->j:Ljava/security/SecureRandom;

    new-instance v0, Lgby;

    invoke-direct {v0}, Lgby;-><init>()V

    sput-object v0, Lgbx;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lgbz;

    invoke-direct {v0}, Lgbz;-><init>()V

    sput-object v0, Lgbx;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lgca;

    invoke-direct {v0}, Lgca;-><init>()V

    sput-object v0, Lgbx;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lgcb;

    invoke-direct {v0}, Lgcb;-><init>()V

    sput-object v0, Lgbx;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lgcc;

    invoke-direct {v0}, Lgcc;-><init>()V

    sput-object v0, Lgbx;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lgcd;

    invoke-direct {v0}, Lgcd;-><init>()V

    sput-object v0, Lgbx;->p:Ljava/lang/ThreadLocal;
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lgbx;->m:Ljava/lang/ThreadLocal;
