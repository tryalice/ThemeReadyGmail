...
# virtual methods
.method public final a(Lckx;)V
    .locals 2

    .prologue
    .line 80
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lckx;

    .line 81
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lckx;

    iget-object v0, v0, Lckx;->g:Lcrz;

    iput-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrz;
    ...
    .line 84
    iput-object p1, v0, Lcom/android/mail/browse/SubjectAndFolderView;->n:Lckx;

    .line 85
    :cond_0
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrz;
...
.method public final a(Lclc;Lcje;Lder;)V
    .locals 0

    .prologue
    .line 12
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lclc;

    .line 13
    iput-object p2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcje;

    .line 14
    iput-object p3, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lder;
...
.method public final a(Lcom/android/mail/providers/Conversation;)V
    ...
    .line 21
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcje;
    ...
    iget-object v5, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lclc;

    iget-object v2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcje;

    .line 24
    invoke-interface {v2}, Lcje;->a()Lcom/android/mail/providers/Account;
    ...
    .line 27
    invoke-virtual {v4}, Lcom/android/mail/browse/SubjectAndFolderView;->a()Lrc;
    ...
    .line 44
    new-instance v8, Lcnl;

    invoke-direct {v8, v1, v2}, Lcnl;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {p1}, Lcom/android/mail/providers/Conversation;->b()Z
    ...
    invoke-direct {v0, v4}, Lcnm;-><init>(Lcom/android/mail/browse/SubjectAndFolderView;)V
    ...
    .line 56
    :cond_3
    iget-object v0, v4, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcnn;

    const/4 v2, 0x0

    const/4 v3, -0x1

    invoke-virtual {v0, p1, v6, v2, v3}, Lcnn;->a(Lcom/android/mail/providers/Conversation;Lcom/android/mail/providers/Account;Ldrx;I)V

    .line 57
    iget-object v0, v4, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcnn;

    .line 58
    invoke-virtual {v0, v7}, Lcnn;->a(Landroid/text/SpannableStringBuilder;)V
    ...
    invoke-direct {v2, v5}, Lczx;-><init>(Lclc;)V
    ...
    invoke-virtual {v1, v2}, Lrc;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(ZZ)V
    ...
    .line 70
    :goto_1
    iget-object v3, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcje;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 89
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrz;
    ...
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lder;

    new-instance v2, Lcle;

    invoke-direct {v2, p0, v3}, Lcle;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V

    .line 93
    invoke-static {}, Lczs;->a()Z

    .line 94
    invoke-virtual {v0, v3, v1, v2}, Lcrz;->a(ZLder;Lczt;)V
    ...
    invoke-direct {v2, p0, v4}, Lcle;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V

    .line 98
    invoke-static {}, Lczs;->a()Z

    .line 99
    invoke-virtual {v0, v4, v1, v2}, Lcrz;->a(ZLder;Lczt;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 102
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lclc;
    ...
    .line 109
    invoke-virtual {v2, v3}, Lcld;->setArguments(Landroid/os/Bundle;)V

    .line 111
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lclc;

    invoke-interface {v1}, Lclc;->getActivity()Landroid/app/Activity;
