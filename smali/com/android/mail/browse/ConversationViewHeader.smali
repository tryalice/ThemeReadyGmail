...
.method public final a(Lckd;)V
    ...
    .prologue
    .line 80
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lckd;

    .line 81
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lckd;

    iget-object v0, v0, Lckd;->g:Lcrd;

    iput-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrd;
    ...
    .line 84
    iput-object p1, v0, Lcom/android/mail/browse/SubjectAndFolderView;->n:Lckd;

    .line 85
    :cond_0
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrd;

    invoke-virtual {v0}, Lcrd;->b()Z
...
.method public final a(Lcki;Lcik;Lddu;)V
    .locals 0

    .prologue
    .line 12
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcki;

    .line 13
    iput-object p2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcik;

    .line 14
    iput-object p3, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lddu;
...
.method public final a(Lcom/android/mail/providers/Conversation;)V
    ...
    .line 21
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcik;
    ...
    iget-object v5, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcki;

    iget-object v2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcik;

    .line 24
    invoke-interface {v2}, Lcik;->a()Lcom/android/mail/providers/Account;
    ...
    .line 27
    invoke-virtual {v4}, Lcom/android/mail/browse/SubjectAndFolderView;->a()Lqz;
    ...
    invoke-direct {v8, v1, v2}, Lcmr;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-direct {v0, v4}, Lcms;-><init>(Lcom/android/mail/browse/SubjectAndFolderView;)V
    ...
    .line 56
    :cond_3
    iget-object v0, v4, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcmt;

    const/4 v2, 0x0

    const/4 v3, -0x1

    invoke-virtual {v0, p1, v6, v2, v3}, Lcmt;->a(Lcom/android/mail/providers/Conversation;Lcom/android/mail/providers/Account;Ldqw;I)V

    .line 57
    iget-object v0, v4, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcmt;

    .line 58
    invoke-virtual {v0, v7}, Lcmt;->a(Landroid/text/SpannableStringBuilder;)V
    ...
    invoke-direct {v2, v5}, Lczb;-><init>(Lcki;)V
    ...
    invoke-virtual {v1, v2}, Lqz;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(ZZ)V
    ...
    .line 70
    :goto_1
    iget-object v3, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcik;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 89
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lcrd;
    ...
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lddu;

    new-instance v2, Lckk;

    invoke-direct {v2, p0, v3}, Lckk;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V

    .line 93
    invoke-static {}, Lcyw;->a()Z

    .line 94
    invoke-virtual {v0, v3, v1, v2}, Lcrd;->a(ZLddu;Lcyx;)V
    ...
    invoke-direct {v2, p0, v4}, Lckk;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V

    .line 98
    invoke-static {}, Lcyw;->a()Z

    .line 99
    invoke-virtual {v0, v4, v1, v2}, Lcrd;->a(ZLddu;Lcyx;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 102
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcki;
    ...
    invoke-interface {v1}, Lcki;->getActivity()Landroid/app/Activity;
