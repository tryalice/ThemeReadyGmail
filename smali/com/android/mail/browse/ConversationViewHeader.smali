...
.method public final a(Lcdk;)V
    ...
    .prologue
    .line 82
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lcdk;

    .line 83
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->g:Lcdk;

    iget-object v0, v0, Lcdk;->g:Lckp;

    iput-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lckp;
    ...
    .line 86
    iput-object p1, v0, Lcom/android/mail/browse/SubjectAndFolderView;->n:Lcdk;

    .line 87
    :cond_0
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lckp;
...
.method public final a(Lcdp;Lcbr;Lcyi;)V
    .locals 0

    .prologue
    .line 11
    iput-object p1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcdp;

    .line 12
    iput-object p2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcbr;

    .line 13
    iput-object p3, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lcyi;
...
.method public final a(Lcom/android/mail/providers/Conversation;)V
    ...
    .line 20
    iget-object v0, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcbr;
    ...
    iget-object v7, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcdp;

    iget-object v2, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcbr;

    .line 25
    invoke-interface {v2}, Lcbr;->a()Lcom/android/mail/providers/Account;
    ...
    .line 28
    invoke-virtual {v6}, Lcom/android/mail/browse/SubjectAndFolderView;->a()Lnd;
    ...
    invoke-direct {v9, v1, v3}, Lcfy;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-direct {v0, v6}, Lcfz;-><init>(Lcom/android/mail/browse/SubjectAndFolderView;)V
    ...
    .line 57
    :cond_3
    iget-object v0, v6, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcga;
    ...
    invoke-virtual/range {v0 .. v5}, Lcga;->a(Lcom/android/mail/providers/Conversation;Lcom/android/mail/providers/Account;Ldne;IZ)V

    .line 58
    iget-object v0, v6, Lcom/android/mail/browse/SubjectAndFolderView;->k:Lcga;

    .line 59
    invoke-virtual {v0, v8}, Lcga;->a(Landroid/text/SpannableStringBuilder;)V
    ...
    invoke-direct {v1, v7}, Lctl;-><init>(Lcdp;)V
    ...
    invoke-virtual {v1, v3}, Lnd;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(ZZ)V
    ...
    .line 67
    iget-object v3, v0, Lckp;->d:Lcom/android/mail/providers/Account;
    ...
    .line 71
    :goto_1
    iget-object v3, p0, Lcom/android/mail/browse/ConversationViewHeader;->e:Lcbr;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 91
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->h:Lckp;
    ...
    .line 94
    iget-object v0, v0, Lckp;->d:Lcom/android/mail/providers/Account;
    ...
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->f:Lcyi;

    new-instance v2, Lcdr;

    invoke-direct {v2, p0, v4}, Lcdr;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V
    ...
    .line 97
    invoke-virtual {v0, v4, v1, v2}, Lckp;->a(ZLcyi;Lcth;)V
    ...
    invoke-direct {v2, p0, v5}, Lcdr;-><init>(Lcom/android/mail/browse/ConversationViewHeader;Z)V
    ...
    .line 103
    invoke-virtual {v0, v5, v1, v2}, Lckp;->a(ZLcyi;Lcth;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 106
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcdp;
    ...
    .line 113
    invoke-virtual {v2, v3}, Lcdq;->setArguments(Landroid/os/Bundle;)V

    .line 115
    iget-object v1, p0, Lcom/android/mail/browse/ConversationViewHeader;->d:Lcdp;

    invoke-interface {v1}, Lcdp;->getActivity()Landroid/app/Activity;
