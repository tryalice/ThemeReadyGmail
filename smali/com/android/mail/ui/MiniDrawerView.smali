...
.method public final a()V
    ...
    .line 12
    iget-object v0, p0, Lcom/android/mail/ui/MiniDrawerView;->a:Ldgw;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/mail/ui/MiniDrawerView;->a:Ldgw;

    invoke-virtual {v0}, Ldgw;->isAdded()Z
    ...
    .line 17
    invoke-virtual {v0}, Ldgw;->k()Landroid/widget/ListAdapter;
    ...
    iget-object v0, v0, Ldio;->a:Landroid/view/View;
    ...
    .line 46
    iget-object v1, v0, Ldgw;->p:Ldhe;

    if-eqz v1, :cond_8

    iget-object v0, v0, Ldgw;->p:Ldhe;

    invoke-interface {v0}, Ldhe;->c()Lcrv;
    ...
    invoke-virtual {v6}, Lcrv;->isClosed()Z
    ...
    invoke-virtual {v6, v5}, Lcrv;->moveToPosition(I)Z
    ...
    .line 52
    invoke-virtual {v6}, Lcrv;->f()Ljava/lang/Object;
    ...
    .line 58
    new-instance v8, Ldin;

    invoke-direct {v8, p0, v0, v1}, Ldin;-><init>(Lcom/android/mail/ui/MiniDrawerView;Lcom/android/mail/providers/Folder;Landroid/widget/ImageView;)V
    ...
    .line 60
    iget-object v1, p0, Lcom/android/mail/ui/MiniDrawerView;->a:Ldgw;

    .line 61
    iget-object v8, v0, Lcom/android/mail/providers/Folder;->p:Ldrx;

    iget-object v1, v1, Ldgw;->k:Ldrx;

    invoke-virtual {v8, v1}, Ldrx;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v8, v7, v0}, Ldio;-><init>(Landroid/view/View;Ljava/lang/Integer;)V
