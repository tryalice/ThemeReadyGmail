...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lblm;-><init>(Lcom/android/email/service/AttachmentService;)V

    iput-object v0, p0, Lcom/android/email/service/AttachmentService;->a:Lblm;
    ...
    iput-object v0, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;
...
.method private final declared-synchronized a(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)V
    ...
    .line 127
    iget-object v0, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    iget-wide v2, p2, Lcom/android/emailcommon/provider/Attachment;->M:J

    invoke-virtual {v0, v2, v3}, Lblj;->c(J)Lbll;
    ...
    .line 134
    iget-object v1, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    invoke-virtual {v1, v0}, Lblj;->b(Lbll;)Z
    ...
    .line 141
    invoke-direct {v0, p1, p2}, Lbll;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)V

    .line 143
    new-instance v1, Lazi;

    invoke-direct {v1, p1, p2}, Lazi;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)V
    ...
    invoke-virtual {v1, v0}, Lblj;->a(Lbll;)Z
...
.method private final declared-synchronized b(Lbll;)Z
    .locals 10
    ...
    iput-wide v2, p1, Lbll;->j:J

    .line 297
    const/4 v1, 0x1

    iput-boolean v1, p1, Lbll;->f:Z
    ...
    .line 299
    iget-object v1, p0, Lcom/android/email/service/AttachmentService;->a:Lblm;

    iget-wide v2, p1, Lbll;->e:J
    ...
    :cond_2
    invoke-interface/range {v0 .. v6}, Lbrn;->a(Lbrx;JJZ)V
    ...
    :try_start_2
    invoke-virtual {p0, p1}, Lcom/android/email/service/AttachmentService;->a(Lbll;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized a()V
    ...
    invoke-static {v2, v3, v6}, Lcvc;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    iget-object v4, v0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    invoke-virtual {v4}, Lblj;->b()I
    ...
    iget-object v2, v0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    invoke-virtual {v2}, Lblj;->a()Lbll;
    ...
    .line 184
    iget-object v5, v4, Lblj;->b:Ljava/lang/Object;
    ...
    .line 185
    :try_start_2
    iget-wide v6, v3, Lbll;->e:J

    .line 186
    invoke-virtual {v4, v6, v7}, Lblj;->b(J)Ljava/util/PriorityQueue;
    ...
    invoke-direct {v0, v3}, Lcom/android/email/service/AttachmentService;->b(Lbll;)Z
    ...
    iget-object v2, v0, Lcom/android/email/service/AttachmentService;->d:Lazj;
    ...
    .line 209
    iget-object v2, v2, Lazj;->e:Landroid/net/ConnectivityManager;
    ...
    invoke-static {v2, v3}, Lbpw;->a(Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    invoke-static {v0, v2, v8, v9}, Lbpw;->a(Landroid/content/Context;Landroid/net/Uri;J)I
    :try_end_7
    ...
    invoke-direct {v2, v0, v7}, Lazi;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)V

    .line 236
    invoke-virtual {v2}, Lazi;->a()Z
    ...
    invoke-static {v2}, Ldrg;->a(Landroid/content/Context;)Z
    ...
    iget-object v2, v0, Lcom/android/email/service/AttachmentService;->l:Lblh;

    .line 253
    iget-object v3, v2, Lblh;->a:Landroid/content/Context;

    if-eqz v3, :cond_14

    .line 254
    iget-object v2, v2, Lblh;->a:Landroid/content/Context;

    invoke-static {v2}, Ldql;->d(Landroid/content/Context;)I
    ...
    invoke-direct {v2, v0, v7}, Lbll;-><init>(Landroid/content/Context;Lcom/android/emailcommon/provider/Attachment;)V

    .line 282
    move-object/from16 v0, p0

    invoke-direct {v0, v2}, Lcom/android/email/service/AttachmentService;->b(Lbll;)Z
    :try_end_9
...
.method public final declared-synchronized a(JI)V
    ...
    .line 328
    :cond_1
    iget-object v2, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    move-wide/from16 v0, p1

    invoke-virtual {v2, v0, v1}, Lblj;->c(J)Lbll;
    ...
    .line 332
    iget-wide v6, v2, Lbll;->k:J

    const-wide/16 v8, 0x1

    add-long/2addr v6, v8

    iput-wide v6, v2, Lbll;->k:J
    ...
    .line 337
    iget-object v4, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    invoke-virtual {v4, v2}, Lblj;->b(Lbll;)Z
    ...
    invoke-virtual {v4, v6, v7}, Lblj;->a(J)Z
    ...
    .line 347
    invoke-static {v3, v5, v6}, Lcvc;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I

    .line 348
    const/4 v3, 0x0

    iput-boolean v3, v2, Lbll;->f:Z

    .line 349
    const-wide/16 v6, 0x0

    iput-wide v6, v2, Lbll;->l:J
    ...
    .line 359
    iget-object v5, p0, Lcom/android/email/service/AttachmentService;->j:Lblj;

    invoke-virtual {v5, v2}, Lblj;->b(Lbll;)Z
    ...
    invoke-static {p0, v2, v8, v9}, Lbpw;->a(Landroid/content/Context;Landroid/net/Uri;J)I
    ...
    .line 378
    invoke-static {v2, v3, v8}, Lcvc;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-static {p0, v8, v9}, Lbts;->d(Landroid/content/Context;J)Z
    ...
    .line 381
    invoke-static {p0, v6, v7}, Lblt;->a(Landroid/content/Context;J)Lbrn;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 382
    :try_start_2
    invoke-interface {v3, v6, v7}, Lbrn;->c(J)V
    :try_end_2
    ...
    invoke-static {p0, v2, v3}, Lbqg;->a(Landroid/content/Context;J)Lbqg;
    ...
    invoke-static {p0, v2, v6, v7}, Lbpw;->a(Landroid/content/Context;Landroid/net/Uri;J)I
    ...
    invoke-virtual {v2, v4, v5}, Lblj;->a(J)Z
    ...
    invoke-static {v4, v3, v6, v7}, Lcvc;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 411
    invoke-interface {v2, v3}, Lcxr;->a(Ljava/lang/String;)V
    :try_end_4
...
.method public final declared-synchronized a(Lbll;)V
    .locals 6
    ...
    invoke-virtual {v0, p1}, Lblj;->b(Lbll;)Z
    ...
    invoke-virtual {v0, v2, v3}, Lblj;->a(J)Z
    ...
    .line 315
    invoke-direct {v0, p1, v2, v3}, Lbll;-><init>(Lbll;J)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lblj;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 435
    iget-wide v6, v0, Lbll;->e:J

    iget-wide v8, v0, Lbll;->c:J
    ...
    iget-wide v8, v0, Lbll;->b:J

    iget-boolean v1, v0, Lbll;->f:Z
    ...
    .line 459
    iget-wide v6, v0, Lbll;->j:J

    iget-wide v8, v0, Lbll;->i:J
    ...
    invoke-static {v7, v1}, Lbts;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public onDestroy()V
    ...
    .line 38
    :cond_0
    iget-object v0, p0, Lcom/android/email/service/AttachmentService;->d:Lazj;
    ...
    .line 41
    iput-boolean v1, v0, Lazj;->f:Z

    .line 42
    iget-object v0, v0, Lazj;->g:Ljava/lang/Thread;
    ...
    .line 45
    :cond_1
    iput-object v2, p0, Lcom/android/email/service/AttachmentService;->d:Lazj;
...
.method public run()V
    ...
    invoke-direct {v0, p0, v1}, Lazj;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/email/service/AttachmentService;->d:Lazj;

    .line 48
    new-instance v0, Lblh;

    invoke-direct {v0, p0}, Lblh;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/email/service/AttachmentService;->l:Lblh;
    ...
    .line 70
    iget-object v1, p0, Lcom/android/email/service/AttachmentService;->d:Lazj;

    .line 71
    if-eqz v1, :cond_5

    .line 73
    iget-boolean v0, v1, Lazj;->h:Z
    ...
    iput-object v0, v1, Lazj;->g:Ljava/lang/Thread;

    .line 77
    iget-object v0, v1, Lazj;->d:Landroid/os/PowerManager$WakeLock;
    ...
    :goto_2
    :try_start_2
    iget-boolean v2, v1, Lazj;->f:Z

    if-nez v2, :cond_b

    .line 79
    iget-object v2, v1, Lazj;->e:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, v1, Lazj;->a:Ljava/lang/String;
    ...
    .line 85
    :cond_4
    iput-object v5, v1, Lazj;->g:Ljava/lang/Thread;
    ...
    .line 90
    :cond_9
    iget-object v2, v1, Lazj;->b:Ljava/lang/Object;
    ...
    .line 91
    :try_start_4
    iget-object v3, v1, Lazj;->d:Landroid/os/PowerManager$WakeLock;
    ...
    .line 92
    :try_start_5
    iget-object v3, v1, Lazj;->b:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lazj;->d:Landroid/os/PowerManager$WakeLock;
