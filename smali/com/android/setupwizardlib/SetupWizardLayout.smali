...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0}, Ldqg;-><init>(Landroid/content/Context;II)V
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .prologue
    .line 6
    invoke-direct {p0, p1, p2, p3}, Ldqg;-><init>(Landroid/content/Context;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .prologue
    .line 9
    invoke-direct {p0, p1, p2}, Ldqg;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 12
    invoke-direct {p0, p1, p2, p3}, Ldqg;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final a(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0, p1, p2}, Ldqq;-><init>(Ldqg;Landroid/util/AttributeSet;I)V

    invoke-virtual {p0, v0, v1}, Lcom/android/setupwizardlib/SetupWizardLayout;->a(Ljava/lang/Class;Ldqs;)V
    ...
    invoke-direct {v1, p0}, Ldqu;-><init>(Ldqg;)V
    ...
    invoke-direct {v1, p0}, Ldqt;-><init>(Ldqg;)V
    ...
    invoke-direct {v0, p0}, Ldqv;-><init>(Ldqg;)V

    .line 19
    const-class v1, Ldqv;

    invoke-virtual {p0, v1, v0}, Lcom/android/setupwizardlib/SetupWizardLayout;->a(Ljava/lang/Class;Ldqs;)V
    ...
    invoke-direct {v2, v0, v1}, Ldrb;-><init>(Ldqv;Landroid/widget/ScrollView;)V

    .line 23
    iput-object v2, v0, Ldqv;->e:Ldra;
...
.method protected final a(I)Landroid/view/ViewGroup;
    ...
    .line 77
    :cond_0
    invoke-super {p0, p1}, Ldqg;->a(I)Landroid/view/ViewGroup;
...
.method public getHeaderText()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Lcom/android/setupwizardlib/SetupWizardLayout;->getMixin(Ljava/lang/Class;)Ldqs;
    ...
    .line 108
    invoke-virtual {v0}, Ldqq;->a()Landroid/widget/TextView;
...
.method public getProgressBarColor()Landroid/content/res/ColorStateList;
    ...
    .line 181
    iget-object v0, v0, Ldqu;->b:Landroid/content/res/ColorStateList;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 65
    invoke-super {p0, p1}, Ldqg;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Ldqg;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 59
    invoke-super {p0}, Ldqg;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public requireScrollToBottom()V
    ...
    invoke-direct {v2, v1}, Ldqx;-><init>(Lcom/android/setupwizardlib/view/NavigationBar;)V

    .line 89
    iput-object v2, v0, Ldqv;->f:Ldqz;
    ...
    invoke-direct {v2, v0, v3}, Ldqw;-><init>(Ldqv;Landroid/view/View$OnClickListener;)V
...
.method public setProgressBarColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Ldqu;->a(Landroid/content/res/ColorStateList;)V
...
.method public setProgressBarShown(Z)V
    ...
    invoke-virtual {v0, p1}, Ldqu;->a(Z)V
