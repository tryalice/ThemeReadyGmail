...
.method public constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    invoke-static {p2}, Lfhc;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lfjx;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfjt;->a([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfjt;->b([B)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lfjy;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method private final a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    .line 2000
    :pswitch_0
    invoke-static {p3, p4}, Lfgw;->p(Landroid/os/Parcel;I)[I
    ...
    .line 4000
    :pswitch_1
    invoke-static {p3, p4}, Lfgw;->a(Landroid/os/Parcel;I)I
    ...
    :goto_1
    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    :pswitch_2
    invoke-static {p3, p4}, Lfgw;->q(Landroid/os/Parcel;I)[J

    move-result-object v0

    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[J)V
    ...
    :goto_5
    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[F)V
    ...
    :pswitch_4
    invoke-static {p3, p4}, Lfgw;->r(Landroid/os/Parcel;I)[D

    move-result-object v0

    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[D)V

    goto :goto_2

    :pswitch_5
    invoke-static {p3, p4}, Lfgw;->s(Landroid/os/Parcel;I)[Ljava/math/BigDecimal;
    ...
    :goto_6
    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[Z)V
    ...
    :pswitch_7
    invoke-static {p3, p4}, Lfgw;->t(Landroid/os/Parcel;I)[Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, v0}, Lfjs;->a(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    :pswitch_9
    invoke-static {p3, p4}, Lfgw;->w(Landroid/os/Parcel;I)[Landroid/os/Parcel;
    ...
    :pswitch_a
    invoke-static {p3, p4}, Lfgw;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_b
    invoke-static {p3, p4}, Lfgw;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_c
    invoke-static {p3, p4}, Lfgw;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_d
    invoke-static {p3, p4}, Lfgw;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_e
    invoke-static {p3, p4}, Lfgw;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_f
    invoke-static {p3, p4}, Lfgw;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_10
    invoke-static {p3, p4}, Lfgw;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_11
    invoke-static {p3, p4}, Lfgw;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfjx;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :pswitch_12
    invoke-static {p3, p4}, Lfgw;->o(Landroid/os/Parcel;I)[B
    ...
    invoke-static {v0}, Lfjt;->a([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfjt;->b([B)Ljava/lang/String;
    ...
    :pswitch_14
    invoke-static {p3, p4}, Lfgw;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    :pswitch_15
    invoke-static {p3, p4}, Lfgw;->v(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method private final a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p3}, Lfgw;->a(Landroid/os/Parcel;)I
    ...
    .line 6000
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->k:Lfjd;
    ...
    .line 8000
    :pswitch_0
    invoke-static {p3, v6}, Lfgw;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_1
    invoke-static {p3, v6}, Lfgw;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_2
    invoke-static {p3, v6}, Lfgw;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_3
    invoke-static {p3, v6}, Lfgw;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_4
    invoke-static {p3, v6}, Lfgw;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_5
    invoke-static {p3, v6}, Lfgw;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_6
    invoke-static {p3, v6}, Lfgw;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_7
    invoke-static {p3, v6}, Lfgw;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_8
    invoke-static {p3, v6}, Lfgw;->o(Landroid/os/Parcel;I)[B
    ...
    :pswitch_9
    invoke-static {p3, v6}, Lfgw;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v1, p3}, Lfgx;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V
...
.method private d()Landroid/os/Parcel;
    ...
    invoke-static {v0, v1}, Lfgy;->a(Landroid/os/Parcel;I)I
    ...
    invoke-static {v0, v1}, Lfgy;->b(Landroid/os/Parcel;I)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v2}, Lfgy;->a(Landroid/os/Parcel;I)I
    ...
    invoke-static {p1, v2}, Lfgy;->b(Landroid/os/Parcel;I)V
    ...
    :goto_0
    invoke-static {p1, v2, v0, p2, v4}, Lfgy;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
