...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lfke;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfka;->a([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfka;->b([B)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lfkf;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method private final a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    .line 26
    :pswitch_0
    invoke-static {p3, p4}, Lfhd;->p(Landroid/os/Parcel;I)[I
    ...
    .line 28
    :pswitch_1
    invoke-static {p3, p4}, Lfhd;->a(Landroid/os/Parcel;I)I
    ...
    :goto_1
    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    :pswitch_2
    invoke-static {p3, p4}, Lfhd;->q(Landroid/os/Parcel;I)[J

    move-result-object v0

    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[J)V
    ...
    :goto_5
    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[F)V
    ...
    :pswitch_4
    invoke-static {p3, p4}, Lfhd;->r(Landroid/os/Parcel;I)[D

    move-result-object v0

    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[D)V

    goto :goto_2

    :pswitch_5
    invoke-static {p3, p4}, Lfhd;->s(Landroid/os/Parcel;I)[Ljava/math/BigDecimal;
    ...
    :goto_6
    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[Z)V
    ...
    :pswitch_7
    invoke-static {p3, p4}, Lfhd;->t(Landroid/os/Parcel;I)[Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, v0}, Lfjz;->a(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    :pswitch_9
    invoke-static {p3, p4}, Lfhd;->w(Landroid/os/Parcel;I)[Landroid/os/Parcel;
    ...
    :pswitch_a
    invoke-static {p3, p4}, Lfhd;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_b
    invoke-static {p3, p4}, Lfhd;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_c
    invoke-static {p3, p4}, Lfhd;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_d
    invoke-static {p3, p4}, Lfhd;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_e
    invoke-static {p3, p4}, Lfhd;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_f
    invoke-static {p3, p4}, Lfhd;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_10
    invoke-static {p3, p4}, Lfhd;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_11
    invoke-static {p3, p4}, Lfhd;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfke;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :pswitch_12
    invoke-static {p3, p4}, Lfhd;->o(Landroid/os/Parcel;I)[B
    ...
    invoke-static {v0}, Lfka;->a([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfka;->b([B)Ljava/lang/String;
    ...
    :pswitch_14
    invoke-static {p3, p4}, Lfhd;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    :pswitch_15
    invoke-static {p3, p4}, Lfhd;->v(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method private final a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p3}, Lfhd;->a(Landroid/os/Parcel;)I
    ...
    .line 20
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->k:Lfjk;
    ...
    .line 22
    :pswitch_0
    invoke-static {p3, v6}, Lfhd;->d(Landroid/os/Parcel;I)I
    ...
    .line 22
    :pswitch_1
    invoke-static {p3, v6}, Lfhd;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_2
    invoke-static {p3, v6}, Lfhd;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_3
    invoke-static {p3, v6}, Lfhd;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_4
    invoke-static {p3, v6}, Lfhd;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_5
    invoke-static {p3, v6}, Lfhd;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_6
    invoke-static {p3, v6}, Lfhd;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_7
    invoke-static {p3, v6}, Lfhd;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_8
    invoke-static {p3, v6}, Lfhd;->o(Landroid/os/Parcel;I)[B
    ...
    :pswitch_9
    invoke-static {p3, v6}, Lfhd;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v1, p3}, Lfhe;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V
...
.method private d()Landroid/os/Parcel;
    ...
    invoke-static {v0, v1}, Lfhf;->a(Landroid/os/Parcel;I)I
    ...
    .line 13
    invoke-static {v0, v1}, Lfhf;->b(Landroid/os/Parcel;I)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v2}, Lfhf;->a(Landroid/os/Parcel;I)I
    ...
    invoke-static {p1, v2}, Lfhf;->b(Landroid/os/Parcel;I)V
    ...
    :goto_0
    invoke-static {p1, v2, v0, p2, v4}, Lfhf;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
