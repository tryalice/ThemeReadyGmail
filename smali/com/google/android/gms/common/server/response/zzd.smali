...
.method public constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    invoke-static {p2}, Lfkx;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lfns;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfno;->a([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lfno;->b([B)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lfnt;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method private final a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    .line 45
    :pswitch_0
    invoke-static {p3, p4}, Lfkr;->p(Landroid/os/Parcel;I)[I
    ...
    .line 48
    :pswitch_1
    invoke-static {p3, p4}, Lfkr;->a(Landroid/os/Parcel;I)I
    ...
    .line 49
    :goto_1
    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    .line 49
    :pswitch_2
    invoke-static {p3, p4}, Lfkr;->q(Landroid/os/Parcel;I)[J

    move-result-object v0

    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[J)V
    ...
    .line 51
    :goto_5
    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[F)V
    ...
    .line 51
    :pswitch_4
    invoke-static {p3, p4}, Lfkr;->r(Landroid/os/Parcel;I)[D

    move-result-object v0

    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[D)V

    goto :goto_2

    :pswitch_5
    invoke-static {p3, p4}, Lfkr;->s(Landroid/os/Parcel;I)[Ljava/math/BigDecimal;
    ...
    .line 53
    :goto_6
    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[Z)V
    ...
    .line 53
    :pswitch_7
    invoke-static {p3, p4}, Lfkr;->t(Landroid/os/Parcel;I)[Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, v0}, Lfnn;->a(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    :pswitch_9
    invoke-static {p3, p4}, Lfkr;->w(Landroid/os/Parcel;I)[Landroid/os/Parcel;
    ...
    :pswitch_a
    invoke-static {p3, p4}, Lfkr;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_b
    invoke-static {p3, p4}, Lfkr;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_c
    invoke-static {p3, p4}, Lfkr;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_d
    invoke-static {p3, p4}, Lfkr;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_e
    invoke-static {p3, p4}, Lfkr;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_f
    invoke-static {p3, p4}, Lfkr;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_10
    invoke-static {p3, p4}, Lfkr;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_11
    invoke-static {p3, p4}, Lfkr;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfns;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :pswitch_12
    invoke-static {p3, p4}, Lfkr;->o(Landroid/os/Parcel;I)[B
    ...
    invoke-static {v0}, Lfno;->a([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfno;->b([B)Ljava/lang/String;
    ...
    :pswitch_14
    invoke-static {p3, p4}, Lfkr;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    :pswitch_15
    invoke-static {p3, p4}, Lfkr;->v(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method private final a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p3}, Lfkr;->a(Landroid/os/Parcel;)I
    ...
    .line 32
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->k:Lfmy;
    ...
    .line 36
    :pswitch_0
    invoke-static {p3, v6}, Lfkr;->d(Landroid/os/Parcel;I)I
    ...
    .line 36
    :pswitch_1
    invoke-static {p3, v6}, Lfkr;->h(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_2
    invoke-static {p3, v6}, Lfkr;->f(Landroid/os/Parcel;I)J
    ...
    :pswitch_3
    invoke-static {p3, v6}, Lfkr;->i(Landroid/os/Parcel;I)F
    ...
    :pswitch_4
    invoke-static {p3, v6}, Lfkr;->j(Landroid/os/Parcel;I)D
    ...
    :pswitch_5
    invoke-static {p3, v6}, Lfkr;->k(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_6
    invoke-static {p3, v6}, Lfkr;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_7
    invoke-static {p3, v6}, Lfkr;->l(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_8
    invoke-static {p3, v6}, Lfkr;->o(Landroid/os/Parcel;I)[B
    ...
    :pswitch_9
    invoke-static {p3, v6}, Lfkr;->n(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v1, p3}, Lfks;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V
...
.method private d()Landroid/os/Parcel;
    ...
    invoke-static {v0, v1}, Lfkt;->a(Landroid/os/Parcel;I)I
    ...
    .line 20
    invoke-static {v0, v1}, Lfkt;->b(Landroid/os/Parcel;I)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 9
    invoke-static {p1, v0, v2}, Lfkt;->b(Landroid/os/Parcel;II)V
    ...
    invoke-static {p1, v2}, Lfkt;->a(Landroid/os/Parcel;I)I
    ...
    invoke-static {p1, v2}, Lfkt;->b(Landroid/os/Parcel;I)V
    ...
    .line 13
    :goto_0
    invoke-static {p1, v2, v0, p2, v4}, Lfkt;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
