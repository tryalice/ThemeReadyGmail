...
.method private constructor <init>(JJLjava/util/Map;Ljava/util/Set;Lemf;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 2
    invoke-static/range {p5 .. p5}, Lemb;->a(Ljava/util/Map;)Z
    ...
    .line 3
    invoke-virtual/range {p7 .. p7}, Lemf;->n()J
...
.method private constructor <init>(JJLjava/util/Map;Ljava/util/Set;Lemf;B)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJ",
    ...
    .prologue
    .line 13
    invoke-direct/range {p0 .. p7}, Lcom/google/android/gm/ConversationInfo;-><init>(JJLjava/util/Map;Ljava/util/Set;Lemf;)V

    .line 14
    return-void
.end method

.method public static a(Lemd;Lemf;)Lcom/google/android/gm/ConversationInfo;
    .locals 10
    ...
    .line 15
    .line 16
    iget-object v0, p0, Lemi;->z:Landroid/database/Cursor;
    ...
    .line 21
    invoke-virtual {p0}, Lemd;->a()J

    move-result-wide v2

    .line 23
    iget-object v0, p0, Lemd;->z:Landroid/database/Cursor;
    ...
    .line 24
    invoke-virtual {p0}, Lemd;->b()Ljava/util/Map;
    ...
    .line 28
    iget-object v7, p0, Lemd;->w:Landroid/text/TextUtils$StringSplitter;
    ...
    .line 29
    iget-object v0, p0, Lemd;->w:Landroid/text/TextUtils$StringSplitter;
    ...
    .line 32
    invoke-direct/range {v1 .. v9}, Lcom/google/android/gm/ConversationInfo;-><init>(JJLjava/util/Map;Ljava/util/Set;Lemf;B)V
    ...
    invoke-static {v0}, Lemb;->b(Ljava/util/Map;)Ljava/util/Set;
