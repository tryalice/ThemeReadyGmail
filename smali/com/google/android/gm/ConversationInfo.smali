...
.method private constructor <init>(JJLjava/util/Map;Ljava/util/Set;Leuc;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 2
    invoke-static/range {p5 .. p5}, Lety;->a(Ljava/util/Map;)Z
    ...
    .line 3
    invoke-virtual/range {p7 .. p7}, Leuc;->n()J
...
.method private constructor <init>(JJLjava/util/Map;Ljava/util/Set;Leuc;B)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJ",
    ...
    .prologue
    .line 13
    invoke-direct/range {p0 .. p7}, Lcom/google/android/gm/ConversationInfo;-><init>(JJLjava/util/Map;Ljava/util/Set;Leuc;)V

    .line 14
    return-void
.end method

.method public static a(Leua;Leuc;)Lcom/google/android/gm/ConversationInfo;
    .locals 10
    ...
    .line 22
    invoke-virtual {p0}, Leua;->a()J

    move-result-wide v2

    .line 24
    iget-object v0, p0, Leua;->z:Landroid/database/Cursor;
    ...
    .line 26
    invoke-virtual {p0}, Leua;->b()Ljava/util/Map;
    ...
    .line 30
    iget-object v7, p0, Leua;->w:Landroid/text/TextUtils$StringSplitter;
    ...
    .line 31
    iget-object v0, p0, Leua;->w:Landroid/text/TextUtils$StringSplitter;
    ...
    .line 35
    invoke-direct/range {v1 .. v9}, Lcom/google/android/gm/ConversationInfo;-><init>(JJLjava/util/Map;Ljava/util/Set;Leuc;B)V
    ...
    invoke-static {v0}, Lety;->b(Ljava/util/Map;)Ljava/util/Set;
