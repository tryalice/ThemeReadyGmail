...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .prologue
    .line 3
    invoke-direct {p0, p1, p2}, Lcke;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->z:Leud;
    ...
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->A:Lebh;
    ...
    .line 8
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Ldzb;

    .line 9
    return-void
.end method

.method private static a(Ljava/net/URI;Lebf;Lcom/google/android/apps/viewer/client/TokenSource;)Lcom/google/android/apps/viewer/client/AuthenticatedUri;
    .locals 2
    ...
    invoke-virtual {p1, v0}, Lebf;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method protected final d()Z
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Ldzb;
    ...
    .line 11
    invoke-virtual {v0}, Ldzb;->a()Landroid/content/Intent;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Ldzb;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    invoke-direct {v9, v0, v1, v2}, Ldyr;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v0, v1}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;
    ...
    .line 22
    invoke-static {v0}, Ldym;->a([Ldyn;)J
    ...
    .line 31
    invoke-virtual {v1, v0}, Lebg;->a(Landroid/content/ContentResolver;)Lebf;
    ...
    invoke-direct {v0, p0}, Lehj;-><init>(Lcom/google/android/gm/browse/GmailAttachmentTile;)V

    invoke-direct {v14, v0}, Lcom/google/android/apps/viewer/client/TokenSourceProxy;-><init>(Ldzg;)V

    .line 36
    iget-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->z:Leud;
    ...
    invoke-static {v5, v1}, Leud;->a(ILjava/util/List;)V
    ...
    .line 43
    invoke-virtual {v0, v1}, Leud;->a(Ljava/util/List;)Ljava/net/URI;

    move-result-object v0

    .line 45
    invoke-static {}, Ldyd;->a()Ldyg;

    move-result-object v1

    invoke-static {v0, v13, v14}, Lcom/google/android/gm/browse/GmailAttachmentTile;->a(Ljava/net/URI;Lebf;Lcom/google/android/apps/viewer/client/TokenSource;)Lcom/google/android/apps/viewer/client/AuthenticatedUri;

    move-result-object v0

    invoke-virtual {v9, v1, v0}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;
    ...
    invoke-virtual/range {v0 .. v7}, Leud;->a(IJLjava/lang/String;IIZ)Ljava/net/URI;

    move-result-object v0

    .line 47
    sget-object v1, Ldyd;->i:Ldyd;
    ...
    .line 49
    sget-object v0, Ldyd;->v:Ldyd;

    invoke-virtual {v9, v0, v8}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;

    .line 50
    sget-object v0, Ldyd;->w:Ldyd;

    invoke-virtual {v9, v0, v12}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;

    .line 51
    sget-object v0, Ldyd;->x:Ldyd;

    invoke-virtual {v9, v0, v4}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;
    ...
    invoke-static {v10, v11, v0}, Ldym;->a(J[Ldyn;)J

    move-result-wide v0

    .line 53
    :goto_3
    sget-object v2, Ldyd;->u:Ldyd;

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    invoke-virtual {v9, v2, v0}, Ldyr;->b(Ldyd;Ljava/lang/Object;)Ldyr;
    ...
    .line 57
    iget-object v2, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Ldzb;

    invoke-static {v2}, Ldyw;->a(Ldzb;)Ldyw;
    ...
    .line 60
    iget-object v4, v3, Ldyw;->b:Ldzb;

    invoke-virtual {v4}, Ldzb;->a()Landroid/content/Intent;
    ...
    invoke-virtual {v3, v4, v1}, Ldyw;->a(Landroid/content/Intent;Ldys;)V
    ...
    invoke-direct {v5, v3, v4, v2}, Ldyx;-><init>(Ldyw;Landroid/content/Intent;Ldys;)V

    .line 66
    iget-object v1, v5, Ldyx;->a:Landroid/content/Intent;
    ...
    iget-object v1, v5, Ldyx;->b:Ldys;

    invoke-interface {v1}, Ldys;->a()Ljava/lang/String;
    ...
    .line 76
    iget-object v4, v5, Ldyx;->a:Landroid/content/Intent;
    ...
    iget-object v7, v5, Ldyx;->a:Landroid/content/Intent;
    ...
    iget-object v6, v5, Ldyx;->a:Landroid/content/Intent;

    invoke-static {v6}, Ldyw;->a(Landroid/content/Intent;)I
    ...
    .line 86
    :cond_3
    iget-object v2, v5, Ldyx;->c:Ldyw;

    iget-object v2, v2, Ldyw;->b:Ldzb;

    invoke-virtual {v0}, Landroid/app/Activity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Ldzb;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
