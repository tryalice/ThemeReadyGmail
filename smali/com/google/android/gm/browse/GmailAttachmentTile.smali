...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .prologue
    .line 3
    invoke-direct {p0, p1, p2}, Lcld;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->z:Leyg;
    ...
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->A:Leff;
    ...
    .line 8
    iput-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Lecz;

    .line 9
    return-void
.end method

.method private static a(Ljava/net/URI;Lefd;Lcom/google/android/apps/viewer/client/TokenSource;)Lcom/google/android/apps/viewer/client/AuthenticatedUri;
    .locals 2
    ...
    invoke-virtual {p1, v0}, Lefd;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method protected final d()Z
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Lecz;
    ...
    .line 11
    invoke-virtual {v0}, Lecz;->a()Landroid/content/Intent;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lecz;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    invoke-direct {v9, v0, v1, v2}, Lecp;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v0, v1}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;

    .line 21
    const/4 v0, 0x5

    new-array v0, v0, [Lecl;

    const/4 v1, 0x0

    sget-object v2, Lecn;->d:Lecn;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lecn;->b:Lecn;
    ...
    .line 22
    invoke-static {v0}, Leck;->a([Lecl;)J
    ...
    .line 31
    invoke-virtual {v1, v0}, Lefe;->a(Landroid/content/ContentResolver;)Lefd;
    ...
    invoke-direct {v0, p0}, Lelh;-><init>(Lcom/google/android/gm/browse/GmailAttachmentTile;)V

    invoke-direct {v14, v0}, Lcom/google/android/apps/viewer/client/TokenSourceProxy;-><init>(Lede;)V

    .line 36
    iget-object v0, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->z:Leyg;
    ...
    invoke-static {v5, v1}, Leyg;->a(ILjava/util/List;)V
    ...
    .line 43
    invoke-virtual {v0, v1}, Leyg;->a(Ljava/util/List;)Ljava/net/URI;

    move-result-object v0

    .line 45
    invoke-static {}, Lecb;->a()Lece;

    move-result-object v1

    invoke-static {v0, v13, v14}, Lcom/google/android/gm/browse/GmailAttachmentTile;->a(Ljava/net/URI;Lefd;Lcom/google/android/apps/viewer/client/TokenSource;)Lcom/google/android/apps/viewer/client/AuthenticatedUri;

    move-result-object v0

    invoke-virtual {v9, v1, v0}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;
    ...
    invoke-virtual/range {v0 .. v7}, Leyg;->a(IJLjava/lang/String;IIZ)Ljava/net/URI;

    move-result-object v0

    .line 47
    sget-object v1, Lecb;->i:Lecb;
    ...
    .line 49
    sget-object v0, Lecb;->v:Lecb;

    invoke-virtual {v9, v0, v8}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;

    .line 50
    sget-object v0, Lecb;->w:Lecb;

    invoke-virtual {v9, v0, v12}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;

    .line 51
    sget-object v0, Lecb;->x:Lecb;

    invoke-virtual {v9, v0, v4}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;
    ...
    invoke-static {v10, v11, v0}, Leck;->a(J[Lecl;)J

    move-result-wide v0

    .line 53
    :goto_3
    sget-object v2, Lecb;->u:Lecb;

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    invoke-virtual {v9, v2, v0}, Lecp;->b(Lecb;Ljava/lang/Object;)Lecp;
    ...
    .line 57
    iget-object v2, p0, Lcom/google/android/gm/browse/GmailAttachmentTile;->B:Lecz;

    invoke-static {v2}, Lecu;->a(Lecz;)Lecu;
    ...
    .line 60
    iget-object v4, v3, Lecu;->b:Lecz;

    invoke-virtual {v4}, Lecz;->a()Landroid/content/Intent;
    ...
    invoke-virtual {v3, v4, v1}, Lecu;->a(Landroid/content/Intent;Lecq;)V
    ...
    invoke-direct {v5, v3, v4, v2}, Lecv;-><init>(Lecu;Landroid/content/Intent;Lecq;)V

    .line 66
    iget-object v1, v5, Lecv;->a:Landroid/content/Intent;
    ...
    iget-object v1, v5, Lecv;->b:Lecq;

    invoke-interface {v1}, Lecq;->a()Ljava/lang/String;
    ...
    .line 76
    iget-object v4, v5, Lecv;->a:Landroid/content/Intent;
    ...
    iget-object v7, v5, Lecv;->a:Landroid/content/Intent;
    ...
    iget-object v6, v5, Lecv;->a:Landroid/content/Intent;

    invoke-static {v6}, Lecu;->a(Landroid/content/Intent;)I
    ...
    .line 86
    :cond_3
    iget-object v2, v5, Lecv;->c:Lecu;

    iget-object v2, v2, Lecu;->b:Lecz;

    invoke-virtual {v0}, Landroid/app/Activity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Lecz;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
