...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;Leby;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Lebc;-><init>(Lorg/apache/http/client/HttpClient;Leby;Ljava/lang/String;)V
...
.method public final a(Landroid/accounts/Account;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 6
    sget-object v4, Lebc;->b:Ljava/lang/String;
    ...
    iget-object v5, p0, Lebc;->e:Ljava/lang/String;

    invoke-virtual {v0, p1, v5}, Leby;->a(Landroid/accounts/Account;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Leca;-><init>(Lorg/apache/http/HttpResponse;)V
    ...
    .line 50
    :try_start_1
    sget-object v2, Ldzl;->a:Ljava/lang/String;
    ...
    .line 21
    invoke-static {v1}, Lkda;->a(Ljava/io/InputStream;)[B

    move-result-object v0

    .line 22
    sget-object v4, Ljkn;->b:Ljkn;
    ...
    invoke-static {v4, v0, v5}, Lkkk;->a(Lkkk;[BLcom/google/protobuf/ExtensionRegistryLite;)Lkkk;
    ...
    invoke-virtual {v0, v4, v5, v6}, Lkkk;->a(ILjava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final a(Landroid/accounts/Account;Ljava/lang/String;Ljkr;)Ljkv;
    .locals 6
    ...
    .line 56
    :try_start_0
    invoke-virtual {p0, v0, p3, p1}, Ldzl;->a(Ljava/lang/String;Lkmq;Landroid/accounts/Account;)Lorg/apache/http/HttpEntity;
    ...
    .catch Leca; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 81
    :cond_3
    iget-object v0, v0, Ljkt;->b:Ljkv;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Leca; {:try_start_1 .. :try_end_1} :catch_1
    .catch Lebx; {:try_start_1 .. :try_end_1} :catch_2
