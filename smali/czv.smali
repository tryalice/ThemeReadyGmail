...
.method protected final a(I)V
    ...
    invoke-virtual {v1, v5}, Ldfs;->getItem(I)Ljava/lang/Object;

    move-result-object v2

    .line 1151
    instance-of v1, v2, Ldnd;
    ...
    .line 3072
    iput-boolean v4, v1, Ldnd;->b:Z

    .line 3073
    check-cast v2, Ldnd;

    .line 4064
    iget-object v1, v2, Ldnd;->a:Lcom/android/mail/providers/Folder;

    .line 1154
    iget-object v2, p0, Lczv;->b:Ljava/util/HashMap;
    ...
    .line 1162
    iget-object v1, p0, Lczv;->b:Ljava/util/HashMap;

    iget-object v2, v0, Lcom/android/mail/providers/Folder;->e:Ldnf;
...
.method protected final a(Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 79
    iget-object v0, p0, Lczv;->e:Ljava/util/Collection;
    ...
    .line 87
    :cond_0
    iget-object v0, p0, Lczv;->h:Lcom/android/mail/providers/Folder;
    ...
    .line 90
    :cond_1
    invoke-static {v2}, Ljhl;->a(Ljava/util/Collection;)Ljhl;
    ...
    .line 102
    invoke-static {p2, v0, v3, v1}, Lczd;->a(Landroid/database/Cursor;Ljava/util/Set;Ljava/util/Set;Z)Landroid/database/Cursor;
    ...
    invoke-direct {v4, p1, v0, v2, v5}, Lczd;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V

    invoke-virtual {v1, v4}, Ldfs;->a(Lddm;)V
    ...
    invoke-direct {v3, p1, v0, v2, v4}, Lczd;-><init>(Landroid/content/Context;Landroid/database/Cursor;Ljava/util/Set;I)V

    invoke-virtual {v1, v3}, Ldfs;->a(Lddm;)V
...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v2, p0, Lczv;->e:Ljava/util/Collection;

    iget-boolean v3, p0, Lczv;->f:Z

    const/4 v4, 0x0

    invoke-interface {v0, v1, v2, v3, v4}, Ldaq;->a(Ljava/util/Collection;Ljava/util/Collection;ZZ)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .line 60
    invoke-super {p0, p1}, Lddj;->onCreate(Landroid/os/Bundle;)V

    .line 62
    iget-object v0, p0, Lczv;->g:Lcom/android/mail/providers/Account;
    ...
    .line 69
    iget-object v5, p0, Lczv;->b:Ljava/util/HashMap;
    ...
    .line 73
    :cond_1
    invoke-virtual {p0}, Lczv;->getLoaderManager()Landroid/app/LoaderManager;
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 121
    invoke-super {p0, p1}, Lddj;->onSaveInstanceState(Landroid/os/Bundle;)V
