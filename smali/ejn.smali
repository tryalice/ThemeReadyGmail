...
.method public static b(Landroid/content/Context;Landroid/os/Bundle;)Lejo;
    .locals 8
    ...
    iput-wide v4, v3, Lejo;->c:J

    .line 7
    iput-object v0, v3, Lejo;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Leqb;->a(Landroid/content/ContentResolver;)Z

    move-result v5

    .line 10
    invoke-static {p0, v0, v4, v5}, Lejn;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Liqu;
    ...
    .line 14
    iput-object v1, v4, Lirc;->messageId:Ljava/lang/String;
    ...
    .line 21
    iput-object v1, v4, Lirc;->partId:Ljava/lang/String;

    .line 23
    new-instance v1, Liqv;

    invoke-direct {v1, v0}, Liqv;-><init>(Liqu;)V

    .line 25
    new-instance v0, Liqw;

    invoke-direct {v0, v1, v4}, Liqw;-><init>(Liqv;Lirc;)V

    .line 28
    invoke-virtual {v0}, Liqw;->c()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lirc;

    iput-object v0, v3, Lejo;->b:Lirc;
    :try_end_0
...
.method public final synthetic a(Landroid/content/Context;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-static {p1, p2}, Lejn;->b(Landroid/content/Context;Landroid/os/Bundle;)Lejo;
