...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;Ldpp;)V
    .locals 8
    ...
    invoke-direct {v0, p1}, Lcir;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Ldpq;->b:Lcir;
    ...
    iput-object v0, p0, Ldpq;->d:Lcom/android/mail/providers/Account;
    ...
    iput-object v0, p0, Ldpq;->i:Ljava/lang/String;
    ...
    .line 16
    iput-object v0, p0, Ldpq;->g:Landroid/net/Uri;

    .line 17
    iput-object v1, p0, Ldpq;->h:Landroid/net/Uri;

    .line 26
    :goto_0
    new-instance v0, Ldpn;

    invoke-direct {v0, p1}, Ldpn;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Ldpq;->j:Ldpn;

    .line 27
    iput-object p3, p0, Ldpq;->s:Ldpp;
    ...
    iput-object v1, p0, Ldpq;->g:Landroid/net/Uri;

    .line 22
    iget-object v0, v0, Lcom/android/mail/providers/Folder;->u:Landroid/net/Uri;

    iput-object v0, p0, Ldpq;->h:Landroid/net/Uri;
    ...
    iget-object v2, p0, Ldpq;->d:Lcom/android/mail/providers/Account;

    iget v3, p0, Ldpq;->e:I

    iget v4, p0, Ldpq;->f:I

    iget-object v5, p0, Ldpq;->g:Landroid/net/Uri;

    iget-object v6, p0, Ldpq;->h:Landroid/net/Uri;

    iget-object v7, p0, Ldpq;->i:Ljava/lang/String;
...
.method private final a()I
    ...
    .prologue
    .line 85
    sget-object v1, Ldpp;->a:Ljava/lang/Object;
    ...
    .line 87
    :try_start_0
    iget-object v0, p0, Ldpq;->l:Landroid/database/Cursor;
...
.method private final a(Ljava/util/List;)Landroid/text/SpannableStringBuilder;
    ...
    .line 185
    iget-object v7, p0, Ldpq;->b:Lcir;

    iget-object v7, v7, Lcir;->D:Ljava/lang/CharSequence;
    ...
    .line 187
    iget-object v4, p0, Ldpq;->u:Ljava/lang/String;

    invoke-static {v0}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v7

    iget-object v8, p0, Ldpq;->u:Ljava/lang/String;
    ...
    invoke-static {v1, v4}, Ldpq;->a([Landroid/text/style/CharacterStyle;Ljava/lang/CharSequence;)Landroid/text/SpannableString;
    ...
    .line 192
    :cond_2
    iget-object v4, p0, Ldpq;->t:Ljava/lang/String;
...
.method private final b()Landroid/widget/RemoteViews;
    ...
    iget-object v2, p0, Ldpq;->g:Landroid/net/Uri;

    iget-object v3, p0, Ldpq;->d:Lcom/android/mail/providers/Account;

    invoke-static {v1, v2, v3}, Ldot;->a(Landroid/content/Context;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Landroid/content/Intent;
    ...
    iget-object v3, p0, Ldpq;->a:Landroid/content/Context;
...
.method public final getCount()I
    ...
    .line 77
    sget-object v3, Ldpp;->a:Ljava/lang/Object;
    ...
    .line 79
    :try_start_0
    invoke-direct {p0}, Ldpq;->a()I

    move-result v4

    .line 80
    iget-object v2, p0, Ldpq;->l:Landroid/database/Cursor;
    ...
    :goto_1
    iput-boolean v2, p0, Ldpq;->q:Z

    .line 83
    iget-boolean v2, p0, Ldpq;->q:Z
...
.method public final getLoadingView()Landroid/widget/RemoteViews;
    ...
    iget-object v2, p0, Ldpq;->a:Landroid/content/Context;
...
.method public final getViewAt(I)Landroid/widget/RemoteViews;
    ...
    .prologue
    .line 91
    sget-object v11, Ldpp;->a:Ljava/lang/Object;
    ...
    iget-object v2, v0, Ldpq;->l:Landroid/database/Cursor;
    ...
    iget-boolean v2, v0, Ldpq;->q:Z

    if-eqz v2, :cond_1

    .line 94
    invoke-direct/range {p0 .. p0}, Ldpq;->a()I
    ...
    .line 95
    :cond_0
    invoke-direct/range {p0 .. p0}, Ldpq;->b()Landroid/widget/RemoteViews;
    ...
    .line 97
    sget-object v2, Ldpp;->b:Ljava/lang/String;
    ...
    iget-object v9, v0, Ldpq;->d:Lcom/android/mail/providers/Account;

    move-object/from16 v0, p0

    iget v10, v0, Ldpq;->f:I
    ...
    .line 104
    invoke-static/range {v2 .. v10}, Lcix;->a(Lcir;Lcom/android/mail/providers/ConversationInfo;Ljava/lang/String;ILjava/util/ArrayList;Ljava/util/ArrayList;Lcfy;Lcom/android/mail/providers/Account;Z)V

    .line 105
    move-object/from16 v0, p0

    invoke-direct {v0, v6}, Ldpq;->a(Ljava/util/List;)Landroid/text/SpannableStringBuilder;
    ...
    iget-object v2, v0, Ldpq;->a:Landroid/content/Context;
    ...
    iget-object v7, v0, Ldpq;->j:Ldpn;

    move-object/from16 v0, p0

    iget-object v8, v0, Ldpq;->a:Landroid/content/Context;
    ...
    iget-object v2, v0, Ldpq;->g:Landroid/net/Uri;

    invoke-direct {v10, v2}, Ldmh;-><init>(Landroid/net/Uri;)V
    ...
    .line 114
    :goto_2
    invoke-virtual {v12}, Lcom/android/mail/providers/Conversation;->f()Ljava/lang/String;
    ...
    .line 119
    :goto_3
    invoke-static {v6, v15, v2}, Ldpn;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v6, v0, v2}, Ldpn;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v2, v0, v3}, Ldpn;->a(Ljava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    .line 136
    invoke-virtual {v12}, Lcom/android/mail/providers/Conversation;->e()Z
    ...
    invoke-direct {v3, v8}, Ldpo;-><init>(Landroid/content/Context;)V

    iput-object v3, v7, Ldpn;->f:Ldpo;

    .line 152
    iget-object v3, v7, Ldpn;->f:Ldpo;

    invoke-virtual {v3, v12, v9, v10, v4}, Ldco;->a(Lcom/android/mail/providers/Conversation;Lcom/android/mail/providers/Account;Ldmh;I)V

    .line 153
    iget-object v3, v7, Ldpn;->f:Ldpo;

    invoke-virtual {v3, v2}, Ldpo;->a(Landroid/widget/RemoteViews;)V
    ...
    iget-object v3, v0, Ldpq;->a:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v4, v0, Ldpq;->g:Landroid/net/Uri;

    move-object/from16 v0, p0

    iget-object v5, v0, Ldpq;->d:Lcom/android/mail/providers/Account;

    invoke-static {v3, v12, v4, v5}, Ldot;->a(Landroid/content/Context;Lcom/android/mail/providers/Conversation;Landroid/net/Uri;Lcom/android/mail/providers/Account;)Landroid/content/Intent;
...
.method public final onCreate()V
    ...
    iget-object v3, p0, Ldpq;->g:Landroid/net/Uri;

    invoke-virtual {v3}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v1, v2, v3}, Ldpp;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;Ljava/lang/String;)V

    .line 30
    iget-object v0, p0, Ldpq;->s:Ldpp;
    ...
    invoke-virtual {v0, v1, v2, v3}, Ldpp;->a(Landroid/content/Context;ILcom/android/mail/providers/Account;)Z
    ...
    .line 32
    :cond_0
    iput-boolean v9, p0, Ldpq;->r:Z

    .line 33
    iget-object v0, p0, Ldpq;->h:Landroid/net/Uri;
    ...
    iput-object v0, p0, Ldpq;->k:Landroid/content/CursorLoader;

    .line 44
    iget-object v0, p0, Ldpq;->k:Landroid/content/CursorLoader;
    ...
    iput-object v0, p0, Ldpq;->t:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldpq;->u:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldpq;->m:Landroid/content/CursorLoader;

    .line 50
    iget-object v0, p0, Ldpq;->m:Landroid/content/CursorLoader;
    ...
    invoke-direct {v0, p0, v1}, Ldpr;-><init>(Ldpq;I)V

    iput-object v0, p0, Ldpq;->o:Ldpr;

    .line 53
    iget-object v0, p0, Ldpq;->o:Ldpr;

    invoke-virtual {v0}, Ldpr;->a()V
    ...
    sget-object v3, Lcuz;->f:[Ljava/lang/String;
    ...
    iput-object v0, p0, Ldpq;->n:Landroid/content/CursorLoader;

    .line 55
    iget-object v0, p0, Ldpq;->n:Landroid/content/CursorLoader;
...
.method public final onDestroy()V
    ...
    iput-object v0, p0, Ldpq;->l:Landroid/database/Cursor;
    ...
    .line 69
    iput-object v2, p0, Ldpq;->m:Landroid/content/CursorLoader;
    ...
    .line 73
    iput-object v2, p0, Ldpq;->n:Landroid/content/CursorLoader;
...
.method public final synthetic onLoadComplete(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    .line 226
    invoke-static {p2}, Ldpq;->a(Landroid/database/Cursor;)Z
    ...
    iget-object v0, p0, Ldpq;->d:Lcom/android/mail/providers/Account;
    ...
    iget-object v4, p0, Ldpq;->d:Lcom/android/mail/providers/Account;

    iget v5, p0, Ldpq;->e:I

    iget v6, p0, Ldpq;->f:I

    iget-object v7, p0, Ldpq;->g:Landroid/net/Uri;

    iget-object v8, p0, Ldpq;->h:Landroid/net/Uri;

    move-object v2, v11

    invoke-virtual/range {v0 .. v9}, Ldpp;->a(Landroid/content/Context;Landroid/widget/RemoteViews;ILcom/android/mail/providers/Account;IILandroid/net/Uri;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Ldpq;->i:Ljava/lang/String;
    ...
    :cond_7
    :try_start_1
    iput-object p2, p0, Ldpq;->l:Landroid/database/Cursor;
