...
.method public static a(Landroid/content/Context;Lbpb;Lcom/android/emailcommon/provider/Account;Lcom/android/emailcommon/provider/Mailbox;I)V
    .locals 10
    ...
    .line 5
    iget-object v6, p1, Lbpb;->q:Ljava/lang/String;
    ...
    .line 14
    invoke-virtual {v0, p0, v6}, Lbpy;->a(Landroid/content/Context;Landroid/database/Cursor;)Lbpw;
    ...
    invoke-static {p0, v2, v3}, Lbpo;->a(Landroid/content/Context;J)Lbpo;
    ...
    .line 27
    invoke-static {p1, v1, v2}, Lboi;->a(Lbpg;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    .line 29
    invoke-static {v1}, Lbtt;->a(Ljava/util/ArrayList;)Lbtu;

    move-result-object v3

    .line 30
    iget-boolean v4, v3, Lbtu;->d:Z

    iget-boolean v5, v3, Lbtu;->e:Z

    invoke-virtual {v0, v4, v5}, Lbqg;->a(ZZ)V

    .line 31
    iget-object v4, v3, Lbtu;->c:Ljava/lang/String;

    iput-object v4, v0, Lbqg;->ai:Ljava/lang/String;

    .line 32
    iget-object v4, v3, Lbtu;->a:Ljava/lang/String;

    iput-object v4, v7, Lbpo;->f:Ljava/lang/String;

    .line 33
    iget-object v3, v3, Lbtu;->b:Ljava/lang/String;

    iput-object v3, v7, Lbpo;->e:Ljava/lang/String;

    .line 34
    invoke-static {v0, p0}, Lblf;->a(Lbpw;Landroid/content/Context;)V

    .line 35
    iget-wide v4, v0, Lbqg;->M:J

    iput-wide v4, v7, Lbpo;->d:J

    .line 36
    invoke-static {v7, p0}, Lblf;->a(Lbpw;Landroid/content/Context;)V

    .line 37
    invoke-static {p4}, Lbqg;->a(I)Z
    ...
    .line 38
    invoke-static {p0, v0, v2}, Lazt;->a(Landroid/content/Context;Lbqg;Ljava/util/ArrayList;)V

    .line 39
    invoke-static {p0, v0, v1}, Lazt;->b(Landroid/content/Context;Lbqg;Ljava/util/ArrayList;)V
...
.method public static a(Lbpw;Landroid/content/Context;)V
    .locals 1

    .prologue
    .line 60
    invoke-virtual {p0}, Lbpw;->g()Z
    ...
    .line 61
    invoke-virtual {p0}, Lbpw;->e()Landroid/content/ContentValues;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lbpw;->a(Landroid/content/Context;Landroid/content/ContentValues;)I
    ...
    .line 62
    :cond_0
    invoke-virtual {p0, p1}, Lbpw;->i(Landroid/content/Context;)Landroid/net/Uri;
