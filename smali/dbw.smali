...
.method static constructor <clinit>()V
    ...
    .line 71
    sput-object v0, Ldbw;->k:Ljava/lang/String;
...
.method private final a(I)V
    ...
    .prologue
    .line 68
    iget-object v0, p0, Ldbw;->b:Ladg;

    const/16 v1, 0x18

    invoke-virtual {v0, p1, v1}, Ladg;->a(II)V
...
.method private final a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Ladg;->f()Ljava/lang/CharSequence;
...
.method private final d()V
    ...
    invoke-direct {p0, v0}, Ldbw;->a(I)V
...
.method public final a(II)V
    ...
    .line 28
    invoke-direct {p0, v3}, Ldbw;->a(I)V
...
.method final a(Lcom/android/mail/providers/Account;)V
    ...
    .line 8
    :cond_1
    iget-object v0, p0, Ldbw;->f:Lcom/android/mail/providers/Account;
    ...
    .line 9
    :goto_1
    iput-object p1, p0, Ldbw;->f:Lcom/android/mail/providers/Account;

    .line 10
    if-eqz v0, :cond_0

    .line 11
    iget-object v0, p0, Ldbw;->c:Lddc;
    ...
    iget-object v5, p0, Ldbw;->f:Lcom/android/mail/providers/Account;

    iget-object v5, v5, Lcom/android/mail/providers/Account;->i:Landroid/net/Uri;

    invoke-direct {v4, v5, v0}, Ldbz;-><init>(Landroid/net/Uri;Landroid/content/ContentResolver;)V
    ...
    invoke-virtual {v4, v0}, Ldbz;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method final b()V
    ...
    .line 45
    :pswitch_0
    iget-object v1, p0, Ldbw;->h:Landroid/view/MenuItem;

    iget-object v0, p0, Ldbw;->d:Ldcb;

    .line 46
    invoke-interface {v0}, Ldcb;->aa()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Ldbw;->i:Z
    ...
    .line 47
    :goto_1
    invoke-static {v1, v0}, Ldti;->a(Landroid/view/MenuItem;Z)V
...
.method final c()V
    ...
    invoke-direct {p0, v0}, Ldbw;->a(Ljava/lang/String;)V
    ...
    .line 63
    iget-object v0, p0, Ldbw;->g:Lcom/android/mail/providers/Folder;
