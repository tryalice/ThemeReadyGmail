...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgdt;->a:Ljava/util/Map;
    ...
    sget-object v0, Lgdt;->a:Ljava/util/Map;
    ...
    sput-object v0, Lgdt;->b:Landroid/os/Handler;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, Lgdt;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lgdt;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgdt;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgdt;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lgdt;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lgdt;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lgdt;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lgdt;->j:Ljava/security/SecureRandom;

    new-instance v0, Lgdu;

    invoke-direct {v0}, Lgdu;-><init>()V

    sput-object v0, Lgdt;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lgdv;

    invoke-direct {v0}, Lgdv;-><init>()V

    sput-object v0, Lgdt;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lgdw;

    invoke-direct {v0}, Lgdw;-><init>()V

    sput-object v0, Lgdt;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lgdx;

    invoke-direct {v0}, Lgdx;-><init>()V

    sput-object v0, Lgdt;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lgdy;

    invoke-direct {v0}, Lgdy;-><init>()V

    sput-object v0, Lgdt;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lgdz;

    invoke-direct {v0}, Lgdz;-><init>()V

    sput-object v0, Lgdt;->p:Ljava/lang/ThreadLocal;
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lgdt;->m:Ljava/lang/ThreadLocal;
