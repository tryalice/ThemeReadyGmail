...
.method public static b(Landroid/content/Context;Landroid/os/Bundle;)Lenh;
    .locals 8
    ...
    iput-wide v4, v3, Lenh;->c:J

    .line 7
    iput-object v0, v3, Lenh;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Lety;->a(Landroid/content/ContentResolver;)Z

    move-result v5

    .line 10
    invoke-static {p0, v0, v4, v5}, Leng;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Lirc;
    ...
    .line 14
    iput-object v1, v4, Lirk;->messageId:Ljava/lang/String;
    ...
    .line 21
    iput-object v1, v4, Lirk;->partId:Ljava/lang/String;

    .line 23
    new-instance v1, Lird;

    invoke-direct {v1, v0}, Lird;-><init>(Lirc;)V

    .line 25
    new-instance v0, Lire;

    invoke-direct {v0, v1, v4}, Lire;-><init>(Lird;Lirk;)V

    .line 28
    invoke-virtual {v0}, Lire;->c()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lirk;

    iput-object v0, v3, Lenh;->b:Lirk;
    :try_end_0
    ...
    invoke-static {v1, v0, v2, v4}, Lcvc;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public final synthetic a(Landroid/content/Context;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-static {p1, p2}, Leng;->b(Landroid/content/Context;Landroid/os/Bundle;)Lenh;
