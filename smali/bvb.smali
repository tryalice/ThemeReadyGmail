...
.method private static a(Lbve;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 31
    :try_start_0
    invoke-interface {p0}, Lbve;->a()Ljava/io/InputStream;
    :try_end_0
    ...
    .line 32
    :try_start_1
    invoke-static {v1}, Lbva;->a(Ljava/io/InputStream;)I
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;I)Lbux;
    .locals 6
    ...
    invoke-direct {v0, p0, p1}, Lbvd;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 12
    invoke-static {v0, v2}, Lbvb;->a(Lbve;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iput-object v0, v1, Lbux;->b:Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p0, p1}, Lbvc;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
