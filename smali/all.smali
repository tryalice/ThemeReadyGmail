...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Lall;->b:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Loh;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-direct {p0, v0, p2}, Lall;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Loh;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lall;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 49
    iget-object v0, p0, Lall;->c:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 50
    iput-object v1, p0, Lall;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Lall;->b:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Lash;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lash;

    move-result-object v4

    .line 5
    invoke-virtual {v4, v3}, Lash;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    iget-object v5, p0, Lall;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lall;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_2
    invoke-virtual {v4, v9}, Lash;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    iget-object v1, p0, Lall;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lall;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    :cond_3
    iget-object v0, v4, Lash;->b:Landroid/content/res/TypedArray;
